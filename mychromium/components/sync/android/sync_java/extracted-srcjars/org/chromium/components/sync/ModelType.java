...
public class ModelType {
  @IntDef({
      ...
      SUPERVISED_USER_WHITELISTS, ARC_PACKAGE, PROXY_TABS, FIRST_PROXY_TYPE, LAST_PROXY_TYPE,
      LAST_USER_MODEL_TYPE, NIGORI, FIRST_CONTROL_MODEL_TYPE, EXPERIMENTS, LAST_CONTROL_MODEL_TYPE,
      LAST_REAL_MODEL_TYPE, MODEL_TYPE_COUNT
  })
   ...
   */
  public static final int PROXY_TABS = 34;
  public static final int FIRST_PROXY_TYPE = 34;
  public static final int LAST_PROXY_TYPE = 34;
  public static final int LAST_USER_MODEL_TYPE = 34;
  /**
   * ---- Control Types ---- An object representing a set of Nigori keys.
   */
  public static final int NIGORI = 35;
  public static final int FIRST_CONTROL_MODEL_TYPE = 35;
  /**
   * Flags to enable experimental features.
   */
  public static final int EXPERIMENTS = 36;
  public static final int LAST_CONTROL_MODEL_TYPE = 36;
  public static final int LAST_REAL_MODEL_TYPE = 36;
  /**
   ...
   */
  public static final int MODEL_TYPE_COUNT = 37;
}
