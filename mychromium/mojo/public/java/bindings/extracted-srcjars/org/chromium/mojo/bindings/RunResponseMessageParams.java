...
public final class RunResponseMessageParams extends org.chromium.mojo.bindings.Struct {
    ...
    public static RunResponseMessageParams deserialize(org.chromium.mojo.bindings.Message message) {
        return decode(new org.chromium.mojo.bindings.Decoder(message));
    }

    @SuppressWarnings("unchecked")
    public static RunResponseMessageParams decode(org.chromium.mojo.bindings.Decoder decoder0) {
        if (decoder0 == null) {
            return null;
        }
    ...
    protected final void encode(org.chromium.mojo.bindings.Encoder encoder) {
        ...
        encoder0.encode(queryVersionResult, 16, false);
    ...
    public boolean equals(Object object) {
        ...
        if (!org.chromium.mojo.bindings.BindingsHelper.equals(this.queryVersionResult, other.queryVersionResult))
            return false;
    ...
    public int hashCode() {
        ...
        result = prime * result + org.chromium.mojo.bindings.BindingsHelper.hashCode(queryVersionResult);
