...
int _arg1;
_arg1 = data.readInt();
this.onDownloadStarted(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
@Override public void onDownloadStarted(boolean started, int downloadId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_onDownloadStarted, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_onDownloadStarted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
// Conduit to pass a Surface from the sandboxed renderer to the plugin.
...
public void onDownloadStarted(boolean started, int downloadId) throws android.os.RemoteException;
}
