 ...
 public:
  ...
  static mojo::Array<uint8_t> Serialize(UserType* input) {
    return mojo::internal::StructSerializeImpl<
        OriginPtr, mojo::Array<uint8_t>>(input);
  }
...
namespace internal {
template <>
struct DataViewTraits<::url::mojom::OriginDataView> {
  using MojomType = ::url::mojom::OriginPtr;
};
}  // namespace internal
}  // namespace mojo
...
template <>
struct  StructTraits<::url::mojom::Origin, ::url::mojom::OriginPtr> {
  ...
  static decltype(::url::mojom::Origin::scheme)& scheme(
      ::url::mojom::OriginPtr& input) {
    return input->scheme;
  }
  static decltype(::url::mojom::Origin::host)& host(
      ::url::mojom::OriginPtr& input) {
    return input->host;
  }
  ...
  static bool Read(::url::mojom::OriginDataView input, ::url::mojom::OriginPtr* output);
};

namespace internal {

template <typename MaybeConstUserType>
struct Serializer<::url::mojom::OriginPtr, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::url::mojom::Origin, UserType>;
