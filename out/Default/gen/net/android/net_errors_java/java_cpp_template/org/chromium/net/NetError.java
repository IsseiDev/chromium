...
public static final int ERR_BLOCKED_ENROLLMENT_CHECK_PENDING = -24;
...
public static final int ERR_SSL_INAPPROPRIATE_FALLBACK = -157;
public static final int ERR_CT_NO_SCTS_VERIFIED_OK = -158;
...
public static final int ERR_SSL_FALLBACK_BEYOND_MINIMUM_VERSION = -165;
...
public static final int ERR_CERT_END = -215;
...
public static final int ERR_SPDY_INADEQUATE_TRANSPORT_SECURITY = -360;
public static final int ERR_SPDY_FLOW_CONTROL_ERROR = -361;
public static final int ERR_SPDY_FRAME_SIZE_ERROR = -362;
public static final int ERR_SPDY_COMPRESSION_ERROR = -363;
