...
base::subtle::AtomicWord g_ProxyChangeListener_clazz __attribute__((unused)) =
    0;
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ProxyChangeListener_create(JNIEnv* env, const
...
"Lorg/chromium/net/ProxyChangeListener;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ProxyChangeListener_clazz(env),
...
static base::android::ScopedJavaLocalRef<jstring>
    ...
    base::android::JavaRefOrBare<jstring>& property) {
  CHECK_CLAZZ(env, ProxyChangeListener_clazz(env),
      ProxyChangeListener_clazz(env), NULL);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
"Ljava/lang/String;",
  ...
  jstring ret =
static_cast<jstring>(env->CallStaticObjectMethod(ProxyChangeListener_clazz(env),
