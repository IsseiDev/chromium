...
namespace {
const char kAndroidTrafficStatsClassPath[] =
    "org/chromium/net/AndroidTrafficStats";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_AndroidTrafficStats_clazz __attribute__((unused)) =
    0;
...
"J",
  ...
  jlong ret =
      env->CallStaticLongMethod(AndroidTrafficStats_clazz(env),
          method_id);
