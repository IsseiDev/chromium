...
namespace {
const char kAndroidCellularSignalStrengthClassPath[] =
    "org/chromium/net/AndroidCellularSignalStrength";
...
static base::subtle::AtomicWord
    g_AndroidCellularSignalStrength_getSignalStrengthDbm = 0;
...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(AndroidCellularSignalStrength_clazz(env),
...
static base::subtle::AtomicWord
    g_AndroidCellularSignalStrength_getSignalStrengthLevel = 0;
