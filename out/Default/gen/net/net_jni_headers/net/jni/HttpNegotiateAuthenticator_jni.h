...
namespace {
const char kHttpNegotiateAuthenticatorClassPath[] =
    "org/chromium/net/HttpNegotiateAuthenticator";
...
void Java_org_chromium_net_HttpNegotiateAuthenticator_nativeSetResult(JNIEnv*
    env,
    jobject jcaller,
...
static base::android::ScopedJavaLocalRef<jobject>
    ...
    base::android::JavaRefOrBare<jstring>& accountType) {
...
"Lorg/chromium/net/HttpNegotiateAuthenticator;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(HttpNegotiateAuthenticator_clazz(env),
          method_id, accountType.obj());
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_HttpNegotiateAuthenticator_getNextAuthToken =
    0;
static void Java_HttpNegotiateAuthenticator_getNextAuthToken(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jlong nativeResultObject,
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsHttpNegotiateAuthenticatorSize =
      arraysize(kMethodsHttpNegotiateAuthenticator);

  if (env->RegisterNatives(HttpNegotiateAuthenticator_clazz(env),
                           kMethodsHttpNegotiateAuthenticator,
                           kMethodsHttpNegotiateAuthenticatorSize) < 0) {
