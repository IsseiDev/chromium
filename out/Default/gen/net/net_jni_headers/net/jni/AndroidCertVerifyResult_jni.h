...
namespace {
const char kAndroidCertVerifyResultClassPath[] =
    "org/chromium/net/AndroidCertVerifyResult";
...
static base::subtle::AtomicWord g_AndroidCertVerifyResult_isIssuedByKnownRoot =
    0;
...
static base::subtle::AtomicWord
    g_AndroidCertVerifyResult_getCertificateChainEncoded = 0;
