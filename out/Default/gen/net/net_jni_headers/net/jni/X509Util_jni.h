...
static void NotifyKeyChainChanged(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_net_X509Util_nativeNotifyKeyChainChanged(JNIEnv* env,
    jclass jcaller) {
  return NotifyKeyChainChanged(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}

static void RecordCertVerifyCapabilitiesHistogram(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
