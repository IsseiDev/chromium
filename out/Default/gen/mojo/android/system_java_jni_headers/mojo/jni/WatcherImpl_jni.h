...
namespace {
const char kWatcherImplClassPath[] =
    "org/chromium/mojo/system/impl/WatcherImpl";
...
static jlong CreateWatcher(JNIEnv* env, const
    base::android::JavaParamRef<jobject>& jcaller);

extern "C" __attribute__((visibility("default")))
jlong Java_org_chromium_mojo_system_impl_WatcherImpl_nativeCreateWatcher(JNIEnv*
    env, jobject jcaller) {
  return CreateWatcher(env, base::android::JavaParamRef<jobject>(env, jcaller));
}

static jint Start(JNIEnv* env, const base::android::JavaParamRef<jobject>&
    jcaller,
    jlong implPtr,
    jint mojoHandle,
    jint flags);
...
extern "C" __attribute__((visibility("default")))
jint Java_org_chromium_mojo_system_impl_WatcherImpl_nativeStart(JNIEnv* env,
    jobject jcaller,
    jlong implPtr,
    jint mojoHandle,
    jint flags) {
...
static void Cancel(JNIEnv* env, const base::android::JavaParamRef<jobject>&
    jcaller,
    jlong implPtr);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_mojo_system_impl_WatcherImpl_nativeCancel(JNIEnv* env,
    jobject jcaller,
    jlong implPtr) {
...
static void Delete(JNIEnv* env, const base::android::JavaParamRef<jobject>&
    jcaller,
    jlong implPtr);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_mojo_system_impl_WatcherImpl_nativeDelete(JNIEnv* env,
    jobject jcaller,
    jlong implPtr) {
...
static void Java_WatcherImpl_onHandleReady(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper result) {
