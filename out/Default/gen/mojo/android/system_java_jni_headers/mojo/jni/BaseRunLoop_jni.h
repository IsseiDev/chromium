...
namespace {
const char kBaseRunLoopClassPath[] =
    "org/chromium/mojo/system/impl/BaseRunLoop";
...
static jlong CreateBaseRunLoop(JNIEnv* env, const
...
jlong
    ...
    env, jobject jcaller) {
  return CreateBaseRunLoop(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}

static void Run(JNIEnv* env, const base::android::JavaParamRef<jobject>&
    jcaller,
    jlong runLoopID);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_mojo_system_impl_BaseRunLoop_nativeRun(JNIEnv* env,
    jobject jcaller,
    jlong runLoopID) {
...
static void RunUntilIdle(JNIEnv* env, const
    base::android::JavaParamRef<jobject>& jcaller,
    jlong runLoopID);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_mojo_system_impl_BaseRunLoop_nativeRunUntilIdle(JNIEnv*
    env, jobject jcaller,
    jlong runLoopID) {
...
static void Quit(JNIEnv* env, const base::android::JavaParamRef<jobject>&
    jcaller,
    jlong runLoopID);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_mojo_system_impl_BaseRunLoop_nativeQuit(JNIEnv* env,
    jobject jcaller,
    jlong runLoopID) {
...
static void PostDelayedTask(JNIEnv* env, const
    base::android::JavaParamRef<jobject>& jcaller,
    jlong runLoopID,
...
void
    ...
    jobject runnable,
    jlong delay) {
  return PostDelayedTask(env, base::android::JavaParamRef<jobject>(env,
      jcaller), runLoopID, base::android::JavaParamRef<jobject>(env, runnable),
      delay);
}

static void DeleteMessageLoop(JNIEnv* env, const
    base::android::JavaParamRef<jobject>& jcaller,
    jlong runLoopID);
...
void
    ...
    env, jobject jcaller,
    jlong runLoopID) {
  return DeleteMessageLoop(env, base::android::JavaParamRef<jobject>(env,
      jcaller), runLoopID);
}

static base::subtle::AtomicWord g_BaseRunLoop_runRunnable = 0;
static void Java_BaseRunLoop_runRunnable(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& runnable) {
