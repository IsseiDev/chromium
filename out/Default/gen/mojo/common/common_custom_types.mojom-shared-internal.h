...
#ifndef MOJO_COMMON_COMMON_CUSTOM_TYPES_MOJOM_SHARED_INTERNAL_H_
#define MOJO_COMMON_COMMON_CUSTOM_TYPES_MOJOM_SHARED_INTERNAL_H_
...
using DictionaryValue_Data = mojo::internal::NativeStruct_Data;
using Time_Data = mojo::internal::NativeStruct_Data;
using TimeDelta_Data = mojo::internal::NativeStruct_Data;
using TimeTicks_Data = mojo::internal::NativeStruct_Data;
using String16_Data = mojo::internal::NativeStruct_Data;
class Version_Data;
...
class Version_Data {
 ...
 private:
  Version_Data() : header_({sizeof(*this), 0}) {
  }
  ~Version_Data() = delete;
};
...
#endif  // MOJO_COMMON_COMMON_CUSTOM_TYPES_MOJOM_SHARED_INTERNAL_H_