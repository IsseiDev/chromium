  ...
  switch (object->tag) {
    ...
    case RunOrClosePipeInput_Tag::PEER_ASSOCIATED_ENDPOINT_CLOSED_EVENT: {
      ...
      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_peer_associated_endpoint_closed_event, "null peer_associated_endpoint_closed_event field in RunOrClosePipeInput",
              validation_context)) {
        return false;
      }
    ...
    case RunOrClosePipeInput_Tag::ASSOCIATED_ENDPOINT_CLOSED_BEFORE_SENT_EVENT: {
      ...
      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_associated_endpoint_closed_before_sent_event, "null associated_endpoint_closed_before_sent_event field in RunOrClosePipeInput",
              validation_context)) {
        return false;
      }
      if (!mojo::internal::ValidateStruct(object->data.f_associated_endpoint_closed_before_sent_event, validation_context))
        return false;
      return true;
    }
    default: {
...
// static
bool AssociatedEndpointClosedBeforeSentEvent_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
