...
define("mojo/public/interfaces/bindings/pipe_control_messages.mojom", [
  ...
  PeerAssociatedEndpointClosedEvent.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, PeerAssociatedEndpointClosedEvent.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AssociatedEndpointClosedBeforeSentEvent.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, AssociatedEndpointClosedBeforeSentEvent.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
