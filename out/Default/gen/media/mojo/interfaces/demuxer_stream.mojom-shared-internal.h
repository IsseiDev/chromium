...
struct DemuxerStream_Type_Data {
 public:
...
struct DemuxerStream_Status_Data {
 public:
  static bool const kIsExtensible = false;
...
#pragma pack(push, 1)
const uint32_t kDemuxerStream_Initialize_Name = 0;
class DemuxerStream_Initialize_Params_Data {
 ...
 private:
  DemuxerStream_Initialize_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class DemuxerStream_Initialize_ResponseParams_Data {
 ...
 private:
  DemuxerStream_Initialize_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDemuxerStream_Read_Name = 1;
class DemuxerStream_Read_Params_Data {
 ...
 private:
  DemuxerStream_Read_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class DemuxerStream_Read_ResponseParams_Data {
 ...
 private:
  DemuxerStream_Read_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDemuxerStream_EnableBitstreamConverter_Name = 2;
class DemuxerStream_EnableBitstreamConverter_Params_Data {
 ...
 private:
  DemuxerStream_EnableBitstreamConverter_Params_Data() : header_({sizeof(*this), 0}) {
  }
