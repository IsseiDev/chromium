...
bool DemuxerStream_Initialize_Params_Data::Validate(
  ...
  const DemuxerStream_Initialize_Params_Data* object = static_cast<const DemuxerStream_Initialize_Params_Data*>(data);
...
bool DemuxerStream_Initialize_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DemuxerStream_Initialize_ResponseParams_Data* object = static_cast<const DemuxerStream_Initialize_ResponseParams_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->pipe,
          "invalid pipe field in DemuxerStream_Initialize_ResponseParams", validation_context)) {
    return false;
  }
...
bool DemuxerStream_Read_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DemuxerStream_Read_Params_Data* object = static_cast<const DemuxerStream_Read_Params_Data*>(data);
...
bool DemuxerStream_Read_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DemuxerStream_Read_ResponseParams_Data* object = static_cast<const DemuxerStream_Read_ResponseParams_Data*>(data);
...
bool DemuxerStream_EnableBitstreamConverter_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const DemuxerStream_EnableBitstreamConverter_Params_Data* object = static_cast<const DemuxerStream_EnableBitstreamConverter_Params_Data*>(data);
