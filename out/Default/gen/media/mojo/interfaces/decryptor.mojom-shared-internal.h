...
#pragma pack(push, 1)
const uint32_t kDecryptor_Initialize_Name = 0;
class Decryptor_Initialize_Params_Data {
 ...
 private:
  Decryptor_Initialize_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_Decrypt_Name = 1;
class Decryptor_Decrypt_Params_Data {
 ...
 private:
  Decryptor_Decrypt_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Decryptor_Decrypt_ResponseParams_Data {
 ...
 private:
  Decryptor_Decrypt_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_CancelDecrypt_Name = 2;
class Decryptor_CancelDecrypt_Params_Data {
 ...
 private:
  Decryptor_CancelDecrypt_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_InitializeAudioDecoder_Name = 3;
class Decryptor_InitializeAudioDecoder_Params_Data {
 ...
 private:
  Decryptor_InitializeAudioDecoder_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Decryptor_InitializeAudioDecoder_ResponseParams_Data {
 ...
 private:
  Decryptor_InitializeAudioDecoder_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_InitializeVideoDecoder_Name = 4;
class Decryptor_InitializeVideoDecoder_Params_Data {
 ...
 private:
  Decryptor_InitializeVideoDecoder_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Decryptor_InitializeVideoDecoder_ResponseParams_Data {
 ...
 private:
  Decryptor_InitializeVideoDecoder_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_DecryptAndDecodeAudio_Name = 5;
class Decryptor_DecryptAndDecodeAudio_Params_Data {
 ...
 private:
  Decryptor_DecryptAndDecodeAudio_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Decryptor_DecryptAndDecodeAudio_ResponseParams_Data {
 ...
 private:
  Decryptor_DecryptAndDecodeAudio_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_DecryptAndDecodeVideo_Name = 6;
class Decryptor_DecryptAndDecodeVideo_Params_Data {
 ...
 private:
  Decryptor_DecryptAndDecodeVideo_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Decryptor_DecryptAndDecodeVideo_ResponseParams_Data {
 ...
 private:
  Decryptor_DecryptAndDecodeVideo_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_ResetDecoder_Name = 7;
class Decryptor_ResetDecoder_Params_Data {
 ...
 private:
  Decryptor_ResetDecoder_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_DeinitializeDecoder_Name = 8;
class Decryptor_DeinitializeDecoder_Params_Data {
 ...
 private:
  Decryptor_DeinitializeDecoder_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDecryptor_ReleaseSharedBuffer_Name = 9;
class Decryptor_ReleaseSharedBuffer_Params_Data {
 ...
 private:
  Decryptor_ReleaseSharedBuffer_Params_Data() : header_({sizeof(*this), 0}) {
  }
