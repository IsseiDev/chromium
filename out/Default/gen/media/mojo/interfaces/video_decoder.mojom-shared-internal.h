...
#pragma pack(push, 1)
const uint32_t kVideoDecoder_Construct_Name = 0;
class VideoDecoder_Construct_Params_Data {
 ...
 private:
  VideoDecoder_Construct_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~VideoDecoder_Construct_Params_Data() = delete;
};
static_assert(sizeof(VideoDecoder_Construct_Params_Data) == 24,
              "Bad sizeof(VideoDecoder_Construct_Params_Data)");
const uint32_t kVideoDecoder_Initialize_Name = 1;
class VideoDecoder_Initialize_Params_Data {
 ...
 private:
  VideoDecoder_Initialize_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class VideoDecoder_Initialize_ResponseParams_Data {
 ...
 private:
  VideoDecoder_Initialize_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kVideoDecoder_Decode_Name = 2;
class VideoDecoder_Decode_Params_Data {
 ...
 private:
  VideoDecoder_Decode_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class VideoDecoder_Decode_ResponseParams_Data {
 ...
 private:
  VideoDecoder_Decode_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kVideoDecoder_Reset_Name = 3;
class VideoDecoder_Reset_Params_Data {
 ...
 private:
  VideoDecoder_Reset_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class VideoDecoder_Reset_ResponseParams_Data {
 ...
 private:
  VideoDecoder_Reset_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kVideoDecoderClient_OnVideoFrameDecoded_Name = 0;
class VideoDecoderClient_OnVideoFrameDecoded_Params_Data {
 ...
 private:
  VideoDecoderClient_OnVideoFrameDecoded_Params_Data() : header_({sizeof(*this), 0}) {
  }
