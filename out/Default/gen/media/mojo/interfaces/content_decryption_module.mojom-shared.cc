...
bool CdmPromiseResult_Data::Validate(
  ...
  if (!::media::mojom::internal::CdmException_Data
...
bool ContentDecryptionModule_CreateSessionAndGenerateRequest_Params_Data::Validate(
  ...
  if (!::media::mojom::internal::ContentDecryptionModule_SessionType_Data
        ::Validate(object->session_type, validation_context))
    return false;


  if (!::media::mojom::internal::ContentDecryptionModule_InitDataType_Data
...
bool ContentDecryptionModuleClient_OnSessionMessage_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->legacy_destination_url, "null legacy_destination_url field in ContentDecryptionModuleClient_OnSessionMessage_Params",
          validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->legacy_destination_url, validation_context))
    return false;
...
// static
bool ContentDecryptionModuleClient_OnLegacySessionError_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ContentDecryptionModuleClient_OnLegacySessionError_Params_Data* object = static_cast<const ContentDecryptionModuleClient_OnLegacySessionError_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->session_id, "null session_id field in ContentDecryptionModuleClient_OnLegacySessionError_Params",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams session_id_validate_params(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->error_message, "null error_message field in ContentDecryptionModuleClient_OnLegacySessionError_Params",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams error_message_validate_params(
...
bool ContentDecryptionModuleClient_OnSessionKeysChange_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->key_information, "null key_information field in ContentDecryptionModuleClient_OnSessionKeysChange_Params",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams key_information_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->key_information, validation_context,
                                         &key_information_validate_params)) {
    return false;
  }
