...
bool Renderer_Initialize_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->client,
          "invalid client field in Renderer_Initialize_Params", validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterface(object->audio,
                                                 validation_context)) {
    return false;
  }

  if (!mojo::internal::ValidateHandleOrInterface(object->video,
                                                 validation_context)) {
    return false;
  }
...
bool Renderer_StartPlayingFrom_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->time, "null time field in Renderer_StartPlayingFrom_Params",
          validation_context)) {
    return false;
  }
...
bool RendererClient_OnTimeUpdate_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->time, "null time field in RendererClient_OnTimeUpdate_Params",
          validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->time, validation_context))
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->max_time, "null max_time field in RendererClient_OnTimeUpdate_Params",
          validation_context)) {
    return false;
  }
...
bool RendererClient_OnVideoNaturalSizeChange_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->size, "null size field in RendererClient_OnVideoNaturalSizeChange_Params",
          validation_context)) {
    return false;
  }
...
bool RendererClient_OnStatisticsUpdate_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->stats, "null stats field in RendererClient_OnStatisticsUpdate_Params",
          validation_context)) {
    return false;
  }
...
// static
bool RendererClient_OnWaitingForDecryptionKey_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RendererClient_OnWaitingForDecryptionKey_Params_Data* object = static_cast<const RendererClient_OnWaitingForDecryptionKey_Params_Data*>(data);
...
// static
bool RendererClient_OnDurationChange_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const RendererClient_OnDurationChange_Params_Data* object = static_cast<const RendererClient_OnDurationChange_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->duration, "null duration field in RendererClient_OnDurationChange_Params",
          validation_context)) {
    return false;
  }
