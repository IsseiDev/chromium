...
#pragma pack(push, 1)
const uint32_t kAudioDecoder_Initialize_Name = 0;
class AudioDecoder_Initialize_Params_Data {
 ...
 private:
  AudioDecoder_Initialize_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~AudioDecoder_Initialize_Params_Data() = delete;
};
static_assert(sizeof(AudioDecoder_Initialize_Params_Data) == 32,
...
class AudioDecoder_Initialize_ResponseParams_Data {
 ...
 private:
  AudioDecoder_Initialize_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAudioDecoder_SetDataSource_Name = 1;
class AudioDecoder_SetDataSource_Params_Data {
 ...
 private:
  AudioDecoder_SetDataSource_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAudioDecoder_Decode_Name = 2;
class AudioDecoder_Decode_Params_Data {
 ...
 private:
  AudioDecoder_Decode_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class AudioDecoder_Decode_ResponseParams_Data {
 ...
 private:
  AudioDecoder_Decode_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAudioDecoder_Reset_Name = 3;
class AudioDecoder_Reset_Params_Data {
 ...
 private:
  AudioDecoder_Reset_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class AudioDecoder_Reset_ResponseParams_Data {
 ...
 private:
  AudioDecoder_Reset_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAudioDecoderClient_OnBufferDecoded_Name = 0;
class AudioDecoderClient_OnBufferDecoded_Params_Data {
 ...
 private:
  AudioDecoderClient_OnBufferDecoded_Params_Data() : header_({sizeof(*this), 0}) {
  }
