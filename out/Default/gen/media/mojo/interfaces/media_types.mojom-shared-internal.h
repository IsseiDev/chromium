...
class Pattern_Data {
 ...
 private:
  Pattern_Data() : header_({sizeof(*this), 0}) {
  }
  ~Pattern_Data() = delete;
};
...
class EncryptionScheme_Data {
 ...
 private:
  EncryptionScheme_Data() : header_({sizeof(*this), 0}) {
  }
...
class AudioDecoderConfig_Data {
 ...
 private:
  AudioDecoderConfig_Data() : header_({sizeof(*this), 0}) {
  }
...
class VideoDecoderConfig_Data {
 ...
 private:
  VideoDecoderConfig_Data() : header_({sizeof(*this), 0}) {
  }
...
class SubsampleEntry_Data {
 public:
  static SubsampleEntry_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(SubsampleEntry_Data))) SubsampleEntry_Data();
  }
 ...
 private:
  SubsampleEntry_Data() : header_({sizeof(*this), 0}) {
  }
...
class DecryptConfig_Data {
 ...
 private:
  DecryptConfig_Data() : header_({sizeof(*this), 0}) {
  }
...
class DecoderBuffer_Data {
 ...
 private:
  DecoderBuffer_Data() : header_({sizeof(*this), 0}) {
  }
...
class AudioBuffer_Data {
 ...
 private:
  AudioBuffer_Data() : header_({sizeof(*this), 0}) {
  }
...
class VideoFrame_Data {
 ...
 private:
  VideoFrame_Data() : header_({sizeof(*this), 0}) {
  }
...
class PipelineStatistics_Data {
 ...
 private:
  PipelineStatistics_Data() : header_({sizeof(*this), 0}) {
  }
