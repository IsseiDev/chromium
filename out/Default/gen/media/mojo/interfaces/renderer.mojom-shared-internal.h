...
#pragma pack(push, 1)
const uint32_t kRenderer_Initialize_Name = 0;
class Renderer_Initialize_Params_Data {
 ...
 private:
  Renderer_Initialize_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Renderer_Initialize_ResponseParams_Data {
 ...
 private:
  Renderer_Initialize_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRenderer_Flush_Name = 1;
class Renderer_Flush_Params_Data {
 ...
 private:
  Renderer_Flush_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Renderer_Flush_ResponseParams_Data {
 ...
 private:
  Renderer_Flush_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRenderer_StartPlayingFrom_Name = 2;
class Renderer_StartPlayingFrom_Params_Data {
 ...
 private:
  Renderer_StartPlayingFrom_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRenderer_SetPlaybackRate_Name = 3;
class Renderer_SetPlaybackRate_Params_Data {
 ...
 private:
  Renderer_SetPlaybackRate_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRenderer_SetVolume_Name = 4;
class Renderer_SetVolume_Params_Data {
 ...
 private:
  Renderer_SetVolume_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRenderer_SetCdm_Name = 5;
class Renderer_SetCdm_Params_Data {
 ...
 private:
  Renderer_SetCdm_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Renderer_SetCdm_ResponseParams_Data {
 ...
 private:
  Renderer_SetCdm_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnTimeUpdate_Name = 0;
class RendererClient_OnTimeUpdate_Params_Data {
 ...
 private:
  RendererClient_OnTimeUpdate_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~RendererClient_OnTimeUpdate_Params_Data() = delete;
};
static_assert(sizeof(RendererClient_OnTimeUpdate_Params_Data) == 24,
              "Bad sizeof(RendererClient_OnTimeUpdate_Params_Data)");
const uint32_t kRendererClient_OnBufferingStateChange_Name = 1;
class RendererClient_OnBufferingStateChange_Params_Data {
 ...
 private:
  RendererClient_OnBufferingStateChange_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnEnded_Name = 2;
class RendererClient_OnEnded_Params_Data {
 ...
 private:
  RendererClient_OnEnded_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnError_Name = 3;
class RendererClient_OnError_Params_Data {
 ...
 private:
  RendererClient_OnError_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnVideoNaturalSizeChange_Name = 4;
class RendererClient_OnVideoNaturalSizeChange_Params_Data {
 ...
 private:
  RendererClient_OnVideoNaturalSizeChange_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnVideoOpacityChange_Name = 5;
class RendererClient_OnVideoOpacityChange_Params_Data {
 ...
 private:
  RendererClient_OnVideoOpacityChange_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnStatisticsUpdate_Name = 6;
class RendererClient_OnStatisticsUpdate_Params_Data {
 ...
 private:
  RendererClient_OnStatisticsUpdate_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnWaitingForDecryptionKey_Name = 7;
class RendererClient_OnWaitingForDecryptionKey_Params_Data {
 ...
 private:
  RendererClient_OnWaitingForDecryptionKey_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRendererClient_OnDurationChange_Name = 8;
class RendererClient_OnDurationChange_Params_Data {
 ...
 private:
  RendererClient_OnDurationChange_Params_Data() : header_({sizeof(*this), 0}) {
  }
