...
SubsampleEntryPtr SubsampleEntry::New() {
  SubsampleEntryPtr rv;
  mojo::internal::StructHelper<SubsampleEntry>::Initialize(&rv);
  return rv;
}
...
// static
bool StructTraits<::media::mojom::Pattern, ::media::mojom::PatternPtr>::Read(
    ::media::mojom::PatternDataView input,
...
// static
bool StructTraits<::media::mojom::EncryptionScheme, ::media::mojom::EncryptionSchemePtr>::Read(
    ::media::mojom::EncryptionSchemeDataView input,
...
// static
bool StructTraits<::media::mojom::AudioDecoderConfig, ::media::mojom::AudioDecoderConfigPtr>::Read(
    ::media::mojom::AudioDecoderConfigDataView input,
...
// static
bool StructTraits<::media::mojom::VideoDecoderConfig, ::media::mojom::VideoDecoderConfigPtr>::Read(
    ::media::mojom::VideoDecoderConfigDataView input,
...
// static
bool StructTraits<::media::mojom::SubsampleEntry, ::media::mojom::SubsampleEntryPtr>::Read(
    ::media::mojom::SubsampleEntryDataView input,
    ::media::mojom::SubsampleEntryPtr* output) {
  bool success = true;
  ::media::mojom::SubsampleEntryPtr result(::media::mojom::SubsampleEntry::New());
...
// static
bool StructTraits<::media::mojom::DecryptConfig, ::media::mojom::DecryptConfigPtr>::Read(
    ::media::mojom::DecryptConfigDataView input,
...
// static
bool StructTraits<::media::mojom::DecoderBuffer, ::media::mojom::DecoderBufferPtr>::Read(
    ::media::mojom::DecoderBufferDataView input,
...
// static
bool StructTraits<::media::mojom::AudioBuffer, ::media::mojom::AudioBufferPtr>::Read(
    ::media::mojom::AudioBufferDataView input,
...
// static
bool StructTraits<::media::mojom::VideoFrame, ::media::mojom::VideoFramePtr>::Read(
    ::media::mojom::VideoFrameDataView input,
...
// static
bool StructTraits<::media::mojom::PipelineStatistics, ::media::mojom::PipelineStatisticsPtr>::Read(
    ::media::mojom::PipelineStatisticsDataView input,
