...
define("media/mojo/interfaces/audio_output.mojom", [
...
], function(bindings, codec, connection, core, validator, audio_parameters$) {
  ...
  AudioOutputStream_Close_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, AudioOutputStream_Close_Params.encodedSize, 0);
  ...
  AudioOutput_CreateStream_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, AudioOutput_CreateStream_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AudioOutput_CreateStream_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, AudioOutput_CreateStream_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AudioOutput_CreateStream_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.stream_id = decoder.decodeStruct(codec.Int32);
    val.stream = decoder.decodeStruct(codec.NullableInterface);
  ...
  AudioOutput_CreateStream_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Int32, val.stream_id);
    encoder.encodeStruct(codec.NullableInterface, val.stream);
  ...
  AudioOutputStreamProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  AudioOutputStreamStub.prototype = Object.create(bindings.StubBase.prototype);
  ...
  AudioOutputProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  AudioOutputStub.prototype = Object.create(bindings.StubBase.prototype);
  AudioOutputStub.prototype.createStream = function(stream_id, params) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.createStream && bindings.StubBindings(this).delegate.createStream(stream_id, params);
  }
