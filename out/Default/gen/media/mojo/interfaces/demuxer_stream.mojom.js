...
define("media/mojo/interfaces/demuxer_stream.mojom", [
  ...
  DemuxerStream_Initialize_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, DemuxerStream_Initialize_Params.encodedSize, 0);
  ...
  DemuxerStream_Initialize_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, DemuxerStream_Initialize_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DemuxerStream_Read_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, DemuxerStream_Read_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DemuxerStream_Read_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, DemuxerStream_Read_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DemuxerStream_EnableBitstreamConverter_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, DemuxerStream_EnableBitstreamConverter_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DemuxerStreamProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  DemuxerStreamStub.prototype = Object.create(bindings.StubBase.prototype);
  DemuxerStreamStub.prototype.initialize = function() {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.initialize && bindings.StubBindings(this).delegate.initialize();
  }
  ...
  DemuxerStreamStub.prototype.enableBitstreamConverter = function() {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.enableBitstreamConverter && bindings.StubBindings(this).delegate.enableBitstreamConverter();
  }
  ...
  DemuxerStream.Type = {};
  DemuxerStream.Type.UNKNOWN = 0;
  DemuxerStream.Type.AUDIO = DemuxerStream.Type.UNKNOWN + 1;
  DemuxerStream.Type.VIDEO = DemuxerStream.Type.AUDIO + 1;
  DemuxerStream.Type.LAST_TYPE = DemuxerStream.Type.VIDEO;
  DemuxerStream.Status = {};
  DemuxerStream.Status.OK = 0;
  DemuxerStream.Status.ABORTED = DemuxerStream.Status.OK + 1;
  DemuxerStream.Status.CONFIG_CHANGED = DemuxerStream.Status.ABORTED + 1;
