...
struct ContentDecryptionModule_SessionType_Data {
 public:
  static bool const kIsExtensible = false;
...
struct ContentDecryptionModule_InitDataType_Data {
 public:
  static bool const kIsExtensible = false;
...
class CdmConfig_Data {
 ...
 private:
  CdmConfig_Data() : header_({sizeof(*this), 0}) {
  }
...
class CdmPromiseResult_Data {
 ...
 private:
  CdmPromiseResult_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_SetClient_Params_Data {
 ...
 private:
  ContentDecryptionModule_SetClient_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModule_Initialize_Name = 1;
class ContentDecryptionModule_Initialize_Params_Data {
 ...
 private:
  ContentDecryptionModule_Initialize_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_Initialize_ResponseParams_Data {
 ...
 private:
  ContentDecryptionModule_Initialize_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModule_SetServerCertificate_Name = 2;
class ContentDecryptionModule_SetServerCertificate_Params_Data {
 ...
 private:
  ContentDecryptionModule_SetServerCertificate_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_SetServerCertificate_ResponseParams_Data {
 ...
 private:
  ContentDecryptionModule_SetServerCertificate_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModule_CreateSessionAndGenerateRequest_Name = 3;
class ContentDecryptionModule_CreateSessionAndGenerateRequest_Params_Data {
 ...
 private:
  ContentDecryptionModule_CreateSessionAndGenerateRequest_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_CreateSessionAndGenerateRequest_ResponseParams_Data {
 ...
 private:
  ContentDecryptionModule_CreateSessionAndGenerateRequest_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModule_LoadSession_Name = 4;
class ContentDecryptionModule_LoadSession_Params_Data {
 ...
 private:
  ContentDecryptionModule_LoadSession_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_LoadSession_ResponseParams_Data {
 ...
 private:
  ContentDecryptionModule_LoadSession_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModule_UpdateSession_Name = 5;
class ContentDecryptionModule_UpdateSession_Params_Data {
 ...
 private:
  ContentDecryptionModule_UpdateSession_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_UpdateSession_ResponseParams_Data {
 ...
 private:
  ContentDecryptionModule_UpdateSession_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModule_CloseSession_Name = 6;
class ContentDecryptionModule_CloseSession_Params_Data {
 ...
 private:
  ContentDecryptionModule_CloseSession_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_CloseSession_ResponseParams_Data {
 ...
 private:
  ContentDecryptionModule_CloseSession_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModule_RemoveSession_Name = 7;
class ContentDecryptionModule_RemoveSession_Params_Data {
 ...
 private:
  ContentDecryptionModule_RemoveSession_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class ContentDecryptionModule_RemoveSession_ResponseParams_Data {
 ...
 private:
  ContentDecryptionModule_RemoveSession_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModuleClient_OnSessionMessage_Name = 0;
class ContentDecryptionModuleClient_OnSessionMessage_Params_Data {
 public:
  ...
  mojo::internal::Pointer<::url::mojom::internal::Url_Data> legacy_destination_url;

 private:
  ContentDecryptionModuleClient_OnSessionMessage_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~ContentDecryptionModuleClient_OnSessionMessage_Params_Data() = delete;
};
static_assert(sizeof(ContentDecryptionModuleClient_OnSessionMessage_Params_Data) == 40,
              "Bad sizeof(ContentDecryptionModuleClient_OnSessionMessage_Params_Data)");
const uint32_t kContentDecryptionModuleClient_OnSessionClosed_Name = 1;
class ContentDecryptionModuleClient_OnSessionClosed_Params_Data {
 ...
 private:
  ContentDecryptionModuleClient_OnSessionClosed_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModuleClient_OnLegacySessionError_Name = 2;
class ContentDecryptionModuleClient_OnLegacySessionError_Params_Data {
 public:
  static ContentDecryptionModuleClient_OnLegacySessionError_Params_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(ContentDecryptionModuleClient_OnLegacySessionError_Params_Data))) ContentDecryptionModuleClient_OnLegacySessionError_Params_Data();
  }
 ...
 private:
  ContentDecryptionModuleClient_OnLegacySessionError_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~ContentDecryptionModuleClient_OnLegacySessionError_Params_Data() = delete;
};
static_assert(sizeof(ContentDecryptionModuleClient_OnLegacySessionError_Params_Data) == 32,
              "Bad sizeof(ContentDecryptionModuleClient_OnLegacySessionError_Params_Data)");
const uint32_t kContentDecryptionModuleClient_OnSessionKeysChange_Name = 3;
class ContentDecryptionModuleClient_OnSessionKeysChange_Params_Data {
 public:
  ...
  uint8_t pad1_[7];
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<internal::CdmKeyInformation_Data>>> key_information;

 private:
  ContentDecryptionModuleClient_OnSessionKeysChange_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kContentDecryptionModuleClient_OnSessionExpirationUpdate_Name = 4;
class ContentDecryptionModuleClient_OnSessionExpirationUpdate_Params_Data {
 ...
 private:
  ContentDecryptionModuleClient_OnSessionExpirationUpdate_Params_Data() : header_({sizeof(*this), 0}) {
  }
