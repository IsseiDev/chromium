...
bool ProvisionFetcher_Retrieve_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->default_url, "null default_url field in ProvisionFetcher_Retrieve_Params",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->request_data, "null request_data field in ProvisionFetcher_Retrieve_Params",
          validation_context)) {
    return false;
  }
