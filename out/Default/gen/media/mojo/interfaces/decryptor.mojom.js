...
define("media/mojo/interfaces/decryptor.mojom", [
...
], function(bindings, codec, connection, core, validator, demuxer_stream$, media_types$) {
  ...
  Decryptor_Initialize_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_Initialize_Params.encodedSize, 0);
  ...
  Decryptor_Decrypt_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_Decrypt_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_Decrypt_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_Decrypt_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_CancelDecrypt_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_CancelDecrypt_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_InitializeAudioDecoder_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_InitializeAudioDecoder_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_InitializeAudioDecoder_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_InitializeAudioDecoder_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_InitializeVideoDecoder_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_InitializeVideoDecoder_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_InitializeVideoDecoder_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_InitializeVideoDecoder_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_DecryptAndDecodeAudio_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_DecryptAndDecodeAudio_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_DecryptAndDecodeAudio_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_DecryptAndDecodeAudio_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 8, 8, new codec.PointerTo(media_types$.AudioBuffer), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_DecryptAndDecodeVideo_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_DecryptAndDecodeVideo_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_DecryptAndDecodeVideo_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_DecryptAndDecodeVideo_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_ResetDecoder_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_ResetDecoder_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_DeinitializeDecoder_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_DeinitializeDecoder_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Decryptor_ReleaseSharedBuffer_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Decryptor_ReleaseSharedBuffer_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DecryptorProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  DecryptorStub.prototype = Object.create(bindings.StubBase.prototype);
  DecryptorStub.prototype.initialize = function(receive_pipe, transmit_pipe) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.initialize && bindings.StubBindings(this).delegate.initialize(receive_pipe, transmit_pipe);
  }
  DecryptorStub.prototype.decrypt = function(stream_type, encrypted) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.decrypt && bindings.StubBindings(this).delegate.decrypt(stream_type, encrypted);
  }
  DecryptorStub.prototype.cancelDecrypt = function(stream_type) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.cancelDecrypt && bindings.StubBindings(this).delegate.cancelDecrypt(stream_type);
  }
  DecryptorStub.prototype.initializeAudioDecoder = function(config) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.initializeAudioDecoder && bindings.StubBindings(this).delegate.initializeAudioDecoder(config);
  }
  DecryptorStub.prototype.initializeVideoDecoder = function(config) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.initializeVideoDecoder && bindings.StubBindings(this).delegate.initializeVideoDecoder(config);
  }
  DecryptorStub.prototype.decryptAndDecodeAudio = function(encrypted) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.decryptAndDecodeAudio && bindings.StubBindings(this).delegate.decryptAndDecodeAudio(encrypted);
  }
  DecryptorStub.prototype.decryptAndDecodeVideo = function(encrypted) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.decryptAndDecodeVideo && bindings.StubBindings(this).delegate.decryptAndDecodeVideo(encrypted);
  }
  DecryptorStub.prototype.resetDecoder = function(stream_type) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.resetDecoder && bindings.StubBindings(this).delegate.resetDecoder(stream_type);
  }
  DecryptorStub.prototype.deinitializeDecoder = function(stream_type) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.deinitializeDecoder && bindings.StubBindings(this).delegate.deinitializeDecoder(stream_type);
  }
  DecryptorStub.prototype.releaseSharedBuffer = function(buffer, buffer_size) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.releaseSharedBuffer && bindings.StubBindings(this).delegate.releaseSharedBuffer(buffer, buffer_size);
  }
  ...
  Decryptor.Status = {};
  Decryptor.Status.SUCCESS = 0;
  Decryptor.Status.NO_KEY = Decryptor.Status.SUCCESS + 1;
  Decryptor.Status.NEED_MORE_DATA = Decryptor.Status.NO_KEY + 1;
  Decryptor.Status.DECRYPTION_ERROR = Decryptor.Status.NEED_MORE_DATA + 1;
