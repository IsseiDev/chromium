...
define("media/mojo/interfaces/provision_fetcher.mojom", [
  ...
  ProvisionFetcher_Retrieve_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, ProvisionFetcher_Retrieve_Params.encodedSize, 0);
  ...
  ProvisionFetcher_Retrieve_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, ProvisionFetcher_Retrieve_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ProvisionFetcher_Retrieve_ResponseParams.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.response = decoder.decodeStruct(codec.NullableString);
    return val;
  };
  ...
  ProvisionFetcher_Retrieve_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStruct(codec.NullableString, val.response);
  };
  ...
  ProvisionFetcherProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  ProvisionFetcherStub.prototype = Object.create(bindings.StubBase.prototype);
  ProvisionFetcherStub.prototype.retrieve = function(default_url, request_data) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.retrieve && bindings.StubBindings(this).delegate.retrieve(default_url, request_data);
  }
