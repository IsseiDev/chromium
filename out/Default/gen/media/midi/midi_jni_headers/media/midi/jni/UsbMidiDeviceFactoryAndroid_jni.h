...
#ifndef org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_JNI
#define org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_JNI
...
namespace {
const char kUsbMidiDeviceFactoryAndroidClassPath[] =
    "org/chromium/media/midi/UsbMidiDeviceFactoryAndroid";
...
void
    Java_org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_nativeOnUsbMidiDeviceRequestDone(JNIEnv*
    env,
    jobject jcaller,
...
extern "C" __attribute__((visibility("default")))
void
    Java_org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_nativeOnUsbMidiDeviceAttached(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeUsbMidiDeviceFactoryAndroid,
    jobject device) {
...
extern "C" __attribute__((visibility("default")))
void
    Java_org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_nativeOnUsbMidiDeviceDetached(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeUsbMidiDeviceFactoryAndroid,
    jint index) {
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_UsbMidiDeviceFactoryAndroid_create(JNIEnv* env, const
...
"J"
")"
"Lorg/chromium/media/midi/UsbMidiDeviceFactoryAndroid;",
      &g_UsbMidiDeviceFactoryAndroid_create);

  jobject ret =
      env->CallStaticObjectMethod(UsbMidiDeviceFactoryAndroid_clazz(env),
          method_id, context.obj(), nativePointer);
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_UsbMidiDeviceFactoryAndroid_enumerateDevices =
    0;
...
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_nativeOnUsbMidiDeviceRequestDone)
    },
...
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_nativeOnUsbMidiDeviceAttached)
    },
...
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_nativeOnUsbMidiDeviceDetached)
    },
};
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsUsbMidiDeviceFactoryAndroidSize =
      arraysize(kMethodsUsbMidiDeviceFactoryAndroid);

  if (env->RegisterNatives(UsbMidiDeviceFactoryAndroid_clazz(env),
                           kMethodsUsbMidiDeviceFactoryAndroid,
                           kMethodsUsbMidiDeviceFactoryAndroidSize) < 0) {
...
#endif  // org_chromium_media_midi_UsbMidiDeviceFactoryAndroid_JNI
