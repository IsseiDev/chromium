...
#ifndef org_chromium_media_midi_MidiOutputPortAndroid_JNI
#define org_chromium_media_midi_MidiOutputPortAndroid_JNI
...
namespace {
const char kMidiOutputPortAndroidClassPath[] =
    "org/chromium/media/midi/MidiOutputPortAndroid";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_MidiOutputPortAndroid_clazz __attribute__((unused)) =
    0;
...
static jboolean Java_MidiOutputPortAndroid_open(JNIEnv* env, const
...
static void Java_MidiOutputPortAndroid_send(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jbyteArray>& bs) {
  CHECK_CLAZZ(env, obj.obj(),
...
static void Java_MidiOutputPortAndroid_close(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      MidiOutputPortAndroid_clazz(env));
  jmethodID method_id =
...
#endif  // org_chromium_media_midi_MidiOutputPortAndroid_JNI
