...
#ifndef org_chromium_media_midi_UsbMidiDeviceAndroid_JNI
#define org_chromium_media_midi_UsbMidiDeviceAndroid_JNI
...
namespace {
const char kUsbMidiDeviceAndroidClassPath[] =
    "org/chromium/media/midi/UsbMidiDeviceAndroid";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_UsbMidiDeviceAndroid_clazz __attribute__((unused)) =
    0;
...
void Java_org_chromium_media_midi_UsbMidiDeviceAndroid_nativeOnData(JNIEnv* env,
    jobject jcaller,
...
static void Java_UsbMidiDeviceAndroid_registerSelf(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jlong nativePointer) {
...
static void Java_UsbMidiDeviceAndroid_send(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper endpointNumber,
...
static base::android::ScopedJavaLocalRef<jbyteArray>
    Java_UsbMidiDeviceAndroid_getDescriptors(JNIEnv* env, const
...
static void Java_UsbMidiDeviceAndroid_close(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      UsbMidiDeviceAndroid_clazz(env));
  jmethodID method_id =
...
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_media_midi_UsbMidiDeviceAndroid_nativeOnData)
    },
};
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsUsbMidiDeviceAndroidSize =
      arraysize(kMethodsUsbMidiDeviceAndroid);

  if (env->RegisterNatives(UsbMidiDeviceAndroid_clazz(env),
                           kMethodsUsbMidiDeviceAndroid,
                           kMethodsUsbMidiDeviceAndroidSize) < 0) {
...
#endif  // org_chromium_media_midi_UsbMidiDeviceAndroid_JNI
