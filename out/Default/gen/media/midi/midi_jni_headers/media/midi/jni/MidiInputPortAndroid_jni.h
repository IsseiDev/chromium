...
#ifndef org_chromium_media_midi_MidiInputPortAndroid_JNI
#define org_chromium_media_midi_MidiInputPortAndroid_JNI
...
namespace {
const char kMidiInputPortAndroidClassPath[] =
    "org/chromium/media/midi/MidiInputPortAndroid";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_MidiInputPortAndroid_clazz __attribute__((unused)) =
    0;
...
void Java_org_chromium_media_midi_MidiInputPortAndroid_nativeOnData(JNIEnv* env,
    jobject jcaller,
...
static jboolean Java_MidiInputPortAndroid_open(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jlong nativeReceiverPointer) {
...
static void Java_MidiInputPortAndroid_close(JNIEnv* env, const
...
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_media_midi_MidiInputPortAndroid_nativeOnData)
    },
};
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsMidiInputPortAndroidSize =
      arraysize(kMethodsMidiInputPortAndroid);

  if (env->RegisterNatives(MidiInputPortAndroid_clazz(env),
                           kMethodsMidiInputPortAndroid,
                           kMethodsMidiInputPortAndroidSize) < 0) {
...
#endif  // org_chromium_media_midi_MidiInputPortAndroid_JNI
