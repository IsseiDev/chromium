...
base::subtle::AtomicWord g_MediaPlayerListener_clazz __attribute__((unused)) =
    0;
...
void Java_org_chromium_media_MediaPlayerListener_nativeOnMediaError(JNIEnv* env,
    jobject jcaller,
  ...
  return native->OnMediaError(env, base::android::JavaParamRef<jobject>(env,
      jcaller), errorType);
}
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_MediaPlayerListener_nativeOnBufferingUpdate(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeMediaPlayerListener,
    jint percent) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_MediaPlayerListener_nativeOnMediaPrepared(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeMediaPlayerListener) {
  MediaPlayerListener* native =
  ...
  return native->OnMediaPrepared(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_MediaPlayerListener_nativeOnSeekComplete(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeMediaPlayerListener) {
  MediaPlayerListener* native =
  ...
  return native->OnSeekComplete(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_MediaPlayerListener_create(JNIEnv* env, jlong
...
"Lorg/chromium/media/MediaPlayerListener;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(MediaPlayerListener_clazz(env),
