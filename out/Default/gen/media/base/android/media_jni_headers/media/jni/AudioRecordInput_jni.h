...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_AudioRecordInput_nativeOnData(JNIEnv* env,
    jobject jcaller,
    jlong nativeAudioRecordInputStream,
    jint size,
...
"Lorg/chromium/media/AudioRecordInput;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(AudioRecordInput_clazz(env),
...
static jboolean Java_AudioRecordInput_open(JNIEnv* env, const
...
static void Java_AudioRecordInput_start(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static void Java_AudioRecordInput_stop(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      AudioRecordInput_clazz(env));
  jmethodID method_id =
...
static void Java_AudioRecordInput_close(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      AudioRecordInput_clazz(env));
  jmethodID method_id =
