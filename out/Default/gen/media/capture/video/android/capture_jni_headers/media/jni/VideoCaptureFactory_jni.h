...
namespace {
const char kVideoCaptureFactoryClassPath[] =
    "org/chromium/media/VideoCaptureFactory";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_VideoCaptureFactory_clazz __attribute__((unused)) =
    0;
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_VideoCaptureFactory_createVideoCapture(JNIEnv* env, const
...
"Lorg/chromium/media/VideoCapture;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(VideoCaptureFactory_clazz(env),
...
static jint Java_VideoCaptureFactory_getNumberOfCameras(JNIEnv* env, const
...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(VideoCaptureFactory_clazz(env),
...
"Ljava/lang/String;",
  ...
  jstring ret =
static_cast<jstring>(env->CallStaticObjectMethod(VideoCaptureFactory_clazz(env),
          method_id, as_jint(id), appContext.obj()));
  jni_generator::CheckException(env);
...
static base::android::ScopedJavaLocalRef<jobjectArray>
    Java_VideoCaptureFactory_getDeviceSupportedFormats(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& appContext,
    JniIntWrapper id) {
  CHECK_CLAZZ(env, VideoCaptureFactory_clazz(env),
      VideoCaptureFactory_clazz(env), NULL);
...
"[Lorg/chromium/media/VideoCaptureFormat;",
  ...
  jobjectArray ret =
static_cast<jobjectArray>(env->CallStaticObjectMethod(VideoCaptureFactory_clazz(env),
...
static base::subtle::AtomicWord g_VideoCaptureFactory_getCaptureFormatHeight =
    0;
...
static base::subtle::AtomicWord
    g_VideoCaptureFactory_getCaptureFormatPixelFormat = 0;
