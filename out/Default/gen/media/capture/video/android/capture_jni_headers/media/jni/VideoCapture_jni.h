...
void Java_org_chromium_media_VideoCapture_nativeOnFrameAvailable(JNIEnv* env,
    jobject jcaller,
  ...
  return native->OnFrameAvailable(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jbyteArray>(env, data), length,
      rotation);
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_VideoCapture_nativeOnI420FrameAvailable(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeVideoCaptureDeviceAndroid,
    jobject yBuffer,
  ...
  return native->OnI420FrameAvailable(env,
      ...
      uvPixelStride, width, height, rotation);
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_VideoCapture_nativeOnError(JNIEnv* env,
    jobject jcaller,
    jlong nativeVideoCaptureDeviceAndroid,
    jstring message) {
  VideoCaptureDeviceAndroid* native =
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_VideoCapture_nativeOnPhotoTaken(JNIEnv* env,
    jobject jcaller,
    jlong nativeVideoCaptureDeviceAndroid,
    jlong callbackId,
    jbyteArray data) {
  ...
  return native->OnPhotoTaken(env, base::android::JavaParamRef<jobject>(env,
      jcaller), callbackId, base::android::JavaParamRef<jbyteArray>(env, data));
}

static base::subtle::AtomicWord g_VideoCapture_allocate = 0;
static jboolean Java_VideoCapture_allocate(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper width,
...
static jboolean Java_VideoCapture_startCapture(JNIEnv* env, const
...
static jboolean Java_VideoCapture_stopCapture(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      VideoCapture_clazz(env), false);
  jmethodID method_id =
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_VideoCapture_getPhotoCapabilities(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static void Java_VideoCapture_setPhotoOptions(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper zoom,
...
"V",
     ...
     env->CallVoidMethod(obj.obj(),
          method_id, as_jint(zoom), as_jint(focusMode), as_jint(width),
              as_jint(height), pointsOfInterest2D.obj());
  jni_generator::CheckException(env);

}

static base::subtle::AtomicWord g_VideoCapture_takePhoto = 0;
static jboolean Java_VideoCapture_takePhoto(JNIEnv* env, const
...
static void Java_VideoCapture_deallocate(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      VideoCapture_clazz(env));
  jmethodID method_id =
...
static jint Java_VideoCapture_queryWidth(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static jint Java_VideoCapture_queryHeight(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      VideoCapture_clazz(env), 0);
  jmethodID method_id =
...
static jint Java_VideoCapture_queryFrameRate(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      VideoCapture_clazz(env), 0);
  jmethodID method_id =
...
static jint Java_VideoCapture_getColorspace(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      VideoCapture_clazz(env), 0);
  jmethodID method_id =
...
"Ljava/lang/String;"
")"
"V", reinterpret_cast<void*>(Java_org_chromium_media_VideoCapture_nativeOnError)
    },
    { "nativeOnPhotoTaken",
"("
"J"
