...
void Java_org_chromium_media_ScreenCapture_nativeOnRGBAFrameAvailable(JNIEnv*
    env,
    jobject jcaller,
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_ScreenCapture_nativeOnI420FrameAvailable(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeScreenCaptureMachineAndroid,
    jobject yBuffer,
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_media_ScreenCapture_nativeOnActivityResult(JNIEnv* env,
    jobject jcaller,
    jlong nativeScreenCaptureMachineAndroid,
    jboolean result) {
  ScreenCaptureMachineAndroid* native =
  ...
  return native->OnActivityResult(env, base::android::JavaParamRef<jobject>(env,
      jcaller), result);
}

static base::subtle::AtomicWord g_ScreenCapture_createScreenCaptureMachine = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_ScreenCapture_createScreenCaptureMachine(JNIEnv* env, const
...
"Lorg/chromium/media/ScreenCapture;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ScreenCapture_clazz(env),
...
static jboolean Java_ScreenCapture_startPrompt(JNIEnv* env, const
...
static void Java_ScreenCapture_startCapture(JNIEnv* env, const
...
static void Java_ScreenCapture_stopCapture(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ScreenCapture_clazz(env));
  jmethodID method_id =
