...
#endif
const WrapperTypeInfo V8AnimationEffectReadOnly::wrapperTypeInfo = { gin::kEmbedderBlink, V8AnimationEffectReadOnly::domTemplate, V8AnimationEffectReadOnly::trace, V8AnimationEffectReadOnly::traceWrappers, 0, 0, V8AnimationEffectReadOnly::preparePrototypeAndInterfaceObject, nullptr, "AnimationEffectReadOnly", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, AnimationEffectReadOnly>::value,
    "AnimationEffectReadOnly inherits from ActiveScriptWrappable, but does not specify "
...
static void timingAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    AnimationEffectTiming* cppValue(WTF::getPtr(impl->timing()));
...
static void getComputedTimingMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8AnimationEffectReadOnlyAccessors[] = {
    {"timing", AnimationEffectReadOnlyV8Internal::timingAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8AnimationEffectReadOnlyMethods[] = {
    {"getComputedTiming", AnimationEffectReadOnlyV8Internal::getComputedTimingMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
