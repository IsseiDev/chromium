...
#endif
const WrapperTypeInfo V8HTMLTableCaptionElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLTableCaptionElement::domTemplate, V8HTMLTableCaptionElement::trace, V8HTMLTableCaptionElement::traceWrappers, 0, 0, V8HTMLTableCaptionElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLTableCaptionElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLTableCaptionElement>::value,
    "HTMLTableCaptionElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLTableCaptionElementAccessors[] = {
    {"align", HTMLTableCaptionElementV8Internal::alignAttributeGetterCallback, HTMLTableCaptionElementV8Internal::alignAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

static void installV8HTMLTableCaptionElementTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8HTMLTableCaptionElement::wrapperTypeInfo.interfaceName, V8HTMLElement::domTemplate(isolate, world), V8HTMLTableCaptionElement::internalFieldCount);
    ...
    V8DOMConfiguration::installAccessors(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8HTMLTableCaptionElementAccessors, WTF_ARRAY_LENGTH(V8HTMLTableCaptionElementAccessors));
}
