...
#endif
const WrapperTypeInfo V8BeforeUnloadEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8BeforeUnloadEvent::domTemplate, V8BeforeUnloadEvent::trace, V8BeforeUnloadEvent::traceWrappers, 0, 0, V8BeforeUnloadEvent::preparePrototypeAndInterfaceObject, nullptr, "BeforeUnloadEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, BeforeUnloadEvent>::value,
    "BeforeUnloadEvent inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8BeforeUnloadEventAccessors[] = {
    {"returnValue", BeforeUnloadEventV8Internal::returnValueAttributeGetterCallback, BeforeUnloadEventV8Internal::returnValueAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"isTrusted", BeforeUnloadEventV8Internal::isTrustedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
};

static void installV8BeforeUnloadEventTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8BeforeUnloadEvent::wrapperTypeInfo.interfaceName, V8Event::domTemplate(isolate, world), V8BeforeUnloadEvent::internalFieldCount);
    ...
    V8DOMConfiguration::installAccessors(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8BeforeUnloadEventAccessors, WTF_ARRAY_LENGTH(V8BeforeUnloadEventAccessors));
}
