...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLBaseElement>::value,
    "HTMLBaseElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLBaseElementAccessors[] = {
    {"href", HTMLBaseElementV8Internal::hrefAttributeGetterCallback, HTMLBaseElementV8Internal::hrefAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"target", HTMLBaseElementV8Internal::targetAttributeGetterCallback, HTMLBaseElementV8Internal::targetAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
