...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, NodeFilter>::value,
    "NodeFilter inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8NodeFilterMethods[] = {
    {"acceptNode", NodeFilterV8Internal::acceptNodeMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
