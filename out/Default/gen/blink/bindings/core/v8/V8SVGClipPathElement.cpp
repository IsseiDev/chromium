...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SVGClipPathElement>::value,
    "SVGClipPathElement inherits from ActiveScriptWrappable, but does not specify "
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8SVGClipPathElement_ClipPathUnits_AttributeGetter);
...
const V8DOMConfiguration::AccessorConfiguration V8SVGClipPathElementAccessors[] = {
    {"clipPathUnits", SVGClipPathElementV8Internal::clipPathUnitsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
