...
#endif
const WrapperTypeInfo V8SVGMetadataElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGMetadataElement::domTemplate, V8SVGMetadataElement::trace, V8SVGMetadataElement::traceWrappers, 0, 0, V8SVGMetadataElement::preparePrototypeAndInterfaceObject, nullptr, "SVGMetadataElement", &V8SVGElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SVGMetadataElement>::value,
    "SVGMetadataElement inherits from ActiveScriptWrappable, but does not specify "
