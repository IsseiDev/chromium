...
#endif
const WrapperTypeInfo V8UnderlyingSourceBase::wrapperTypeInfo = { gin::kEmbedderBlink, V8UnderlyingSourceBase::domTemplate, V8UnderlyingSourceBase::trace, V8UnderlyingSourceBase::traceWrappers, V8UnderlyingSourceBase::toActiveScriptWrappable, 0, V8UnderlyingSourceBase::preparePrototypeAndInterfaceObject, nullptr, "UnderlyingSourceBase", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void startMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        v8SetReturnValue(info, ScriptPromise::rejectRaw(ScriptState::current(info.GetIsolate()), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "start", "UnderlyingSourceBase", 1, info.Length())));
        return;
    }
...
static void pullMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void notifyLockAcquiredMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void notifyLockReleasedMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::MethodConfiguration V8UnderlyingSourceBaseMethods[] = {
    {"start", UnderlyingSourceBaseV8Internal::startMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"pull", UnderlyingSourceBaseV8Internal::pullMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"cancel", UnderlyingSourceBaseV8Internal::cancelMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"notifyLockAcquired", UnderlyingSourceBaseV8Internal::notifyLockAcquiredMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"notifyLockReleased", UnderlyingSourceBaseV8Internal::notifyLockReleasedMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
ActiveScriptWrappable* V8UnderlyingSourceBase::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
