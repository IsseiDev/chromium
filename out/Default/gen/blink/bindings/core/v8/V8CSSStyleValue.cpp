...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSStyleValue>::value,
    "CSSStyleValue inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "parse", "CSSStyleValue", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::AccessorConfiguration V8CSSStyleValueAccessors[] = {
    {"cssText", CSSStyleValueV8Internal::cssTextAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8CSSStyleValueMethods[] = {
    {"parse", CSSStyleValueV8Internal::parseMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInterface},
};
