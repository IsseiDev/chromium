...
#endif
const WrapperTypeInfo V8DataTransfer::wrapperTypeInfo = { gin::kEmbedderBlink, V8DataTransfer::domTemplate, V8DataTransfer::trace, V8DataTransfer::traceWrappers, 0, 0, V8DataTransfer::preparePrototypeAndInterfaceObject, nullptr, "DataTransfer", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DataTransfer>::value,
    "DataTransfer inherits from ActiveScriptWrappable, but does not specify "
...
static void itemsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "items"), v8Value);
...
static void filesAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    v8::Local<v8::Value> v8Value(toV8(cppValue, holder, info.GetIsolate()));
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "files"), v8Value);
        v8SetReturnValue(info, v8Value);
    }
}
...
static void getDataMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "getData", "DataTransfer", 1, info.Length()));
        return;
    }
    DataTransfer* impl = V8DataTransfer::toImpl(info.Holder());
...
static void setDataMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 2)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "setData", "DataTransfer", 2, info.Length()));
        return;
    }
    DataTransfer* impl = V8DataTransfer::toImpl(info.Holder());
    V8StringResource<> format;
...
const V8DOMConfiguration::AccessorConfiguration V8DataTransferAccessors[] = {
    {"dropEffect", DataTransferV8Internal::dropEffectAttributeGetterCallback, DataTransferV8Internal::dropEffectAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"effectAllowed", DataTransferV8Internal::effectAllowedAttributeGetterCallback, DataTransferV8Internal::effectAllowedAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"items", DataTransferV8Internal::itemsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"types", DataTransferV8Internal::typesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"files", DataTransferV8Internal::filesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8DataTransferMethods[] = {
    {"setDragImage", DataTransferV8Internal::setDragImageMethodCallback, 0, 3, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getData", DataTransferV8Internal::getDataMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"setData", DataTransferV8Internal::setDataMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"clearData", DataTransferV8Internal::clearDataMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
