...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, PerformanceObserver>::value,
    "PerformanceObserver inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "observe", "PerformanceObserver", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::MethodConfiguration V8PerformanceObserverMethods[] = {
    {"observe", PerformanceObserverV8Internal::observeMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"disconnect", PerformanceObserverV8Internal::disconnectMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
