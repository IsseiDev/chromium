...
#endif
const WrapperTypeInfo V8AudioTrackList::wrapperTypeInfo = { gin::kEmbedderBlink, V8AudioTrackList::domTemplate, V8AudioTrackList::trace, V8AudioTrackList::traceWrappers, 0, V8AudioTrackList::visitDOMWrapper, V8AudioTrackList::preparePrototypeAndInterfaceObject, nullptr, "AudioTrackList", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, AudioTrackList>::value,
    "AudioTrackList inherits from ActiveScriptWrappable, but does not specify "
...
static void getTrackByIdMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "getTrackById", "AudioTrackList", 1, info.Length()));
        return;
    }
...
const V8DOMConfiguration::AccessorConfiguration V8AudioTrackListAccessors[] = {
    {"length", AudioTrackListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onchange", AudioTrackListV8Internal::onchangeAttributeGetterCallback, AudioTrackListV8Internal::onchangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onaddtrack", AudioTrackListV8Internal::onaddtrackAttributeGetterCallback, AudioTrackListV8Internal::onaddtrackAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onremovetrack", AudioTrackListV8Internal::onremovetrackAttributeGetterCallback, AudioTrackListV8Internal::onremovetrackAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8AudioTrackListMethods[] = {
    {"getTrackById", AudioTrackListV8Internal::getTrackByIdMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
