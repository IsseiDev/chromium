...
#ifndef V8HTMLBaseElement_h
#define V8HTMLBaseElement_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<HTMLBaseElement>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<HTMLBaseElement>());
    }
