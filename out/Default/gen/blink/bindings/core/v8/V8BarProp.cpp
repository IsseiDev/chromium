...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, BarProp>::value,
    "BarProp inherits from ActiveScriptWrappable, but does not specify "
...
static void visibleAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8BarPropAccessors[] = {
    {"visible", BarPropV8Internal::visibleAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
