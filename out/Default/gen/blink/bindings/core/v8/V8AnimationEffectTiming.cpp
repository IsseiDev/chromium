...
#endif
const WrapperTypeInfo V8AnimationEffectTiming::wrapperTypeInfo = { gin::kEmbedderBlink, V8AnimationEffectTiming::domTemplate, V8AnimationEffectTiming::trace, V8AnimationEffectTiming::traceWrappers, 0, 0, V8AnimationEffectTiming::preparePrototypeAndInterfaceObject, nullptr, "AnimationEffectTiming", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, AnimationEffectTiming>::value,
    "AnimationEffectTiming inherits from ActiveScriptWrappable, but does not specify "
...
{
    v8::Local<v8::Object> holder = info.Holder();
    ExceptionState exceptionState(ExceptionState::SetterContext, "easing", "AnimationEffectTiming", holder, info.GetIsolate());
    AnimationEffectTiming* impl = V8AnimationEffectTiming::toImpl(holder);
    V8StringResource<> cppValue = v8Value;
    if (!cppValue.prepare())
        return;
...
const V8DOMConfiguration::AccessorConfiguration V8AnimationEffectTimingAccessors[] = {
    {"delay", AnimationEffectTimingV8Internal::delayAttributeGetterCallback, AnimationEffectTimingV8Internal::delayAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"endDelay", AnimationEffectTimingV8Internal::endDelayAttributeGetterCallback, AnimationEffectTimingV8Internal::endDelayAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"fill", AnimationEffectTimingV8Internal::fillAttributeGetterCallback, AnimationEffectTimingV8Internal::fillAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"iterationStart", AnimationEffectTimingV8Internal::iterationStartAttributeGetterCallback, AnimationEffectTimingV8Internal::iterationStartAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"iterations", AnimationEffectTimingV8Internal::iterationsAttributeGetterCallback, AnimationEffectTimingV8Internal::iterationsAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"duration", AnimationEffectTimingV8Internal::durationAttributeGetterCallback, AnimationEffectTimingV8Internal::durationAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"direction", AnimationEffectTimingV8Internal::directionAttributeGetterCallback, AnimationEffectTimingV8Internal::directionAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"easing", AnimationEffectTimingV8Internal::easingAttributeGetterCallback, AnimationEffectTimingV8Internal::easingAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8AnimationEffectTimingTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8AnimationEffectTiming::wrapperTypeInfo.interfaceName, v8::Local<v8::FunctionTemplate>(), V8AnimationEffectTiming::internalFieldCount);
