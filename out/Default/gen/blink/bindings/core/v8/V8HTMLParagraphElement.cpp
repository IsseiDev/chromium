...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLParagraphElement>::value,
    "HTMLParagraphElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLParagraphElementAccessors[] = {
    {"align", HTMLParagraphElementV8Internal::alignAttributeGetterCallback, HTMLParagraphElementV8Internal::alignAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
