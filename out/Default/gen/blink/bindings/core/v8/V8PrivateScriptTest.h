...
class V8PrivateScriptTest {
    STATIC_ONLY(V8PrivateScriptTest);
public:
    class PrivateScript {
    ...
    public:
        ...
        static bool echoNodeMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* value, Node** result);
        ...
        static bool setIntegerToDocumentMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Document* document, int value);
        static bool getIntegerFromDocumentMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Document* document, int* result);
        static bool createElementMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Document* document, Node** result);
        static bool appendChildMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* node1, Node* node2);
        static bool firstChildMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* node, Node** result);
        static bool nextSiblingMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* node, Node** result);
        static bool innerHTMLMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* node, String* result);
        static bool setInnerHTMLMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* node, String string);
        static bool addClickListenerMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* node);
        static bool clickNodeMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Document* document, Node* node);
        ...
        static bool dispatchDocumentOnloadMethod(LocalFrame* frame, PrivateScriptTest* holderImpl, Document* document);
        ...
        static bool nodeAttributeAttributeGetter(LocalFrame* frame, PrivateScriptTest* holderImpl, Node** result);
        static bool nodeAttributeAttributeSetter(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* cppValue);
        static bool nodeAttributeThrowsIndexSizeErrorAttributeGetter(LocalFrame* frame, PrivateScriptTest* holderImpl, Node** result);
        static bool nodeAttributeThrowsIndexSizeErrorAttributeSetter(LocalFrame* frame, PrivateScriptTest* holderImpl, Node* cppValue);
    ...
    {
        visitor->traceWrappers(scriptWrappable->toImpl<PrivateScriptTest>());
    }
