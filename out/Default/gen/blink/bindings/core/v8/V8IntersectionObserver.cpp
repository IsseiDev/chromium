...
#endif
const WrapperTypeInfo V8IntersectionObserver::wrapperTypeInfo = { gin::kEmbedderBlink, V8IntersectionObserver::domTemplate, V8IntersectionObserver::trace, V8IntersectionObserver::traceWrappers, 0, V8IntersectionObserver::visitDOMWrapper, V8IntersectionObserver::preparePrototypeAndInterfaceObject, nullptr, "IntersectionObserver", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, IntersectionObserver>::value,
    "IntersectionObserver inherits from ActiveScriptWrappable, but does not specify "
...
static void rootMarginAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void thresholdsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "disconnect", "IntersectionObserver", info.Holder(), info.GetIsolate());
    IntersectionObserver* impl = V8IntersectionObserver::toImpl(info.Holder());
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "takeRecords", "IntersectionObserver", info.Holder(), info.GetIsolate());
    IntersectionObserver* impl = V8IntersectionObserver::toImpl(info.Holder());
...
const V8DOMConfiguration::AccessorConfiguration V8IntersectionObserverAccessors[] = {
    {"root", IntersectionObserverV8Internal::rootAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"rootMargin", IntersectionObserverV8Internal::rootMarginAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"thresholds", IntersectionObserverV8Internal::thresholdsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::IntersectionObserver_Constructor);
