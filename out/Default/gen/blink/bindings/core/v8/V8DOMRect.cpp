...
#endif
const WrapperTypeInfo V8DOMRect::wrapperTypeInfo = { gin::kEmbedderBlink, V8DOMRect::domTemplate, V8DOMRect::trace, V8DOMRect::traceWrappers, 0, 0, V8DOMRect::preparePrototypeAndInterfaceObject, nullptr, "DOMRect", &V8DOMRectReadOnly::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMRect>::value,
    "DOMRect inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8DOMRectAccessors[] = {
    {"x", DOMRectV8Internal::xAttributeGetterCallback, DOMRectV8Internal::xAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"y", DOMRectV8Internal::yAttributeGetterCallback, DOMRectV8Internal::yAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"width", DOMRectV8Internal::widthAttributeGetterCallback, DOMRectV8Internal::widthAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"height", DOMRectV8Internal::heightAttributeGetterCallback, DOMRectV8Internal::heightAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
