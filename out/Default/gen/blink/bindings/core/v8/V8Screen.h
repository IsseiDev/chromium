...
public:
    ...
    {
        visitor->traceWrappers(scriptWrappable->toImpl<Screen>());
    }
    ...
    CORE_EXPORT static void installV8ScreenTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interfaceTemplate);
