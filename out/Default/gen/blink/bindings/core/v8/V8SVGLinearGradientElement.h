...
#ifndef V8SVGLinearGradientElement_h
#define V8SVGLinearGradientElement_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<SVGLinearGradientElement>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<SVGLinearGradientElement>());
    }
...
#endif // V8SVGLinearGradientElement_h
