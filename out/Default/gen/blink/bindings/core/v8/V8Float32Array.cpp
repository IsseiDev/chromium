...
#endif
const WrapperTypeInfo V8Float32Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Float32Array::trace, V8Float32Array::traceWrappers, 0, 0, V8Float32Array::preparePrototypeAndInterfaceObject, nullptr, "Float32Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMFloat32Array>::value,
    "DOMFloat32Array inherits from ActiveScriptWrappable, but does not specify "
