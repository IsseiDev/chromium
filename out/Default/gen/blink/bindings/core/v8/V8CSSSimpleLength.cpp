...
#endif
const WrapperTypeInfo V8CSSSimpleLength::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSSimpleLength::domTemplate, V8CSSSimpleLength::trace, V8CSSSimpleLength::traceWrappers, 0, 0, V8CSSSimpleLength::preparePrototypeAndInterfaceObject, nullptr, "CSSSimpleLength", &V8CSSLengthValue::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSSimpleLength>::value,
    "CSSSimpleLength inherits from ActiveScriptWrappable, but does not specify "
...
{
    v8::Local<v8::Object> holder = info.Holder();
    ExceptionState exceptionState(ExceptionState::SetterContext, "value", "CSSSimpleLength", holder, info.GetIsolate());
    CSSSimpleLength* impl = V8CSSSimpleLength::toImpl(holder);
...
static void valueAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    CSSSimpleLengthV8Internal::valueAttributeSetter(v8Value, info);
}
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "CSSSimpleLength", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::AccessorConfiguration V8CSSSimpleLengthAccessors[] = {
    {"value", CSSSimpleLengthV8Internal::valueAttributeGetterCallback, CSSSimpleLengthV8Internal::valueAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", CSSSimpleLengthV8Internal::typeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
