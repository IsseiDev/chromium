...
#endif
const WrapperTypeInfo V8CSSViewportRule::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSViewportRule::domTemplate, V8CSSViewportRule::trace, V8CSSViewportRule::traceWrappers, 0, 0, V8CSSViewportRule::preparePrototypeAndInterfaceObject, nullptr, "CSSViewportRule", &V8CSSRule::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSViewportRule>::value,
    "CSSViewportRule inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8CSSViewportRuleAccessors[] = {
    {"style", CSSViewportRuleV8Internal::styleAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
