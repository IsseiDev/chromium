...
#endif
const WrapperTypeInfo V8SVGAnimatedAngle::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGAnimatedAngle::domTemplate, V8SVGAnimatedAngle::trace, V8SVGAnimatedAngle::traceWrappers, 0, V8SVGAnimatedAngle::visitDOMWrapper, V8SVGAnimatedAngle::preparePrototypeAndInterfaceObject, nullptr, "SVGAnimatedAngle", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SVGAnimatedAngle>::value,
    "SVGAnimatedAngle inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedAngleAccessors[] = {
    {"baseVal", SVGAnimatedAngleV8Internal::baseValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animVal", SVGAnimatedAngleV8Internal::animValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
