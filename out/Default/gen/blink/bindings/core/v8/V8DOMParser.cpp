...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMParser>::value,
    "DOMParser inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8DOMParserMethods[] = {
    {"parseFromString", DOMParserV8Internal::parseFromStringMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
