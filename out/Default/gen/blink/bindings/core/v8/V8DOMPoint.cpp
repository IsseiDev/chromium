...
#endif
const WrapperTypeInfo V8DOMPoint::wrapperTypeInfo = { gin::kEmbedderBlink, V8DOMPoint::domTemplate, V8DOMPoint::trace, V8DOMPoint::traceWrappers, 0, 0, V8DOMPoint::preparePrototypeAndInterfaceObject, nullptr, "DOMPoint", &V8DOMPointReadOnly::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMPoint>::value,
    "DOMPoint inherits from ActiveScriptWrappable, but does not specify "
...
static void constructor1(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    DOMPoint* impl = DOMPoint::create(point);
...
const V8DOMConfiguration::AccessorConfiguration V8DOMPointAccessors[] = {
    {"x", DOMPointV8Internal::xAttributeGetterCallback, DOMPointV8Internal::xAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"y", DOMPointV8Internal::yAttributeGetterCallback, DOMPointV8Internal::yAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"z", DOMPointV8Internal::zAttributeGetterCallback, DOMPointV8Internal::zAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"w", DOMPointV8Internal::wAttributeGetterCallback, DOMPointV8Internal::wAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
