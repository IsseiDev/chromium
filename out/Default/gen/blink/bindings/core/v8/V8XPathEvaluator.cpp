...
#endif
const WrapperTypeInfo V8XPathEvaluator::wrapperTypeInfo = { gin::kEmbedderBlink, V8XPathEvaluator::domTemplate, V8XPathEvaluator::trace, V8XPathEvaluator::traceWrappers, 0, 0, V8XPathEvaluator::preparePrototypeAndInterfaceObject, nullptr, "XPathEvaluator", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, XPathEvaluator>::value,
    "XPathEvaluator inherits from ActiveScriptWrappable, but does not specify "
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8XPathEvaluator_CreateExpression_Method);
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "createNSResolver", "XPathEvaluator", 1, info.Length()));
        return;
    }
    XPathEvaluator* impl = V8XPathEvaluator::toImpl(info.Holder());
    Node* nodeResolver;
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8XPathEvaluator_CreateNSResolver_Method);
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8XPathEvaluator_Evaluate_Method);
...
const V8DOMConfiguration::MethodConfiguration V8XPathEvaluatorMethods[] = {
    {"createExpression", XPathEvaluatorV8Internal::createExpressionMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"createNSResolver", XPathEvaluatorV8Internal::createNSResolverMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"evaluate", XPathEvaluatorV8Internal::evaluateMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};

void V8XPathEvaluator::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8XPathEvaluator_Constructor);
