...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLMenuItemElement>::value,
    "HTMLMenuItemElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLMenuItemElementAccessors[] = {
    {"type", HTMLMenuItemElementV8Internal::typeAttributeGetterCallback, HTMLMenuItemElementV8Internal::typeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"label", HTMLMenuItemElementV8Internal::labelAttributeGetterCallback, HTMLMenuItemElementV8Internal::labelAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"icon", HTMLMenuItemElementV8Internal::iconAttributeGetterCallback, HTMLMenuItemElementV8Internal::iconAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"disabled", HTMLMenuItemElementV8Internal::disabledAttributeGetterCallback, HTMLMenuItemElementV8Internal::disabledAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"checked", HTMLMenuItemElementV8Internal::checkedAttributeGetterCallback, HTMLMenuItemElementV8Internal::checkedAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"radiogroup", HTMLMenuItemElementV8Internal::radiogroupAttributeGetterCallback, HTMLMenuItemElementV8Internal::radiogroupAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"default", HTMLMenuItemElementV8Internal::defaultAttributeGetterCallback, HTMLMenuItemElementV8Internal::defaultAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
