...
#endif
const WrapperTypeInfo V8HTMLSlotElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLSlotElement::domTemplate, V8HTMLSlotElement::trace, V8HTMLSlotElement::traceWrappers, 0, 0, V8HTMLSlotElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLSlotElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLSlotElement>::value,
    "HTMLSlotElement inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "assignedNodes", "HTMLSlotElement", info.Holder(), info.GetIsolate());
...
static void assignedNodesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLSlotElementAccessors[] = {
    {"name", HTMLSlotElementV8Internal::nameAttributeGetterCallback, HTMLSlotElementV8Internal::nameAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8HTMLSlotElementMethods[] = {
    {"assignedNodes", HTMLSlotElementV8Internal::assignedNodesMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
