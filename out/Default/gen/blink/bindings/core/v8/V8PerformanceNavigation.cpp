...
#endif
const WrapperTypeInfo V8PerformanceNavigation::wrapperTypeInfo = { gin::kEmbedderBlink, V8PerformanceNavigation::domTemplate, V8PerformanceNavigation::trace, V8PerformanceNavigation::traceWrappers, 0, 0, V8PerformanceNavigation::preparePrototypeAndInterfaceObject, nullptr, "PerformanceNavigation", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, PerformanceNavigation>::value,
    "PerformanceNavigation inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8PerformanceNavigationAccessors[] = {
    {"type", PerformanceNavigationV8Internal::typeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"redirectCount", PerformanceNavigationV8Internal::redirectCountAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
