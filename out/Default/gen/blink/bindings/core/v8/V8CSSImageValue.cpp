...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSStyleImageValue>::value,
    "CSSStyleImageValue inherits from ActiveScriptWrappable, but does not specify "
...
static void intrinsicWidthAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void intrinsicHeightAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void intrinsicRatioAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8CSSImageValueAccessors[] = {
    {"intrinsicWidth", CSSStyleImageValueV8Internal::intrinsicWidthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"intrinsicHeight", CSSStyleImageValueV8Internal::intrinsicHeightAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"intrinsicRatio", CSSStyleImageValueV8Internal::intrinsicRatioAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
