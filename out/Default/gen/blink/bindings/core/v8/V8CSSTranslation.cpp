...
#endif
const WrapperTypeInfo V8CSSTranslation::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSTranslation::domTemplate, V8CSSTranslation::trace, V8CSSTranslation::traceWrappers, 0, 0, V8CSSTranslation::preparePrototypeAndInterfaceObject, nullptr, "CSSTranslation", &V8CSSTransformComponent::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

// This static member must be declared by DEFINE_WRAPPERTYPEINFO in CSSTranslation.h.
// For details, see the comment of DEFINE_WRAPPERTYPEINFO in
// bindings/core/v8/ScriptWrappable.h.
const WrapperTypeInfo& CSSTranslation::s_wrapperTypeInfo = V8CSSTranslation::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSTranslation>::value,
    "CSSTranslation inherits from ActiveScriptWrappable, but does not specify "
...
static void zAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    v8::Local<v8::Value> v8Value(toV8(cppValue, holder, info.GetIsolate()));
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "z"), v8Value);
        v8SetReturnValue(info, v8Value);
    }
}
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "CSSTranslation", info.Holder(), info.GetIsolate());
    CSSLengthValue* x;
    CSSLengthValue* y;
    {
...
const V8DOMConfiguration::AccessorConfiguration V8CSSTranslationAccessors[] = {
    {"x", CSSTranslationV8Internal::xAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"y", CSSTranslationV8Internal::yAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"z", CSSTranslationV8Internal::zAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
