...
#endif
const WrapperTypeInfo V8KeyframeEffect::wrapperTypeInfo = { gin::kEmbedderBlink, V8KeyframeEffect::domTemplate, V8KeyframeEffect::trace, V8KeyframeEffect::traceWrappers, 0, 0, V8KeyframeEffect::preparePrototypeAndInterfaceObject, nullptr, "KeyframeEffect", &V8AnimationEffectReadOnly::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, KeyframeEffect>::value,
    "KeyframeEffect inherits from ActiveScriptWrappable, but does not specify "
...
static void installV8KeyframeEffectTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8KeyframeEffect::wrapperTypeInfo.interfaceName, V8AnimationEffectReadOnly::domTemplate(isolate, world), V8KeyframeEffect::internalFieldCount);
