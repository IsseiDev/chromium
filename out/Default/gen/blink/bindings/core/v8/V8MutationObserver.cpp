...
#endif
const WrapperTypeInfo V8MutationObserver::wrapperTypeInfo = { gin::kEmbedderBlink, V8MutationObserver::domTemplate, V8MutationObserver::trace, V8MutationObserver::traceWrappers, 0, V8MutationObserver::visitDOMWrapper, V8MutationObserver::preparePrototypeAndInterfaceObject, nullptr, "MutationObserver", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, MutationObserver>::value,
    "MutationObserver inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8MutationObserverMethods[] = {
    {"observe", MutationObserverV8Internal::observeMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"disconnect", MutationObserverV8Internal::disconnectMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"takeRecords", MutationObserverV8Internal::takeRecordsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
