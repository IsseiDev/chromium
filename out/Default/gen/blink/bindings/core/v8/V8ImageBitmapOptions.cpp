...
void V8ImageBitmapOptions::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, ImageBitmapOptions& impl, ExceptionState& exceptionState)
{
    ...
    if (colorSpaceConversionValue.IsEmpty() || colorSpaceConversionValue->IsUndefined()) {
        ...
        if (!isValidEnum(colorSpaceConversion, validValues, WTF_ARRAY_LENGTH(validValues), "ColorSpaceConversion", exceptionState))
            return;
    ...
    if (RuntimeEnabledFeatures::experimentalCanvasFeaturesEnabled()) {
        ...
        if (resizeHeightValue.IsEmpty() || resizeHeightValue->IsUndefined()) {
            // Do nothing.
        } else if (resizeHeightValue->IsNull()) {
            impl.setResizeHeightToNull();
        } else {
    ...
    if (RuntimeEnabledFeatures::experimentalCanvasFeaturesEnabled()) {
        ...
        if (resizeWidthValue.IsEmpty() || resizeWidthValue->IsUndefined()) {
            // Do nothing.
        } else if (resizeWidthValue->IsNull()) {
            impl.setResizeWidthToNull();
        } else {
...
bool toV8ImageBitmapOptions(const ImageBitmapOptions& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
    ...
    if (impl.hasResizeHeight()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "resizeHeight"), v8::Null(isolate))))
            return false;
    }
    ...
    if (impl.hasResizeWidth()) {
        ...
        if (!v8CallBoolean(dictionary->CreateDataProperty(isolate->GetCurrentContext(), v8String(isolate, "resizeWidth"), v8::Null(isolate))))
            return false;
    }
