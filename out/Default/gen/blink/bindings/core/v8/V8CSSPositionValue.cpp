...
#endif
const WrapperTypeInfo V8CSSPositionValue::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSPositionValue::domTemplate, V8CSSPositionValue::trace, V8CSSPositionValue::traceWrappers, 0, 0, V8CSSPositionValue::preparePrototypeAndInterfaceObject, nullptr, "CSSPositionValue", &V8CSSStyleValue::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSPositionValue>::value,
    "CSSPositionValue inherits from ActiveScriptWrappable, but does not specify "
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 2)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForConstructor(info.GetIsolate(), "CSSPositionValue", 2, info.Length()));
        return;
    }
    CSSLengthValue* x;
    CSSLengthValue* y;
...
const V8DOMConfiguration::AccessorConfiguration V8CSSPositionValueAccessors[] = {
    {"x", CSSPositionValueV8Internal::xAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"y", CSSPositionValueV8Internal::yAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
