...
#endif
const WrapperTypeInfo V8CSSVariableReferenceValue::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSVariableReferenceValue::domTemplate, V8CSSVariableReferenceValue::trace, V8CSSVariableReferenceValue::traceWrappers, 0, 0, V8CSSVariableReferenceValue::preparePrototypeAndInterfaceObject, nullptr, "CSSVariableReferenceValue", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSStyleVariableReferenceValue>::value,
    "CSSStyleVariableReferenceValue inherits from ActiveScriptWrappable, but does not specify "
...
static void variableAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void fallbackAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Object> holder = info.Holder();
    CSSStyleVariableReferenceValue* impl = V8CSSVariableReferenceValue::toImpl(holder);
    CSSTokenStreamValue* cppValue(WTF::getPtr(impl->fallback()));
    if (cppValue && DOMDataStore::setReturnValue(info.GetReturnValue(), cppValue))
        return;
    v8::Local<v8::Value> v8Value(toV8(cppValue, holder, info.GetIsolate()));
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "fallback"), v8Value);
        v8SetReturnValue(info, v8Value);
    }
}

static void fallbackAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8CSSVariableReferenceValueAccessors[] = {
    {"variable", CSSStyleVariableReferenceValueV8Internal::variableAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"fallback", CSSStyleVariableReferenceValueV8Internal::fallbackAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
