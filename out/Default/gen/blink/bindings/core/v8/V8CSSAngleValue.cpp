...
#endif
const WrapperTypeInfo V8CSSAngleValue::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSAngleValue::domTemplate, V8CSSAngleValue::trace, V8CSSAngleValue::traceWrappers, 0, 0, V8CSSAngleValue::preparePrototypeAndInterfaceObject, nullptr, "CSSAngleValue", &V8CSSStyleValue::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSAngleValue>::value,
    "CSSAngleValue inherits from ActiveScriptWrappable, but does not specify "
...
static void degreesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void radiansAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void gradiansAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void turnsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "CSSAngleValue", info.Holder(), info.GetIsolate());
    ...
    V8StringResource<> unit;
    {
        ...
        if (!isValidEnum(unit, validValues, WTF_ARRAY_LENGTH(validValues), "CSSAngleUnit", exceptionState)) {
            exceptionState.throwIfNeeded();
            return;
        }
    }
    CSSAngleValue* impl = CSSAngleValue::create(value, unit, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8CSSAngleValueAccessors[] = {
    {"degrees", CSSAngleValueV8Internal::degreesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"radians", CSSAngleValueV8Internal::radiansAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"gradians", CSSAngleValueV8Internal::gradiansAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"turns", CSSAngleValueV8Internal::turnsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
