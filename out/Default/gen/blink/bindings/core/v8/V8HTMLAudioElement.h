...
#ifndef V8HTMLAudioElement_h
#define V8HTMLAudioElement_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<HTMLAudioElement>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<HTMLAudioElement>());
    }
