...
#endif
const WrapperTypeInfo V8CustomEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8CustomEvent::domTemplate, V8CustomEvent::trace, V8CustomEvent::traceWrappers, 0, 0, V8CustomEvent::preparePrototypeAndInterfaceObject, nullptr, "CustomEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CustomEvent>::value,
    "CustomEvent inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "initCustomEvent", "CustomEvent", info.Holder(), info.GetIsolate());
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8CustomEvent_InitCustomEvent_Method);
...
const V8DOMConfiguration::AccessorConfiguration V8CustomEventAccessors[] = {
    {"detail", CustomEventV8Internal::detailAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"isTrusted", CustomEventV8Internal::isTrustedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8CustomEventMethods[] = {
    {"initCustomEvent", CustomEventV8Internal::initCustomEventMethodCallback, 0, 4, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
