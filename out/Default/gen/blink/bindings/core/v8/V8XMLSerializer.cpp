...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, XMLSerializer>::value,
    "XMLSerializer inherits from ActiveScriptWrappable, but does not specify "
...
static void serializeToStringMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "serializeToString", "XMLSerializer", 1, info.Length()));
        return;
    }
...
const V8DOMConfiguration::MethodConfiguration V8XMLSerializerMethods[] = {
    {"serializeToString", XMLSerializerV8Internal::serializeToStringMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
