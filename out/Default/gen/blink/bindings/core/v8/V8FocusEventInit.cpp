...
void V8FocusEventInit::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, FocusEventInit& impl, ExceptionState& exceptionState)
{
...
FocusEventInit NativeValueTraits<FocusEventInit>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    FocusEventInit impl;
    V8FocusEventInit::toImpl(isolate, value, impl, exceptionState);
    return impl;
}
