...
#endif
const WrapperTypeInfo V8FileReaderSync::wrapperTypeInfo = { gin::kEmbedderBlink, V8FileReaderSync::domTemplate, V8FileReaderSync::trace, V8FileReaderSync::traceWrappers, 0, 0, V8FileReaderSync::preparePrototypeAndInterfaceObject, nullptr, "FileReaderSync", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, FileReaderSync>::value,
    "FileReaderSync inherits from ActiveScriptWrappable, but does not specify "
...
static void readAsArrayBufferMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    DOMArrayBuffer* result = impl->readAsArrayBuffer(executionContext, blob, exceptionState);
...
{
    FileReaderSync* impl = FileReaderSync::create();
...
const V8DOMConfiguration::MethodConfiguration V8FileReaderSyncMethods[] = {
    {"readAsArrayBuffer", FileReaderSyncV8Internal::readAsArrayBufferMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"readAsBinaryString", FileReaderSyncV8Internal::readAsBinaryStringMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"readAsText", FileReaderSyncV8Internal::readAsTextMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"readAsDataURL", FileReaderSyncV8Internal::readAsDataURLMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
