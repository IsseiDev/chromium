...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, EventTarget>::value,
    "EventTarget inherits from ActiveScriptWrappable, but does not specify "
