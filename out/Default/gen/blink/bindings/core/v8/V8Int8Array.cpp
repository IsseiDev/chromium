...
#endif
const WrapperTypeInfo V8Int8Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Int8Array::trace, V8Int8Array::traceWrappers, 0, 0, V8Int8Array::preparePrototypeAndInterfaceObject, nullptr, "Int8Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMInt8Array>::value,
    "DOMInt8Array inherits from ActiveScriptWrappable, but does not specify "
