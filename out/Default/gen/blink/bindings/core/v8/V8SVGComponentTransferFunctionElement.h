...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<SVGComponentTransferFunctionElement>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<SVGComponentTransferFunctionElement>());
    }
