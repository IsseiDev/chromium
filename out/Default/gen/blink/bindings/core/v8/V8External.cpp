...
#endif
const WrapperTypeInfo V8External::wrapperTypeInfo = { gin::kEmbedderBlink, V8External::domTemplate, V8External::trace, V8External::traceWrappers, 0, 0, V8External::preparePrototypeAndInterfaceObject, nullptr, "External", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, External>::value,
    "External inherits from ActiveScriptWrappable, but does not specify "
...
static void AddSearchProviderMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void IsSearchProviderInstalledMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::MethodConfiguration V8ExternalMethods[] = {
    {"AddSearchProvider", ExternalV8Internal::AddSearchProviderMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"IsSearchProviderInstalled", ExternalV8Internal::IsSearchProviderInstalledMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
