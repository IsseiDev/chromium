...
#ifndef V8SVGTextPositioningElement_h
#define V8SVGTextPositioningElement_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<SVGTextPositioningElement>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<SVGTextPositioningElement>());
    }
...
#endif // V8SVGTextPositioningElement_h
