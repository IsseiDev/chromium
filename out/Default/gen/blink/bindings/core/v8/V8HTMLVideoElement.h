...
public:
    ...
    {
        visitor->traceWrappers(scriptWrappable->toImpl<HTMLVideoElement>());
    }
    ...
    CORE_EXPORT static void installV8HTMLVideoElementTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interfaceTemplate);
