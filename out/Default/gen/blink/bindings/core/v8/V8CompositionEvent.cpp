...
#endif
const WrapperTypeInfo V8CompositionEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8CompositionEvent::domTemplate, V8CompositionEvent::trace, V8CompositionEvent::traceWrappers, 0, 0, V8CompositionEvent::preparePrototypeAndInterfaceObject, nullptr, "CompositionEvent", &V8UIEvent::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CompositionEvent>::value,
    "CompositionEvent inherits from ActiveScriptWrappable, but does not specify "
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8CompositionEvent_InitCompositionEvent_Method);
...
const V8DOMConfiguration::AccessorConfiguration V8CompositionEventAccessors[] = {
    {"data", CompositionEventV8Internal::dataAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"isTrusted", CompositionEventV8Internal::isTrustedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8CompositionEventMethods[] = {
    {"initCompositionEvent", CompositionEventV8Internal::initCompositionEventMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
