...
#ifndef V8DataTransferItem_h
#define V8DataTransferItem_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<DataTransferItem>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<DataTransferItem>());
    }
    ...
    CORE_EXPORT static void installV8DataTransferItemTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interfaceTemplate);

private:
    static InstallTemplateFunction installV8DataTransferItemTemplateFunction;
};
