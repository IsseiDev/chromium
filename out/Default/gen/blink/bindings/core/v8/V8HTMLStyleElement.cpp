...
#endif
const WrapperTypeInfo V8HTMLStyleElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLStyleElement::domTemplate, V8HTMLStyleElement::trace, V8HTMLStyleElement::traceWrappers, 0, 0, V8HTMLStyleElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLStyleElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLStyleElement>::value,
    "HTMLStyleElement inherits from ActiveScriptWrappable, but does not specify "
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8HTMLStyleElement_Disabled_AttributeGetter);
...
static void disabledAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8HTMLStyleElement_Disabled_AttributeSetter);
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLStyleElementAccessors[] = {
    {"disabled", HTMLStyleElementV8Internal::disabledAttributeGetterCallback, HTMLStyleElementV8Internal::disabledAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"media", HTMLStyleElementV8Internal::mediaAttributeGetterCallback, HTMLStyleElementV8Internal::mediaAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", HTMLStyleElementV8Internal::typeAttributeGetterCallback, HTMLStyleElementV8Internal::typeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"sheet", HTMLStyleElementV8Internal::sheetAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
