...
#endif
const WrapperTypeInfo V8Uint8Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Uint8Array::trace, V8Uint8Array::traceWrappers, 0, 0, V8Uint8Array::preparePrototypeAndInterfaceObject, nullptr, "Uint8Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMUint8Array>::value,
    "DOMUint8Array inherits from ActiveScriptWrappable, but does not specify "
