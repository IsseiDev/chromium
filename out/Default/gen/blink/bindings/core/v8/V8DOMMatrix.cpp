...
#endif
const WrapperTypeInfo V8DOMMatrix::wrapperTypeInfo = { gin::kEmbedderBlink, V8DOMMatrix::domTemplate, V8DOMMatrix::trace, V8DOMMatrix::traceWrappers, 0, 0, V8DOMMatrix::preparePrototypeAndInterfaceObject, nullptr, "DOMMatrix", &V8DOMMatrixReadOnly::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMMatrix>::value,
    "DOMMatrix inherits from ActiveScriptWrappable, but does not specify "
...
static void multiplySelfMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "multiplySelf", "DOMMatrix", 1, info.Length()));
        return;
    }
    ...
    DOMMatrix* other;
    {
        ...
        if (!other) {
            V8ThrowException::throwTypeError(info.GetIsolate(), ExceptionMessages::failedToExecute("multiplySelf", "DOMMatrix", "parameter 1 is not of type 'DOMMatrix'."));
            return;
        }
    }
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "preMultiplySelf", "DOMMatrix", 1, info.Length()));
        return;
    }
    DOMMatrix* impl = V8DOMMatrix::toImpl(info.Holder());
    DOMMatrix* other;
    {
        other = V8DOMMatrix::toImplWithTypeCheck(info.GetIsolate(), info[0]);
        if (!other) {
            V8ThrowException::throwTypeError(info.GetIsolate(), ExceptionMessages::failedToExecute("preMultiplySelf", "DOMMatrix", "parameter 1 is not of type 'DOMMatrix'."));
            return;
        }
    }
...
{
    DOMMatrix* impl = DOMMatrix::create();
...
static void constructor2(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    DOMMatrixReadOnly* other;
    {
        ...
        if (!other) {
            V8ThrowException::throwTypeError(info.GetIsolate(), ExceptionMessages::failedToConstruct("DOMMatrix", "parameter 1 is not of type 'DOMMatrixReadOnly'."));
            return;
        }
    }
    DOMMatrix* impl = DOMMatrix::create(other);
    v8::Local<v8::Object> wrapper = info.Holder();
    wrapper = impl->associateWithWrapper(info.GetIsolate(), &V8DOMMatrix::wrapperTypeInfo, wrapper);
    v8SetReturnValue(info, wrapper);
}
...
const V8DOMConfiguration::AccessorConfiguration V8DOMMatrixAccessors[] = {
    {"a", DOMMatrixV8Internal::aAttributeGetterCallback, DOMMatrixV8Internal::aAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"b", DOMMatrixV8Internal::bAttributeGetterCallback, DOMMatrixV8Internal::bAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"c", DOMMatrixV8Internal::cAttributeGetterCallback, DOMMatrixV8Internal::cAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"d", DOMMatrixV8Internal::dAttributeGetterCallback, DOMMatrixV8Internal::dAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"e", DOMMatrixV8Internal::eAttributeGetterCallback, DOMMatrixV8Internal::eAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"f", DOMMatrixV8Internal::fAttributeGetterCallback, DOMMatrixV8Internal::fAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m11", DOMMatrixV8Internal::m11AttributeGetterCallback, DOMMatrixV8Internal::m11AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m12", DOMMatrixV8Internal::m12AttributeGetterCallback, DOMMatrixV8Internal::m12AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m13", DOMMatrixV8Internal::m13AttributeGetterCallback, DOMMatrixV8Internal::m13AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m14", DOMMatrixV8Internal::m14AttributeGetterCallback, DOMMatrixV8Internal::m14AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m21", DOMMatrixV8Internal::m21AttributeGetterCallback, DOMMatrixV8Internal::m21AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m22", DOMMatrixV8Internal::m22AttributeGetterCallback, DOMMatrixV8Internal::m22AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m23", DOMMatrixV8Internal::m23AttributeGetterCallback, DOMMatrixV8Internal::m23AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m24", DOMMatrixV8Internal::m24AttributeGetterCallback, DOMMatrixV8Internal::m24AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m31", DOMMatrixV8Internal::m31AttributeGetterCallback, DOMMatrixV8Internal::m31AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m32", DOMMatrixV8Internal::m32AttributeGetterCallback, DOMMatrixV8Internal::m32AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m33", DOMMatrixV8Internal::m33AttributeGetterCallback, DOMMatrixV8Internal::m33AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m34", DOMMatrixV8Internal::m34AttributeGetterCallback, DOMMatrixV8Internal::m34AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m41", DOMMatrixV8Internal::m41AttributeGetterCallback, DOMMatrixV8Internal::m41AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m42", DOMMatrixV8Internal::m42AttributeGetterCallback, DOMMatrixV8Internal::m42AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m43", DOMMatrixV8Internal::m43AttributeGetterCallback, DOMMatrixV8Internal::m43AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"m44", DOMMatrixV8Internal::m44AttributeGetterCallback, DOMMatrixV8Internal::m44AttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8DOMMatrixMethods[] = {
    {"multiplySelf", DOMMatrixV8Internal::multiplySelfMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"preMultiplySelf", DOMMatrixV8Internal::preMultiplySelfMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"translateSelf", DOMMatrixV8Internal::translateSelfMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"scaleSelf", DOMMatrixV8Internal::scaleSelfMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"scale3dSelf", DOMMatrixV8Internal::scale3dSelfMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"scaleNonUniformSelf", DOMMatrixV8Internal::scaleNonUniformSelfMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
