...
#endif
const WrapperTypeInfo V8CSSKeywordValue::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSKeywordValue::domTemplate, V8CSSKeywordValue::trace, V8CSSKeywordValue::traceWrappers, 0, 0, V8CSSKeywordValue::preparePrototypeAndInterfaceObject, nullptr, "CSSKeywordValue", &V8CSSStyleValue::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& CSSKeywordValue::s_wrapperTypeInfo = V8CSSKeywordValue::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSKeywordValue>::value,
    "CSSKeywordValue inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "CSSKeywordValue", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::AccessorConfiguration V8CSSKeywordValueAccessors[] = {
    {"keywordValue", CSSKeywordValueV8Internal::keywordValueAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
