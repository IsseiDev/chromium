...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, ResizeObserver>::value,
    "ResizeObserver inherits from ActiveScriptWrappable, but does not specify "
...
static void observeMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "observe", "ResizeObserver", 1, info.Length()));
        return;
    }
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "unobserve", "ResizeObserver", 1, info.Length()));
        return;
    }
    ResizeObserver* impl = V8ResizeObserver::toImpl(info.Holder());
    Element* target;
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForConstructor(info.GetIsolate(), "ResizeObserver", 1, info.Length()));
        return;
    }
...
const V8DOMConfiguration::MethodConfiguration V8ResizeObserverMethods[] = {
    {"observe", ResizeObserverV8Internal::observeMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"unobserve", ResizeObserverV8Internal::unobserveMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"disconnect", ResizeObserverV8Internal::disconnectMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
