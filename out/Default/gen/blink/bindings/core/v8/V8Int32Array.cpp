...
#endif
const WrapperTypeInfo V8Int32Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Int32Array::trace, V8Int32Array::traceWrappers, 0, 0, V8Int32Array::preparePrototypeAndInterfaceObject, nullptr, "Int32Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMInt32Array>::value,
    "DOMInt32Array inherits from ActiveScriptWrappable, but does not specify "
