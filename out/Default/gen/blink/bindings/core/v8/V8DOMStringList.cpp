...
#endif
const WrapperTypeInfo V8DOMStringList::wrapperTypeInfo = { gin::kEmbedderBlink, V8DOMStringList::domTemplate, V8DOMStringList::trace, V8DOMStringList::traceWrappers, 0, 0, V8DOMStringList::preparePrototypeAndInterfaceObject, nullptr, "DOMStringList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMStringList>::value,
    "DOMStringList inherits from ActiveScriptWrappable, but does not specify "
...
static void itemMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    v8SetReturnValueStringOrNull(info, impl->item(executionContext, index), info.GetIsolate());
}
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "contains", "DOMStringList", 1, info.Length()));
        return;
    }
    DOMStringList* impl = V8DOMStringList::toImpl(info.Holder());
    ...
    ExecutionContext* executionContext = currentExecutionContext(info.GetIsolate());
    v8SetReturnValueBool(info, impl->contains(executionContext, string));
}

static void containsMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::DOMStringListContains);
...
const V8DOMConfiguration::AccessorConfiguration V8DOMStringListAccessors[] = {
    {"length", DOMStringListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8DOMStringListMethods[] = {
    {"item", DOMStringListV8Internal::itemMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"contains", DOMStringListV8Internal::containsMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
