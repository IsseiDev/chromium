...
#ifndef V8SVGFEConvolveMatrixElement_h
#define V8SVGFEConvolveMatrixElement_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<SVGFEConvolveMatrixElement>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<SVGFEConvolveMatrixElement>());
    }
...
#endif // V8SVGFEConvolveMatrixElement_h
