...
#ifndef V8ScrollOptions_h
#define V8ScrollOptions_h
...
public:
    CORE_EXPORT static void toImpl(v8::Isolate*, v8::Local<v8::Value>, ScrollOptions&, ExceptionState&);
};
...
template <>
struct NativeValueTraits<ScrollOptions> {
    static ScrollOptions nativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
