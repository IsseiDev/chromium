...
#endif
const WrapperTypeInfo V8SVGPoint::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGPoint::domTemplate, V8SVGPoint::trace, V8SVGPoint::traceWrappers, 0, V8SVGPoint::visitDOMWrapper, V8SVGPoint::preparePrototypeAndInterfaceObject, nullptr, "SVGPoint", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SVGPointTearOff>::value,
    "SVGPointTearOff inherits from ActiveScriptWrappable, but does not specify "
...
static void matrixTransformMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "matrixTransform", "SVGPoint", 1, info.Length()));
        return;
    }
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::SVGPointMatrixTransform);
...
const V8DOMConfiguration::AccessorConfiguration V8SVGPointAccessors[] = {
    {"x", SVGPointTearOffV8Internal::xAttributeGetterCallback, SVGPointTearOffV8Internal::xAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"y", SVGPointTearOffV8Internal::yAttributeGetterCallback, SVGPointTearOffV8Internal::yAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8SVGPointMethods[] = {
    {"matrixTransform", SVGPointTearOffV8Internal::matrixTransformMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
