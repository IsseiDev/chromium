...
#endif
const WrapperTypeInfo V8HTMLDirectoryElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLDirectoryElement::domTemplate, V8HTMLDirectoryElement::trace, V8HTMLDirectoryElement::traceWrappers, 0, 0, V8HTMLDirectoryElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLDirectoryElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLDirectoryElement>::value,
    "HTMLDirectoryElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLDirectoryElementAccessors[] = {
    {"compact", HTMLDirectoryElementV8Internal::compactAttributeGetterCallback, HTMLDirectoryElementV8Internal::compactAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
