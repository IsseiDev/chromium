...
#endif
const WrapperTypeInfo V8CompositorProxy::wrapperTypeInfo = { gin::kEmbedderBlink, V8CompositorProxy::domTemplate, V8CompositorProxy::trace, V8CompositorProxy::traceWrappers, 0, 0, V8CompositorProxy::preparePrototypeAndInterfaceObject, nullptr, "CompositorProxy", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CompositorProxy>::value,
    "CompositorProxy inherits from ActiveScriptWrappable, but does not specify "
...
static void initializedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void supportsMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "supports", "CompositorProxy", 1, info.Length()));
        return;
    }
...
const V8DOMConfiguration::AccessorConfiguration V8CompositorProxyAccessors[] = {
    {"initialized", CompositorProxyV8Internal::initializedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"opacity", CompositorProxyV8Internal::opacityAttributeGetterCallback, CompositorProxyV8Internal::opacityAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"scrollLeft", CompositorProxyV8Internal::scrollLeftAttributeGetterCallback, CompositorProxyV8Internal::scrollLeftAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"scrollTop", CompositorProxyV8Internal::scrollTopAttributeGetterCallback, CompositorProxyV8Internal::scrollTopAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"transform", CompositorProxyV8Internal::transformAttributeGetterCallback, CompositorProxyV8Internal::transformAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8CompositorProxyMethods[] = {
    {"supports", CompositorProxyV8Internal::supportsMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"disconnect", CompositorProxyV8Internal::disconnectMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
