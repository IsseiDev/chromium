...
#endif
const WrapperTypeInfo V8HTMLShadowElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLShadowElement::domTemplate, V8HTMLShadowElement::trace, V8HTMLShadowElement::traceWrappers, 0, 0, V8HTMLShadowElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLShadowElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLShadowElement>::value,
    "HTMLShadowElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8HTMLShadowElementMethods[] = {
    {"getDistributedNodes", HTMLShadowElementV8Internal::getDistributedNodesMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
