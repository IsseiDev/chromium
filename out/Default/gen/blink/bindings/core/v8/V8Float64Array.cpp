...
#endif
const WrapperTypeInfo V8Float64Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Float64Array::trace, V8Float64Array::traceWrappers, 0, 0, V8Float64Array::preparePrototypeAndInterfaceObject, nullptr, "Float64Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMFloat64Array>::value,
    "DOMFloat64Array inherits from ActiveScriptWrappable, but does not specify "
