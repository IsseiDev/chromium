...
#endif
const WrapperTypeInfo V8CSSPageRule::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSPageRule::domTemplate, V8CSSPageRule::trace, V8CSSPageRule::traceWrappers, 0, 0, V8CSSPageRule::preparePrototypeAndInterfaceObject, nullptr, "CSSPageRule", &V8CSSRule::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& CSSPageRule::s_wrapperTypeInfo = V8CSSPageRule::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSPageRule>::value,
    "CSSPageRule inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8CSSPageRuleAccessors[] = {
    {"selectorText", CSSPageRuleV8Internal::selectorTextAttributeGetterCallback, CSSPageRuleV8Internal::selectorTextAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"style", CSSPageRuleV8Internal::styleAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

static void installV8CSSPageRuleTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8CSSPageRule::wrapperTypeInfo.interfaceName, V8CSSRule::domTemplate(isolate, world), V8CSSPageRule::internalFieldCount);
    ...
    V8DOMConfiguration::installAccessors(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8CSSPageRuleAccessors, WTF_ARRAY_LENGTH(V8CSSPageRuleAccessors));
}
