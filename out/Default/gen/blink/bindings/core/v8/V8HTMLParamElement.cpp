...
#endif
const WrapperTypeInfo V8HTMLParamElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLParamElement::domTemplate, V8HTMLParamElement::trace, V8HTMLParamElement::traceWrappers, 0, 0, V8HTMLParamElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLParamElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLParamElement>::value,
    "HTMLParamElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLParamElementAccessors[] = {
    {"name", HTMLParamElementV8Internal::nameAttributeGetterCallback, HTMLParamElementV8Internal::nameAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"value", HTMLParamElementV8Internal::valueAttributeGetterCallback, HTMLParamElementV8Internal::valueAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", HTMLParamElementV8Internal::typeAttributeGetterCallback, HTMLParamElementV8Internal::typeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"valueType", HTMLParamElementV8Internal::valueTypeAttributeGetterCallback, HTMLParamElementV8Internal::valueTypeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
