...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, MemoryInfo>::value,
    "MemoryInfo inherits from ActiveScriptWrappable, but does not specify "
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8MemoryInfo_TotalJSHeapSize_AttributeGetter);
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8MemoryInfo_UsedJSHeapSize_AttributeGetter);
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::V8MemoryInfo_JSHeapSizeLimit_AttributeGetter);
...
const V8DOMConfiguration::AccessorConfiguration V8MemoryInfoAccessors[] = {
    {"totalJSHeapSize", MemoryInfoV8Internal::totalJSHeapSizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"usedJSHeapSize", MemoryInfoV8Internal::usedJSHeapSizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"jsHeapSizeLimit", MemoryInfoV8Internal::jsHeapSizeLimitAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
