...
#endif
const WrapperTypeInfo V8Uint16Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Uint16Array::trace, V8Uint16Array::traceWrappers, 0, 0, V8Uint16Array::preparePrototypeAndInterfaceObject, nullptr, "Uint16Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMUint16Array>::value,
    "DOMUint16Array inherits from ActiveScriptWrappable, but does not specify "
