...
#endif
const WrapperTypeInfo V8HTMLBRElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLBRElement::domTemplate, V8HTMLBRElement::trace, V8HTMLBRElement::traceWrappers, 0, 0, V8HTMLBRElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLBRElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLBRElement>::value,
    "HTMLBRElement inherits from ActiveScriptWrappable, but does not specify "
...
static void clearAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void clearAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLBRElementAccessors[] = {
    {"clear", HTMLBRElementV8Internal::clearAttributeGetterCallback, HTMLBRElementV8Internal::clearAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
