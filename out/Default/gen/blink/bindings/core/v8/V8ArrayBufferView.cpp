...
// This static member must be declared by DEFINE_WRAPPERTYPEINFO in DOMArrayBufferView.h.
// For details, see the comment of DEFINE_WRAPPERTYPEINFO in
// bindings/core/v8/ScriptWrappable.h.
const WrapperTypeInfo& DOMArrayBufferView::s_wrapperTypeInfo = V8ArrayBufferView::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMArrayBufferView>::value,
    "DOMArrayBufferView inherits from ActiveScriptWrappable, but does not specify "
