...
#endif
const WrapperTypeInfo V8Blob::wrapperTypeInfo = { gin::kEmbedderBlink, V8Blob::domTemplate, V8Blob::trace, V8Blob::traceWrappers, 0, 0, V8Blob::preparePrototypeAndInterfaceObject, nullptr, "Blob", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, Blob>::value,
    "Blob inherits from ActiveScriptWrappable, but does not specify "
...
static void isClosedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8BlobAccessors[] = {
    {"size", BlobV8Internal::sizeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", BlobV8Internal::typeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8BlobMethods[] = {
    {"slice", BlobV8Internal::sliceMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8BlobTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    if (RuntimeEnabledFeatures::fileAPIBlobCloseEnabled()) {
        const V8DOMConfiguration::AccessorConfiguration accessorisClosedConfiguration = \
        {"isClosed", BlobV8Internal::isClosedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
    ...
    if (RuntimeEnabledFeatures::fileAPIBlobCloseEnabled()) {
        const V8DOMConfiguration::MethodConfiguration closeMethodConfiguration = {"close", BlobV8Internal::closeMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
