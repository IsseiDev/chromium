...
#endif
const WrapperTypeInfo V8CSSStyleDeclaration::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSStyleDeclaration::domTemplate, V8CSSStyleDeclaration::trace, V8CSSStyleDeclaration::traceWrappers, 0, V8CSSStyleDeclaration::visitDOMWrapper, V8CSSStyleDeclaration::preparePrototypeAndInterfaceObject, nullptr, "CSSStyleDeclaration", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSStyleDeclaration>::value,
    "CSSStyleDeclaration inherits from ActiveScriptWrappable, but does not specify "
...
static void parentRuleAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "parentRule"), v8Value);
...
static void cssFloatAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    v8::Local<v8::Object> holder = info.Holder();
    ExceptionState exceptionState(ExceptionState::SetterContext, "cssFloat", "CSSStyleDeclaration", holder, info.GetIsolate());
    CSSStyleDeclaration* impl = V8CSSStyleDeclaration::toImpl(holder);
...
static void cssFloatAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Value> v8Value = info[0];
    CEReactionsScope ceReactionsScope;
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "getPropertyValue", "CSSStyleDeclaration", 1, info.Length()));
        return;
    }
    CSSStyleDeclaration* impl = V8CSSStyleDeclaration::toImpl(info.Holder());
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "getPropertyPriority", "CSSStyleDeclaration", 1, info.Length()));
        return;
    }
    CSSStyleDeclaration* impl = V8CSSStyleDeclaration::toImpl(info.Holder());
    V8StringResource<> property;
...
const V8DOMConfiguration::AccessorConfiguration V8CSSStyleDeclarationAccessors[] = {
    {"cssText", CSSStyleDeclarationV8Internal::cssTextAttributeGetterCallback, CSSStyleDeclarationV8Internal::cssTextAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"length", CSSStyleDeclarationV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"parentRule", CSSStyleDeclarationV8Internal::parentRuleAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"cssFloat", CSSStyleDeclarationV8Internal::cssFloatAttributeGetterCallback, CSSStyleDeclarationV8Internal::cssFloatAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8CSSStyleDeclarationMethods[] = {
    {"item", CSSStyleDeclarationV8Internal::itemMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getPropertyValue", CSSStyleDeclarationV8Internal::getPropertyValueMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getPropertyPriority", CSSStyleDeclarationV8Internal::getPropertyPriorityMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"setProperty", CSSStyleDeclarationV8Internal::setPropertyMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"removeProperty", CSSStyleDeclarationV8Internal::removePropertyMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8CSSStyleDeclarationTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    // Indexed properties
    v8::IndexedPropertyHandlerConfiguration indexedPropertyHandlerConfig(CSSStyleDeclarationV8Internal::indexedPropertyGetterCallback, 0, 0, 0, indexedPropertyEnumerator<CSSStyleDeclaration>, v8::Local<v8::Value>(), v8::PropertyHandlerFlags::kNone);
