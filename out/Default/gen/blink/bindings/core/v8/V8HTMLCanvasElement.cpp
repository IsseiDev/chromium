...
#endif
WrapperTypeInfo V8HTMLCanvasElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLCanvasElement::domTemplate, V8HTMLCanvasElement::trace, V8HTMLCanvasElement::traceWrappers, 0, 0, V8HTMLCanvasElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLCanvasElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLCanvasElement>::value,
    "HTMLCanvasElement inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "toBlob", "HTMLCanvasElement", info.Holder(), info.GetIsolate());
...
static void toBlobMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLCanvasElementAccessors[] = {
    {"width", HTMLCanvasElementV8Internal::widthAttributeGetterCallback, HTMLCanvasElementV8Internal::widthAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"height", HTMLCanvasElementV8Internal::heightAttributeGetterCallback, HTMLCanvasElementV8Internal::heightAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8HTMLCanvasElementMethods[] = {
    {"toDataURL", HTMLCanvasElementV8Internal::toDataURLMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"toBlob", HTMLCanvasElementV8Internal::toBlobMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
