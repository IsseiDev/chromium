...
#ifndef V8PromiseRejectionEventInit_h
#define V8PromiseRejectionEventInit_h
...
public:
    CORE_EXPORT static void toImpl(v8::Isolate*, v8::Local<v8::Value>, PromiseRejectionEventInit&, ExceptionState&);
};
...
template <>
struct NativeValueTraits<PromiseRejectionEventInit> {
    static PromiseRejectionEventInit nativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
...
#endif // V8PromiseRejectionEventInit_h
