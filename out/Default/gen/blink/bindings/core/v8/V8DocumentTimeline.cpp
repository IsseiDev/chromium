...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DocumentTimeline>::value,
    "DocumentTimeline inherits from ActiveScriptWrappable, but does not specify "
