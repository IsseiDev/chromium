...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CSSTransformComponent>::value,
    "CSSTransformComponent inherits from ActiveScriptWrappable, but does not specify "
...
static void asMatrixMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8CSSTransformComponentAccessors[] = {
    {"cssText", CSSTransformComponentV8Internal::cssTextAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8CSSTransformComponentMethods[] = {
    {"is2D", CSSTransformComponentV8Internal::is2DMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"asMatrix", CSSTransformComponentV8Internal::asMatrixMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
