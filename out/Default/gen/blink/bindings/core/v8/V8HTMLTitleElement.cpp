...
#endif
const WrapperTypeInfo V8HTMLTitleElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLTitleElement::domTemplate, V8HTMLTitleElement::trace, V8HTMLTitleElement::traceWrappers, 0, 0, V8HTMLTitleElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLTitleElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLTitleElement>::value,
    "HTMLTitleElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLTitleElementAccessors[] = {
    {"text", HTMLTitleElementV8Internal::textAttributeGetterCallback, HTMLTitleElementV8Internal::textAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
