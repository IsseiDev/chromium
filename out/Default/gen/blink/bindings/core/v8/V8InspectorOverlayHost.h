...
#ifndef V8InspectorOverlayHost_h
#define V8InspectorOverlayHost_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<InspectorOverlayHost>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<InspectorOverlayHost>());
    }
...
#endif // V8InspectorOverlayHost_h
