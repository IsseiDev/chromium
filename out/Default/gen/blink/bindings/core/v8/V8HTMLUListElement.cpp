...
#endif
const WrapperTypeInfo V8HTMLUListElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLUListElement::domTemplate, V8HTMLUListElement::trace, V8HTMLUListElement::traceWrappers, 0, 0, V8HTMLUListElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLUListElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLUListElement>::value,
    "HTMLUListElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLUListElementAccessors[] = {
    {"compact", HTMLUListElementV8Internal::compactAttributeGetterCallback, HTMLUListElementV8Internal::compactAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", HTMLUListElementV8Internal::typeAttributeGetterCallback, HTMLUListElementV8Internal::typeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

static void installV8HTMLUListElementTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8HTMLUListElement::wrapperTypeInfo.interfaceName, V8HTMLElement::domTemplate(isolate, world), V8HTMLUListElement::internalFieldCount);
    ...
    V8DOMConfiguration::installAccessors(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8HTMLUListElementAccessors, WTF_ARRAY_LENGTH(V8HTMLUListElementAccessors));
}
