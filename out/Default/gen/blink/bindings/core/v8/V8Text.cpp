...
#endif
const WrapperTypeInfo V8Text::wrapperTypeInfo = { gin::kEmbedderBlink, V8Text::domTemplate, V8Text::trace, V8Text::traceWrappers, 0, 0, V8Text::preparePrototypeAndInterfaceObject, nullptr, "Text", &V8CharacterData::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, Text>::value,
    "Text inherits from ActiveScriptWrappable, but does not specify "
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::TextWholeText);
...
const V8DOMConfiguration::AccessorConfiguration V8TextAccessors[] = {
    {"wholeText", TextV8Internal::wholeTextAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8TextMethods[] = {
    {"splitText", TextV8Internal::splitTextMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getDestinationInsertionPoints", TextV8Internal::getDestinationInsertionPointsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8TextTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    if (RuntimeEnabledFeatures::shadowDOMV1Enabled()) {
        ...
        {"assignedSlot", TextV8Internal::assignedSlotAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
