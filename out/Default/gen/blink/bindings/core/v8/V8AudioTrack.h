...
#ifndef V8AudioTrack_h
#define V8AudioTrack_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<AudioTrack>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<AudioTrack>());
    }
    ...
    CORE_EXPORT static void installV8AudioTrackTemplate(v8::Isolate*, const DOMWrapperWorld&, v8::Local<v8::FunctionTemplate> interfaceTemplate);

private:
    static InstallTemplateFunction installV8AudioTrackTemplateFunction;
};
