...
#endif
const WrapperTypeInfo V8TimeRanges::wrapperTypeInfo = { gin::kEmbedderBlink, V8TimeRanges::domTemplate, V8TimeRanges::trace, V8TimeRanges::traceWrappers, 0, 0, V8TimeRanges::preparePrototypeAndInterfaceObject, nullptr, "TimeRanges", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, TimeRanges>::value,
    "TimeRanges inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8TimeRangesAccessors[] = {
    {"length", TimeRangesV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8TimeRangesMethods[] = {
    {"start", TimeRangesV8Internal::startMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"end", TimeRangesV8Internal::endMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
