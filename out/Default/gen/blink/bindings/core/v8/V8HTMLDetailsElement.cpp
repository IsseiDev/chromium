...
#endif
const WrapperTypeInfo V8HTMLDetailsElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLDetailsElement::domTemplate, V8HTMLDetailsElement::trace, V8HTMLDetailsElement::traceWrappers, 0, 0, V8HTMLDetailsElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLDetailsElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLDetailsElement>::value,
    "HTMLDetailsElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLDetailsElementAccessors[] = {
    {"open", HTMLDetailsElementV8Internal::openAttributeGetterCallback, HTMLDetailsElementV8Internal::openAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
