...
#ifndef V8KeyframeEffect_h
#define V8KeyframeEffect_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<KeyframeEffect>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<KeyframeEffect>());
    }
