...
#endif
const WrapperTypeInfo V8HTMLMetaElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLMetaElement::domTemplate, V8HTMLMetaElement::trace, V8HTMLMetaElement::traceWrappers, 0, 0, V8HTMLMetaElement::preparePrototypeAndInterfaceObject, nullptr, "HTMLMetaElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, HTMLMetaElement>::value,
    "HTMLMetaElement inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLMetaElementAccessors[] = {
    {"name", HTMLMetaElementV8Internal::nameAttributeGetterCallback, HTMLMetaElementV8Internal::nameAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"httpEquiv", HTMLMetaElementV8Internal::httpEquivAttributeGetterCallback, HTMLMetaElementV8Internal::httpEquivAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"content", HTMLMetaElementV8Internal::contentAttributeGetterCallback, HTMLMetaElementV8Internal::contentAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"scheme", HTMLMetaElementV8Internal::schemeAttributeGetterCallback, HTMLMetaElementV8Internal::schemeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
