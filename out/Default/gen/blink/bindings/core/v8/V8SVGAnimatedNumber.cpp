...
#endif
const WrapperTypeInfo V8SVGAnimatedNumber::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGAnimatedNumber::domTemplate, V8SVGAnimatedNumber::trace, V8SVGAnimatedNumber::traceWrappers, 0, V8SVGAnimatedNumber::visitDOMWrapper, V8SVGAnimatedNumber::preparePrototypeAndInterfaceObject, nullptr, "SVGAnimatedNumber", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SVGAnimatedNumber>::value,
    "SVGAnimatedNumber inherits from ActiveScriptWrappable, but does not specify "
...
{
    v8::Local<v8::Object> holder = info.Holder();
    ExceptionState exceptionState(ExceptionState::SetterContext, "baseVal", "SVGAnimatedNumber", holder, info.GetIsolate());
    SVGAnimatedNumber* impl = V8SVGAnimatedNumber::toImpl(holder);
...
const V8DOMConfiguration::AccessorConfiguration V8SVGAnimatedNumberAccessors[] = {
    {"baseVal", SVGAnimatedNumberV8Internal::baseValAttributeGetterCallback, SVGAnimatedNumberV8Internal::baseValAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"animVal", SVGAnimatedNumberV8Internal::animValAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
