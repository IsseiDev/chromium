...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, XPathNSResolver>::value,
    "XPathNSResolver inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8XPathNSResolverMethods[] = {
    {"lookupNamespaceURI", XPathNSResolverV8Internal::lookupNamespaceURIMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
