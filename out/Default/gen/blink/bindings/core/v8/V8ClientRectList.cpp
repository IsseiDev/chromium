...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, ClientRectList>::value,
    "ClientRectList inherits from ActiveScriptWrappable, but does not specify "
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::ClientRectListItem);
...
const V8DOMConfiguration::AccessorConfiguration V8ClientRectListAccessors[] = {
    {"length", ClientRectListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8ClientRectListMethods[] = {
    {"item", ClientRectListV8Internal::itemMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
