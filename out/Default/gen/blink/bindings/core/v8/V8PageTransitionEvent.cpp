...
#endif
const WrapperTypeInfo V8PageTransitionEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8PageTransitionEvent::domTemplate, V8PageTransitionEvent::trace, V8PageTransitionEvent::traceWrappers, 0, 0, V8PageTransitionEvent::preparePrototypeAndInterfaceObject, nullptr, "PageTransitionEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, PageTransitionEvent>::value,
    "PageTransitionEvent inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8PageTransitionEventAccessors[] = {
    {"persisted", PageTransitionEventV8Internal::persistedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"isTrusted", PageTransitionEventV8Internal::isTrustedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::DontDelete | v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder},
};
