...
public:
    ...
    static Cache* toImpl(v8::Local<v8::Object> object)
    {
        return toScriptWrappable(object)->toImpl<Cache>();
    }
    MODULES_EXPORT static Cache* toImplWithTypeCheck(v8::Isolate*, v8::Local<v8::Value>);
    MODULES_EXPORT static const WrapperTypeInfo wrapperTypeInfo;
    template<typename VisitorDispatcher>
    static void trace(VisitorDispatcher visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->trace(scriptWrappable->toImpl<Cache>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<Cache>());
    }
...
template <>
struct V8TypeOf<Cache> {
    typedef V8Cache Type;
};
