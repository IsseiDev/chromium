...
#ifndef V8MediaKeySystemAccess_h
#define V8MediaKeySystemAccess_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<MediaKeySystemAccess>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<MediaKeySystemAccess>());
    }
...
#endif // V8MediaKeySystemAccess_h
