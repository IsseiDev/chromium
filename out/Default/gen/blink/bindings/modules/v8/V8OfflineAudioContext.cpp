...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::OfflineAudioContextStartRendering);
    OfflineAudioContextV8Internal::startRenderingMethod(info);
}

static void suspendMethodPromise(const v8::FunctionCallbackInfo<v8::Value>& info, ExceptionState& exceptionState)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "suspend", "OfflineAudioContext", info.Holder(), info.GetIsolate());
    suspendMethodPromise(info, exceptionState);
    if (exceptionState.hadException())
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::OfflineAudioContextSuspend);
...
{
    UseCounter::countIfNotPrivateScript(info.GetIsolate(), currentExecutionContext(info.GetIsolate()), UseCounter::OfflineAudioContextResume);
    OfflineAudioContextV8Internal::resumeMethod(info);
}
...
const V8DOMConfiguration::AccessorConfiguration V8OfflineAudioContextAccessors[] = {
    {"oncomplete", OfflineAudioContextV8Internal::oncompleteAttributeGetterCallback, OfflineAudioContextV8Internal::oncompleteAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"length", OfflineAudioContextV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8OfflineAudioContextMethods[] = {
    {"startRendering", OfflineAudioContextV8Internal::startRenderingMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"suspend", OfflineAudioContextV8Internal::suspendMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"resume", OfflineAudioContextV8Internal::resumeMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8OfflineAudioContextTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8OfflineAudioContext::wrapperTypeInfo.interfaceName, V8AudioContext::domTemplate(isolate, world), V8OfflineAudioContext::internalFieldCount);
...
ActiveScriptWrappable* V8OfflineAudioContext::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
