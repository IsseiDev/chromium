...
#ifndef V8MediaSettingsRange_h
#define V8MediaSettingsRange_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<MediaSettingsRange>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<MediaSettingsRange>());
    }
