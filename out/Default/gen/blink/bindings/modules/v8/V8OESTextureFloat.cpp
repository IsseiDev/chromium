...
#endif
const WrapperTypeInfo V8OESTextureFloat::wrapperTypeInfo = { gin::kEmbedderBlink, V8OESTextureFloat::domTemplate, V8OESTextureFloat::trace, V8OESTextureFloat::traceWrappers, 0, V8OESTextureFloat::visitDOMWrapper, V8OESTextureFloat::preparePrototypeAndInterfaceObject, nullptr, "OESTextureFloat", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, OESTextureFloat>::value,
    "OESTextureFloat inherits from ActiveScriptWrappable, but does not specify "
...
static void installV8OESTextureFloatTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8OESTextureFloat::wrapperTypeInfo.interfaceName, v8::Local<v8::FunctionTemplate>(), V8OESTextureFloat::internalFieldCount);
...
v8::Local<v8::FunctionTemplate> V8OESTextureFloat::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world)
{
    return V8DOMConfiguration::domClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8OESTextureFloatTemplate);
}
