...
#endif
const WrapperTypeInfo V8IDBObserver::wrapperTypeInfo = { gin::kEmbedderBlink, V8IDBObserver::domTemplate, V8IDBObserver::trace, V8IDBObserver::traceWrappers, 0, 0, V8IDBObserver::preparePrototypeAndInterfaceObject, nullptr, "IDBObserver", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& IDBObserver::s_wrapperTypeInfo = V8IDBObserver::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, IDBObserver>::value,
    "IDBObserver inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "observe", "IDBObserver", info.Holder(), info.GetIsolate());
    ...
    impl->observe(db, tx, exceptionState);
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "unobserve", "IDBObserver", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::MethodConfiguration V8IDBObserverMethods[] = {
    {"observe", IDBObserverV8Internal::observeMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"unobserve", IDBObserverV8Internal::unobserveMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
