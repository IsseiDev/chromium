...
#endif
const WrapperTypeInfo V8EXTShaderTextureLOD::wrapperTypeInfo = { gin::kEmbedderBlink, V8EXTShaderTextureLOD::domTemplate, V8EXTShaderTextureLOD::trace, V8EXTShaderTextureLOD::traceWrappers, 0, V8EXTShaderTextureLOD::visitDOMWrapper, V8EXTShaderTextureLOD::preparePrototypeAndInterfaceObject, nullptr, "EXTShaderTextureLOD", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, EXTShaderTextureLOD>::value,
    "EXTShaderTextureLOD inherits from ActiveScriptWrappable, but does not specify "
