...
#endif
const WrapperTypeInfo V8Clients::wrapperTypeInfo = { gin::kEmbedderBlink, V8Clients::domTemplate, V8Clients::trace, V8Clients::traceWrappers, 0, 0, V8Clients::preparePrototypeAndInterfaceObject, nullptr, "Clients", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, ServiceWorkerClients>::value,
    "ServiceWorkerClients inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "get", "Clients", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::MethodConfiguration V8ClientsMethods[] = {
    {"matchAll", ServiceWorkerClientsV8Internal::matchAllMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"claim", ServiceWorkerClientsV8Internal::claimMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8ClientsTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    if (RuntimeEnabledFeatures::serviceWorkerClientsGetIDEnabled()) {
        const V8DOMConfiguration::MethodConfiguration getMethodConfiguration = {"get", ServiceWorkerClientsV8Internal::getMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
        V8DOMConfiguration::installMethod(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, getMethodConfiguration);
    }
    if (RuntimeEnabledFeatures::serviceWorkerClientAttributesEnabled()) {
        const V8DOMConfiguration::MethodConfiguration openWindowMethodConfiguration = {"openWindow", ServiceWorkerClientsV8Internal::openWindowMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
        V8DOMConfiguration::installMethod(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, openWindowMethodConfiguration);
    }
}
