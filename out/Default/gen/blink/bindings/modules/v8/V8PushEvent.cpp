...
#include "bindings/modules/v8/V8PushEventInit.h"
...
#endif
const WrapperTypeInfo V8PushEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8PushEvent::domTemplate, V8PushEvent::trace, V8PushEvent::traceWrappers, 0, 0, V8PushEvent::preparePrototypeAndInterfaceObject, nullptr, "PushEvent", &V8ExtendableEvent::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& PushEvent::s_wrapperTypeInfo = V8PushEvent::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, PushEvent>::value,
    "PushEvent inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "PushEvent", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::AccessorConfiguration V8PushEventAccessors[] = {
    {"data", PushEventV8Internal::dataAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8PushEventTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8PushEvent::wrapperTypeInfo.interfaceName, V8ExtendableEvent::domTemplate(isolate, world), V8PushEvent::internalFieldCount);
    ...
    if (RuntimeEnabledFeatures::pushMessagingEnabled()) {
        V8DOMConfiguration::installAccessors(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8PushEventAccessors, WTF_ARRAY_LENGTH(V8PushEventAccessors));
    }
}
