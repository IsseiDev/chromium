...
#endif
const WrapperTypeInfo V8MIDIOutput::wrapperTypeInfo = { gin::kEmbedderBlink, V8MIDIOutput::domTemplate, V8MIDIOutput::trace, V8MIDIOutput::traceWrappers, V8MIDIOutput::toActiveScriptWrappable, V8MIDIOutput::visitDOMWrapper, V8MIDIOutput::preparePrototypeAndInterfaceObject, nullptr, "MIDIOutput", &V8MIDIPort::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::MethodConfiguration V8MIDIOutputMethods[] = {
    {"send", MIDIOutputV8Internal::sendMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
ActiveScriptWrappable* V8MIDIOutput::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
