...
#endif
const WrapperTypeInfo V8InstallEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8InstallEvent::domTemplate, V8InstallEvent::trace, V8InstallEvent::traceWrappers, 0, 0, V8InstallEvent::preparePrototypeAndInterfaceObject, nullptr, "InstallEvent", &V8ExtendableEvent::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, InstallEvent>::value,
    "InstallEvent inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "registerForeignFetch", "InstallEvent", info.Holder(), info.GetIsolate());
...
static void registerForeignFetchMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::MethodConfiguration V8InstallEventMethods[] = {
    {"registerForeignFetch", InstallEventV8Internal::registerForeignFetchMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8InstallEventTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    V8DOMConfiguration::installMethods(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8InstallEventMethods, WTF_ARRAY_LENGTH(V8InstallEventMethods));
}
