...
if (RuntimeEnabledFeatures::audioVideoTracksEnabled()) {
    ...
    if (RuntimeEnabledFeatures::audioVideoTracksEnabled()) {
        ...
        {"sourceBuffer", VideoTrackPartialV8Internal::sourceBufferAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder};
...
void V8VideoTrackPartial::preparePrototypeAndInterfaceObject(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> prototypeObject, v8::Local<v8::Function> interfaceObject, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    V8VideoTrack::preparePrototypeAndInterfaceObject(context, world, prototypeObject, interfaceObject, interfaceTemplate);
}
...
void V8VideoTrackPartial::initialize()
{
    ...
    V8VideoTrack::updateWrapperTypeInfo(
        ...
        &V8VideoTrackPartial::preparePrototypeAndInterfaceObject);
}
