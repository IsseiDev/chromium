...
#endif
const WrapperTypeInfo V8WebGLCompressedTextureETC1::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLCompressedTextureETC1::domTemplate, V8WebGLCompressedTextureETC1::trace, V8WebGLCompressedTextureETC1::traceWrappers, 0, V8WebGLCompressedTextureETC1::visitDOMWrapper, V8WebGLCompressedTextureETC1::preparePrototypeAndInterfaceObject, nullptr, "WebGLCompressedTextureETC1", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, WebGLCompressedTextureETC1>::value,
    "WebGLCompressedTextureETC1 inherits from ActiveScriptWrappable, but does not specify "
