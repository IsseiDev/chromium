...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, VRFieldOfView>::value,
    "VRFieldOfView inherits from ActiveScriptWrappable, but does not specify "
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    VRFieldOfView* impl = VRFieldOfView::create(fov);
...
const V8DOMConfiguration::AccessorConfiguration V8VRFieldOfViewAccessors[] = {
    {"upDegrees", VRFieldOfViewV8Internal::upDegreesAttributeGetterCallback, VRFieldOfViewV8Internal::upDegreesAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"downDegrees", VRFieldOfViewV8Internal::downDegreesAttributeGetterCallback, VRFieldOfViewV8Internal::downDegreesAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"leftDegrees", VRFieldOfViewV8Internal::leftDegreesAttributeGetterCallback, VRFieldOfViewV8Internal::leftDegreesAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"rightDegrees", VRFieldOfViewV8Internal::rightDegreesAttributeGetterCallback, VRFieldOfViewV8Internal::rightDegreesAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8VRFieldOfViewTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    interfaceTemplate->SetCallHandler(V8VRFieldOfView::constructorCallback);
