...
#endif
const WrapperTypeInfo V8Geoposition::wrapperTypeInfo = { gin::kEmbedderBlink, V8Geoposition::domTemplate, V8Geoposition::trace, V8Geoposition::traceWrappers, 0, 0, V8Geoposition::preparePrototypeAndInterfaceObject, nullptr, "Geoposition", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, Geoposition>::value,
    "Geoposition inherits from ActiveScriptWrappable, but does not specify "
...
static void coordsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "coords"), v8Value);
...
const V8DOMConfiguration::AccessorConfiguration V8GeopositionAccessors[] = {
    {"coords", GeopositionV8Internal::coordsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"timestamp", GeopositionV8Internal::timestampAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
