...
#ifndef V8VRDisplayCapabilities_h
#define V8VRDisplayCapabilities_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<VRDisplayCapabilities>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<VRDisplayCapabilities>());
    }
...
#endif // V8VRDisplayCapabilities_h
