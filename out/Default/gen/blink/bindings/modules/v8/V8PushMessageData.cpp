...
#endif
const WrapperTypeInfo V8PushMessageData::wrapperTypeInfo = { gin::kEmbedderBlink, V8PushMessageData::domTemplate, V8PushMessageData::trace, V8PushMessageData::traceWrappers, 0, 0, V8PushMessageData::preparePrototypeAndInterfaceObject, nullptr, "PushMessageData", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, PushMessageData>::value,
    "PushMessageData inherits from ActiveScriptWrappable, but does not specify "
