...
#endif
const WrapperTypeInfo V8SpeechRecognitionAlternative::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechRecognitionAlternative::domTemplate, V8SpeechRecognitionAlternative::trace, V8SpeechRecognitionAlternative::traceWrappers, 0, 0, V8SpeechRecognitionAlternative::preparePrototypeAndInterfaceObject, nullptr, "SpeechRecognitionAlternative", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SpeechRecognitionAlternative>::value,
    "SpeechRecognitionAlternative inherits from ActiveScriptWrappable, but does not specify "
...
static void transcriptAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void confidenceAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8SpeechRecognitionAlternativeAccessors[] = {
    {"transcript", SpeechRecognitionAlternativeV8Internal::transcriptAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"confidence", SpeechRecognitionAlternativeV8Internal::confidenceAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
