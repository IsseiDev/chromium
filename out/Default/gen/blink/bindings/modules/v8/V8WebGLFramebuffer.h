...
#ifndef V8WebGLFramebuffer_h
#define V8WebGLFramebuffer_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<WebGLFramebuffer>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<WebGLFramebuffer>());
    }
