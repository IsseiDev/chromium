...
#endif
const WrapperTypeInfo V8ServiceWorker::wrapperTypeInfo = { gin::kEmbedderBlink, V8ServiceWorker::domTemplate, V8ServiceWorker::trace, V8ServiceWorker::traceWrappers, V8ServiceWorker::toActiveScriptWrappable, 0, V8ServiceWorker::preparePrototypeAndInterfaceObject, nullptr, "ServiceWorker", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8ServiceWorkerAccessors[] = {
    {"scriptURL", ServiceWorkerV8Internal::scriptURLAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"state", ServiceWorkerV8Internal::stateAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onstatechange", ServiceWorkerV8Internal::onstatechangeAttributeGetterCallback, ServiceWorkerV8Internal::onstatechangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onerror", ServiceWorkerV8Internal::onerrorAttributeGetterCallback, ServiceWorkerV8Internal::onerrorAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8ServiceWorkerMethods[] = {
    {"postMessage", ServiceWorkerV8Internal::postMessageMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
ActiveScriptWrappable* V8ServiceWorker::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
