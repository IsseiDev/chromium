...
#ifndef V8MediaKeySystemMediaCapability_h
#define V8MediaKeySystemMediaCapability_h
...
public:
    MODULES_EXPORT static void toImpl(v8::Isolate*, v8::Local<v8::Value>, MediaKeySystemMediaCapability&, ExceptionState&);
};
...
template <>
struct NativeValueTraits<MediaKeySystemMediaCapability> {
    static MediaKeySystemMediaCapability nativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
...
#endif // V8MediaKeySystemMediaCapability_h
