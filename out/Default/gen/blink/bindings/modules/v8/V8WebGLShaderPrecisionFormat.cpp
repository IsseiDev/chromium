...
#endif
const WrapperTypeInfo V8WebGLShaderPrecisionFormat::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLShaderPrecisionFormat::domTemplate, V8WebGLShaderPrecisionFormat::trace, V8WebGLShaderPrecisionFormat::traceWrappers, 0, 0, V8WebGLShaderPrecisionFormat::preparePrototypeAndInterfaceObject, nullptr, "WebGLShaderPrecisionFormat", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, WebGLShaderPrecisionFormat>::value,
    "WebGLShaderPrecisionFormat inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8WebGLShaderPrecisionFormatAccessors[] = {
    {"rangeMin", WebGLShaderPrecisionFormatV8Internal::rangeMinAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"rangeMax", WebGLShaderPrecisionFormatV8Internal::rangeMaxAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"precision", WebGLShaderPrecisionFormatV8Internal::precisionAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
