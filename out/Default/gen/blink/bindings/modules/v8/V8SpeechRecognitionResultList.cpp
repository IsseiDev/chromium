...
#endif
const WrapperTypeInfo V8SpeechRecognitionResultList::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechRecognitionResultList::domTemplate, V8SpeechRecognitionResultList::trace, V8SpeechRecognitionResultList::traceWrappers, 0, 0, V8SpeechRecognitionResultList::preparePrototypeAndInterfaceObject, nullptr, "SpeechRecognitionResultList", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SpeechRecognitionResultList>::value,
    "SpeechRecognitionResultList inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8SpeechRecognitionResultListAccessors[] = {
    {"length", SpeechRecognitionResultListV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8SpeechRecognitionResultListMethods[] = {
    {"item", SpeechRecognitionResultListV8Internal::itemMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
