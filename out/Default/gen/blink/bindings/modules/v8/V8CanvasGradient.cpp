...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CanvasGradient>::value,
    "CanvasGradient inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8CanvasGradientMethods[] = {
    {"addColorStop", CanvasGradientV8Internal::addColorStopMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
