...
#endif
const WrapperTypeInfo V8PushSubscription::wrapperTypeInfo = { gin::kEmbedderBlink, V8PushSubscription::domTemplate, V8PushSubscription::trace, V8PushSubscription::traceWrappers, 0, 0, V8PushSubscription::preparePrototypeAndInterfaceObject, nullptr, "PushSubscription", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, PushSubscription>::value,
    "PushSubscription inherits from ActiveScriptWrappable, but does not specify "
...
static void optionsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "options"), v8Value);
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "getKey", "PushSubscription", info.Holder(), info.GetIsolate());
    ...
    V8StringResource<> name;
    {
        ...
        if (!isValidEnum(name, validValues, WTF_ARRAY_LENGTH(validValues), "PushEncryptionKeyName", exceptionState)) {
            exceptionState.throwIfNeeded();
            return;
        }
    }
...
const V8DOMConfiguration::AccessorConfiguration V8PushSubscriptionAccessors[] = {
    {"endpoint", PushSubscriptionV8Internal::endpointAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"options", PushSubscriptionV8Internal::optionsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8PushSubscriptionMethods[] = {
    {"getKey", PushSubscriptionV8Internal::getKeyMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"unsubscribe", PushSubscriptionV8Internal::unsubscribeMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"toJSON", PushSubscriptionV8Internal::toJSONMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
