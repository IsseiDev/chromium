...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, IIRFilterNode>::value,
    "IIRFilterNode inherits from ActiveScriptWrappable, but does not specify "
