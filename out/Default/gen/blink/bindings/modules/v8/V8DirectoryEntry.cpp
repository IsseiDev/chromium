...
#endif
const WrapperTypeInfo V8DirectoryEntry::wrapperTypeInfo = { gin::kEmbedderBlink, V8DirectoryEntry::domTemplate, V8DirectoryEntry::trace, V8DirectoryEntry::traceWrappers, 0, 0, V8DirectoryEntry::preparePrototypeAndInterfaceObject, nullptr, "DirectoryEntry", &V8Entry::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DirectoryEntry>::value,
    "DirectoryEntry inherits from ActiveScriptWrappable, but does not specify "
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "removeRecursively", "DirectoryEntry", 1, info.Length()));
        return;
    }
    DirectoryEntry* impl = V8DirectoryEntry::toImpl(info.Holder());
...
const V8DOMConfiguration::MethodConfiguration V8DirectoryEntryMethods[] = {
    {"createReader", DirectoryEntryV8Internal::createReaderMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getFile", DirectoryEntryV8Internal::getFileMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getDirectory", DirectoryEntryV8Internal::getDirectoryMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"removeRecursively", DirectoryEntryV8Internal::removeRecursivelyMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
