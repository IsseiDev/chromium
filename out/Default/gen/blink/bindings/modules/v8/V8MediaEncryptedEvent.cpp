...
#endif
const WrapperTypeInfo V8MediaEncryptedEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaEncryptedEvent::domTemplate, V8MediaEncryptedEvent::trace, V8MediaEncryptedEvent::traceWrappers, 0, 0, V8MediaEncryptedEvent::preparePrototypeAndInterfaceObject, nullptr, "MediaEncryptedEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, MediaEncryptedEvent>::value,
    "MediaEncryptedEvent inherits from ActiveScriptWrappable, but does not specify "
...
static void initDataAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "initData"), v8Value);
...
const V8DOMConfiguration::AccessorConfiguration V8MediaEncryptedEventAccessors[] = {
    {"initDataType", MediaEncryptedEventV8Internal::initDataTypeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"initData", MediaEncryptedEventV8Internal::initDataAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
