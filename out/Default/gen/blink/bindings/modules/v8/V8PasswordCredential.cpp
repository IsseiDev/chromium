...
#endif
const WrapperTypeInfo V8PasswordCredential::wrapperTypeInfo = { gin::kEmbedderBlink, V8PasswordCredential::domTemplate, V8PasswordCredential::trace, V8PasswordCredential::traceWrappers, 0, 0, V8PasswordCredential::preparePrototypeAndInterfaceObject, nullptr, "PasswordCredential", &V8SiteBoundCredential::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, PasswordCredential>::value,
    "PasswordCredential inherits from ActiveScriptWrappable, but does not specify "
