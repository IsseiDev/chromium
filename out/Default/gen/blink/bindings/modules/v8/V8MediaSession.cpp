...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, MediaSession>::value,
    "MediaSession inherits from ActiveScriptWrappable, but does not specify "
...
static void metadataAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    v8::Local<v8::Object> holder = info.Holder();
    ExceptionState exceptionState(ExceptionState::SetterContext, "metadata", "MediaSession", holder, info.GetIsolate());
    MediaSession* impl = V8MediaSession::toImpl(holder);
...
static void metadataAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void activateMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ScriptPromise result = impl->activate(scriptState);
...
static void deactivateMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    MediaSession* impl = V8MediaSession::toImpl(info.Holder());
    ScriptState* scriptState = ScriptState::forReceiverObject(info);
    ScriptPromise result = impl->deactivate(scriptState);
    v8SetReturnValue(info, result.v8Value());
}
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "MediaSession", info.Holder(), info.GetIsolate());
    ExecutionContext* executionContext = currentExecutionContext(info.GetIsolate());
    MediaSession* impl = MediaSession::create(executionContext, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8MediaSessionAccessors[] = {
    {"metadata", MediaSessionV8Internal::metadataAttributeGetterCallback, MediaSessionV8Internal::metadataAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8MediaSessionMethods[] = {
    {"activate", MediaSessionV8Internal::activateMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"deactivate", MediaSessionV8Internal::deactivateMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
static void installV8MediaSessionTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    interfaceTemplate->SetCallHandler(V8MediaSession::constructorCallback);
