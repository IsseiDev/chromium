...
#ifndef V8WebGLShaderPrecisionFormat_h
#define V8WebGLShaderPrecisionFormat_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<WebGLShaderPrecisionFormat>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<WebGLShaderPrecisionFormat>());
    }
...
#endif // V8WebGLShaderPrecisionFormat_h
