...
#endif
const WrapperTypeInfo V8PaymentRequest::wrapperTypeInfo = { gin::kEmbedderBlink, V8PaymentRequest::domTemplate, V8PaymentRequest::trace, V8PaymentRequest::traceWrappers, V8PaymentRequest::toActiveScriptWrappable, 0, V8PaymentRequest::preparePrototypeAndInterfaceObject, nullptr, "PaymentRequest", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void onshippingaddresschangeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void onshippingaddresschangeAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    impl->setOnshippingaddresschange(V8EventListenerList::getEventListener(ScriptState::current(info.GetIsolate()), v8Value, true, ListenerFindOrCreate));
}

static void onshippingaddresschangeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void onshippingoptionchangeAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void onshippingoptionchangeAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    impl->setOnshippingoptionchange(V8EventListenerList::getEventListener(ScriptState::current(info.GetIsolate()), v8Value, true, ListenerFindOrCreate));
}

static void onshippingoptionchangeAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    v8::Local<v8::Value> v8Value = info[0];
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "PaymentRequest", info.Holder(), info.GetIsolate());
    ...
    ScriptState* scriptState = ScriptState::forReceiverObject(info);
    PaymentRequest* impl = PaymentRequest::create(scriptState, methodData, details, options, exceptionState);
...
const V8DOMConfiguration::AccessorConfiguration V8PaymentRequestAccessors[] = {
    {"shippingAddress", PaymentRequestV8Internal::shippingAddressAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"shippingOption", PaymentRequestV8Internal::shippingOptionAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onshippingaddresschange", PaymentRequestV8Internal::onshippingaddresschangeAttributeGetterCallback, PaymentRequestV8Internal::onshippingaddresschangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onshippingoptionchange", PaymentRequestV8Internal::onshippingoptionchangeAttributeGetterCallback, PaymentRequestV8Internal::onshippingoptionchangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8PaymentRequestMethods[] = {
    {"show", PaymentRequestV8Internal::showMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"abort", PaymentRequestV8Internal::abortMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
ActiveScriptWrappable* V8PaymentRequest::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
