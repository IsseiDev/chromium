...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, IDBKeyRange>::value,
    "IDBKeyRange inherits from ActiveScriptWrappable, but does not specify "
...
static void onlyMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    IDBKeyRange* result = IDBKeyRange::only(executionContext, value, exceptionState);
...
static void lowerBoundMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ExecutionContext* executionContext = currentExecutionContext(info.GetIsolate());
    IDBKeyRange* result = IDBKeyRange::lowerBound(executionContext, bound, open, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void upperBoundMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ExecutionContext* executionContext = currentExecutionContext(info.GetIsolate());
    IDBKeyRange* result = IDBKeyRange::upperBound(executionContext, bound, open, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void boundMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    ExecutionContext* executionContext = currentExecutionContext(info.GetIsolate());
    IDBKeyRange* result = IDBKeyRange::bound(executionContext, lower, upper, lowerOpen, upperOpen, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "includes", "IDBKeyRange", info.Holder(), info.GetIsolate());
    if (UNLIKELY(info.Length() < 1)) {
        setMinimumArityTypeError(exceptionState, 1, info.Length());
        exceptionState.throwIfNeeded();
        return;
    ...
    ExecutionContext* executionContext = currentExecutionContext(info.GetIsolate());
    bool result = impl->includes(executionContext, key, exceptionState);
    if (exceptionState.hadException()) {
        exceptionState.throwIfNeeded();
        return;
    }
...
static void includesMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8IDBKeyRangeAccessors[] = {
    {"lower", IDBKeyRangeV8Internal::lowerAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"upper", IDBKeyRangeV8Internal::upperAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"lowerOpen", IDBKeyRangeV8Internal::lowerOpenAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"upperOpen", IDBKeyRangeV8Internal::upperOpenAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8IDBKeyRangeMethods[] = {
    {"only", IDBKeyRangeV8Internal::onlyMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInterface},
    {"lowerBound", IDBKeyRangeV8Internal::lowerBoundMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInterface},
    {"upperBound", IDBKeyRangeV8Internal::upperBoundMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInterface},
    {"bound", IDBKeyRangeV8Internal::boundMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnInterface},
    {"includes", IDBKeyRangeV8Internal::includesMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
