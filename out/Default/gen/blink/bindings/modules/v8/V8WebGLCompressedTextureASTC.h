...
#ifndef V8WebGLCompressedTextureASTC_h
#define V8WebGLCompressedTextureASTC_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<WebGLCompressedTextureASTC>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<WebGLCompressedTextureASTC>());
    }
...
#endif // V8WebGLCompressedTextureASTC_h
