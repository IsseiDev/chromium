...
#endif
const WrapperTypeInfo V8USBOutTransferResult::wrapperTypeInfo = { gin::kEmbedderBlink, V8USBOutTransferResult::domTemplate, V8USBOutTransferResult::trace, V8USBOutTransferResult::traceWrappers, 0, 0, V8USBOutTransferResult::preparePrototypeAndInterfaceObject, nullptr, "USBOutTransferResult", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, USBOutTransferResult>::value,
    "USBOutTransferResult inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8USBOutTransferResultAccessors[] = {
    {"bytesWritten", USBOutTransferResultV8Internal::bytesWrittenAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"status", USBOutTransferResultV8Internal::statusAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
