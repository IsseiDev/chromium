...
#endif
const WrapperTypeInfo V8BatteryManager::wrapperTypeInfo = { gin::kEmbedderBlink, V8BatteryManager::domTemplate, V8BatteryManager::trace, V8BatteryManager::traceWrappers, V8BatteryManager::toActiveScriptWrappable, 0, V8BatteryManager::preparePrototypeAndInterfaceObject, nullptr, "BatteryManager", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8BatteryManagerAccessors[] = {
    {"charging", BatteryManagerV8Internal::chargingAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"chargingTime", BatteryManagerV8Internal::chargingTimeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"dischargingTime", BatteryManagerV8Internal::dischargingTimeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"level", BatteryManagerV8Internal::levelAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    ...
    {"onchargingtimechange", BatteryManagerV8Internal::onchargingtimechangeAttributeGetterCallback, BatteryManagerV8Internal::onchargingtimechangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"ondischargingtimechange", BatteryManagerV8Internal::ondischargingtimechangeAttributeGetterCallback, BatteryManagerV8Internal::ondischargingtimechangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onlevelchange", BatteryManagerV8Internal::onlevelchangeAttributeGetterCallback, BatteryManagerV8Internal::onlevelchangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
ActiveScriptWrappable* V8BatteryManager::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
