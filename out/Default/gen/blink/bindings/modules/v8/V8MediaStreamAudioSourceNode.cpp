...
#endif
const WrapperTypeInfo V8MediaStreamAudioSourceNode::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaStreamAudioSourceNode::domTemplate, V8MediaStreamAudioSourceNode::trace, V8MediaStreamAudioSourceNode::traceWrappers, 0, 0, V8MediaStreamAudioSourceNode::preparePrototypeAndInterfaceObject, nullptr, "MediaStreamAudioSourceNode", &V8AudioSourceNode::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, MediaStreamAudioSourceNode>::value,
    "MediaStreamAudioSourceNode inherits from ActiveScriptWrappable, but does not specify "
...
static void mediaStreamAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "mediaStream"), v8Value);
...
const V8DOMConfiguration::AccessorConfiguration V8MediaStreamAudioSourceNodeAccessors[] = {
    {"mediaStream", MediaStreamAudioSourceNodeV8Internal::mediaStreamAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
