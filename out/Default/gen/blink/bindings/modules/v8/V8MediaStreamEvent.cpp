...
#endif
const WrapperTypeInfo V8MediaStreamEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaStreamEvent::domTemplate, V8MediaStreamEvent::trace, V8MediaStreamEvent::traceWrappers, 0, 0, V8MediaStreamEvent::preparePrototypeAndInterfaceObject, nullptr, "MediaStreamEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, MediaStreamEvent>::value,
    "MediaStreamEvent inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8MediaStreamEventAccessors[] = {
    {"stream", MediaStreamEventV8Internal::streamAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
