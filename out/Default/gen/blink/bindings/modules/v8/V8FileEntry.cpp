...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, FileEntry>::value,
    "FileEntry inherits from ActiveScriptWrappable, but does not specify "
...
static void createWriterMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "createWriter", "FileEntry", 1, info.Length()));
        return;
    }
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "file", "FileEntry", 1, info.Length()));
        return;
    }
    FileEntry* impl = V8FileEntry::toImpl(info.Holder());
...
const V8DOMConfiguration::MethodConfiguration V8FileEntryMethods[] = {
    {"createWriter", FileEntryV8Internal::createWriterMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"file", FileEntryV8Internal::fileMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
