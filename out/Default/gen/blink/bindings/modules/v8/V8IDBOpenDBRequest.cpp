...
#endif
const WrapperTypeInfo V8IDBOpenDBRequest::wrapperTypeInfo = { gin::kEmbedderBlink, V8IDBOpenDBRequest::domTemplate, V8IDBOpenDBRequest::trace, V8IDBOpenDBRequest::traceWrappers, V8IDBOpenDBRequest::toActiveScriptWrappable, 0, V8IDBOpenDBRequest::preparePrototypeAndInterfaceObject, nullptr, "IDBOpenDBRequest", &V8IDBRequest::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8IDBOpenDBRequestAccessors[] = {
    {"onblocked", IDBOpenDBRequestV8Internal::onblockedAttributeGetterCallback, IDBOpenDBRequestV8Internal::onblockedAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
...
ActiveScriptWrappable* V8IDBOpenDBRequest::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
