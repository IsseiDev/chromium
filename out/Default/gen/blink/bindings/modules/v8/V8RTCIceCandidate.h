...
#ifndef V8RTCIceCandidate_h
#define V8RTCIceCandidate_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<RTCIceCandidate>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<RTCIceCandidate>());
    }
