...
#endif
const WrapperTypeInfo V8WebGLLoseContext::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLLoseContext::domTemplate, V8WebGLLoseContext::trace, V8WebGLLoseContext::traceWrappers, 0, V8WebGLLoseContext::visitDOMWrapper, V8WebGLLoseContext::preparePrototypeAndInterfaceObject, nullptr, "WebGLLoseContext", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, WebGLLoseContext>::value,
    "WebGLLoseContext inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8WebGLLoseContextMethods[] = {
    {"loseContext", WebGLLoseContextV8Internal::loseContextMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"restoreContext", WebGLLoseContextV8Internal::restoreContextMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
