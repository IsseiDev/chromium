...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, WebGLDebugShaders>::value,
    "WebGLDebugShaders inherits from ActiveScriptWrappable, but does not specify "
...
static void getTranslatedShaderSourceMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "getTranslatedShaderSource", "WebGLDebugShaders", 1, info.Length()));
        return;
    }
...
const V8DOMConfiguration::MethodConfiguration V8WebGLDebugShadersMethods[] = {
    {"getTranslatedShaderSource", WebGLDebugShadersV8Internal::getTranslatedShaderSourceMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
