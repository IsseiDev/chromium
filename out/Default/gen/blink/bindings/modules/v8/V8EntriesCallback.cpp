...
V8EntriesCallback::V8EntriesCallback(v8::Local<v8::Function> callback, ScriptState* scriptState)
...
DEFINE_TRACE(V8EntriesCallback)
{
...
void V8EntriesCallback::handleEvent(const HeapVector<Member<Entry>>& entries)
{
    ...
    v8::Local<v8::Value> argv[] = { entriesHandle };
