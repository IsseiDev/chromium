...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, BluetoothRemoteGATTCharacteristic>::value,
    "BluetoothRemoteGATTCharacteristic inherits from ActiveScriptWrappable, but does not specify "
...
static void serviceAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "service"), v8Value);
        v8SetReturnValue(info, v8Value);
    }
}

static void serviceAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "writeValue", "BluetoothRemoteGATTCharacteristic", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::AccessorConfiguration V8BluetoothRemoteGATTCharacteristicAccessors[] = {
    {"service", BluetoothRemoteGATTCharacteristicV8Internal::serviceAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"uuid", BluetoothRemoteGATTCharacteristicV8Internal::uuidAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"properties", BluetoothRemoteGATTCharacteristicV8Internal::propertiesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"value", BluetoothRemoteGATTCharacteristicV8Internal::valueAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"oncharacteristicvaluechanged", BluetoothRemoteGATTCharacteristicV8Internal::oncharacteristicvaluechangedAttributeGetterCallback, BluetoothRemoteGATTCharacteristicV8Internal::oncharacteristicvaluechangedAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8BluetoothRemoteGATTCharacteristicMethods[] = {
    {"readValue", BluetoothRemoteGATTCharacteristicV8Internal::readValueMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"writeValue", BluetoothRemoteGATTCharacteristicV8Internal::writeValueMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"startNotifications", BluetoothRemoteGATTCharacteristicV8Internal::startNotificationsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"stopNotifications", BluetoothRemoteGATTCharacteristicV8Internal::stopNotificationsMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
