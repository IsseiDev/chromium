...
#endif
const WrapperTypeInfo V8NavigatorUserMediaError::wrapperTypeInfo = { gin::kEmbedderBlink, V8NavigatorUserMediaError::domTemplate, V8NavigatorUserMediaError::trace, V8NavigatorUserMediaError::traceWrappers, 0, 0, V8NavigatorUserMediaError::preparePrototypeAndInterfaceObject, nullptr, "NavigatorUserMediaError", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, NavigatorUserMediaError>::value,
    "NavigatorUserMediaError inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8NavigatorUserMediaErrorAccessors[] = {
    {"name", NavigatorUserMediaErrorV8Internal::nameAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"message", NavigatorUserMediaErrorV8Internal::messageAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"constraintName", NavigatorUserMediaErrorV8Internal::constraintNameAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
