...
#endif
const WrapperTypeInfo V8SpeechGrammar::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechGrammar::domTemplate, V8SpeechGrammar::trace, V8SpeechGrammar::traceWrappers, 0, 0, V8SpeechGrammar::preparePrototypeAndInterfaceObject, nullptr, "SpeechGrammar", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& SpeechGrammar::s_wrapperTypeInfo = V8SpeechGrammar::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, SpeechGrammar>::value,
    "SpeechGrammar inherits from ActiveScriptWrappable, but does not specify "
...
{
    v8::Local<v8::Object> holder = info.Holder();
    ExceptionState exceptionState(ExceptionState::SetterContext, "weight", "SpeechGrammar", holder, info.GetIsolate());
    SpeechGrammar* impl = V8SpeechGrammar::toImpl(holder);
...
const V8DOMConfiguration::AccessorConfiguration V8SpeechGrammarAccessors[] = {
    {"src", SpeechGrammarV8Internal::srcAttributeGetterCallback, SpeechGrammarV8Internal::srcAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"weight", SpeechGrammarV8Internal::weightAttributeGetterCallback, SpeechGrammarV8Internal::weightAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
