...
#ifndef V8WebGLTexture_h
#define V8WebGLTexture_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<WebGLTexture>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<WebGLTexture>());
    }
