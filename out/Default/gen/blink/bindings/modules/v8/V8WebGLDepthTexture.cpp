...
#endif
const WrapperTypeInfo V8WebGLDepthTexture::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLDepthTexture::domTemplate, V8WebGLDepthTexture::trace, V8WebGLDepthTexture::traceWrappers, 0, V8WebGLDepthTexture::visitDOMWrapper, V8WebGLDepthTexture::preparePrototypeAndInterfaceObject, nullptr, "WebGLDepthTexture", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, WebGLDepthTexture>::value,
    "WebGLDepthTexture inherits from ActiveScriptWrappable, but does not specify "
