...
#endif
const WrapperTypeInfo V8StereoPannerNode::wrapperTypeInfo = { gin::kEmbedderBlink, V8StereoPannerNode::domTemplate, V8StereoPannerNode::trace, V8StereoPannerNode::traceWrappers, 0, 0, V8StereoPannerNode::preparePrototypeAndInterfaceObject, nullptr, "StereoPannerNode", &V8AudioNode::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, StereoPannerNode>::value,
    "StereoPannerNode inherits from ActiveScriptWrappable, but does not specify "
...
static void panAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "pan"), v8Value);
...
const V8DOMConfiguration::AccessorConfiguration V8StereoPannerNodeAccessors[] = {
    {"pan", StereoPannerNodeV8Internal::panAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
