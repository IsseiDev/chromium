...
#endif
const WrapperTypeInfo V8RTCCertificate::wrapperTypeInfo = { gin::kEmbedderBlink, V8RTCCertificate::domTemplate, V8RTCCertificate::trace, V8RTCCertificate::traceWrappers, 0, 0, V8RTCCertificate::preparePrototypeAndInterfaceObject, nullptr, "RTCCertificate", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, RTCCertificate>::value,
    "RTCCertificate inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8RTCCertificateAccessors[] = {
    {"expires", RTCCertificateV8Internal::expiresAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
