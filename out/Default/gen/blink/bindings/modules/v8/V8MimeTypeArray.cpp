...
#endif
const WrapperTypeInfo V8MimeTypeArray::wrapperTypeInfo = { gin::kEmbedderBlink, V8MimeTypeArray::domTemplate, V8MimeTypeArray::trace, V8MimeTypeArray::traceWrappers, 0, 0, V8MimeTypeArray::preparePrototypeAndInterfaceObject, nullptr, "MimeTypeArray", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DOMMimeTypeArray>::value,
    "DOMMimeTypeArray inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8MimeTypeArrayAccessors[] = {
    {"length", DOMMimeTypeArrayV8Internal::lengthAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8MimeTypeArrayMethods[] = {
    {"item", DOMMimeTypeArrayV8Internal::itemMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"namedItem", DOMMimeTypeArrayV8Internal::namedItemMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
