...
#endif
const WrapperTypeInfo V8DelayNode::wrapperTypeInfo = { gin::kEmbedderBlink, V8DelayNode::domTemplate, V8DelayNode::trace, V8DelayNode::traceWrappers, 0, 0, V8DelayNode::preparePrototypeAndInterfaceObject, nullptr, "DelayNode", &V8AudioNode::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DelayNode>::value,
    "DelayNode inherits from ActiveScriptWrappable, but does not specify "
...
static void delayTimeAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "delayTime"), v8Value);
...
const V8DOMConfiguration::AccessorConfiguration V8DelayNodeAccessors[] = {
    {"delayTime", DelayNodeV8Internal::delayTimeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
