...
#endif
const WrapperTypeInfo V8DirectoryReader::wrapperTypeInfo = { gin::kEmbedderBlink, V8DirectoryReader::domTemplate, V8DirectoryReader::trace, V8DirectoryReader::traceWrappers, 0, 0, V8DirectoryReader::preparePrototypeAndInterfaceObject, nullptr, "DirectoryReader", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DirectoryReader>::value,
    "DirectoryReader inherits from ActiveScriptWrappable, but does not specify "
...
static void readEntriesMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "readEntries", "DirectoryReader", 1, info.Length()));
        return;
    }
...
const V8DOMConfiguration::MethodConfiguration V8DirectoryReaderMethods[] = {
    {"readEntries", DirectoryReaderV8Internal::readEntriesMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
