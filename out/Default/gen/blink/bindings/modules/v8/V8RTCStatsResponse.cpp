...
#endif
const WrapperTypeInfo V8RTCStatsResponse::wrapperTypeInfo = { gin::kEmbedderBlink, V8RTCStatsResponse::domTemplate, V8RTCStatsResponse::trace, V8RTCStatsResponse::traceWrappers, 0, 0, V8RTCStatsResponse::preparePrototypeAndInterfaceObject, nullptr, "RTCStatsResponse", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, RTCStatsResponse>::value,
    "RTCStatsResponse inherits from ActiveScriptWrappable, but does not specify "
...
static void namedPropertyGetter(v8::Local<v8::Name> name, const v8::PropertyCallbackInfo<v8::Value>& info)
{
    ...
    RTCLegacyStatsReport* result = impl->namedItem(propertyName);
    if (!result)
        return;
...
const V8DOMConfiguration::MethodConfiguration V8RTCStatsResponseMethods[] = {
    {"result", RTCStatsResponseV8Internal::resultMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"namedItem", RTCStatsResponseV8Internal::namedItemMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
