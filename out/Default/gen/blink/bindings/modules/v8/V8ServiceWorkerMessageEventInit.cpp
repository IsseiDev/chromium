...
#include "V8ServiceWorkerMessageEventInit.h"
...
void V8ServiceWorkerMessageEventInit::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, ServiceWorkerMessageEventInit& impl, ExceptionState& exceptionState)
{
    ...
    if (sourceValue.IsEmpty() || sourceValue->IsUndefined()) {
        ...
        V8ServiceWorkerOrMessagePort::toImpl(isolate, sourceValue, source, UnionTypeConversionMode::NotNullable, exceptionState);
        if (exceptionState.hadException())
            return;
...
v8::Local<v8::Value> ServiceWorkerMessageEventInit::toV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const
{
    v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
    if (!toV8ServiceWorkerMessageEventInit(*this, v8Object, creationContext, isolate))
        return v8::Local<v8::Value>();
    return v8Object;
}

bool toV8ServiceWorkerMessageEventInit(const ServiceWorkerMessageEventInit& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate)
{
...
ServiceWorkerMessageEventInit NativeValueTraits<ServiceWorkerMessageEventInit>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState)
{
    ServiceWorkerMessageEventInit impl;
    V8ServiceWorkerMessageEventInit::toImpl(isolate, value, impl, exceptionState);
    return impl;
}
