...
#endif
const WrapperTypeInfo V8PresentationAvailability::wrapperTypeInfo = { gin::kEmbedderBlink, V8PresentationAvailability::domTemplate, V8PresentationAvailability::trace, V8PresentationAvailability::traceWrappers, V8PresentationAvailability::toActiveScriptWrappable, 0, V8PresentationAvailability::preparePrototypeAndInterfaceObject, nullptr, "PresentationAvailability", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8PresentationAvailabilityAccessors[] = {
    {"value", PresentationAvailabilityV8Internal::valueAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"onchange", PresentationAvailabilityV8Internal::onchangeAttributeGetterCallback, PresentationAvailabilityV8Internal::onchangeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
ActiveScriptWrappable* V8PresentationAvailability::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
