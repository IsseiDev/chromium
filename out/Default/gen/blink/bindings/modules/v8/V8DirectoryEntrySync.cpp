...
#endif
const WrapperTypeInfo V8DirectoryEntrySync::wrapperTypeInfo = { gin::kEmbedderBlink, V8DirectoryEntrySync::domTemplate, V8DirectoryEntrySync::trace, V8DirectoryEntrySync::traceWrappers, 0, 0, V8DirectoryEntrySync::preparePrototypeAndInterfaceObject, nullptr, "DirectoryEntrySync", &V8EntrySync::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, DirectoryEntrySync>::value,
    "DirectoryEntrySync inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8DirectoryEntrySyncMethods[] = {
    {"createReader", DirectoryEntrySyncV8Internal::createReaderMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getFile", DirectoryEntrySyncV8Internal::getFileMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getDirectory", DirectoryEntrySyncV8Internal::getDirectoryMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"removeRecursively", DirectoryEntrySyncV8Internal::removeRecursivelyMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
