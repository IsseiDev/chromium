...
#endif
const WrapperTypeInfo V8GamepadButton::wrapperTypeInfo = { gin::kEmbedderBlink, V8GamepadButton::domTemplate, V8GamepadButton::trace, V8GamepadButton::traceWrappers, 0, 0, V8GamepadButton::preparePrototypeAndInterfaceObject, nullptr, "GamepadButton", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, GamepadButton>::value,
    "GamepadButton inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8GamepadButtonAccessors[] = {
    {"pressed", GamepadButtonV8Internal::pressedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"value", GamepadButtonV8Internal::valueAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
