...
public:
    ...
    static ArrayBufferOrArrayBufferViewOrDictionary fromArrayBuffer(DOMArrayBuffer*);
    ...
    static ArrayBufferOrArrayBufferViewOrDictionary fromArrayBufferView(DOMArrayBufferView*);
