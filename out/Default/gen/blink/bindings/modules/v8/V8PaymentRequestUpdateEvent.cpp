...
#endif
const WrapperTypeInfo V8PaymentRequestUpdateEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8PaymentRequestUpdateEvent::domTemplate, V8PaymentRequestUpdateEvent::trace, V8PaymentRequestUpdateEvent::traceWrappers, 0, 0, V8PaymentRequestUpdateEvent::preparePrototypeAndInterfaceObject, nullptr, "PaymentRequestUpdateEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, PaymentRequestUpdateEvent>::value,
    "PaymentRequestUpdateEvent inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "updateWith", "PaymentRequestUpdateEvent", info.Holder(), info.GetIsolate());
...
static void updateWithMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "PaymentRequestUpdateEvent", info.Holder(), info.GetIsolate());
    if (UNLIKELY(info.Length() < 1)) {
        setMinimumArityTypeError(exceptionState, 1, info.Length());
        exceptionState.throwIfNeeded();
        return;
...
const V8DOMConfiguration::MethodConfiguration V8PaymentRequestUpdateEventMethods[] = {
    {"updateWith", PaymentRequestUpdateEventV8Internal::updateWithMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
