...
#ifndef V8ClientQueryOptions_h
#define V8ClientQueryOptions_h
...
public:
    MODULES_EXPORT static void toImpl(v8::Isolate*, v8::Local<v8::Value>, ClientQueryOptions&, ExceptionState&);
};
...
template <>
struct NativeValueTraits<ClientQueryOptions> {
    static ClientQueryOptions nativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
