...
#endif
const WrapperTypeInfo V8SensorErrorEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8SensorErrorEvent::domTemplate, V8SensorErrorEvent::trace, V8SensorErrorEvent::traceWrappers, 0, 0, V8SensorErrorEvent::preparePrototypeAndInterfaceObject, nullptr, "SensorErrorEvent", &V8ErrorEvent::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SensorErrorEvent>::value,
    "SensorErrorEvent inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "SensorErrorEvent", info.Holder(), info.GetIsolate());
    ...
    SensorErrorEventInit errorEventInitDict;
    {
        ...
        if (!isUndefinedOrNull(info[1]) && !info[1]->IsObject()) {
            exceptionState.throwTypeError("parameter 2 ('errorEventInitDict') is not an object.");
            exceptionState.throwIfNeeded();
            return;
        }
        V8SensorErrorEventInit::toImpl(info.GetIsolate(), info[1], errorEventInitDict, exceptionState);
        if (exceptionState.throwIfNeeded())
            return;
    }
    SensorErrorEvent* impl = SensorErrorEvent::create(type, errorEventInitDict);
...
static void installV8SensorErrorEventTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8SensorErrorEvent::wrapperTypeInfo.interfaceName, V8ErrorEvent::domTemplate(isolate, world), V8SensorErrorEvent::internalFieldCount);
