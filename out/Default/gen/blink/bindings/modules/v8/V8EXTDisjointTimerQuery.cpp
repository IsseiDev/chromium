...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, EXTDisjointTimerQuery>::value,
    "EXTDisjointTimerQuery inherits from ActiveScriptWrappable, but does not specify "
...
static void createQueryEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void deleteQueryEXTMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "deleteQueryEXT", "EXTDisjointTimerQuery", 1, info.Length()));
        return;
    }
    EXTDisjointTimerQuery* impl = V8EXTDisjointTimerQuery::toImpl(info.Holder());
...
static void deleteQueryEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "isQueryEXT", "EXTDisjointTimerQuery", 1, info.Length()));
        return;
    }
    EXTDisjointTimerQuery* impl = V8EXTDisjointTimerQuery::toImpl(info.Holder());
    WebGLTimerQueryEXT* query;
...
static void isQueryEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "beginQueryEXT", "EXTDisjointTimerQuery", info.Holder(), info.GetIsolate());
...
static void beginQueryEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "endQueryEXT", "EXTDisjointTimerQuery", info.Holder(), info.GetIsolate());
    if (UNLIKELY(info.Length() < 1)) {
...
static void endQueryEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "queryCounterEXT", "EXTDisjointTimerQuery", info.Holder(), info.GetIsolate());
    if (UNLIKELY(info.Length() < 2)) {
        setMinimumArityTypeError(exceptionState, 2, info.Length());
        exceptionState.throwIfNeeded();
        return;
...
static void queryCounterEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "getQueryEXT", "EXTDisjointTimerQuery", info.Holder(), info.GetIsolate());
    if (UNLIKELY(info.Length() < 2)) {
        setMinimumArityTypeError(exceptionState, 2, info.Length());
        exceptionState.throwIfNeeded();
        return;
...
static void getQueryEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "getQueryObjectEXT", "EXTDisjointTimerQuery", info.Holder(), info.GetIsolate());
    if (UNLIKELY(info.Length() < 2)) {
        setMinimumArityTypeError(exceptionState, 2, info.Length());
        exceptionState.throwIfNeeded();
        return;
...
static void getQueryObjectEXTMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::MethodConfiguration V8EXTDisjointTimerQueryMethods[] = {
    {"createQueryEXT", EXTDisjointTimerQueryV8Internal::createQueryEXTMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"deleteQueryEXT", EXTDisjointTimerQueryV8Internal::deleteQueryEXTMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"isQueryEXT", EXTDisjointTimerQueryV8Internal::isQueryEXTMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"beginQueryEXT", EXTDisjointTimerQueryV8Internal::beginQueryEXTMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"endQueryEXT", EXTDisjointTimerQueryV8Internal::endQueryEXTMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"queryCounterEXT", EXTDisjointTimerQueryV8Internal::queryCounterEXTMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getQueryEXT", EXTDisjointTimerQueryV8Internal::getQueryEXTMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"getQueryObjectEXT", EXTDisjointTimerQueryV8Internal::getQueryObjectEXTMethodCallback, 0, 2, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
