...
#endif
const WrapperTypeInfo V8OESTextureHalfFloatLinear::wrapperTypeInfo = { gin::kEmbedderBlink, V8OESTextureHalfFloatLinear::domTemplate, V8OESTextureHalfFloatLinear::trace, V8OESTextureHalfFloatLinear::traceWrappers, 0, V8OESTextureHalfFloatLinear::visitDOMWrapper, V8OESTextureHalfFloatLinear::preparePrototypeAndInterfaceObject, nullptr, "OESTextureHalfFloatLinear", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, OESTextureHalfFloatLinear>::value,
    "OESTextureHalfFloatLinear inherits from ActiveScriptWrappable, but does not specify "
...
static void installV8OESTextureHalfFloatLinearTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8OESTextureHalfFloatLinear::wrapperTypeInfo.interfaceName, v8::Local<v8::FunctionTemplate>(), V8OESTextureHalfFloatLinear::internalFieldCount);
...
v8::Local<v8::FunctionTemplate> V8OESTextureHalfFloatLinear::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world)
{
    return V8DOMConfiguration::domClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8OESTextureHalfFloatLinearTemplate);
}
