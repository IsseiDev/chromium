...
#endif
const WrapperTypeInfo V8RTCSessionDescription::wrapperTypeInfo = { gin::kEmbedderBlink, V8RTCSessionDescription::domTemplate, V8RTCSessionDescription::trace, V8RTCSessionDescription::traceWrappers, 0, 0, V8RTCSessionDescription::preparePrototypeAndInterfaceObject, nullptr, "RTCSessionDescription", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, RTCSessionDescription>::value,
    "RTCSessionDescription inherits from ActiveScriptWrappable, but does not specify "
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    RTCSessionDescription* impl = RTCSessionDescription::create(descriptionInitDict);
...
const V8DOMConfiguration::AccessorConfiguration V8RTCSessionDescriptionAccessors[] = {
    {"type", RTCSessionDescriptionV8Internal::typeAttributeGetterCallback, RTCSessionDescriptionV8Internal::typeAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"sdp", RTCSessionDescriptionV8Internal::sdpAttributeGetterCallback, RTCSessionDescriptionV8Internal::sdpAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8RTCSessionDescriptionMethods[] = {
    {"toJSON", RTCSessionDescriptionV8Internal::toJSONMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
