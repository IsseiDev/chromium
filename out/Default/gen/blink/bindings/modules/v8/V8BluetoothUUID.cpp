...
#endif
const WrapperTypeInfo V8BluetoothUUID::wrapperTypeInfo = { gin::kEmbedderBlink, V8BluetoothUUID::domTemplate, V8BluetoothUUID::trace, V8BluetoothUUID::traceWrappers, 0, 0, V8BluetoothUUID::preparePrototypeAndInterfaceObject, nullptr, "BluetoothUUID", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, BluetoothUUID>::value,
    "BluetoothUUID inherits from ActiveScriptWrappable, but does not specify "
