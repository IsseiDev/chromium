...
static void getContextMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    HTMLCanvasElementModule::getContext(*impl, contextId, attributes, result);
...
{
    ExceptionState exceptionState(ExceptionState::ExecutionContext, "transferControlToOffscreen", "HTMLCanvasElement", info.Holder(), info.GetIsolate());
    HTMLCanvasElement* impl = V8HTMLCanvasElement::toImpl(info.Holder());
...
static void transferControlToOffscreenMethodCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::MethodConfiguration V8HTMLCanvasElementMethods[] = {
    {"getContext", HTMLCanvasElementPartialV8Internal::getContextMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
void V8HTMLCanvasElementPartial::installV8HTMLCanvasElementTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    if (RuntimeEnabledFeatures::experimentalCanvasFeaturesEnabled()) {
        const V8DOMConfiguration::MethodConfiguration transferControlToOffscreenMethodConfiguration = {"transferControlToOffscreen", HTMLCanvasElementPartialV8Internal::transferControlToOffscreenMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
...
void V8HTMLCanvasElementPartial::preparePrototypeAndInterfaceObject(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> prototypeObject, v8::Local<v8::Function> interfaceObject, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    V8HTMLCanvasElement::preparePrototypeAndInterfaceObject(context, world, prototypeObject, interfaceObject, interfaceTemplate);
}
