...
#endif
const WrapperTypeInfo V8Body::wrapperTypeInfo = { gin::kEmbedderBlink, V8Body::domTemplate, V8Body::trace, V8Body::traceWrappers, V8Body::toActiveScriptWrappable, 0, V8Body::preparePrototypeAndInterfaceObject, nullptr, "Body", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8BodyAccessors[] = {
    {"bodyUsed", BodyV8Internal::bodyUsedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8BodyMethods[] = {
    {"arrayBuffer", BodyV8Internal::arrayBufferMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"blob", BodyV8Internal::blobMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"json", BodyV8Internal::jsonMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"text", BodyV8Internal::textMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
...
ActiveScriptWrappable* V8Body::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
