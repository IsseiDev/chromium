...
#include "V8PresentationConnectionCloseEvent.h"

#include "bindings/core/v8/ExceptionState.h"
#include "bindings/core/v8/V8DOMConfiguration.h"
#include "bindings/core/v8/V8ObjectConstructor.h"
#include "bindings/modules/v8/V8PresentationConnectionCloseEventInit.h"
...
#endif
const WrapperTypeInfo V8PresentationConnectionCloseEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8PresentationConnectionCloseEvent::domTemplate, V8PresentationConnectionCloseEvent::trace, V8PresentationConnectionCloseEvent::traceWrappers, 0, 0, V8PresentationConnectionCloseEvent::preparePrototypeAndInterfaceObject, nullptr, "PresentationConnectionCloseEvent", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& PresentationConnectionCloseEvent::s_wrapperTypeInfo = V8PresentationConnectionCloseEvent::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, PresentationConnectionCloseEvent>::value,
    "PresentationConnectionCloseEvent inherits from ActiveScriptWrappable, but does not specify "
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "PresentationConnectionCloseEvent", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::AccessorConfiguration V8PresentationConnectionCloseEventAccessors[] = {
    {"reason", PresentationConnectionCloseEventV8Internal::reasonAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"message", PresentationConnectionCloseEventV8Internal::messageAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
static void installV8PresentationConnectionCloseEventTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8PresentationConnectionCloseEvent::wrapperTypeInfo.interfaceName, V8Event::domTemplate(isolate, world), V8PresentationConnectionCloseEvent::internalFieldCount);
    ...
    if (RuntimeEnabledFeatures::presentationEnabled()) {
        V8DOMConfiguration::installAccessors(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8PresentationConnectionCloseEventAccessors, WTF_ARRAY_LENGTH(V8PresentationConnectionCloseEventAccessors));
    }
}
