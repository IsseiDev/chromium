...
#endif
const WrapperTypeInfo V8USBInterface::wrapperTypeInfo = { gin::kEmbedderBlink, V8USBInterface::domTemplate, V8USBInterface::trace, V8USBInterface::traceWrappers, 0, 0, V8USBInterface::preparePrototypeAndInterfaceObject, nullptr, "USBInterface", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& USBInterface::s_wrapperTypeInfo = V8USBInterface::wrapperTypeInfo;

static_assert(
    !std::is_base_of<ActiveScriptWrappable, USBInterface>::value,
    "USBInterface inherits from ActiveScriptWrappable, but does not specify "
...
static void interfaceNumberAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void alternateAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "alternate"), v8Value);
        v8SetReturnValue(info, v8Value);
    }
}

static void alternateAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void alternatesAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void claimedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
{
    ExceptionState exceptionState(ExceptionState::ConstructionContext, "USBInterface", info.Holder(), info.GetIsolate());
...
const V8DOMConfiguration::AccessorConfiguration V8USBInterfaceAccessors[] = {
    {"interfaceNumber", USBInterfaceV8Internal::interfaceNumberAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"alternate", USBInterfaceV8Internal::alternateAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"alternates", USBInterfaceV8Internal::alternatesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"claimed", USBInterfaceV8Internal::claimedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
