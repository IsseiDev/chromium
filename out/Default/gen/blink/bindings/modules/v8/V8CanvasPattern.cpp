...
#endif
const WrapperTypeInfo V8CanvasPattern::wrapperTypeInfo = { gin::kEmbedderBlink, V8CanvasPattern::domTemplate, V8CanvasPattern::trace, V8CanvasPattern::traceWrappers, 0, 0, V8CanvasPattern::preparePrototypeAndInterfaceObject, nullptr, "CanvasPattern", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, CanvasPattern>::value,
    "CanvasPattern inherits from ActiveScriptWrappable, but does not specify "
...
static void setTransformMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "setTransform", "CanvasPattern", 1, info.Length()));
        return;
    }
...
void V8CanvasPattern::preparePrototypeAndInterfaceObject(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> prototypeObject, v8::Local<v8::Function> interfaceObject, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    ...
    if (executionContext && (executionContext->isDocument())) {
        if (RuntimeEnabledFeatures::experimentalCanvasFeaturesEnabled()) {
            const V8DOMConfiguration::MethodConfiguration setTransformMethodConfiguration = {"setTransform", CanvasPatternV8Internal::setTransformMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype};
