...
#ifndef V8USBIsochronousOutTransferResult_h
#define V8USBIsochronousOutTransferResult_h
...
public:
    ...
    {
        visitor->trace(scriptWrappable->toImpl<USBIsochronousOutTransferResult>());
    }
    static void traceWrappers(WrapperVisitor* visitor, ScriptWrappable* scriptWrappable)
    {
        visitor->traceWrappers(scriptWrappable->toImpl<USBIsochronousOutTransferResult>());
    }
...
#endif // V8USBIsochronousOutTransferResult_h
