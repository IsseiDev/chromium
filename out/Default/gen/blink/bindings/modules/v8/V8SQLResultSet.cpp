...
#endif
const WrapperTypeInfo V8SQLResultSet::wrapperTypeInfo = { gin::kEmbedderBlink, V8SQLResultSet::domTemplate, V8SQLResultSet::trace, V8SQLResultSet::traceWrappers, 0, 0, V8SQLResultSet::preparePrototypeAndInterfaceObject, nullptr, "SQLResultSet", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SQLResultSet>::value,
    "SQLResultSet inherits from ActiveScriptWrappable, but does not specify "
...
static void rowsAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    if (!v8Value.IsEmpty()) {
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), "rows"), v8Value);
...
const V8DOMConfiguration::AccessorConfiguration V8SQLResultSetAccessors[] = {
    {"rows", SQLResultSetV8Internal::rowsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"insertId", SQLResultSetV8Internal::insertIdAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"rowsAffected", SQLResultSetV8Internal::rowsAffectedAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
