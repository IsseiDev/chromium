...
#endif
const WrapperTypeInfo V8VideoPlaybackQuality::wrapperTypeInfo = { gin::kEmbedderBlink, V8VideoPlaybackQuality::domTemplate, V8VideoPlaybackQuality::trace, V8VideoPlaybackQuality::traceWrappers, 0, 0, V8VideoPlaybackQuality::preparePrototypeAndInterfaceObject, nullptr, "VideoPlaybackQuality", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, VideoPlaybackQuality>::value,
    "VideoPlaybackQuality inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8VideoPlaybackQualityAccessors[] = {
    {"creationTime", VideoPlaybackQualityV8Internal::creationTimeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"totalVideoFrames", VideoPlaybackQualityV8Internal::totalVideoFramesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"droppedVideoFrames", VideoPlaybackQualityV8Internal::droppedVideoFramesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"corruptedVideoFrames", VideoPlaybackQualityV8Internal::corruptedVideoFramesAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
