...
#endif
const WrapperTypeInfo V8BluetoothDevice::wrapperTypeInfo = { gin::kEmbedderBlink, V8BluetoothDevice::domTemplate, V8BluetoothDevice::trace, V8BluetoothDevice::traceWrappers, 0, 0, V8BluetoothDevice::preparePrototypeAndInterfaceObject, nullptr, "BluetoothDevice", &V8EventTarget::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, BluetoothDevice>::value,
    "BluetoothDevice inherits from ActiveScriptWrappable, but does not specify "
...
static void ongattserverdisconnectedAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
static void ongattserverdisconnectedAttributeSetter(v8::Local<v8::Value> v8Value, const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    impl->setOngattserverdisconnected(V8EventListenerList::getEventListener(ScriptState::current(info.GetIsolate()), v8Value, true, ListenerFindOrCreate));
}

static void ongattserverdisconnectedAttributeSetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
...
const V8DOMConfiguration::AccessorConfiguration V8BluetoothDeviceAccessors[] = {
    {"id", BluetoothDeviceV8Internal::idAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"name", BluetoothDeviceV8Internal::nameAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"gatt", BluetoothDeviceV8Internal::gattAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"uuids", BluetoothDeviceV8Internal::uuidsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"ongattserverdisconnected", BluetoothDeviceV8Internal::ongattserverdisconnectedAttributeGetterCallback, BluetoothDeviceV8Internal::ongattserverdisconnectedAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
