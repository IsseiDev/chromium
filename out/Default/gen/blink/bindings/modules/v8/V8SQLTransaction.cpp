...
#endif
const WrapperTypeInfo V8SQLTransaction::wrapperTypeInfo = { gin::kEmbedderBlink, V8SQLTransaction::domTemplate, V8SQLTransaction::trace, V8SQLTransaction::traceWrappers, 0, 0, V8SQLTransaction::preparePrototypeAndInterfaceObject, nullptr, "SQLTransaction", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SQLTransaction>::value,
    "SQLTransaction inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::MethodConfiguration V8SQLTransactionMethods[] = {
    {"executeSql", SQLTransactionV8Internal::executeSqlMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
