...
#endif
const WrapperTypeInfo V8RTCLegacyStatsReport::wrapperTypeInfo = { gin::kEmbedderBlink, V8RTCLegacyStatsReport::domTemplate, V8RTCLegacyStatsReport::trace, V8RTCLegacyStatsReport::traceWrappers, 0, 0, V8RTCLegacyStatsReport::preparePrototypeAndInterfaceObject, nullptr, "RTCLegacyStatsReport", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, RTCLegacyStatsReport>::value,
    "RTCLegacyStatsReport inherits from ActiveScriptWrappable, but does not specify "
...
static void statMethod(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    if (UNLIKELY(info.Length() < 1)) {
        V8ThrowException::throwException(info.GetIsolate(), createMinimumArityTypeErrorForMethod(info.GetIsolate(), "stat", "RTCLegacyStatsReport", 1, info.Length()));
        return;
    }
...
const V8DOMConfiguration::AccessorConfiguration V8RTCLegacyStatsReportAccessors[] = {
    {"timestamp", RTCLegacyStatsReportV8Internal::timestampAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"id", RTCLegacyStatsReportV8Internal::idAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"type", RTCLegacyStatsReportV8Internal::typeAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};

const V8DOMConfiguration::MethodConfiguration V8RTCLegacyStatsReportMethods[] = {
    {"stat", RTCLegacyStatsReportV8Internal::statMethodCallback, 0, 1, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
    {"names", RTCLegacyStatsReportV8Internal::namesMethodCallback, 0, 0, v8::None, V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype},
};
