...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, WebGLCompressedTextureASTC>::value,
    "WebGLCompressedTextureASTC inherits from ActiveScriptWrappable, but does not specify "
