...
const V8DOMConfiguration::AccessorConfiguration V8MIDIInputAccessors[] = {
    {"onmidimessage", MIDIInputV8Internal::onmidimessageAttributeGetterCallback, MIDIInputV8Internal::onmidimessageAttributeSetterCallback, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
ActiveScriptWrappable* V8MIDIInput::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
