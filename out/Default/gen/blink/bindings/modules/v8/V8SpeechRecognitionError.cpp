...
#endif
const WrapperTypeInfo V8SpeechRecognitionError::wrapperTypeInfo = { gin::kEmbedderBlink, V8SpeechRecognitionError::domTemplate, V8SpeechRecognitionError::trace, V8SpeechRecognitionError::traceWrappers, 0, 0, V8SpeechRecognitionError::preparePrototypeAndInterfaceObject, nullptr, "SpeechRecognitionError", &V8Event::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, SpeechRecognitionError>::value,
    "SpeechRecognitionError inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8SpeechRecognitionErrorAccessors[] = {
    {"error", SpeechRecognitionErrorV8Internal::errorAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"message", SpeechRecognitionErrorV8Internal::messageAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
