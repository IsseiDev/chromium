...
static_assert(
    !std::is_base_of<ActiveScriptWrappable, ServiceWorkerMessageEvent>::value,
    "ServiceWorkerMessageEvent inherits from ActiveScriptWrappable, but does not specify "
...
const V8DOMConfiguration::AccessorConfiguration V8ServiceWorkerMessageEventAccessors[] = {
    {"data", ServiceWorkerMessageEventV8Internal::dataAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"origin", ServiceWorkerMessageEventV8Internal::originAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"lastEventId", ServiceWorkerMessageEventV8Internal::lastEventIdAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"source", ServiceWorkerMessageEventV8Internal::sourceAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"ports", ServiceWorkerMessageEventV8Internal::portsAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
void V8ServiceWorkerMessageEvent::constructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
{
    ...
    V8ServiceWorkerMessageEvent::constructorCustom(info);
}

static void installV8ServiceWorkerMessageEventTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate)
{
    // Initialize the interface object's template.
    V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8ServiceWorkerMessageEvent::wrapperTypeInfo.interfaceName, V8Event::domTemplate(isolate, world), V8ServiceWorkerMessageEvent::internalFieldCount);
    interfaceTemplate->SetCallHandler(V8ServiceWorkerMessageEvent::constructorCallback);
    ...
    V8DOMConfiguration::installAccessors(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8ServiceWorkerMessageEventAccessors, WTF_ARRAY_LENGTH(V8ServiceWorkerMessageEventAccessors));
}

v8::Local<v8::FunctionTemplate> V8ServiceWorkerMessageEvent::domTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world)
{
    return V8DOMConfiguration::domClassTemplate(isolate, world, const_cast<WrapperTypeInfo*>(&wrapperTypeInfo), installV8ServiceWorkerMessageEventTemplate);
}
