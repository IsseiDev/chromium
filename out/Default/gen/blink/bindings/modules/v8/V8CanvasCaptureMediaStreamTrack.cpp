...
#endif
const WrapperTypeInfo V8CanvasCaptureMediaStreamTrack::wrapperTypeInfo = { gin::kEmbedderBlink, V8CanvasCaptureMediaStreamTrack::domTemplate, V8CanvasCaptureMediaStreamTrack::trace, V8CanvasCaptureMediaStreamTrack::traceWrappers, V8CanvasCaptureMediaStreamTrack::toActiveScriptWrappable, 0, V8CanvasCaptureMediaStreamTrack::preparePrototypeAndInterfaceObject, nullptr, "CanvasCaptureMediaStreamTrack", &V8MediaStreamTrack::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8CanvasCaptureMediaStreamTrackAccessors[] = {
    {"canvas", CanvasCaptureMediaStreamTrackV8Internal::canvasAttributeGetterCallback, 0, 0, 0, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::ExposedToAllScripts, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
...
ActiveScriptWrappable* V8CanvasCaptureMediaStreamTrack::toActiveScriptWrappable(v8::Local<v8::Object> wrapper)
{
