...
const AtomicString& PaymentRequestUpdateEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[13];
const AtomicString& RTCDTMFToneChangeEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[14];
const AtomicString& RTCDataChannelEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[15];
const AtomicString& RTCIceCandidateEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[16];
const AtomicString& PresentationConnectionAvailableEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[17];
const AtomicString& PresentationConnectionCloseEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[18];
const AtomicString& PushEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[19];
const AtomicString& SensorErrorEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[20];
const AtomicString& SensorReadingEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[21];
...
const AtomicString& ServiceWorkerMessageEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[27];
const AtomicString& SpeechRecognitionError = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[28];
const AtomicString& SpeechRecognitionEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[29];
const AtomicString& SpeechSynthesisEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[30];
const AtomicString& StorageEvent = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[31];
