...
const AtomicString& PresentationReceiver = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[28];
...
const AtomicString& RemotePlaybackAvailability = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[31];
const AtomicString& ScreenOrientation = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[32];
const AtomicString& Sensor = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[33];
const AtomicString& ServiceWorker = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[34];
const AtomicString& ServiceWorkerContainer = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[35];
const AtomicString& ServiceWorkerGlobalScope = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[36];
const AtomicString& ServiceWorkerRegistration = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[37];
const AtomicString& SpeechRecognition = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[38];
const AtomicString& SpeechSynthesis = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[39];
const AtomicString& SpeechSynthesisUtterance = reinterpret_cast<AtomicString*>(&ModulesNamesStorage)[40];
...
void initModules()
{
    ...
    static const NameEntry kNames[] = {
        ...
        { "PresentationReceiver", 8245599, 20 },
        { "PresentationRequest", 4728545, 19 },
        { "RemotePlayback", 14509464, 14 },
        { "RemotePlaybackAvailability", 9933107, 26 },
