...
public:
    ...
    DOMArrayBuffer* initData() const { return m_initData; }
    void setInitData(DOMArrayBuffer* value) { m_initData = value; }
    void setInitDataToNull() { m_initData = Member<DOMArrayBuffer>(); }
