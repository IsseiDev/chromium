...
#ifndef protocol_DeviceOrientation_h
#define protocol_DeviceOrientation_h
...
public:
    static void wire(UberDispatcher*, blink::protocol::DeviceOrientation::Backend*);
...
#endif // !defined(protocol_DeviceOrientation_h)
