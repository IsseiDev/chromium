...
#ifndef protocol_IndexedDB_h
#define protocol_IndexedDB_h
...
// Database with an array of object stores.
class CORE_EXPORT DatabaseWithObjectStores {
    PROTOCOL_DISALLOW_COPY(DatabaseWithObjectStores);
public:
    static std::unique_ptr<DatabaseWithObjectStores> parse(protocol::Value* value, ErrorSupport* errors);
    ...
    public:
        ...
        DatabaseWithObjectStoresBuilder<STATE | NameSet>& setName(const WTF::String& value)
        {
...
// Object store.
class CORE_EXPORT ObjectStore {
    PROTOCOL_DISALLOW_COPY(ObjectStore);
public:
    static std::unique_ptr<ObjectStore> parse(protocol::Value* value, ErrorSupport* errors);
    ...
    public:
        ...
        ObjectStoreBuilder<STATE | NameSet>& setName(const WTF::String& value)
        {
            static_assert(!(STATE & NameSet), "property name should not be set yet");
            m_result->setName(value);
            return castState<NameSet>();
...
// Object store index.
class CORE_EXPORT ObjectStoreIndex {
    PROTOCOL_DISALLOW_COPY(ObjectStoreIndex);
public:
    static std::unique_ptr<ObjectStoreIndex> parse(protocol::Value* value, ErrorSupport* errors);
    ...
    public:
        ...
        ObjectStoreIndexBuilder<STATE | NameSet>& setName(const WTF::String& value)
        {
            static_assert(!(STATE & NameSet), "property name should not be set yet");
            m_result->setName(value);
            return castState<NameSet>();
...
public:
    static std::unique_ptr<Key> parse(protocol::Value* value, ErrorSupport* errors);
    ...
    WTF::String getString(const WTF::String& defaultValue) { return m_string.isJust() ? m_string.fromJust() : defaultValue; }
    void setString(const WTF::String& value) { m_string = value; }
    ...
    public:
        ...
        KeyBuilder<STATE | TypeSet>& setType(const WTF::String& value)
        {
        ...
        KeyBuilder<STATE>& setString(const WTF::String& value)
        {
...
// Key range.
class CORE_EXPORT KeyRange {
    PROTOCOL_DISALLOW_COPY(KeyRange);
public:
    static std::unique_ptr<KeyRange> parse(protocol::Value* value, ErrorSupport* errors);
...
public:
    ...
    protocol::Runtime::API::RemoteObject* getKey() { return m_key.get(); }
    void setKey(std::unique_ptr<protocol::Runtime::API::RemoteObject> value) { m_key = std::move(value); }

    protocol::Runtime::API::RemoteObject* getPrimaryKey() { return m_primaryKey.get(); }
    void setPrimaryKey(std::unique_ptr<protocol::Runtime::API::RemoteObject> value) { m_primaryKey = std::move(value); }

    protocol::Runtime::API::RemoteObject* getValue() { return m_value.get(); }
    void setValue(std::unique_ptr<protocol::Runtime::API::RemoteObject> value) { m_value = std::move(value); }
    ...
    public:
        ...
        DataEntryBuilder<STATE | KeySet>& setKey(std::unique_ptr<protocol::Runtime::API::RemoteObject> value)
        {
        ...
        DataEntryBuilder<STATE | PrimaryKeySet>& setPrimaryKey(std::unique_ptr<protocol::Runtime::API::RemoteObject> value)
        {
        ...
        DataEntryBuilder<STATE | ValueSet>& setValue(std::unique_ptr<protocol::Runtime::API::RemoteObject> value)
        {
...
private:
    ...
    std::unique_ptr<protocol::Runtime::API::RemoteObject> m_key;
    std::unique_ptr<protocol::Runtime::API::RemoteObject> m_primaryKey;
    std::unique_ptr<protocol::Runtime::API::RemoteObject> m_value;
};


// Key path.
class CORE_EXPORT KeyPath {
    PROTOCOL_DISALLOW_COPY(KeyPath);
public:
    static std::unique_ptr<KeyPath> parse(protocol::Value* value, ErrorSupport* errors);
    ...
    bool hasArray() { return m_array.isJust(); }
    protocol::Array<WTF::String>* getArray(protocol::Array<WTF::String>* defaultValue) { return m_array.isJust() ? m_array.fromJust() : defaultValue; }
    void setArray(std::unique_ptr<protocol::Array<WTF::String>> value) { m_array = std::move(value); }
    ...
    public:
        ...
        KeyPathBuilder<STATE | TypeSet>& setType(const WTF::String& value)
        {
            static_assert(!(STATE & TypeSet), "property type should not be set yet");
            m_result->setType(value);
            return castState<TypeSet>();
        ...
        KeyPathBuilder<STATE>& setString(const WTF::String& value)
        {
            m_result->setString(value);
            return *this;
        }

        KeyPathBuilder<STATE>& setArray(std::unique_ptr<protocol::Array<WTF::String>> value)
        {
            m_result->setArray(std::move(value));
            return *this;
        }
...
private:
    ...
    WTF::String m_type;
    Maybe<WTF::String> m_string;
    Maybe<protocol::Array<WTF::String>> m_array;
};
...
public:
    ...
    class CORE_EXPORT RequestDatabaseNamesCallback : public BackendCallback {
    public:
        virtual void sendSuccess(std::unique_ptr<protocol::Array<WTF::String>> databaseNames) = 0;
    };
    virtual void requestDatabaseNames(const WTF::String& in_securityOrigin, std::unique_ptr<RequestDatabaseNamesCallback> callback) = 0;
    class CORE_EXPORT RequestDatabaseCallback : public BackendCallback {
    public:
        virtual void sendSuccess(std::unique_ptr<protocol::IndexedDB::DatabaseWithObjectStores> databaseWithObjectStores) = 0;
    };
    virtual void requestDatabase(const WTF::String& in_securityOrigin, const WTF::String& in_databaseName, std::unique_ptr<RequestDatabaseCallback> callback) = 0;
    class CORE_EXPORT RequestDataCallback : public BackendCallback {
    public:
    ...
    virtual void requestData(const WTF::String& in_securityOrigin, const WTF::String& in_databaseName, const WTF::String& in_objectStoreName, const WTF::String& in_indexName, int in_skipCount, int in_pageSize, const Maybe<protocol::IndexedDB::KeyRange>& in_keyRange, std::unique_ptr<RequestDataCallback> callback) = 0;
    class CORE_EXPORT ClearObjectStoreCallback : public BackendCallback {
    public:
        virtual void sendSuccess() = 0;
    };
    virtual void clearObjectStore(const WTF::String& in_securityOrigin, const WTF::String& in_databaseName, const WTF::String& in_objectStoreName, std::unique_ptr<ClearObjectStoreCallback> callback) = 0;
...
public:
    static void wire(UberDispatcher*, blink::protocol::IndexedDB::Backend*);
...
#endif // !defined(protocol_IndexedDB_h)
