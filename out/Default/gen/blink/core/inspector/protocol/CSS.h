...
#ifndef protocol_CSS_h
#define protocol_CSS_h
...
// 
using StyleSheetId = WTF::String;
// Stylesheet type: "injected" for stylesheets injected via extension, "user-agent" for user-agent stylesheets, "inspector" for stylesheets created by the inspector (i.e. those holding the "via inspector" rules), "regular" for regular stylesheets.
using StyleSheetOrigin = WTF::String;
...
// CSS rule collection for a single pseudo style.
class CORE_EXPORT PseudoElementMatches {
...
public:
    ...
    WTF::String getPseudoType() { return m_pseudoType; }
    ...
    public:
        ...
        PseudoElementMatchesBuilder<STATE | PseudoTypeSet>& setPseudoType(const WTF::String& value)
        {
...
public:
    ...
    public:
        ...
        ValueBuilder<STATE | TextSet>& setText(const WTF::String& value)
        {
...
// Selector list data.
class CORE_EXPORT SelectorList {
...
public:
    ...
    public:
        ...
        SelectorListBuilder<STATE | TextSet>& setText(const WTF::String& value)
        {
            static_assert(!(STATE & TextSet), "property text should not be set yet");
            m_result->setText(value);
            return castState<TextSet>();
...
// CSS stylesheet metainformation.
class CORE_EXPORT CSSStyleSheetHeader {
...
public:
    ...
    WTF::String getStyleSheetId() { return m_styleSheetId; }
    void setStyleSheetId(const WTF::String& value) { m_styleSheetId = value; }
    ...
    WTF::String getSourceMapURL(const WTF::String& defaultValue) { return m_sourceMapURL.isJust() ? m_sourceMapURL.fromJust() : defaultValue; }
    void setSourceMapURL(const WTF::String& value) { m_sourceMapURL = value; }
    ...
    public:
        ...
        CSSStyleSheetHeaderBuilder<STATE | StyleSheetIdSet>& setStyleSheetId(const WTF::String& value)
        {
        ...
        CSSStyleSheetHeaderBuilder<STATE | FrameIdSet>& setFrameId(const WTF::String& value)
        {
        ...
        CSSStyleSheetHeaderBuilder<STATE | SourceURLSet>& setSourceURL(const WTF::String& value)
        {
        ...
        CSSStyleSheetHeaderBuilder<STATE>& setSourceMapURL(const WTF::String& value)
        {
            m_result->setSourceMapURL(value);
            return *this;
        }

        CSSStyleSheetHeaderBuilder<STATE | OriginSet>& setOrigin(const WTF::String& value)
        {
        ...
        CSSStyleSheetHeaderBuilder<STATE | TitleSet>& setTitle(const WTF::String& value)
        {
...
private:
    ...
    WTF::String m_styleSheetId;
    WTF::String m_frameId;
    WTF::String m_sourceURL;
    Maybe<WTF::String> m_sourceMapURL;
    WTF::String m_origin;
    WTF::String m_title;
...
public:
    ...
    WTF::String getStyleSheetId(const WTF::String& defaultValue) { return m_styleSheetId.isJust() ? m_styleSheetId.fromJust() : defaultValue; }
    void setStyleSheetId(const WTF::String& value) { m_styleSheetId = value; }
    ...
    public:
        ...
        CSSRuleBuilder<STATE>& setStyleSheetId(const WTF::String& value)
        {
            m_result->setStyleSheetId(value);
            return *this;
        }
        ...
        CSSRuleBuilder<STATE | OriginSet>& setOrigin(const WTF::String& value)
        {
            static_assert(!(STATE & OriginSet), "property origin should not be set yet");
            m_result->setOrigin(value);
            return castState<OriginSet>();
...
private:
    ...
    Maybe<WTF::String> m_styleSheetId;
...
// 
class CORE_EXPORT ShorthandEntry {
...
public:
    ...
    public:
        ...
        ShorthandEntryBuilder<STATE | NameSet>& setName(const WTF::String& value)
        {
        ...
        ShorthandEntryBuilder<STATE | ValueSet>& setValue(const WTF::String& value)
        {
...
// 
class CORE_EXPORT CSSComputedStyleProperty {
...
public:
    ...
    public:
        ...
        CSSComputedStylePropertyBuilder<STATE | NameSet>& setName(const WTF::String& value)
        {
            static_assert(!(STATE & NameSet), "property name should not be set yet");
            m_result->setName(value);
            return castState<NameSet>();
        ...
        CSSComputedStylePropertyBuilder<STATE | ValueSet>& setValue(const WTF::String& value)
        {
            static_assert(!(STATE & ValueSet), "property value should not be set yet");
            m_result->setValue(value);
            return castState<ValueSet>();
...
public:
    ...
    WTF::String getCssText(const WTF::String& defaultValue) { return m_cssText.isJust() ? m_cssText.fromJust() : defaultValue; }
    void setCssText(const WTF::String& value) { m_cssText = value; }
    ...
    public:
        ...
        CSSStyleBuilder<STATE>& setStyleSheetId(const WTF::String& value)
        {
            m_result->setStyleSheetId(value);
            return *this;
        }
        ...
        CSSStyleBuilder<STATE>& setCssText(const WTF::String& value)
        {
...
private:
    ...
    Maybe<WTF::String> m_cssText;
    Maybe<protocol::CSS::SourceRange> m_range;
};


// CSS property declaration data.
class CORE_EXPORT CSSProperty {
...
public:
    ...
    public:
        ...
        CSSPropertyBuilder<STATE | NameSet>& setName(const WTF::String& value)
        {
            static_assert(!(STATE & NameSet), "property name should not be set yet");
            m_result->setName(value);
            return castState<NameSet>();
        ...
        CSSPropertyBuilder<STATE | ValueSet>& setValue(const WTF::String& value)
        {
            static_assert(!(STATE & ValueSet), "property value should not be set yet");
            m_result->setValue(value);
            return castState<ValueSet>();
        ...
        CSSPropertyBuilder<STATE>& setText(const WTF::String& value)
        {
            m_result->setText(value);
            return *this;
        }
...
public:
    ...
    WTF::String getSourceURL(const WTF::String& defaultValue) { return m_sourceURL.isJust() ? m_sourceURL.fromJust() : defaultValue; }
    void setSourceURL(const WTF::String& value) { m_sourceURL = value; }
    ...
    public:
        ...
        CSSMediaBuilder<STATE | TextSet>& setText(const WTF::String& value)
        {
            static_assert(!(STATE & TextSet), "property text should not be set yet");
            m_result->setText(value);
            return castState<TextSet>();
        ...
        CSSMediaBuilder<STATE | SourceSet>& setSource(const WTF::String& value)
        {
        ...
        CSSMediaBuilder<STATE>& setSourceURL(const WTF::String& value)
        {
            m_result->setSourceURL(value);
            return *this;
        }
        ...
        CSSMediaBuilder<STATE>& setStyleSheetId(const WTF::String& value)
        {
            m_result->setStyleSheetId(value);
            return *this;
        }
...
// Media query expression descriptor.
class CORE_EXPORT MediaQueryExpression {
...
public:
    ...
    WTF::String getUnit() { return m_unit; }
    void setUnit(const WTF::String& value) { m_unit = value; }

    WTF::String getFeature() { return m_feature; }
    void setFeature(const WTF::String& value) { m_feature = value; }
    ...
    public:
        ...
        MediaQueryExpressionBuilder<STATE | UnitSet>& setUnit(const WTF::String& value)
        {
        ...
        MediaQueryExpressionBuilder<STATE | FeatureSet>& setFeature(const WTF::String& value)
        {
...
// Information about amount of glyphs that were rendered with given font.
class CORE_EXPORT PlatformFontUsage {
...
public:
    ...
    WTF::String getFamilyName() { return m_familyName; }
    void setFamilyName(const WTF::String& value) { m_familyName = value; }
    ...
    public:
        ...
        PlatformFontUsageBuilder<STATE | FamilyNameSet>& setFamilyName(const WTF::String& value)
        {
...
// CSS keyframes rule representation.
class CORE_EXPORT CSSKeyframesRule {
...
// CSS keyframe rule representation.
class CORE_EXPORT CSSKeyframeRule {
...
public:
    ...
    public:
        ...
        CSSKeyframeRuleBuilder<STATE>& setStyleSheetId(const WTF::String& value)
        {
            m_result->setStyleSheetId(value);
            return *this;
        }

        CSSKeyframeRuleBuilder<STATE | OriginSet>& setOrigin(const WTF::String& value)
        {
            static_assert(!(STATE & OriginSet), "property origin should not be set yet");
            m_result->setOrigin(value);
            return castState<OriginSet>();
...
// A descriptor of operation to mutate style declaration text.
class CORE_EXPORT StyleDeclarationEdit {
...
public:
    ...
    public:
        ...
        StyleDeclarationEditBuilder<STATE | StyleSheetIdSet>& setStyleSheetId(const WTF::String& value)
        {
            static_assert(!(STATE & StyleSheetIdSet), "property styleSheetId should not be set yet");
            m_result->setStyleSheetId(value);
            return castState<StyleSheetIdSet>();
        ...
        StyleDeclarationEditBuilder<STATE | TextSet>& setText(const WTF::String& value)
        {
            static_assert(!(STATE & TextSet), "property text should not be set yet");
            m_result->setText(value);
            return castState<TextSet>();
...
public:
    class CORE_EXPORT EnableCallback : public BackendCallback {
    public:
    ...
    virtual void getStyleSheetText(ErrorString*, const WTF::String& in_styleSheetId, WTF::String* out_text) = 0;
    virtual void setStyleSheetText(ErrorString*, const WTF::String& in_styleSheetId, const WTF::String& in_text, Maybe<WTF::String>* out_sourceMapURL) = 0;
    virtual void setRuleSelector(ErrorString*, const WTF::String& in_styleSheetId, std::unique_ptr<protocol::CSS::SourceRange> in_range, const WTF::String& in_selector, std::unique_ptr<protocol::CSS::SelectorList>* out_selectorList) = 0;
    virtual void setKeyframeKey(ErrorString*, const WTF::String& in_styleSheetId, std::unique_ptr<protocol::CSS::SourceRange> in_range, const WTF::String& in_keyText, std::unique_ptr<protocol::CSS::Value>* out_keyText) = 0;
    ...
    virtual void setMediaText(ErrorString*, const WTF::String& in_styleSheetId, std::unique_ptr<protocol::CSS::SourceRange> in_range, const WTF::String& in_text, std::unique_ptr<protocol::CSS::CSSMedia>* out_media) = 0;
    virtual void createStyleSheet(ErrorString*, const WTF::String& in_frameId, WTF::String* out_styleSheetId) = 0;
    virtual void addRule(ErrorString*, const WTF::String& in_styleSheetId, const WTF::String& in_ruleText, std::unique_ptr<protocol::CSS::SourceRange> in_location, std::unique_ptr<protocol::CSS::CSSRule>* out_rule) = 0;
    virtual void forcePseudoState(ErrorString*, int in_nodeId, std::unique_ptr<protocol::Array<WTF::String>> in_forcedPseudoClasses) = 0;
    virtual void getMediaQueries(ErrorString*, std::unique_ptr<protocol::Array<protocol::CSS::CSSMedia>>* out_medias) = 0;
    virtual void setEffectivePropertyValueForNode(ErrorString*, int in_nodeId, const WTF::String& in_propertyName, const WTF::String& in_value) = 0;
    virtual void getBackgroundColors(ErrorString*, int in_nodeId, Maybe<protocol::Array<WTF::String>>* out_backgroundColors) = 0;
...
public:
    ...
    void fontsUpdated();
    void styleSheetChanged(const WTF::String& styleSheetId);
    void styleSheetAdded(std::unique_ptr<protocol::CSS::CSSStyleSheetHeader> header);
    void styleSheetRemoved(const WTF::String& styleSheetId);
    void layoutEditorChange(const WTF::String& styleSheetId, std::unique_ptr<protocol::CSS::SourceRange> changeRange);
...
public:
    static void wire(UberDispatcher*, blink::protocol::CSS::Backend*);
