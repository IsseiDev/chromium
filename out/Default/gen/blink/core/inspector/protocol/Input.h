...
#ifndef protocol_Input_h
#define protocol_Input_h
...
class TouchPoint;
// 
using GestureSourceType = WTF::String;
...
// 
class CORE_EXPORT TouchPoint {
    PROTOCOL_DISALLOW_COPY(TouchPoint);
public:
    static std::unique_ptr<TouchPoint> parse(protocol::Value* value, ErrorSupport* errors);
    ...
    WTF::String getState() { return m_state; }
    void setState(const WTF::String& value) { m_state = value; }
    ...
    public:
        ...
        TouchPointBuilder<STATE | StateSet>& setState(const WTF::String& value)
        {
...
public:
    virtual void dispatchTouchEvent(ErrorString*, const WTF::String& in_type, std::unique_ptr<protocol::Array<protocol::Input::TouchPoint>> in_touchPoints, const Maybe<int>& in_modifiers, const Maybe<double>& in_timestamp) = 0;
...
public:
    static void wire(UberDispatcher*, blink::protocol::Input::Backend*);
...
#endif // !defined(protocol_Input_h)
