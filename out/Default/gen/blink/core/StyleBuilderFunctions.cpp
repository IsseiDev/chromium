...
{
    state.style()->accessSVGStyle().setVectorEffect(toCSSPrimitiveValue(value).convertTo<EVectorEffect>());
}
...
{
    state.style()->accessSVGStyle().setFillRule(toCSSPrimitiveValue(value).convertTo<WindRule>());
}
...
{
    state.style()->accessSVGStyle().setColorInterpolation(toCSSPrimitiveValue(value).convertTo<EColorInterpolation>());
}
...
{
    state.style()->setBreakBefore(toCSSPrimitiveValue(value).convertTo<EBreak>());
}
...
{
    state.style()->accessSVGStyle().setDominantBaseline(toCSSPrimitiveValue(value).convertTo<EDominantBaseline>());
}
...
{
    state.style()->setMotionRotation(StyleBuilderConverter::convertMotionRotation(state, value));
}
...
{
    state.style()->setPrintColorAdjust(state.parentStyle()->getPrintColorAdjust());
}
...
{
    state.style()->setBreakAfter(toCSSPrimitiveValue(value).convertTo<EBreak>());
}
...
{
    state.style()->setMotionPath(ComputedStyle::initialMotionPath());
}
...
{
    state.style()->setMotionPath(StyleBuilderConverter::convertPathOrNone(state, value));
}
...
{
    state.style()->accessSVGStyle().setTextAnchor(toCSSPrimitiveValue(value).convertTo<ETextAnchor>());
}
...
{
    state.style()->setHyphens(toCSSPrimitiveValue(value).convertTo<Hyphens>());
}
...
{
    state.style()->setBreakInside(toCSSPrimitiveValue(value).convertTo<EBreak>());
}
...
{
    state.style()->setOverflowAnchor(toCSSPrimitiveValue(value).convertTo<EOverflowAnchor>());
}
...
{
    state.style()->accessSVGStyle().setShapeRendering(toCSSPrimitiveValue(value).convertTo<EShapeRendering>());
}
...
{
    state.style()->accessSVGStyle().setColorRendering(toCSSPrimitiveValue(value).convertTo<EColorRendering>());
}
...
{
    state.style()->accessSVGStyle().setJoinStyle(toCSSPrimitiveValue(value).convertTo<LineJoin>());
}
...
{
    state.style()->accessSVGStyle().setCapStyle(toCSSPrimitiveValue(value).convertTo<LineCap>());
}
...
{
    state.style()->accessSVGStyle().setColorInterpolationFilters(toCSSPrimitiveValue(value).convertTo<EColorInterpolation>());
}
...
{
    state.style()->accessSVGStyle().setBufferedRendering(toCSSPrimitiveValue(value).convertTo<EBufferedRendering>());
}
...
{
    state.style()->accessSVGStyle().setAlignmentBaseline(toCSSPrimitiveValue(value).convertTo<EAlignmentBaseline>());
}
...
{
    state.style()->accessSVGStyle().setMaskType(toCSSPrimitiveValue(value).convertTo<EMaskType>());
}
...
{
    state.style()->setEmptyCells(toCSSPrimitiveValue(value).convertTo<EEmptyCells>());
}
...
void StyleBuilderFunctions::applyValueCSSPropertyMotionOffset(StyleResolverState& state, const CSSValue& value)
{
...
{
    state.style()->accessSVGStyle().setClipRule(toCSSPrimitiveValue(value).convertTo<WindRule>());
}
...
void StyleBuilderFunctions::applyValueCSSPropertyGridTemplateColumns(StyleResolverState& state, const CSSValue& value)
{
    ...
    state.style()->setGridAutoRepeatColumnsInsertionPoint(autoRepeatInsertionPoint);
    state.style()->setAutoRepeatNamedGridColumnLines(autoRepeatNamedGridLines);
    state.style()->setAutoRepeatOrderedNamedGridColumnLines(autoRepeatOrderedNamedGridLines);
...
void StyleBuilderFunctions::applyValueCSSPropertyGridTemplateRows(StyleResolverState& state, const CSSValue& value)
{
    ...
    state.style()->setGridAutoRepeatRowsInsertionPoint(autoRepeatInsertionPoint);
    state.style()->setAutoRepeatNamedGridRowLines(autoRepeatNamedGridLines);
    state.style()->setAutoRepeatOrderedNamedGridRowLines(autoRepeatOrderedNamedGridLines);
