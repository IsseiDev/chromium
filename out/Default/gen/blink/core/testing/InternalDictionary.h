...
public:
    ...
    Element* elementMember() const { return m_elementMember; }
    void setElementMember(Element* value) { m_elementMember = value; }
    ...
    EventTarget* eventTargetOrNullMember() const { return m_eventTargetOrNullMember; }
    void setEventTargetOrNullMember(EventTarget* value) { m_eventTargetOrNullMember = value; }
    void setEventTargetOrNullMemberToNull() { m_eventTargetOrNullMember = Member<EventTarget>(); }
