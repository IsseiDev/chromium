...
const AtomicString& BeforeUnloadEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[5];
const AtomicString& ClipboardEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[6];
const AtomicString& CompositionEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[7];
const AtomicString& CustomEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[8];
const AtomicString& DragEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[9];
...
const AtomicString& RelatedEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[24];
const AtomicString& ResourceProgressEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[25];
const AtomicString& SecurityPolicyViolationEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[26];
const AtomicString& TextEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[27];
const AtomicString& TouchEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[28];
const AtomicString& TransitionEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[29];
const AtomicString& UIEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[30];
const AtomicString& WheelEvent = reinterpret_cast<AtomicString*>(&NamesStorage)[31];
