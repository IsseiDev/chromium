...
{
    std::unique_ptr<const MathMLQualifiedName*[]> tags = wrapArrayUnique(new const MathMLQualifiedName*[MathMLTagsCount]);
...
{
    std::unique_ptr<const QualifiedName*[]> attrs = wrapArrayUnique(new const QualifiedName*[MathMLAttrsCount]);
