...
Event* EventFactory::create(ExecutionContext* executionContext, const String& type)
{
    if (type == "FontFaceSetLoadEvent") {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventFontFaceSetLoadEvent);
        return FontFaceSetLoadEvent::create();
    }
    if (type == "MediaQueryListEvent") {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventMediaQueryListEvent);
    ...
    if (type == "ApplicationCacheErrorEvent") {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventApplicationCacheErrorEvent);
    ...
    if (type == "ClipboardEvent") {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventClipboardEvent);
    ...
    if (type == "PromiseRejectionEvent") {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventPromiseRejectionEvent);
        return PromiseRejectionEvent::create();
    }
    if (type == "ResourceProgressEvent") {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventResourceProgressEvent);
        return ResourceProgressEvent::create();
    }
    if (type == "SecurityPolicyViolationEvent") {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventSecurityPolicyViolationEvent);
    ...
    if (equalIgnoringCase(type, "TouchEvent") && RuntimeEnabledFeatures::touchEnabled()) {
    ...
    if (type == "OrientationEvent" && RuntimeEnabledFeatures::orientationEventEnabled()) {
        UseCounter::count(executionContext, UseCounter::DocumentCreateEventOrientationEvent);
        return Event::create();
    }
    if (type == "SVGEvents") {
