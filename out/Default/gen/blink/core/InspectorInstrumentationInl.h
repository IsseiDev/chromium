...
CORE_EXPORT void didReceiveData(LocalFrame*, unsigned long, const char*, int, int);
...
CORE_EXPORT void willExecuteScript(ExecutionContext*);
CORE_EXPORT void didExecuteScript(ExecutionContext*);
} // namespace InspectorInstrumentation
