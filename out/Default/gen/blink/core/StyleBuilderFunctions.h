...
public:
    ...
    static void applyValueCSSPropertyMotionRotation(StyleResolverState&, const CSSValue&);
    ...
    static void applyValueCSSPropertyMotionPath(StyleResolverState&, const CSSValue&);
    ...
    static void applyValueCSSPropertyWebkitClipPath(StyleResolverState&, const CSSValue&);
    ...
    static void applyValueCSSPropertyMotionOffset(StyleResolverState&, const CSSValue&);
