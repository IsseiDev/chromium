...
public:
    ...
    bool hasInspectorWebPerfAgents() const { return m_hasInspectorWebPerfAgents; }
    const HeapHashSet<Member<InspectorWebPerfAgent>>& inspectorWebPerfAgents() const { return m_inspectorWebPerfAgents; }
    void addInspectorWebPerfAgent(InspectorWebPerfAgent* agent);
    void removeInspectorWebPerfAgent(InspectorWebPerfAgent* agent);
...
private:
    ...
    HeapHashSet<Member<InspectorWebPerfAgent>> m_inspectorWebPerfAgents;
    bool m_hasInspectorWebPerfAgents;
