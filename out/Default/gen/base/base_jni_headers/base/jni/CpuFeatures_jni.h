...
static jint GetCoreCount(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller);

extern "C" __attribute__((visibility("default")))
jint Java_org_chromium_base_CpuFeatures_nativeGetCoreCount(JNIEnv* env, jclass
    jcaller) {
  return GetCoreCount(env, base::android::JavaParamRef<jclass>(env, jcaller));
}

static jlong GetCpuFeatures(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

extern "C" __attribute__((visibility("default")))
jlong Java_org_chromium_base_CpuFeatures_nativeGetCpuFeatures(JNIEnv* env,
    jclass jcaller) {
