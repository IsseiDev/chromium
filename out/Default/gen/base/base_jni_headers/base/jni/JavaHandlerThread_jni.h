...
void Java_org_chromium_base_JavaHandlerThread_nativeInitializeThread(JNIEnv*
    env,
    jobject jcaller,
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_JavaHandlerThread_nativeStopThread(JNIEnv* env,
    jobject jcaller,
    jlong nativeJavaHandlerThread,
    jlong nativeEvent) {
  JavaHandlerThread* native =
...
"Lorg/chromium/base/JavaHandlerThread;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(JavaHandlerThread_clazz(env),
          method_id, name.obj());
...
static void Java_JavaHandlerThread_start(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jlong nativeThread,
    jlong nativeEvent) {
