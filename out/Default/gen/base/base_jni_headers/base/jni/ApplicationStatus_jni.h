...
namespace {
const char kApplicationStatusClassPath[] =
    "org/chromium/base/ApplicationStatus";
...
static void OnApplicationStateChange(JNIEnv* env, const
...
void
    ...
    env, jclass jcaller,
    jint newState) {
  return OnApplicationStateChange(env, base::android::JavaParamRef<jclass>(env,
      jcaller), newState);
}
...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(ApplicationStatus_clazz(env),
          method_id);
...
static base::subtle::AtomicWord
    g_ApplicationStatus_registerThreadSafeNativeApplicationStateListener = 0;
static void
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsApplicationStatusSize =
      arraysize(kMethodsApplicationStatus);

  if (env->RegisterNatives(ApplicationStatus_clazz(env),
                           kMethodsApplicationStatus,
                           kMethodsApplicationStatusSize) < 0) {
