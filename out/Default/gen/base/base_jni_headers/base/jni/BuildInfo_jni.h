...
"Ljava/lang/String;",
  ...
  jstring ret =
      static_cast<jstring>(env->CallStaticObjectMethod(BuildInfo_clazz(env),
          method_id));
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_BuildInfo_getGMSVersionCode(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_BuildInfo_getPackageVersionCode(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, BuildInfo_clazz(env),
      BuildInfo_clazz(env), NULL);
  jmethodID method_id =
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_BuildInfo_getPackageVersionName(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, BuildInfo_clazz(env),
      BuildInfo_clazz(env), NULL);
  jmethodID method_id =
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_BuildInfo_getPackageLabel(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, BuildInfo_clazz(env),
      BuildInfo_clazz(env), NULL);
  jmethodID method_id =
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_BuildInfo_getPackageName(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, BuildInfo_clazz(env),
      BuildInfo_clazz(env), NULL);
  jmethodID method_id =
...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(BuildInfo_clazz(env),
          method_id);
  jni_generator::CheckException(env);
  return ret;
}
