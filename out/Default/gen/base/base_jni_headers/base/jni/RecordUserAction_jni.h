...
namespace {
const char kRecordUserActionClassPath[] =
    "org/chromium/base/metrics/RecordUserAction";
...
static void RecordUserAction(JNIEnv* env, const
...
void
    ...
    env, jclass jcaller,
    jstring action) {
  return RecordUserAction(env, base::android::JavaParamRef<jclass>(env,
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  if (env->RegisterNatives(RecordUserAction_clazz(env),
                           ...
                           kMethodsRecordUserActionSize) < 0) {
