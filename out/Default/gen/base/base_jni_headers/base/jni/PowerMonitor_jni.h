...
static void OnBatteryChargingChanged(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_PowerMonitor_nativeOnBatteryChargingChanged(JNIEnv*
    env, jclass jcaller) {
  return OnBatteryChargingChanged(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}

static void OnMainActivitySuspended(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_PowerMonitor_nativeOnMainActivitySuspended(JNIEnv*
    env, jclass jcaller) {
  return OnMainActivitySuspended(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}

static void OnMainActivityResumed(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_PowerMonitor_nativeOnMainActivityResumed(JNIEnv*
    env, jclass jcaller) {
  return OnMainActivityResumed(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}
...
"Z",
  ...
  jboolean ret =
      env->CallStaticBooleanMethod(PowerMonitor_clazz(env),
          method_id);
...
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_base_PowerMonitor_nativeOnMainActivitySuspended)
    },
    { "nativeOnMainActivityResumed",
"("
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_base_PowerMonitor_nativeOnMainActivityResumed)
    },
};
