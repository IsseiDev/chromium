...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(ContentUriUtils_clazz(env),
...
"Z",
  ...
  jboolean ret =
      env->CallStaticBooleanMethod(ContentUriUtils_clazz(env),
          method_id, context.obj(), uriString.obj());
  jni_generator::CheckException(env);
  return ret;
}
...
"Ljava/lang/String;",
  ...
  jstring ret =
static_cast<jstring>(env->CallStaticObjectMethod(ContentUriUtils_clazz(env),
          method_id, context.obj(), uriString.obj()));
  jni_generator::CheckException(env);
