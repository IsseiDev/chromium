...
jstring Java_org_chromium_base_FieldTrialList_nativeFindFullName(JNIEnv* env,
    jclass jcaller,
    jstring trialName) {
...
static jboolean TrialExists(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    const base::android::JavaParamRef<jstring>& trialName);

extern "C" __attribute__((visibility("default")))
jboolean Java_org_chromium_base_FieldTrialList_nativeTrialExists(JNIEnv* env,
    jclass jcaller,
    jstring trialName) {
