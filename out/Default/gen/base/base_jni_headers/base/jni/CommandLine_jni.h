...
static void Reset(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_CommandLine_nativeReset(JNIEnv* env, jclass jcaller)
    {
  return Reset(env, base::android::JavaParamRef<jclass>(env, jcaller));
}

static jboolean HasSwitch(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    const base::android::JavaParamRef<jstring>& switchString);

extern "C" __attribute__((visibility("default")))
jboolean Java_org_chromium_base_CommandLine_nativeHasSwitch(JNIEnv* env, jclass
    jcaller,
...
extern "C" __attribute__((visibility("default")))
jstring Java_org_chromium_base_CommandLine_nativeGetSwitchValue(JNIEnv* env,
    jclass jcaller,
    jstring switchString) {
...
static void AppendSwitch(JNIEnv* env, const base::android::JavaParamRef<jclass>&
    jcaller,
    const base::android::JavaParamRef<jstring>& switchString);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_CommandLine_nativeAppendSwitch(JNIEnv* env, jclass
    jcaller,
    jstring switchString) {
...
static void AppendSwitchWithValue(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    const base::android::JavaParamRef<jstring>& switchString,
    const base::android::JavaParamRef<jstring>& value);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_CommandLine_nativeAppendSwitchWithValue(JNIEnv* env,
    jclass jcaller,
    jstring switchString,
    jstring value) {
  return AppendSwitchWithValue(env, base::android::JavaParamRef<jclass>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, switchString),
      base::android::JavaParamRef<jstring>(env, value));
}

static void AppendSwitchesAndArguments(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    const base::android::JavaParamRef<jobjectArray>& array);

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_CommandLine_nativeAppendSwitchesAndArguments(JNIEnv*
    env, jclass jcaller,
    jobjectArray array) {
...
"("
")"
"V", reinterpret_cast<void*>(Java_org_chromium_base_CommandLine_nativeReset) },
    { "nativeHasSwitch",
"("
"Ljava/lang/String;"
")"
