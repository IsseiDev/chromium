...
static void Java_Callback_onResultFromNativeV_JLO(JNIEnv* env, const
...
static void Java_Callback_onResultFromNativeV_Z(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jboolean result) {
  CHECK_CLAZZ(env, obj.obj(),
      Callback_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static void Java_Callback_onResultFromNativeV_I(JNIEnv* env, const
