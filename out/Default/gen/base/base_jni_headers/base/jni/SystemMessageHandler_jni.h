...
base::subtle::AtomicWord g_SystemMessageHandler_clazz __attribute__((unused)) =
    0;
...
void Java_org_chromium_base_SystemMessageHandler_nativeDoRunLoopOnce(JNIEnv*
    env, jobject jcaller,
    jlong messagePumpDelegateNative,
    jlong messagePumpNative,
    jlong delayedScheduledTimeTicks) {
...
static void Java_SystemMessageHandler_scheduleDelayedWork(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jlong delayedTimeTicks,
    jlong millis) {
  CHECK_CLAZZ(env, obj.obj(),
      SystemMessageHandler_clazz(env));
  jmethodID method_id =
