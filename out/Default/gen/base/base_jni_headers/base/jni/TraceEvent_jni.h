...
void Java_org_chromium_base_TraceEvent_nativeRegisterEnabledObserver(JNIEnv*
    env, jclass jcaller) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeStartATrace(JNIEnv* env, jclass
    jcaller) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeStopATrace(JNIEnv* env, jclass
    jcaller) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeInstant(JNIEnv* env, jclass
    jcaller,
    jstring name,
    jstring arg) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeBegin(JNIEnv* env, jclass jcaller,
    jstring name,
    jstring arg) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeEnd(JNIEnv* env, jclass jcaller,
    jstring name,
    jstring arg) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeBeginToplevel(JNIEnv* env, jclass
    jcaller) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeEndToplevel(JNIEnv* env, jclass
    jcaller) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeStartAsync(JNIEnv* env, jclass
    jcaller,
    jstring name,
    jlong id) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_TraceEvent_nativeFinishAsync(JNIEnv* env, jclass
    jcaller,
    jstring name,
    jlong id) {
