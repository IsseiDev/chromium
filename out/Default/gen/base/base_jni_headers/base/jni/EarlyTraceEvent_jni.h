...
jlong Java_org_chromium_base_EarlyTraceEvent_nativeGetTimeTicksNowUs(JNIEnv*
    env, jclass jcaller) {
  return GetTimeTicksNowUs(env, base::android::JavaParamRef<jclass>(env,
      jcaller));
}

static void RecordEarlyEvent(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_base_EarlyTraceEvent_nativeRecordEarlyEvent(JNIEnv* env,
    jclass jcaller,
    jstring name,
    jlong beginTimeMs,
    jlong endTimeMs,
    jint threadId) {
  return RecordEarlyEvent(env, base::android::JavaParamRef<jclass>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, name), beginTimeMs,
      endTimeMs, threadId);
}
...
")"
"J",
    reinterpret_cast<void*>(Java_org_chromium_base_EarlyTraceEvent_nativeGetTimeTicksNowUs)
    },
