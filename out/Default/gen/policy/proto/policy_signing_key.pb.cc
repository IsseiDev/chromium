...
const PolicySigningKey& PolicySigningKey::default_instance() {
  ...
  protobuf_AddDesc_policy_5fsigning_5fkey_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_policy_5fsigning_5fkey_2eproto();
#endif
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_signing_key_signature;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_verification_key;
        break;
      }
