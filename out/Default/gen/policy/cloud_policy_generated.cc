...
void DecodePolicy(const em::CloudPolicySettings& policy,
  ...
  if (policy.has_defaultkeygensetting()) {
    const em::IntegerPolicyProto& policy_proto = policy.defaultkeygensetting();
    if (policy_proto.has_value()) {
      PolicyLevel level = POLICY_LEVEL_MANDATORY;
      bool do_set = true;
      if (policy_proto.has_policy_options()) {
      ...
      if (do_set) {
        ...
        if (value) {
          std::unique_ptr<ExternalDataFetcher>
              external_data_fetcher(nullptr);
          map->Set(key::kDefaultKeygenSetting, 
                   level, 
                   POLICY_SCOPE_USER, 
                   POLICY_SOURCE_CLOUD, 
                   std::move(value), 
  ...
  if (policy.has_keygenallowedforurls()) {
    const em::StringListPolicyProto& policy_proto = policy.keygenallowedforurls();
    if (policy_proto.has_value()) {
      PolicyLevel level = POLICY_LEVEL_MANDATORY;
      bool do_set = true;
      if (policy_proto.has_policy_options()) {
      ...
      if (do_set) {
        ...
        if (value) {
          std::unique_ptr<ExternalDataFetcher>
              external_data_fetcher(nullptr);
          map->Set(key::kKeygenAllowedForUrls, 
                   level, 
                   POLICY_SCOPE_USER, 
                   POLICY_SOURCE_CLOUD, 
                   std::move(value), 
  ...
  if (policy.has_keygenblockedforurls()) {
    const em::StringListPolicyProto& policy_proto = policy.keygenblockedforurls();
    if (policy_proto.has_value()) {
      PolicyLevel level = POLICY_LEVEL_MANDATORY;
      bool do_set = true;
      if (policy_proto.has_policy_options()) {
      ...
      if (do_set) {
        ...
        if (value) {
          std::unique_ptr<ExternalDataFetcher>
              external_data_fetcher(nullptr);
          map->Set(key::kKeygenBlockedForUrls, 
                   level, 
                   POLICY_SCOPE_USER, 
                   POLICY_SOURCE_CLOUD, 
                   std::move(value), 
