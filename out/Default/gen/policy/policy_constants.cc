...
//  is_deprecated  is_device_policy  id    max_external_data_size
  ...
  { false,         false,           331,                        0,
    { RISK_TAG_FILTERING, RISK_TAG_NONE, RISK_TAG_NONE } },
  // AlternateErrorPagesEnabled
  { false,         false,             5,                        0,
    { RISK_TAG_NONE, RISK_TAG_NONE, RISK_TAG_NONE } },
  ...
  { false,         false,           335,                        0,
    { RISK_TAG_SYSTEM_SECURITY, RISK_TAG_NONE, RISK_TAG_NONE } },
  ...
  { false,         false,            54,                        0,
    { RISK_TAG_WEBSITE_SHARING, RISK_TAG_NONE, RISK_TAG_NONE } },
  ...
  { false,         false,           313,                        0,
    { RISK_TAG_SYSTEM_SECURITY, RISK_TAG_WEBSITE_SHARING,
...
//  Type                          Extra
  { base::Value::TYPE_DICTIONARY,     2 },  // root node
  { base::Value::TYPE_STRING,        -1 },  // simple type: string
  { base::Value::TYPE_BOOLEAN,       -1 },  // simple type: boolean
  { base::Value::TYPE_LIST,           1 },  // simple type: stringlist
  { base::Value::TYPE_INTEGER,        0 },  // integer with enumeration restriction: DefaultCookiesSetting
  { base::Value::TYPE_INTEGER,        1 },  // integer with enumeration restriction (use range instead): DefaultGeolocationSetting
  { base::Value::TYPE_INTEGER,        2 },  // integer with enumeration restriction (use range instead): DefaultImagesSetting
  { base::Value::TYPE_INTEGER,        2 },  // integer with enumeration restriction (use range instead): DefaultJavaScriptSetting
  { base::Value::TYPE_INTEGER,        2 },  // integer with enumeration restriction (use range instead): DefaultKeygenSetting
  { base::Value::TYPE_INTEGER,        2 },  // integer with enumeration restriction (use range instead): DefaultPopupsSetting
  { base::Value::TYPE_INTEGER,        3 },  // integer with enumeration restriction (use range instead): DefaultWebBluetoothGuardSetting
  { base::Value::TYPE_INTEGER,        4 },  // integer with enumeration restriction (use range instead): IncognitoModeAvailability
  { base::Value::TYPE_DICTIONARY,     0 },  // items of ManagedBookmarks
  { base::Value::TYPE_LIST,          12 },  // 
  { base::Value::TYPE_LIST,          12 },  // 
  { base::Value::TYPE_INTEGER,        4 },  // integer with enumeration restriction (use range instead): NetworkPredictionOptions
  { base::Value::TYPE_STRING,         5 },  // string with enumeration restriction: ProxyMode
  { base::Value::TYPE_INTEGER,        6 },  // integer with enumeration restriction (use range instead): ProxyServerMode
  { base::Value::TYPE_DICTIONARY,     1 },  // ProxySettings
};
...
//  Property                                          #Schema
  ...
  { key::kDefaultKeygenSetting,                             8 },
  { key::kDefaultPopupsSetting,                             9 },
  ...
  { key::kDefaultWebBluetoothGuardSetting,                 10 },
  ...
  { key::kKeygenAllowedForUrls,                             3 },
  { key::kKeygenBlockedForUrls,                             3 },
