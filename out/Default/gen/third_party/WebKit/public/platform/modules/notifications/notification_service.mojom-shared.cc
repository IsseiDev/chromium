...
bool NotificationService_GetPermissionStatus_Params_Data::Validate(
  ...
  const NotificationService_GetPermissionStatus_Params_Data* object = static_cast<const NotificationService_GetPermissionStatus_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->origin, "null origin field in NotificationService_GetPermissionStatus_Params",
          validation_context)) {
    return false;
  }
...
bool NotificationService_GetPermissionStatus_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const NotificationService_GetPermissionStatus_ResponseParams_Data* object = static_cast<const NotificationService_GetPermissionStatus_ResponseParams_Data*>(data);
