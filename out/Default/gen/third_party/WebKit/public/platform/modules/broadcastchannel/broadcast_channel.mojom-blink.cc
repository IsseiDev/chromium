...
class BroadcastChannelProvider_ConnectToChannel_ParamsDataView {
 public:
  ...
  BroadcastChannelClientAssociatedPtrInfo TakeReceiver() {
    ...
    bool ret =
        mojo::internal::Deserialize<::blink::mojom::blink::BroadcastChannelClientAssociatedPtrInfo>(
  ...
  BroadcastChannelClientAssociatedRequest TakeSender() {
    ...
    bool ret =
        mojo::internal::Deserialize<::blink::mojom::blink::BroadcastChannelClientAssociatedRequest>(
...
void BroadcastChannelClientProxy::OnMessage(
    mojo::WTFArray<uint8_t> in_message) {
...
bool BroadcastChannelClientStub::Accept(mojo::Message* message) {
  ...
  switch (message->header()->name) {
    case internal::kBroadcastChannelClient_OnMessage_Name: {
      ...
      bool success = true;
      mojo::WTFArray<uint8_t> p_message{};
...
void BroadcastChannelProviderProxy::ConnectToChannel(
  ...
  mojo::internal::Serialize<::blink::mojom::blink::BroadcastChannelClientAssociatedPtrInfo>(
  ...
  mojo::internal::Serialize<::blink::mojom::blink::BroadcastChannelClientAssociatedRequest>(
