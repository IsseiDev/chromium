...
#pragma pack(push, 1)
const uint32_t kShareService_Share_Name = 0;
class ShareService_Share_Params_Data {
 ...
 private:
  ShareService_Share_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~ShareService_Share_Params_Data() = delete;
};
static_assert(sizeof(ShareService_Share_Params_Data) == 24,
...
class ShareService_Share_ResponseParams_Data {
 ...
 private:
  ShareService_Share_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
