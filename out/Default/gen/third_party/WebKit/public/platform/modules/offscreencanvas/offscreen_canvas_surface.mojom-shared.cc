...
// static
bool OffscreenCanvasSurface_GetSurfaceId_Params_Data::Validate(
    const void* data,
  ...
  const OffscreenCanvasSurface_GetSurfaceId_Params_Data* object = static_cast<const OffscreenCanvasSurface_GetSurfaceId_Params_Data*>(data);
...
// static
bool OffscreenCanvasSurface_GetSurfaceId_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const OffscreenCanvasSurface_GetSurfaceId_ResponseParams_Data* object = static_cast<const OffscreenCanvasSurface_GetSurfaceId_ResponseParams_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->surface_id, "null surface_id field in OffscreenCanvasSurface_GetSurfaceId_ResponseParams",
          validation_context)) {
    return false;
  }
...
// static
bool OffscreenCanvasSurface_RequestSurfaceCreation_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const OffscreenCanvasSurface_RequestSurfaceCreation_Params_Data* object = static_cast<const OffscreenCanvasSurface_RequestSurfaceCreation_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->surface_id, "null surface_id field in OffscreenCanvasSurface_RequestSurfaceCreation_Params",
          validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->surface_id, validation_context))
