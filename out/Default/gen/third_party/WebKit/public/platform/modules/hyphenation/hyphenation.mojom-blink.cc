...
bool Hyphenation::OpenDictionary(const WTF::String& locale, mojo::ScopedHandle* hyphenation_dictionary_handle) {
  NOTREACHED();
  return false;
}
...
bool HyphenationProxy::OpenDictionary(
    const WTF::String& param_locale, mojo::ScopedHandle* param_hyphenation_dictionary_handle) {
