...
class SyncRegistration_Data {
 ...
 private:
  SyncRegistration_Data() : header_({sizeof(*this), 0}) {
  }
...
class BackgroundSyncService_Register_Params_Data {
 ...
 private:
  BackgroundSyncService_Register_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class BackgroundSyncService_Register_ResponseParams_Data {
 ...
 private:
  BackgroundSyncService_Register_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kBackgroundSyncService_GetRegistrations_Name = 1;
class BackgroundSyncService_GetRegistrations_Params_Data {
 ...
 private:
  BackgroundSyncService_GetRegistrations_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class BackgroundSyncService_GetRegistrations_ResponseParams_Data {
 ...
 private:
  BackgroundSyncService_GetRegistrations_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
class BackgroundSyncServiceClient_Sync_Params_Data {
 ...
 private:
  BackgroundSyncServiceClient_Sync_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class BackgroundSyncServiceClient_Sync_ResponseParams_Data {
 ...
 private:
  BackgroundSyncServiceClient_Sync_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
