...
class CONTENT_EXPORT OffscreenCanvasSurfaceStub : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
 public:
...
class CONTENT_EXPORT OffscreenCanvasSurfaceRequestValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
  explicit OffscreenCanvasSurfaceRequestValidator(mojo::MessageReceiver* sink = nullptr);

  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT OffscreenCanvasSurfaceResponseValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
