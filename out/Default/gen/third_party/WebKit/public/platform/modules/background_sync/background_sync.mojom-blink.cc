...
#include "third_party/WebKit/public/platform/modules/background_sync/background_sync.mojom-blink.h"
...
class BackgroundSyncService_Register_ParamsDataView {
 public:
  ...
  bool ReadOptions(UserType* output) {
    ...
    return mojo::internal::Deserialize<::blink::mojom::blink::SyncRegistrationPtr>(
...
class BackgroundSyncService_Register_ResponseParamsDataView {
 public:
  ...
  bool ReadErr(UserType* output) const {
    ...
    return mojo::internal::Deserialize<::blink::mojom::blink::BackgroundSyncError>(
        data_value, output);
  }

  ::blink::mojom::blink::BackgroundSyncError err() const {
    return static_cast<::blink::mojom::blink::BackgroundSyncError>(data_->err);
  }
  inline void GetOptionsDataView(
      SyncRegistrationDataView* output);
...
class BackgroundSyncService_GetRegistrations_ResponseParamsDataView {
 public:
  ...
  bool ReadRegistrations(UserType* output) {
    ...
    return mojo::internal::Deserialize<mojo::Array<::blink::mojom::blink::SyncRegistrationPtr>>(
        pointer, output, context_);
  }
 private:
...
class BackgroundSyncServiceClient_Sync_ParamsDataView {
 public:
  ...
  bool ReadLastChance(UserType* output) const {
    ...
    return mojo::internal::Deserialize<::blink::mojom::blink::BackgroundSyncEventLastChance>(
        data_value, output);
  }

  ::blink::mojom::blink::BackgroundSyncEventLastChance last_chance() const {
    return static_cast<::blink::mojom::blink::BackgroundSyncEventLastChance>(data_->last_chance);
  }
 private:
...
class BackgroundSyncServiceClient_Sync_ResponseParamsDataView {
 public:
  ...
  bool ReadStatus(UserType* output) const {
    ...
    return mojo::internal::Deserialize<::blink::mojom::blink::ServiceWorkerEventStatus>(
        data_value, output);
  }

  ::blink::mojom::blink::ServiceWorkerEventStatus status() const {
    return static_cast<::blink::mojom::blink::ServiceWorkerEventStatus>(data_->status);
  }
 private:
...
bool BackgroundSyncService_GetRegistrations_ForwardToCallback::Accept(
  ...
  bool success = true;
  BackgroundSyncError p_err{};
  mojo::WTFArray<SyncRegistrationPtr> p_registrations{};
...
void BackgroundSyncServiceProxy::Register(
  ...
  size += mojo::internal::PrepareToSerialize<::blink::mojom::blink::SyncRegistrationPtr>(
  ...
  mojo::internal::Serialize<::blink::mojom::blink::SyncRegistrationPtr>(
...
void BackgroundSyncService_Register_ProxyToResponder::Run(
  ...
  ALLOW_UNUSED_LOCAL(params);
  mojo::internal::Serialize<::blink::mojom::blink::BackgroundSyncError>(
      in_err, &params->err);
  typename decltype(params->options)::BaseType* options_ptr;
  mojo::internal::Serialize<::blink::mojom::blink::SyncRegistrationPtr>(
      in_options, builder.buffer(), &options_ptr, &serialization_context_);
...
class BackgroundSyncService_GetRegistrations_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      BackgroundSyncError in_err, mojo::WTFArray<SyncRegistrationPtr> in_registrations);
...
void BackgroundSyncService_GetRegistrations_ProxyToResponder::Run(
  ...
  size += mojo::internal::PrepareToSerialize<mojo::Array<::blink::mojom::blink::SyncRegistrationPtr>>(
  ...
  const mojo::internal::ContainerValidateParams registrations_validate_params(
      0, false, nullptr);
  mojo::internal::Serialize<mojo::Array<::blink::mojom::blink::SyncRegistrationPtr>>(
...
void BackgroundSyncServiceClientProxy::Sync(
    const WTF::String& in_tag, BackgroundSyncEventLastChance in_last_chance, const SyncCallback& callback) {
  ...
  mojo::internal::Serialize<::blink::mojom::blink::BackgroundSyncEventLastChance>(
...
void BackgroundSyncServiceClient_Sync_ProxyToResponder::Run(
  ...
  ALLOW_UNUSED_LOCAL(params);
  mojo::internal::Serialize<::blink::mojom::blink::ServiceWorkerEventStatus>(
...
// static
bool StructTraits<::blink::mojom::blink::SyncRegistration, ::blink::mojom::blink::SyncRegistrationPtr>::Read(
    ::blink::mojom::blink::SyncRegistrationDataView input,
