...
define("third_party/WebKit/public/platform/modules/notifications/notification_service.mojom", [
...
], function(bindings, codec, connection, core, validator, permission_status$) {
  ...
  NotificationService_GetPermissionStatus_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, NotificationService_GetPermissionStatus_Params.encodedSize, 0);
  ...
  NotificationService_GetPermissionStatus_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, NotificationService_GetPermissionStatus_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NotificationServiceStub.prototype.getPermissionStatus = function(origin) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.getPermissionStatus && bindings.StubBindings(this).delegate.getPermissionStatus(origin);
  }
