...
bool PermissionService_HasPermission_Params_Data::Validate(
  ...
  if (!::blink::mojom::internal::PermissionName_Data
        ::Validate(object->permission, validation_context))
    return false;
...
// static
bool PermissionService_GetNextPermissionChange_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->origin, "null origin field in PermissionService_GetNextPermissionChange_Params",
          validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->origin, validation_context))
...
// static
bool PermissionService_GetNextPermissionChange_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
