...
#include "third_party/WebKit/public/platform/modules/notifications/notification_service.mojom-blink.h"
...
bool NotificationService::GetPermissionStatus(const WTF::String& origin, ::blink::mojom::blink::PermissionStatus* status) {
  NOTREACHED();
  return false;
}
class NotificationService_GetPermissionStatus_HandleSyncResponse
 ...
 private:
  ...
  bool* result_;
  ::blink::mojom::blink::PermissionStatus* out_status_;DISALLOW_COPY_AND_ASSIGN(NotificationService_GetPermissionStatus_HandleSyncResponse);
};
...
bool NotificationServiceProxy::GetPermissionStatus(
    const WTF::String& param_origin, ::blink::mojom::blink::PermissionStatus* param_status) {
...
void NotificationServiceProxy::GetPermissionStatus(
    const WTF::String& in_origin, const GetPermissionStatusCallback& callback) {
  size_t size = sizeof(::blink::mojom::internal::NotificationService_GetPermissionStatus_Params_Data);
  size += mojo::internal::PrepareToSerialize<mojo::String>(
