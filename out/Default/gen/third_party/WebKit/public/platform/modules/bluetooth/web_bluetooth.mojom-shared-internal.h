...
#include "device/bluetooth/public/interfaces/bluetooth_uuid.mojom-shared-internal.h"
...
class WebBluetoothScanFilter_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::device::mojom::internal::BluetoothUUID_Data>>> services;
  mojo::internal::Pointer<mojo::internal::String_Data> name;
  mojo::internal::Pointer<mojo::internal::String_Data> name_prefix;

 private:
  WebBluetoothScanFilter_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothRequestDeviceOptions_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::device::mojom::internal::BluetoothUUID_Data>>> optional_services;

 private:
  WebBluetoothRequestDeviceOptions_Data() : header_({sizeof(*this), 0}) {
  }
  ~WebBluetoothRequestDeviceOptions_Data() = delete;
};
static_assert(sizeof(WebBluetoothRequestDeviceOptions_Data) == 24,
...
class WebBluetoothDeviceId_Data {
 ...
 private:
  WebBluetoothDeviceId_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothDevice_Data {
 ...
 private:
  WebBluetoothDevice_Data() : header_({sizeof(*this), 0}) {
  }
  ~WebBluetoothDevice_Data() = delete;
};
static_assert(sizeof(WebBluetoothDevice_Data) == 32,
...
class WebBluetoothRemoteGATTService_Data {
 ...
 private:
  WebBluetoothRemoteGATTService_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothRemoteGATTCharacteristic_Data {
 ...
 private:
  WebBluetoothRemoteGATTCharacteristic_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_SetClient_Name = 0;
class WebBluetoothService_SetClient_Params_Data {
 ...
 private:
  WebBluetoothService_SetClient_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RequestDevice_Name = 1;
class WebBluetoothService_RequestDevice_Params_Data {
 ...
 private:
  WebBluetoothService_RequestDevice_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RequestDevice_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RequestDevice_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteServerConnect_Name = 2;
class WebBluetoothService_RemoteServerConnect_Params_Data {
 ...
 private:
  WebBluetoothService_RemoteServerConnect_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RemoteServerConnect_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RemoteServerConnect_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteServerDisconnect_Name = 3;
class WebBluetoothService_RemoteServerDisconnect_Params_Data {
 ...
 private:
  WebBluetoothService_RemoteServerDisconnect_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteServerGetPrimaryServices_Name = 4;
class WebBluetoothService_RemoteServerGetPrimaryServices_Params_Data {
 public:
  ...
  int32_t quantity;
  uint8_t pad1_[4];
  mojo::internal::Pointer<::device::mojom::internal::BluetoothUUID_Data> services_uuid;

 private:
  WebBluetoothService_RemoteServerGetPrimaryServices_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RemoteServerGetPrimaryServices_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RemoteServerGetPrimaryServices_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteServiceGetCharacteristics_Name = 5;
class WebBluetoothService_RemoteServiceGetCharacteristics_Params_Data {
 public:
  ...
  int32_t quantity;
  uint8_t pad1_[4];
  mojo::internal::Pointer<::device::mojom::internal::BluetoothUUID_Data> characteristics_uuid;

 private:
  WebBluetoothService_RemoteServiceGetCharacteristics_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RemoteServiceGetCharacteristics_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RemoteServiceGetCharacteristics_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteCharacteristicReadValue_Name = 6;
class WebBluetoothService_RemoteCharacteristicReadValue_Params_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicReadValue_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RemoteCharacteristicReadValue_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicReadValue_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteCharacteristicWriteValue_Name = 7;
class WebBluetoothService_RemoteCharacteristicWriteValue_Params_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicWriteValue_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RemoteCharacteristicWriteValue_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicWriteValue_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteCharacteristicStartNotifications_Name = 8;
class WebBluetoothService_RemoteCharacteristicStartNotifications_Params_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicStartNotifications_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RemoteCharacteristicStartNotifications_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicStartNotifications_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothService_RemoteCharacteristicStopNotifications_Name = 9;
class WebBluetoothService_RemoteCharacteristicStopNotifications_Params_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicStopNotifications_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebBluetoothService_RemoteCharacteristicStopNotifications_ResponseParams_Data {
 ...
 private:
  WebBluetoothService_RemoteCharacteristicStopNotifications_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothServiceClient_RemoteCharacteristicValueChanged_Name = 0;
class WebBluetoothServiceClient_RemoteCharacteristicValueChanged_Params_Data {
 ...
 private:
  WebBluetoothServiceClient_RemoteCharacteristicValueChanged_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebBluetoothServiceClient_GattServerDisconnected_Name = 1;
class WebBluetoothServiceClient_GattServerDisconnected_Params_Data {
 ...
 private:
  WebBluetoothServiceClient_GattServerDisconnected_Params_Data() : header_({sizeof(*this), 0}) {
  }
