...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_REQUEST_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_REQUEST_MOJOM_SHARED_INTERNAL_H_
...
class PaymentAddress_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::String_Data> careOf;
  mojo::internal::Pointer<mojo::internal::String_Data> phone;

 private:
  PaymentAddress_Data() : header_({sizeof(*this), 0}) {
  }
  ~PaymentAddress_Data() = delete;
};
static_assert(sizeof(PaymentAddress_Data) == 112,
...
class PaymentCurrencyAmount_Data {
 ...
 private:
  PaymentCurrencyAmount_Data() : header_({sizeof(*this), 0}) {
  }
...
class PaymentResponse_Data {
 ...
 private:
  PaymentResponse_Data() : header_({sizeof(*this), 0}) {
  }
  ~PaymentResponse_Data() = delete;
};
static_assert(sizeof(PaymentResponse_Data) == 56,
...
class PaymentItem_Data {
 ...
 private:
  PaymentItem_Data() : header_({sizeof(*this), 0}) {
  }
  ~PaymentItem_Data() = delete;
};
static_assert(sizeof(PaymentItem_Data) == 24,
...
class PaymentShippingOption_Data {
 ...
 private:
  PaymentShippingOption_Data() : header_({sizeof(*this), 0}) {
  }
...
class PaymentDetailsModifier_Data {
 ...
 private:
  PaymentDetailsModifier_Data() : header_({sizeof(*this), 0}) {
  }
...
class PaymentDetails_Data {
 ...
 private:
  PaymentDetails_Data() : header_({sizeof(*this), 0}) {
  }
  ~PaymentDetails_Data() = delete;
};
static_assert(sizeof(PaymentDetails_Data) == 40,
...
class PaymentOptions_Data {
 ...
 private:
  PaymentOptions_Data() : header_({sizeof(*this), 0}) {
  }
...
class PaymentMethodData_Data {
 ...
 private:
  PaymentMethodData_Data() : header_({sizeof(*this), 0}) {
  }
  ~PaymentMethodData_Data() = delete;
};
static_assert(sizeof(PaymentMethodData_Data) == 24,
              "Bad sizeof(PaymentMethodData_Data)");
const uint32_t kPaymentRequestClient_OnShippingAddressChange_Name = 0;
class PaymentRequestClient_OnShippingAddressChange_Params_Data {
 ...
 private:
  PaymentRequestClient_OnShippingAddressChange_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequestClient_OnShippingOptionChange_Name = 1;
class PaymentRequestClient_OnShippingOptionChange_Params_Data {
 ...
 private:
  PaymentRequestClient_OnShippingOptionChange_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequestClient_OnPaymentResponse_Name = 2;
class PaymentRequestClient_OnPaymentResponse_Params_Data {
 ...
 private:
  PaymentRequestClient_OnPaymentResponse_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequestClient_OnError_Name = 3;
class PaymentRequestClient_OnError_Params_Data {
 ...
 private:
  PaymentRequestClient_OnError_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequestClient_OnComplete_Name = 4;
class PaymentRequestClient_OnComplete_Params_Data {
 ...
 private:
  PaymentRequestClient_OnComplete_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequestClient_OnAbort_Name = 5;
class PaymentRequestClient_OnAbort_Params_Data {
 ...
 private:
  PaymentRequestClient_OnAbort_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequest_SetClient_Name = 0;
class PaymentRequest_SetClient_Params_Data {
 public:
  static PaymentRequest_SetClient_Params_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(PaymentRequest_SetClient_Params_Data))) PaymentRequest_SetClient_Params_Data();
  }
 ...
 private:
  PaymentRequest_SetClient_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~PaymentRequest_SetClient_Params_Data() = delete;
};
static_assert(sizeof(PaymentRequest_SetClient_Params_Data) == 16,
              "Bad sizeof(PaymentRequest_SetClient_Params_Data)");
const uint32_t kPaymentRequest_Show_Name = 1;
class PaymentRequest_Show_Params_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<internal::PaymentMethodData_Data>>> methodData;
  mojo::internal::Pointer<internal::PaymentDetails_Data> details;
  mojo::internal::Pointer<internal::PaymentOptions_Data> options;

 private:
  PaymentRequest_Show_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~PaymentRequest_Show_Params_Data() = delete;
};
static_assert(sizeof(PaymentRequest_Show_Params_Data) == 32,
              "Bad sizeof(PaymentRequest_Show_Params_Data)");
const uint32_t kPaymentRequest_UpdateWith_Name = 2;
class PaymentRequest_UpdateWith_Params_Data {
 ...
 private:
  PaymentRequest_UpdateWith_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequest_Abort_Name = 3;
class PaymentRequest_Abort_Params_Data {
 ...
 private:
  PaymentRequest_Abort_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPaymentRequest_Complete_Name = 4;
class PaymentRequest_Complete_Params_Data {
 ...
 private:
  PaymentRequest_Complete_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_PAYMENTS_PAYMENT_REQUEST_MOJOM_SHARED_INTERNAL_H_