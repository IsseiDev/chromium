...
class OffscreenCanvasSurface_Require_ParamsDataView {
 public:
  ...
  bool ReadSequence(UserType* output) {
    ...
    return mojo::internal::Deserialize<::cc::mojom::SurfaceSequencePtr>(
        pointer, output, context_);
  }
 private:
...
void OffscreenCanvasSurfaceProxy::Require(
  ...
  size += mojo::internal::PrepareToSerialize<::cc::mojom::SurfaceIdPtr>(
      in_surface_id, &serialization_context_);
  size += mojo::internal::PrepareToSerialize<::cc::mojom::SurfaceSequencePtr>(
  ...
  mojo::internal::Serialize<::cc::mojom::SurfaceSequencePtr>(
