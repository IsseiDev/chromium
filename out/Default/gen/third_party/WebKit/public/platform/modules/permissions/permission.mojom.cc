...
class PermissionService_HasPermission_ParamsDataView {
 public:
  ...
  ::blink::mojom::PermissionName permission() const {
    return static_cast<::blink::mojom::PermissionName>(data_->permission);
  }
...
class PermissionService_RequestPermissions_ParamsDataView {
 public:
  ...
  bool ReadPermission(UserType* output) {
    ...
    return mojo::internal::Deserialize<mojo::Array<::blink::mojom::PermissionName>>(
        pointer, output, context_);
  }
  inline void GetOriginDataView(
      ::url::mojom::OriginDataView* output);
...
class PermissionService_RequestPermissions_ResponseParamsDataView {
 public:
  ...
  bool ReadStatuses(UserType* output) {
    ...
    return mojo::internal::Deserialize<mojo::Array<::blink::mojom::PermissionStatus>>(
        pointer, output, context_);
  }
 private:
...
void PermissionServiceProxy::HasPermission(
    PermissionName in_permission, const url::Origin& in_origin, const HasPermissionCallback& callback) {
...
void PermissionServiceProxy::RequestPermission(
    PermissionName in_permission, const url::Origin& in_origin, bool in_user_gesture, const RequestPermissionCallback& callback) {
...
void PermissionServiceProxy::RequestPermissions(
    const std::vector<PermissionName>& in_permission, const url::Origin& in_origin, bool in_user_gesture, const RequestPermissionsCallback& callback) {
  size_t size = sizeof(::blink::mojom::internal::PermissionService_RequestPermissions_Params_Data);
  size += mojo::internal::PrepareToSerialize<mojo::Array<::blink::mojom::PermissionName>>(
  ...
  mojo::internal::Serialize<mojo::Array<::blink::mojom::PermissionName>>(
...
void PermissionServiceProxy::RevokePermission(
    PermissionName in_permission, const url::Origin& in_origin, const RevokePermissionCallback& callback) {
...
void PermissionServiceProxy::GetNextPermissionChange(
    PermissionName in_permission, const url::Origin& in_origin, ::blink::mojom::PermissionStatus in_last_known_status, const GetNextPermissionChangeCallback& callback) {
...
void PermissionService_RequestPermissions_ProxyToResponder::Run(
  ...
  size += mojo::internal::PrepareToSerialize<mojo::Array<::blink::mojom::PermissionStatus>>(
  ...
  mojo::internal::Serialize<mojo::Array<::blink::mojom::PermissionStatus>>(
...
std::move(p_user_gesture), callback);
    ...
    case internal::kPermissionService_RequestPermissions_Name: {
      ...
      (&serialization_context_)->handles.Swap((message)->mutable_handles());
      bool success = true;
      std::vector<PermissionName> p_permission{};
      url::Origin p_origin{};
      bool p_user_gesture{};
