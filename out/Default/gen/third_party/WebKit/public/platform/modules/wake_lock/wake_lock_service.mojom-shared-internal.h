...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_WAKE_LOCK_WAKE_LOCK_SERVICE_MOJOM_SHARED_INTERNAL_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_WAKE_LOCK_WAKE_LOCK_SERVICE_MOJOM_SHARED_INTERNAL_H_
...
class WakeLockService_RequestWakeLock_Params_Data {
 ...
 private:
  WakeLockService_RequestWakeLock_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WakeLockService_CancelWakeLock_Params_Data {
 ...
 private:
  WakeLockService_CancelWakeLock_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_WAKE_LOCK_WAKE_LOCK_SERVICE_MOJOM_SHARED_INTERNAL_H_