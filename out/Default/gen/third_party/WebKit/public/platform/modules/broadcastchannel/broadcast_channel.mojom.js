...
define("third_party/WebKit/public/platform/modules/broadcastchannel/broadcast_channel.mojom", [
...
], function(bindings, codec, connection, core, validator, origin$) {
  ...
  BroadcastChannelClient_OnMessage_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, BroadcastChannelClient_OnMessage_Params.encodedSize, 0);
  ...
  BroadcastChannelProvider_ConnectToChannel_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, BroadcastChannelProvider_ConnectToChannel_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  BroadcastChannelClientProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  BroadcastChannelClientStub.prototype = Object.create(bindings.StubBase.prototype);
  ...
  BroadcastChannelProviderProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  BroadcastChannelProviderStub.prototype = Object.create(bindings.StubBase.prototype);
  BroadcastChannelProviderStub.prototype.connectToChannel = function(origin, name, receiver, sender) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.connectToChannel && bindings.StubBindings(this).delegate.connectToChannel(origin, name, receiver, sender);
  }
