...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_WAKE_LOCK_WAKE_LOCK_SERVICE_MOJOM_BLINK_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_WAKE_LOCK_WAKE_LOCK_SERVICE_MOJOM_BLINK_H_
...
class BLINK_PLATFORM_EXPORT WakeLockService {
 public:
...
class BLINK_PLATFORM_EXPORT WakeLockServiceProxy
...
class BLINK_PLATFORM_EXPORT WakeLockServiceStub : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
 public:
  WakeLockServiceStub();
...
class BLINK_PLATFORM_EXPORT WakeLockServiceRequestValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
...
#endif  // THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_MODULES_WAKE_LOCK_WAKE_LOCK_SERVICE_MOJOM_BLINK_H_