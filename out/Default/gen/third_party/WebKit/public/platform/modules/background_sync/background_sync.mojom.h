...
class CONTENT_EXPORT BackgroundSyncService {
 public:
  ...
  using GetRegistrationsCallback = base::Callback<void(BackgroundSyncError, mojo::Array<SyncRegistrationPtr>)>;
...
class CONTENT_EXPORT BackgroundSyncServiceClient {
 public:
  static const char Name_[];
  static const uint32_t Version_ = 0;
  static const bool PassesAssociatedKinds_ = false;
  ...
  using SyncCallback = base::Callback<void(::blink::mojom::ServiceWorkerEventStatus)>;
  virtual void Sync(const mojo::String& tag, BackgroundSyncEventLastChance last_chance, const SyncCallback& callback) = 0;
};
...
class CONTENT_EXPORT BackgroundSyncServiceClientProxy
    : public BackgroundSyncServiceClient,
      public NON_EXPORTED_BASE(mojo::internal::ControlMessageProxy) {
 public:
  explicit BackgroundSyncServiceClientProxy(mojo::MessageReceiverWithResponder* receiver);
  void Sync(const mojo::String& tag, BackgroundSyncEventLastChance last_chance, const SyncCallback& callback) override;
...
class CONTENT_EXPORT BackgroundSyncServiceStub : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
 public:
...
class CONTENT_EXPORT BackgroundSyncServiceClientStub : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
 public:
...
class CONTENT_EXPORT BackgroundSyncServiceRequestValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
  explicit BackgroundSyncServiceRequestValidator(mojo::MessageReceiver* sink = nullptr);

  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT BackgroundSyncServiceClientRequestValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
  explicit BackgroundSyncServiceClientRequestValidator(mojo::MessageReceiver* sink = nullptr);

  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT BackgroundSyncServiceResponseValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
  explicit BackgroundSyncServiceResponseValidator(mojo::MessageReceiver* sink = nullptr);

  bool Accept(mojo::Message* message) override;
};
class CONTENT_EXPORT BackgroundSyncServiceClientResponseValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
 ...
 public:
  ...
  static mojo::Array<uint8_t> Serialize(UserType* input) {
    return mojo::internal::StructSerializeImpl<
        SyncRegistrationPtr, mojo::Array<uint8_t>>(input);
  }
  ...
  static bool Deserialize(const mojo::Array<uint8_t>& input,
    ...
    return mojo::internal::StructDeserializeImpl<
        SyncRegistrationPtr, mojo::Array<uint8_t>>(
            input, output);
  }
...
class SyncRegistrationDataView {
 public:
  ...
  ::blink::mojom::BackgroundSyncNetworkState network_state() const {
    return static_cast<::blink::mojom::BackgroundSyncNetworkState>(data_->network_state);
  }
 private:
...
namespace internal {
template <>
struct DataViewTraits<::blink::mojom::SyncRegistrationDataView> {
  using MojomType = ::blink::mojom::SyncRegistrationPtr;
};
}  // namespace internal
}  // namespace mojo
...
template <>
struct CONTENT_EXPORT StructTraits<::blink::mojom::SyncRegistration, ::blink::mojom::SyncRegistrationPtr> {
  ...
  static decltype(::blink::mojom::SyncRegistration::tag)& tag(
      ::blink::mojom::SyncRegistrationPtr& input) {
    return input->tag;
  }
  ...
  static bool Read(::blink::mojom::SyncRegistrationDataView input, ::blink::mojom::SyncRegistrationPtr* output);
};

namespace internal {

template <typename MaybeConstUserType>
struct Serializer<::blink::mojom::SyncRegistrationPtr, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::blink::mojom::SyncRegistration, UserType>;
