...
bool PaymentAddress_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->careOf, "null careOf field in PaymentAddress",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams careOf_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->careOf, validation_context,
                                         &careOf_validate_params)) {
    return false;
  }
...
bool PaymentDetailsModifier_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->supported_methods, "null supported_methods field in PaymentDetailsModifier",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->total, "null total field in PaymentDetailsModifier",
          validation_context)) {
    return false;
  }
...
bool PaymentRequestClient_OnError_Params_Data::Validate(
  ...
  if (!::blink::mojom::internal::PaymentErrorReason_Data
...
// static
bool PaymentRequest_SetClient_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const PaymentRequest_SetClient_Params_Data* object = static_cast<const PaymentRequest_SetClient_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->client,
          "invalid client field in PaymentRequest_SetClient_Params", validation_context)) {
    return false;
  }
...
bool PaymentRequest_Show_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->methodData, "null methodData field in PaymentRequest_Show_Params",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->details, "null details field in PaymentRequest_Show_Params",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->options, "null options field in PaymentRequest_Show_Params",
          validation_context)) {
    return false;
  }
...
bool PaymentRequest_Complete_Params_Data::Validate(
  ...
  if (!::blink::mojom::internal::PaymentComplete_Data
