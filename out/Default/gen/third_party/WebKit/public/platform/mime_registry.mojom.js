...
define("third_party/WebKit/public/platform/mime_registry.mojom", [
  ...
  MimeRegistry_GetMimeTypeFromExtension_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, MimeRegistry_GetMimeTypeFromExtension_Params.encodedSize, 0);
  ...
  MimeRegistry_GetMimeTypeFromExtension_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, MimeRegistry_GetMimeTypeFromExtension_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MimeRegistryProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  MimeRegistryStub.prototype = Object.create(bindings.StubBase.prototype);
  MimeRegistryStub.prototype.getMimeTypeFromExtension = function(extension) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.getMimeTypeFromExtension && bindings.StubBindings(this).delegate.getMimeTypeFromExtension(extension);
  }
