...
bool MimeRegistry::GetMimeTypeFromExtension(const mojo::String& extension, mojo::String* mime_type) {
  NOTREACHED();
  return false;
}
class MimeRegistry_GetMimeTypeFromExtension_HandleSyncResponse
 ...
 public:
  MimeRegistry_GetMimeTypeFromExtension_HandleSyncResponse(
      ...
      bool* result, mojo::String* out_mime_type)
 ...
 private:
  ...
  bool* result_;
  mojo::String* out_mime_type_;DISALLOW_COPY_AND_ASSIGN(MimeRegistry_GetMimeTypeFromExtension_HandleSyncResponse);
};
...
bool MimeRegistryProxy::GetMimeTypeFromExtension(
    const mojo::String& param_extension, mojo::String* param_mime_type) {
...
void MimeRegistryProxy::GetMimeTypeFromExtension(
    const mojo::String& in_extension, const GetMimeTypeFromExtensionCallback& callback) {
  size_t size = sizeof(::blink::mojom::internal::MimeRegistry_GetMimeTypeFromExtension_Params_Data);
  size += mojo::internal::PrepareToSerialize<mojo::String>(
