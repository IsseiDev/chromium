...
void protobuf_AssignDesc_chunk_2eproto();
...
class ChunkData : public ::google::protobuf::MessageLite {
 public:
  ChunkData();
  virtual ~ChunkData();
 ...
 private:
  ...
  int prefix_type_;
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_chunk_2eproto_impl();
  #else
  friend void  protobuf_AddDesc_chunk_2eproto();
  #endif
  friend void protobuf_AssignDesc_chunk_2eproto();
  friend void protobuf_ShutdownFile_chunk_2eproto();
