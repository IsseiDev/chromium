...
void
    Java_org_chromium_chrome_browser_ServiceTabLauncher_nativeOnWebContentsForRequestAvailable(JNIEnv*
    env, jclass jcaller,
    jint requestId,
    jobject webContents) {
...
"V",
     ...
     env->CallStaticVoidMethod(ServiceTabLauncher_clazz(env),
          method_id, context.obj(), as_jint(requestId), incognito, url.obj(),
              as_jint(disposition), referrerUrl.obj(), as_jint(referrerPolicy),
              extraHeaders.obj(), postData.obj());
...
")"
"V",
    reinterpret_cast<void*>(Java_org_chromium_chrome_browser_ServiceTabLauncher_nativeOnWebContentsForRequestAvailable)
    },
};
