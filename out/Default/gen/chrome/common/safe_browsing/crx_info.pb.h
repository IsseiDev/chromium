...
class ClientCRXListInfoRequest : public ::google::protobuf::MessageLite {
 public:
  ...
  inline ClientCRXListInfoRequest* New() const { return New(NULL); }

  ClientCRXListInfoRequest* New(::google::protobuf::Arena* arena) const;
...
class ClientCRXListInfoResponse_UserMessage : public ::google::protobuf::MessageLite {
 public:
  ...
  inline ClientCRXListInfoResponse_UserMessage* New() const { return New(NULL); }

  ClientCRXListInfoResponse_UserMessage* New(::google::protobuf::Arena* arena) const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
...
class ClientCRXListInfoResponse : public ::google::protobuf::MessageLite {
 public:
  ...
  inline ClientCRXListInfoResponse* New() const { return New(NULL); }

  ClientCRXListInfoResponse* New(::google::protobuf::Arena* arena) const;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from);
