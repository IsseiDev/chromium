...
class Channel_SetPeerPid_Params_Data {
 ...
 private:
  Channel_SetPeerPid_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kChannel_Receive_Name = 1;
class Channel_Receive_Params_Data {
 ...
 private:
  Channel_Receive_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kChannel_GetAssociatedInterface_Name = 2;
class Channel_GetAssociatedInterface_Params_Data {
 ...
 private:
  Channel_GetAssociatedInterface_Params_Data() : header_({sizeof(*this), 0}) {
  }
