...
define("device/battery/battery_monitor.mojom", [
...
], function(bindings, codec, connection, core, validator, battery_status$) {
  ...
  BatteryMonitor_QueryNextStatus_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, BatteryMonitor_QueryNextStatus_Params.encodedSize, 0);
  ...
  BatteryMonitor_QueryNextStatus_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, BatteryMonitor_QueryNextStatus_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  BatteryMonitorProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  BatteryMonitorStub.prototype = Object.create(bindings.StubBase.prototype);
  BatteryMonitorStub.prototype.queryNextStatus = function() {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.queryNextStatus && bindings.StubBindings(this).delegate.queryNextStatus();
  }
