...
// static
bool BatteryMonitor_QueryNextStatus_Params_Data::Validate(
    const void* data,
...
// static
bool BatteryMonitor_QueryNextStatus_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->status, "null status field in BatteryMonitor_QueryNextStatus_ResponseParams",
          validation_context)) {
    return false;
  }
