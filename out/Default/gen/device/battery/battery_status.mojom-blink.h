...
#ifndef DEVICE_BATTERY_BATTERY_STATUS_MOJOM_BLINK_H_
#define DEVICE_BATTERY_BATTERY_STATUS_MOJOM_BLINK_H_
 ...
 public:
  ...
  static mojo::WTFArray<uint8_t> Serialize(UserType* input) {
    return mojo::internal::StructSerializeImpl<
        BatteryStatusPtr, mojo::WTFArray<uint8_t>>(input);
  }
  ...
  static bool Deserialize(const mojo::WTFArray<uint8_t>& input,
    ...
    return mojo::internal::StructDeserializeImpl<
        BatteryStatusPtr, mojo::WTFArray<uint8_t>>(
            input, output);
  }
...
namespace internal {
template <>
struct DataViewTraits<::device::blink::BatteryStatusDataView> {
  using MojomType = ::device::blink::BatteryStatusPtr;
};
}  // namespace internal
}  // namespace mojo
...
template <>
struct  StructTraits<::device::blink::BatteryStatus, ::device::blink::BatteryStatusPtr> {
  static bool IsNull(const ::device::blink::BatteryStatusPtr& input) { return !input; }
  static void SetToNull(::device::blink::BatteryStatusPtr* output) { output->reset(); }
  static decltype(::device::blink::BatteryStatus::charging) charging(
      const ::device::blink::BatteryStatusPtr& input) {
    return input->charging;
  }
  static decltype(::device::blink::BatteryStatus::charging_time) charging_time(
      const ::device::blink::BatteryStatusPtr& input) {
    return input->charging_time;
  }
  static decltype(::device::blink::BatteryStatus::discharging_time) discharging_time(
      const ::device::blink::BatteryStatusPtr& input) {
    return input->discharging_time;
  }
  static decltype(::device::blink::BatteryStatus::level) level(
      const ::device::blink::BatteryStatusPtr& input) {
    return input->level;
  }

  static bool Read(::device::blink::BatteryStatusDataView input, ::device::blink::BatteryStatusPtr* output);
};

namespace internal {

template <typename MaybeConstUserType>
struct Serializer<::device::blink::BatteryStatusPtr, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::device::blink::BatteryStatus, UserType>;
  ...
  static bool Deserialize(::device::internal::BatteryStatus_Data* input,
    ...
    ::device::blink::BatteryStatusDataView data_view(input, context);
...
#endif  // DEVICE_BATTERY_BATTERY_STATUS_MOJOM_BLINK_H_