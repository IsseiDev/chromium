...
bool NFCError_Data::Validate(
  ...
  if (!::device::nfc::internal::NFCErrorType_Data
...
bool NFCRecord_Data::Validate(
  ...
  if (!::device::nfc::internal::NFCRecordType_Data
        ::Validate(object->record_type, validation_context))
    return false;
...
bool NFCPushOptions_Data::Validate(
  ...
  if (!::device::nfc::internal::NFCPushTarget_Data
...
bool NFCWatchOptions_Data::Validate(
  ...
  if (!::device::nfc::internal::NFCWatchMode_Data
