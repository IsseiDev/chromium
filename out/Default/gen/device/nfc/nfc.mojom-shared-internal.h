...
class NFCError_Data {
 ...
 private:
  NFCError_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFCRecord_Data {
 ...
 private:
  NFCRecord_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFCMessage_Data {
 ...
 private:
  NFCMessage_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFCPushOptions_Data {
 ...
 private:
  NFCPushOptions_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFCRecordTypeFilter_Data {
 ...
 private:
  NFCRecordTypeFilter_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFC_Push_Params_Data {
 ...
 private:
  NFC_Push_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFC_Push_ResponseParams_Data {
 ...
 private:
  NFC_Push_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kNFC_CancelPush_Name = 2;
class NFC_CancelPush_Params_Data {
 ...
 private:
  NFC_CancelPush_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFC_CancelPush_ResponseParams_Data {
 ...
 private:
  NFC_CancelPush_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kNFC_Watch_Name = 3;
class NFC_Watch_Params_Data {
 ...
 private:
  NFC_Watch_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFC_Watch_ResponseParams_Data {
 ...
 private:
  NFC_Watch_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kNFC_CancelWatch_Name = 4;
class NFC_CancelWatch_Params_Data {
 ...
 private:
  NFC_CancelWatch_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFC_CancelWatch_ResponseParams_Data {
 ...
 private:
  NFC_CancelWatch_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kNFC_CancelAllWatches_Name = 5;
class NFC_CancelAllWatches_Params_Data {
 ...
 private:
  NFC_CancelAllWatches_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class NFC_CancelAllWatches_ResponseParams_Data {
 ...
 private:
  NFC_CancelAllWatches_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kNFC_SuspendNFCOperations_Name = 6;
class NFC_SuspendNFCOperations_Params_Data {
 ...
 private:
  NFC_SuspendNFCOperations_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kNFC_ResumeNFCOperations_Name = 7;
class NFC_ResumeNFCOperations_Params_Data {
 ...
 private:
  NFC_ResumeNFCOperations_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kNFCClient_OnWatch_Name = 0;
class NFCClient_OnWatch_Params_Data {
 ...
 private:
  NFCClient_OnWatch_Params_Data() : header_({sizeof(*this), 0}) {
  }
