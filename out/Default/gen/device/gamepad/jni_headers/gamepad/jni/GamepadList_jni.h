...
static void SetGamepadData(JNIEnv* env, const
...
void Java_org_chromium_device_gamepad_GamepadList_nativeSetGamepadData(JNIEnv*
    env, jobject jcaller,
    jlong webGamepadsPtr,
    jint index,
    jboolean mapping,
...
static void Java_GamepadList_updateGamepadData(JNIEnv* env, jlong
    webGamepadsPtr) {
