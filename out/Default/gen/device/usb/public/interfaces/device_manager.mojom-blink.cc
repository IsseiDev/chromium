...
class DeviceManager_GetDevices_ParamsDataView {
 public:
  ...
  bool ReadOptions(UserType* output) {
    ...
    return mojo::internal::Deserialize<::device::usb::blink::EnumerationOptionsPtr>(
...
class DeviceManager_GetDevices_ResponseParamsDataView {
 public:
  ...
  inline void GetResultsDataView(
      mojo::ArrayDataView<::device::usb::blink::DeviceInfoDataView>* output);

  template <typename UserType>
  bool ReadResults(UserType* output) {
    auto pointer = data_->results.Get();
    return mojo::internal::Deserialize<mojo::Array<::device::usb::blink::DeviceInfoPtr>>(
        pointer, output, context_);
  }
 private:
...
inline void DeviceManager_GetDevices_ResponseParamsDataView::GetResultsDataView(
    mojo::ArrayDataView<::device::usb::blink::DeviceInfoDataView>* output) {
  auto pointer = data_->results.Get();
  *output = mojo::ArrayDataView<::device::usb::blink::DeviceInfoDataView>(pointer, context_);
}
...
class DeviceManager_GetDevice_ParamsDataView {
 public:
  ...
  ::device::usb::blink::DeviceRequest TakeDeviceRequest() {
    ::device::usb::blink::DeviceRequest result;
    bool ret =
        mojo::internal::Deserialize<::device::usb::blink::DeviceRequest>(
...
class DeviceManager_SetClient_ParamsDataView {
 public:
  ...
  DeviceManagerClientPtr TakeClient() {
    ...
    bool ret =
        mojo::internal::Deserialize<::device::usb::blink::DeviceManagerClientPtr>(
...
bool DeviceManager_GetDevices_ForwardToCallback::Accept(
  ...
  bool success = true;
  WTF::Vector<::device::usb::blink::DeviceInfoPtr> p_results{};
...
void DeviceManagerProxy::GetDevices(
  ...
  size += mojo::internal::PrepareToSerialize<::device::usb::blink::EnumerationOptionsPtr>(
  ...
  mojo::internal::Serialize<::device::usb::blink::EnumerationOptionsPtr>(
...
void DeviceManagerProxy::GetDevice(
    const WTF::String& in_guid, ::device::usb::blink::DeviceRequest in_device_request) {
  ...
  mojo::internal::Serialize<::device::usb::blink::DeviceRequest>(
...
void DeviceManagerProxy::SetClient(
  ...
  ALLOW_UNUSED_LOCAL(params);
  mojo::internal::Serialize<::device::usb::blink::DeviceManagerClientPtr>(
...
class DeviceManager_GetDevices_ProxyToResponder {
 ...
 private:
  ...
  void Run(
      WTF::Vector<::device::usb::blink::DeviceInfoPtr> in_results);
...
void DeviceManager_GetDevices_ProxyToResponder::Run(
  ...
  size += mojo::internal::PrepareToSerialize<mojo::Array<::device::usb::blink::DeviceInfoPtr>>(
  ...
  const mojo::internal::ContainerValidateParams results_validate_params(
      0, false, nullptr);
  mojo::internal::Serialize<mojo::Array<::device::usb::blink::DeviceInfoPtr>>(
...
bool DeviceManagerStub::Accept(mojo::Message* message) {
  ...
  switch (message->header()->name) {
    ...
    case internal::kDeviceManager_GetDevice_Name: {
      ...
      bool success = true;
      WTF::String p_guid{};
      ::device::usb::blink::DeviceRequest p_device_request{};
...
void DeviceManagerClientProxy::OnDeviceAdded(
    ::device::usb::blink::DeviceInfoPtr in_device_info) {
...
bool DeviceManagerClientStub::Accept(mojo::Message* message) {
  ...
  switch (message->header()->name) {
    case internal::kDeviceManagerClient_OnDeviceAdded_Name: {
      ...
      (&serialization_context_)->handles.Swap((message)->mutable_handles());
      bool success = true;
      ::device::usb::blink::DeviceInfoPtr p_device_info{};
...
// static
bool StructTraits<::device::usb::blink::DeviceFilter, ::device::usb::blink::DeviceFilterPtr>::Read(
    ::device::usb::blink::DeviceFilterDataView input,
    ::device::usb::blink::DeviceFilterPtr* output) {
  bool success = true;
  ::device::usb::blink::DeviceFilterPtr result(::device::usb::blink::DeviceFilter::New());
...
// static
bool StructTraits<::device::usb::blink::EnumerationOptions, ::device::usb::blink::EnumerationOptionsPtr>::Read(
    ::device::usb::blink::EnumerationOptionsDataView input,
    ::device::usb::blink::EnumerationOptionsPtr* output) {
  bool success = true;
  ::device::usb::blink::EnumerationOptionsPtr result(::device::usb::blink::EnumerationOptions::New());
