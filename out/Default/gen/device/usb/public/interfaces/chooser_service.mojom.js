...
define("device/usb/public/interfaces/chooser_service.mojom", [
  ...
  ChooserService_GetPermission_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, ChooserService_GetPermission_Params.encodedSize, 0);
  ...
  ChooserService_GetPermission_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, ChooserService_GetPermission_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ChooserServiceProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  ChooserServiceStub.prototype = Object.create(bindings.StubBase.prototype);
