...
#ifndef DEVICE_USB_PUBLIC_INTERFACES_DEVICE_MANAGER_MOJOM_H_
#define DEVICE_USB_PUBLIC_INTERFACES_DEVICE_MANAGER_MOJOM_H_
...
class  DeviceManager {
 public:
  ...
  using GetDevicesCallback = base::Callback<void(std::vector<::device::usb::DeviceInfoPtr>)>;
  virtual void GetDevices(EnumerationOptionsPtr options, const GetDevicesCallback& callback) = 0;

  virtual void GetDevice(const std::string& guid, ::device::usb::DeviceRequest device_request) = 0;
...
class  DeviceManagerClient {
 public:
  ...
  virtual void OnDeviceAdded(::device::usb::DeviceInfoPtr device_info) = 0;

  virtual void OnDeviceRemoved(::device::usb::DeviceInfoPtr device_info) = 0;
};
...
class  DeviceManagerProxy
 ...
 public:
  ...
  void GetDevice(const std::string& guid, ::device::usb::DeviceRequest device_request) override;
...
class  DeviceManagerClientProxy
 ...
 public:
  ...
  void OnDeviceAdded(::device::usb::DeviceInfoPtr device_info) override;
  void OnDeviceRemoved(::device::usb::DeviceInfoPtr device_info) override;
 ...
 public:
  ...
  static mojo::Array<uint8_t> Serialize(UserType* input) {
    return mojo::internal::StructSerializeImpl<
        DeviceFilterPtr, mojo::Array<uint8_t>>(input);
  }
  ...
  static bool Deserialize(const mojo::Array<uint8_t>& input,
    ...
    return mojo::internal::StructDeserializeImpl<
        DeviceFilterPtr, mojo::Array<uint8_t>>(
            input, output);
  }
...
namespace internal {
template <>
struct DataViewTraits<::device::usb::DeviceFilterDataView> {
  using MojomType = ::device::usb::DeviceFilterPtr;
};
}  // namespace internal
}  // namespace mojo
...
class  EnumerationOptions {
 public:
  ...
  static mojo::Array<uint8_t> Serialize(UserType* input) {
    return mojo::internal::StructSerializeImpl<
        EnumerationOptionsPtr, mojo::Array<uint8_t>>(input);
  }
  ...
  static bool Deserialize(const mojo::Array<uint8_t>& input,
                          UserType* output) {
    return mojo::internal::StructDeserializeImpl<
        EnumerationOptionsPtr, mojo::Array<uint8_t>>(
            input, output);
  }

  base::Optional<std::vector<DeviceFilterPtr>> filters;
 private:
...
class EnumerationOptionsDataView {
 public:
  ...
  bool ReadFilters(UserType* output) {
    ...
    return mojo::internal::Deserialize<mojo::Array<::device::usb::DeviceFilterPtr>>(
...
namespace internal {
template <>
struct DataViewTraits<::device::usb::EnumerationOptionsDataView> {
  using MojomType = ::device::usb::EnumerationOptionsPtr;
};
}  // namespace internal
}  // namespace mojo
...
template <>
struct  StructTraits<::device::usb::DeviceFilter, ::device::usb::DeviceFilterPtr> {
  static bool IsNull(const ::device::usb::DeviceFilterPtr& input) { return !input; }
  static void SetToNull(::device::usb::DeviceFilterPtr* output) { output->reset(); }
  static decltype(::device::usb::DeviceFilter::has_vendor_id) has_vendor_id(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->has_vendor_id;
  }
  static decltype(::device::usb::DeviceFilter::vendor_id) vendor_id(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->vendor_id;
  }
  static decltype(::device::usb::DeviceFilter::has_product_id) has_product_id(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->has_product_id;
  }
  static decltype(::device::usb::DeviceFilter::product_id) product_id(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->product_id;
  }
  static decltype(::device::usb::DeviceFilter::has_class_code) has_class_code(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->has_class_code;
  }
  static decltype(::device::usb::DeviceFilter::class_code) class_code(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->class_code;
  }
  static decltype(::device::usb::DeviceFilter::has_subclass_code) has_subclass_code(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->has_subclass_code;
  }
  static decltype(::device::usb::DeviceFilter::subclass_code) subclass_code(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->subclass_code;
  }
  static decltype(::device::usb::DeviceFilter::has_protocol_code) has_protocol_code(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->has_protocol_code;
  }
  static decltype(::device::usb::DeviceFilter::protocol_code) protocol_code(
      const ::device::usb::DeviceFilterPtr& input) {
    return input->protocol_code;
  }

  static bool Read(::device::usb::DeviceFilterDataView input, ::device::usb::DeviceFilterPtr* output);
};

namespace internal {

template <typename MaybeConstUserType>
struct Serializer<::device::usb::DeviceFilterPtr, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::device::usb::DeviceFilter, UserType>;
...
template <>
struct  StructTraits<::device::usb::EnumerationOptions, ::device::usb::EnumerationOptionsPtr> {
  static bool IsNull(const ::device::usb::EnumerationOptionsPtr& input) { return !input; }
  static void SetToNull(::device::usb::EnumerationOptionsPtr* output) { output->reset(); }
  static decltype(::device::usb::EnumerationOptions::filters)& filters(
      ::device::usb::EnumerationOptionsPtr& input) {
    return input->filters;
  }

  static bool Read(::device::usb::EnumerationOptionsDataView input, ::device::usb::EnumerationOptionsPtr* output);
};

namespace internal {

template <typename MaybeConstUserType>
struct Serializer<::device::usb::EnumerationOptionsPtr, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::device::usb::EnumerationOptions, UserType>;
  ...
  static size_t PrepareToSerialize(MaybeConstUserType& input,
    ...
    size += mojo::internal::PrepareToSerialize<mojo::Array<::device::usb::DeviceFilterPtr>>(
        in_filters, context);
    return size;
  }
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    auto result =
      ...
      const mojo::internal::ContainerValidateParams filters_validate_params(
          0, false, nullptr);
      mojo::internal::Serialize<mojo::Array<::device::usb::DeviceFilterPtr>>(
...
#endif  // DEVICE_USB_PUBLIC_INTERFACES_DEVICE_MANAGER_MOJOM_H_