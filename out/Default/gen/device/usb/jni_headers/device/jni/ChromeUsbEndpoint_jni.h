...
namespace {
const char kChromeUsbEndpointClassPath[] =
    "org/chromium/device/usb/ChromeUsbEndpoint";
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeUsbEndpoint_create(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& endpoint) {
...
"Lorg/chromium/device/usb/ChromeUsbEndpoint;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeUsbEndpoint_clazz(env),
...
static jint Java_ChromeUsbEndpoint_getAddress(JNIEnv* env, const
...
static jint Java_ChromeUsbEndpoint_getAttributes(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeUsbEndpoint_clazz(env), 0);
  jmethodID method_id =
...
static jint Java_ChromeUsbEndpoint_getInterval(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeUsbEndpoint_clazz(env), 0);
  jmethodID method_id =
