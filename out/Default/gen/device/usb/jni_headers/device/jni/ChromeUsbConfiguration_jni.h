...
namespace {
const char kChromeUsbConfigurationClassPath[] =
    "org/chromium/device/usb/ChromeUsbConfiguration";
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeUsbConfiguration_create(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& configuration) {
...
"Lorg/chromium/device/usb/ChromeUsbConfiguration;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeUsbConfiguration_clazz(env),
          method_id, configuration.obj());
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_ChromeUsbConfiguration_getConfigurationValue =
    0;
...
static base::android::ScopedJavaLocalRef<jobjectArray>
    Java_ChromeUsbConfiguration_getInterfaces(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeUsbConfiguration_clazz(env), NULL);
  jmethodID method_id =
