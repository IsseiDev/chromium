...
namespace {
const char kChromeUsbConnectionClassPath[] =
    "org/chromium/device/usb/ChromeUsbConnection";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_ChromeUsbConnection_clazz __attribute__((unused)) =
    0;
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeUsbConnection_create(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& connection) {
...
"Lorg/chromium/device/usb/ChromeUsbConnection;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeUsbConnection_clazz(env),
...
static void Java_ChromeUsbConnection_close(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
