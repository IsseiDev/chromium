...
namespace {
const char kChromeUsbInterfaceClassPath[] =
    "org/chromium/device/usb/ChromeUsbInterface";
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeUsbInterface_create(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& iface) {
...
"Lorg/chromium/device/usb/ChromeUsbInterface;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeUsbInterface_clazz(env),
          method_id, iface.obj());
...
static base::android::ScopedJavaLocalRef<jobjectArray>
    Java_ChromeUsbInterface_getEndpoints(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeUsbInterface_clazz(env), NULL);
  jmethodID method_id =
