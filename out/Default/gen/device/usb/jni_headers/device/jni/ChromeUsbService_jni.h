...
namespace {
const char kChromeUsbServiceClassPath[] =
    "org/chromium/device/usb/ChromeUsbService";
...
void Java_org_chromium_device_usb_ChromeUsbService_nativeDeviceAttached(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeUsbServiceAndroid,
    jobject device) {
  UsbServiceAndroid* native =
      reinterpret_cast<UsbServiceAndroid*>(nativeUsbServiceAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "DeviceAttached");
  return native->DeviceAttached(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jobject>(env, device));
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_device_usb_ChromeUsbService_nativeDeviceDetached(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeUsbServiceAndroid,
    jint deviceId) {
  ...
  return native->DeviceDetached(env, base::android::JavaParamRef<jobject>(env,
      jcaller), deviceId);
}
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeUsbService_create(JNIEnv* env, const
...
"Lorg/chromium/device/usb/ChromeUsbService;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeUsbService_clazz(env),
...
static base::android::ScopedJavaLocalRef<jobjectArray>
    Java_ChromeUsbService_getDevices(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeUsbService_openDevice(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jobject>& wrapper) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeUsbService_clazz(env), NULL);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static void Java_ChromeUsbService_close(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeUsbService_clazz(env));
  jmethodID method_id =
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  if (env->RegisterNatives(ChromeUsbService_clazz(env),
                           ...
                           kMethodsChromeUsbServiceSize) < 0) {
