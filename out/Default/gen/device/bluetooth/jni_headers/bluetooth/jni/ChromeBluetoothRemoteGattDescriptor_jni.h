...
namespace {
const char kChromeBluetoothRemoteGattDescriptorClassPath[] =
    "org/chromium/device/bluetooth/ChromeBluetoothRemoteGattDescriptor";
...
static base::subtle::AtomicWord g_ChromeBluetoothRemoteGattDescriptor_create =
    0;
...
"Lorg/chromium/device/bluetooth/ChromeBluetoothRemoteGattDescriptor;",
  ...
  jobject ret =
env->CallStaticObjectMethod(ChromeBluetoothRemoteGattDescriptor_clazz(env),
...
static base::subtle::AtomicWord g_ChromeBluetoothRemoteGattDescriptor_getUUID =
    0;
...
static base::subtle::AtomicWord
    g_ChromeBluetoothRemoteGattDescriptor_readRemoteDescriptor = 0;
static jboolean
...
static base::subtle::AtomicWord
    g_ChromeBluetoothRemoteGattDescriptor_writeRemoteDescriptor = 0;
static jboolean
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsChromeBluetoothRemoteGattDescriptorSize =
      arraysize(kMethodsChromeBluetoothRemoteGattDescriptor);

  if (env->RegisterNatives(ChromeBluetoothRemoteGattDescriptor_clazz(env),
                           kMethodsChromeBluetoothRemoteGattDescriptor,
                           kMethodsChromeBluetoothRemoteGattDescriptorSize) < 0)
                               {
