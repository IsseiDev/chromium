...
namespace {
const char kChromeBluetoothRemoteGattServiceClassPath[] =
    "org/chromium/device/bluetooth/ChromeBluetoothRemoteGattService";
...
"Lorg/chromium/device/bluetooth/ChromeBluetoothRemoteGattService;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeBluetoothRemoteGattService_clazz(env),
...
static base::subtle::AtomicWord
    g_ChromeBluetoothRemoteGattService_createCharacteristics = 0;
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsChromeBluetoothRemoteGattServiceSize =
      arraysize(kMethodsChromeBluetoothRemoteGattService);

  if (env->RegisterNatives(ChromeBluetoothRemoteGattService_clazz(env),
                           kMethodsChromeBluetoothRemoteGattService,
                           kMethodsChromeBluetoothRemoteGattServiceSize) < 0) {
