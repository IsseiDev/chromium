...
namespace {
const char kChromeBluetoothAdapterClassPath[] =
    "org/chromium/device/bluetooth/ChromeBluetoothAdapter";
...
void
  ...
  return native->OnScanFailed(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
void
  ...
  return native->CreateOrUpdateDeviceOnScan(env,
      ...
      base::android::JavaParamRef<jobject>(env, bluetoothDeviceWrapper),
      base::android::JavaParamRef<jobjectArray>(env, advertisedUuids));
}
...
static base::subtle::AtomicWord
    g_ChromeBluetoothAdapter_onBluetoothAdapterAndroidDestruction = 0;
static void
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeBluetoothAdapter_create(JNIEnv* env, jlong
...
"Lorg/chromium/device/bluetooth/ChromeBluetoothAdapter;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeBluetoothAdapter_clazz(env),
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_ChromeBluetoothAdapter_getAddress(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_ChromeBluetoothAdapter_getName(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeBluetoothAdapter_clazz(env), NULL);
  jmethodID method_id =
...
static jboolean Java_ChromeBluetoothAdapter_setPowered(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jboolean powered) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeBluetoothAdapter_clazz(env), false);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsChromeBluetoothAdapterSize =
      arraysize(kMethodsChromeBluetoothAdapter);

  if (env->RegisterNatives(ChromeBluetoothAdapter_clazz(env),
                           kMethodsChromeBluetoothAdapter,
                           kMethodsChromeBluetoothAdapterSize) < 0) {
