...
const char kBluetoothAdapterWrapperClassPath[] =
...
static base::subtle::AtomicWord
    g_BluetoothAdapterWrapper_createWithDefaultAdapter = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_BluetoothAdapterWrapper_createWithDefaultAdapter(JNIEnv* env, const
...
"Lorg/chromium/device/bluetooth/Wrappers$BluetoothAdapterWrapper;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(BluetoothAdapterWrapper_clazz(env),
