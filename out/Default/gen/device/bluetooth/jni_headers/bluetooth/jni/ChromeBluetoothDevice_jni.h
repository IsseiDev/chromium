...
namespace {
const char kChromeBluetoothDeviceClassPath[] =
    "org/chromium/device/bluetooth/ChromeBluetoothDevice";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_ChromeBluetoothDevice_clazz __attribute__((unused)) =
    0;
...
static base::subtle::AtomicWord
    g_ChromeBluetoothDevice_onBluetoothDeviceAndroidDestruction = 0;
static void
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ChromeBluetoothDevice_create(JNIEnv* env, jlong
    nativeBluetoothDeviceAndroid,
...
"Lorg/chromium/device/bluetooth/ChromeBluetoothDevice;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ChromeBluetoothDevice_clazz(env),
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_ChromeBluetoothDevice_getAddress(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeBluetoothDevice_clazz(env), NULL);
  jmethodID method_id =
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_ChromeBluetoothDevice_getName(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ChromeBluetoothDevice_clazz(env), NULL);
  jmethodID method_id =
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsChromeBluetoothDeviceSize =
      arraysize(kMethodsChromeBluetoothDevice);

  if (env->RegisterNatives(ChromeBluetoothDevice_clazz(env),
                           kMethodsChromeBluetoothDevice,
                           kMethodsChromeBluetoothDeviceSize) < 0) {
