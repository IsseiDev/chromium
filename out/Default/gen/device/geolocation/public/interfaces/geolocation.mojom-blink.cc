...
class GeolocationService_QueryNextPosition_ResponseParamsDataView {
 public:
  ...
  bool ReadGeoposition(UserType* output) {
    ...
    return mojo::internal::Deserialize<::device::mojom::blink::GeopositionPtr>(
...
void GeolocationService_QueryNextPosition_ProxyToResponder::Run(
  ...
  size += mojo::internal::PrepareToSerialize<::device::mojom::blink::GeopositionPtr>(
  ...
  mojo::internal::Serialize<::device::mojom::blink::GeopositionPtr>(
...
// static
bool StructTraits<::device::mojom::blink::Geoposition, ::device::mojom::blink::GeopositionPtr>::Read(
    ::device::mojom::blink::GeopositionDataView input,
