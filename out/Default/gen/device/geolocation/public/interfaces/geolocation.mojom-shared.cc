...
bool Geoposition_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->error_message, "null error_message field in Geoposition",
          validation_context)) {
    return false;
  }
...
// static
bool GeolocationService_SetHighAccuracy_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool GeolocationService_QueryNextPosition_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool GeolocationService_QueryNextPosition_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->geoposition, "null geoposition field in GeolocationService_QueryNextPosition_ResponseParams",
          validation_context)) {
    return false;
  }
