...
define("device/vibration/vibration_manager.mojom", [
  ...
  VibrationManager_Vibrate_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, VibrationManager_Vibrate_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VibrationManager_Cancel_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, VibrationManager_Cancel_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
