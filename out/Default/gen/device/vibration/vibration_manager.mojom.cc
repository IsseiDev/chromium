...
const uint32_t VibrationManager::Version_;
...
bool VibrationManager_Vibrate_ForwardToCallback::Accept(
  ...
  internal::VibrationManager_Vibrate_ResponseParams_Data* params =
      reinterpret_cast<internal::VibrationManager_Vibrate_ResponseParams_Data*>(
...
bool VibrationManager_Cancel_ForwardToCallback::Accept(
  ...
  internal::VibrationManager_Cancel_ResponseParams_Data* params =
      reinterpret_cast<internal::VibrationManager_Cancel_ResponseParams_Data*>(
          message->mutable_payload());
...
void VibrationManagerProxy::Vibrate(
  ...
  auto params =
      ::device::internal::VibrationManager_Vibrate_Params_Data::New(builder.buffer());
...
void VibrationManagerProxy::Cancel(
  ...
  auto params =
      ::device::internal::VibrationManager_Cancel_Params_Data::New(builder.buffer());
  ALLOW_UNUSED_LOCAL(params);
  (&serialization_context_)->handles.Swap(
      builder.message()->mutable_handles());
  mojo::MessageReceiver* responder =
...
void VibrationManager_Vibrate_ProxyToResponder::Run(
  ...
  auto params =
      ::device::internal::VibrationManager_Vibrate_ResponseParams_Data::New(builder.buffer());
  ALLOW_UNUSED_LOCAL(params);
  (&serialization_context_)->handles.Swap(
      builder.message()->mutable_handles());
...
void VibrationManager_Cancel_ProxyToResponder::Run(
  ...
  mojo::internal::ResponseMessageBuilder builder(
      ...
      is_sync_ ? mojo::Message::kFlagIsSync : 0);
  auto params =
      ::device::internal::VibrationManager_Cancel_ResponseParams_Data::New(builder.buffer());
  ALLOW_UNUSED_LOCAL(params);
  (&serialization_context_)->handles.Swap(
      builder.message()->mutable_handles());
  bool ok = responder_->Accept(builder.message());
...
bool VibrationManagerStub::AcceptWithResponder(
  ...
  switch (message->header()->name) {
    case internal::kVibrationManager_Vibrate_Name: {
      ...
      mojo::internal::MessageDispatchContext context(message);
      sink_->Vibrate(
std::move(p_milliseconds), callback);
      return true;
    }
    case internal::kVibrationManager_Cancel_Name: {
...
VibrationManagerResponseValidator::VibrationManagerResponseValidator(
    mojo::MessageReceiver* sink) : MessageFilter(sink) {
}
