...
"Lorg/chromium/device/power_save_blocker/PowerSaveBlocker;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(PowerSaveBlocker_clazz(env),
          method_id);
...
static void Java_PowerSaveBlocker_applyBlock(JNIEnv* env, const
...
static void Java_PowerSaveBlocker_removeBlock(JNIEnv* env, const
