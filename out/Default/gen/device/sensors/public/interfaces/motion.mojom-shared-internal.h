...
#pragma pack(push, 1)
const uint32_t kMotionSensor_StartPolling_Name = 0;
class MotionSensor_StartPolling_Params_Data {
 ...
 private:
  MotionSensor_StartPolling_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class MotionSensor_StartPolling_ResponseParams_Data {
 ...
 private:
  MotionSensor_StartPolling_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kMotionSensor_StopPolling_Name = 1;
class MotionSensor_StopPolling_Params_Data {
 ...
 private:
  MotionSensor_StopPolling_Params_Data() : header_({sizeof(*this), 0}) {
  }
