...
define("device/sensors/public/interfaces/motion.mojom", [
  ...
  MotionSensor_StartPolling_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, MotionSensor_StartPolling_Params.encodedSize, 0);
  ...
  MotionSensor_StartPolling_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, MotionSensor_StartPolling_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MotionSensor_StopPolling_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, MotionSensor_StopPolling_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MotionSensorProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  MotionSensorStub.prototype = Object.create(bindings.StubBase.prototype);
