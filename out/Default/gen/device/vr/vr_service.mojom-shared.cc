...
bool VRDisplay_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VRDisplay_Data* object = static_cast<const VRDisplay_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->displayName, "null displayName field in VRDisplay",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->capabilities, "null capabilities field in VRDisplay",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->leftEye, "null leftEye field in VRDisplay",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->rightEye, "null rightEye field in VRDisplay",
          validation_context)) {
    return false;
  }
...
// static
bool VRService_GetDisplays_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VRService_GetDisplays_Params_Data* object = static_cast<const VRService_GetDisplays_Params_Data*>(data);
...
// static
bool VRService_GetDisplays_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VRService_GetDisplays_ResponseParams_Data* object = static_cast<const VRService_GetDisplays_ResponseParams_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->displays, "null displays field in VRService_GetDisplays_ResponseParams",
          validation_context)) {
    return false;
  }
...
// static
bool VRService_GetPose_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VRService_GetPose_Params_Data* object = static_cast<const VRService_GetPose_Params_Data*>(data);
...
// static
bool VRService_GetPose_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VRService_GetPose_ResponseParams_Data* object = static_cast<const VRService_GetPose_ResponseParams_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->pose, "null pose field in VRService_GetPose_ResponseParams",
          validation_context)) {
    return false;
  }
...
// static
bool VRService_ResetPose_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VRService_ResetPose_Params_Data* object = static_cast<const VRService_ResetPose_Params_Data*>(data);
...
// static
bool VRServiceClient_OnDisplayChanged_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const VRServiceClient_OnDisplayChanged_Params_Data* object = static_cast<const VRServiceClient_OnDisplayChanged_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->display, "null display field in VRServiceClient_OnDisplayChanged_Params",
          validation_context)) {
    return false;
  }
