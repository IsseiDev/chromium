...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(ShaderVariableProto, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(58)) goto parse_loop_fields;
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(ShaderVaryingProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_is_row_major_layout;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(ShaderInterfaceBlockProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_mapped_name;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_instance_name;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_array_size;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_layout;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_is_row_major_layout;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_static_use;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_fields;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(66)) goto parse_loop_fields;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_attribs;
        if (input->ExpectTag(26)) goto parse_loop_uniforms;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(26)) goto parse_loop_uniforms;
        if (input->ExpectTag(34)) goto parse_loop_varyings;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(34)) goto parse_loop_varyings;
        if (input->ExpectTag(42)) goto parse_loop_output_variables;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(42)) goto parse_loop_output_variables;
        if (input->ExpectTag(50)) goto parse_loop_interface_blocks;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
