...
define("gpu/ipc/common/gpu_info.mojom", [
...
], function(bindings, codec, connection, core, validator, dx_diag_node$, common_custom_types$, geometry$) {
  ...
  GpuDevice.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, GpuDevice.encodedSize, 0);
  ...
  VideoDecodeAcceleratorSupportedProfile.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, VideoDecodeAcceleratorSupportedProfile.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoDecodeAcceleratorSupportedProfile.decode = function(decoder) {
    ...
    val.encrypted_only = decoder.decodeStruct(codec.Uint8);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  VideoDecodeAcceleratorSupportedProfile.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Uint8, val.encrypted_only);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  VideoDecodeAcceleratorCapabilities.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, VideoDecodeAcceleratorCapabilities.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoDecodeAcceleratorCapabilities.encodedSize = codec.kStructHeaderSize + 8;
  ...
  VideoEncodeAcceleratorSupportedProfile.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, VideoEncodeAcceleratorSupportedProfile.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GpuInfo.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, GpuInfo.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, common_custom_types$.Version, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  GpuInfo.encodedSize = codec.kStructHeaderSize + 208;
  ...
  GpuInfo.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.initialization_time = decoder.decodeStructPointer(common_custom_types$.TimeDelta);
    ...
    val.jpeg_decode_accelerator_supported = (packed >> 7) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.gl_reset_notification_strategy = decoder.decodeStruct(codec.Uint32);
    val.display_link_version = decoder.decodeStructPointer(common_custom_types$.Version);
  ...
  GpuInfo.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(common_custom_types$.TimeDelta, val.initialization_time);
    packed = 0;
    ...
    packed |= (val.jpeg_decode_accelerator_supported & 1) << 7
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStruct(codec.Uint32, val.gl_reset_notification_strategy);
    encoder.encodeStructPointer(common_custom_types$.Version, val.display_link_version);
