...
// static
bool StructTraits<::gpu::mojom::GpuDevice, ::gpu::mojom::GpuDevicePtr>::Read(
    ::gpu::mojom::GpuDeviceDataView input,
...
// static
bool StructTraits<::gpu::mojom::VideoDecodeAcceleratorSupportedProfile, ::gpu::mojom::VideoDecodeAcceleratorSupportedProfilePtr>::Read(
    ::gpu::mojom::VideoDecodeAcceleratorSupportedProfileDataView input,
...
// static
bool StructTraits<::gpu::mojom::VideoDecodeAcceleratorCapabilities, ::gpu::mojom::VideoDecodeAcceleratorCapabilitiesPtr>::Read(
    ::gpu::mojom::VideoDecodeAcceleratorCapabilitiesDataView input,
...
// static
bool StructTraits<::gpu::mojom::VideoEncodeAcceleratorSupportedProfile, ::gpu::mojom::VideoEncodeAcceleratorSupportedProfilePtr>::Read(
    ::gpu::mojom::VideoEncodeAcceleratorSupportedProfileDataView input,
...
// static
bool StructTraits<::gpu::mojom::GpuInfo, ::gpu::mojom::GpuInfoPtr>::Read(
    ::gpu::mojom::GpuInfoDataView input,
