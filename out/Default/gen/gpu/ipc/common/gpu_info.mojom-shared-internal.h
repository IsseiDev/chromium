...
class GpuDevice_Data {
 ...
 private:
  GpuDevice_Data() : header_({sizeof(*this), 0}) {
  }
...
class VideoDecodeAcceleratorSupportedProfile_Data {
 ...
 private:
  VideoDecodeAcceleratorSupportedProfile_Data() : header_({sizeof(*this), 0}) {
  }
...
class VideoDecodeAcceleratorCapabilities_Data {
 ...
 private:
  VideoDecodeAcceleratorCapabilities_Data() : header_({sizeof(*this), 0}) {
  }
  ~VideoDecodeAcceleratorCapabilities_Data() = delete;
};
static_assert(sizeof(VideoDecodeAcceleratorCapabilities_Data) == 16,
...
class VideoEncodeAcceleratorSupportedProfile_Data {
 ...
 private:
  VideoEncodeAcceleratorSupportedProfile_Data() : header_({sizeof(*this), 0}) {
  }
...
class GpuInfo_Data {
 ...
 private:
  GpuInfo_Data() : header_({sizeof(*this), 0}) {
  }
  ~GpuInfo_Data() = delete;
};
