...
bool GpuInfo_Data::Validate(
  ...
  if (!::gpu::mojom::internal::CollectInfoResult_Data
        ::Validate(object->basic_info_state, validation_context))
    return false;


  if (!::gpu::mojom::internal::CollectInfoResult_Data
        ::Validate(object->context_info_state, validation_context))
    return false;


  if (!::gpu::mojom::internal::CollectInfoResult_Data
        ::Validate(object->dx_diagnostics_info_state, validation_context))
    return false;
