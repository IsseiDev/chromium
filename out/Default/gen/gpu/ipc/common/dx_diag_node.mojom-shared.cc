...
bool DxDiagNode_Data::Validate(
  ...
  const DxDiagNode_Data* object = static_cast<const DxDiagNode_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->values, "null values field in DxDiagNode",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->children, "null children field in DxDiagNode",
          validation_context)) {
    return false;
  }
