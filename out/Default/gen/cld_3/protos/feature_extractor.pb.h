...
class Parameter : public ::google::protobuf::MessageLite {
 public:
  ...
  GOOGLE_ATTRIBUTE_NOINLINE void Swap(Parameter* other);
...
class FeatureFunctionDescriptor : public ::google::protobuf::MessageLite {
 public:
  ...
  GOOGLE_ATTRIBUTE_NOINLINE void Swap(FeatureFunctionDescriptor* other);
...
class FeatureExtractorDescriptor : public ::google::protobuf::MessageLite {
 public:
  ...
  GOOGLE_ATTRIBUTE_NOINLINE void Swap(FeatureExtractorDescriptor* other);
