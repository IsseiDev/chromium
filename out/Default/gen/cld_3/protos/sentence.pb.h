...
class Sentence : public ::google::protobuf::MessageLite {
 public:
  ...
  GOOGLE_ATTRIBUTE_NOINLINE void Swap(Sentence* other);
...
class Token : public ::google::protobuf::MessageLite {
 public:
  ...
  GOOGLE_ATTRIBUTE_NOINLINE void Swap(Token* other);
...
template <> struct is_proto_enum< ::chrome_lang_id::Token_BreakLevel> : ::google::protobuf::internal::true_type {};
