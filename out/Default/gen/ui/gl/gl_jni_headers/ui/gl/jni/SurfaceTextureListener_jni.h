...
void Java_org_chromium_ui_gl_SurfaceTextureListener_nativeFrameAvailable(JNIEnv*
    env,
    jobject jcaller,
  ...
  return native->FrameAvailable(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_ui_gl_SurfaceTextureListener_nativeDestroy(JNIEnv* env,
    jobject jcaller,
    jlong nativeSurfaceTextureListener) {
  SurfaceTextureListener* native =
      reinterpret_cast<SurfaceTextureListener*>(nativeSurfaceTextureListener);
