...
static base::android::ScopedJavaLocalRef<jobject>
    Java_SurfaceTexturePlatformWrapper_create(JNIEnv* env, JniIntWrapper
    textureId) {
...
"Landroid/graphics/SurfaceTexture;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(SurfaceTexturePlatformWrapper_clazz(env),
...
static void Java_SurfaceTexturePlatformWrapper_destroy(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& surfaceTexture) {
  CHECK_CLAZZ(env, SurfaceTexturePlatformWrapper_clazz(env),
...
static void Java_SurfaceTexturePlatformWrapper_setFrameAvailableCallback(JNIEnv*
    env, const base::android::JavaRefOrBare<jobject>& surfaceTexture,
