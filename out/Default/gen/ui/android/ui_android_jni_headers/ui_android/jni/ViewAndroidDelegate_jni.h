...
namespace {
const char kViewAndroidDelegateClassPath[] =
    "org/chromium/ui/base/ViewAndroidDelegate";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_ViewAndroidDelegate_clazz __attribute__((unused)) =
    0;
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ViewAndroidDelegate_acquireView(JNIEnv* env, const
...
static void Java_ViewAndroidDelegate_removeView(JNIEnv* env, const
...
static void Java_ViewAndroidDelegate_startDragAndDrop(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
