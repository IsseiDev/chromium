...
jlong Java_org_chromium_ui_base_WindowAndroid_nativeInit(JNIEnv* env, jobject
    jcaller) {
  return Init(env, base::android::JavaParamRef<jobject>(env, jcaller));
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_ui_base_WindowAndroid_nativeOnVSync(JNIEnv* env,
    jobject jcaller,
  ...
  return native->OnVSync(env, base::android::JavaParamRef<jobject>(env,
      jcaller), vsyncTimeMicros, vsyncPeriodMicros);
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_ui_base_WindowAndroid_nativeOnVisibilityChanged(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeWindowAndroid,
    jboolean visible) {
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_ui_base_WindowAndroid_nativeOnActivityStopped(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeWindowAndroid) {
  WindowAndroid* native = reinterpret_cast<WindowAndroid*>(nativeWindowAndroid);
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_ui_base_WindowAndroid_nativeOnActivityStarted(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeWindowAndroid) {
  WindowAndroid* native = reinterpret_cast<WindowAndroid*>(nativeWindowAndroid);
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_ui_base_WindowAndroid_nativeDestroy(JNIEnv* env,
    jobject jcaller,
    jlong nativeWindowAndroid) {
  WindowAndroid* native = reinterpret_cast<WindowAndroid*>(nativeWindowAndroid);
...
"Lorg/chromium/ui/base/WindowAndroid;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(WindowAndroid_clazz(env),
...
static jboolean Java_WindowAndroid_hasPermission(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jstring>& permission) {
...
"("
")"
"J", reinterpret_cast<void*>(Java_org_chromium_ui_base_WindowAndroid_nativeInit)
    },
    { "nativeOnVSync",
"("
"J"
