...
namespace {
const char kResourceManagerClassPath[] =
    "org/chromium/ui/resources/ResourceManager";
...
void
    ...
    jint apertureRight,
    jint apertureBottom) {
  ResourceManagerImpl* native =
      reinterpret_cast<ResourceManagerImpl*>(nativeResourceManagerImpl);
  CHECK_NATIVE_PTR(env, jcaller, native, "OnResourceReady");
  return native->OnResourceReady(env, base::android::JavaParamRef<jobject>(env,
      jcaller), resType, resId, base::android::JavaParamRef<jobject>(env,
      bitmap), paddingLeft, paddingTop, paddingRight, paddingBottom,
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ResourceManager_create(JNIEnv* env, const
...
"Lorg/chromium/ui/resources/ResourceManager;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ResourceManager_clazz(env),
...
static void Java_ResourceManager_destroy(JNIEnv* env, const
...
static void Java_ResourceManager_resourceRequested(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper resType,
    JniIntWrapper resId) {
  CHECK_CLAZZ(env, obj.obj(),
      ResourceManager_clazz(env));
  jmethodID method_id =
...
static void Java_ResourceManager_preloadResource(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper resType,
    JniIntWrapper resId) {
  CHECK_CLAZZ(env, obj.obj(),
      ResourceManager_clazz(env));
...
static jlong Java_ResourceManager_getNativePtr(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
