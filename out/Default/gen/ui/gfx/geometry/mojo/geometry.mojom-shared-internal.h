...
class Point_Data {
 ...
 private:
  Point_Data() : header_({sizeof(*this), 0}) {
  }
  ~Point_Data() = delete;
};
...
class PointF_Data {
 ...
 private:
  PointF_Data() : header_({sizeof(*this), 0}) {
  }
  ~PointF_Data() = delete;
};
...
class Size_Data {
 ...
 private:
  Size_Data() : header_({sizeof(*this), 0}) {
  }
  ~Size_Data() = delete;
};
...
class SizeF_Data {
 ...
 private:
  SizeF_Data() : header_({sizeof(*this), 0}) {
  }
  ~SizeF_Data() = delete;
};
...
class Rect_Data {
 ...
 private:
  Rect_Data() : header_({sizeof(*this), 0}) {
  }
  ~Rect_Data() = delete;
};
...
class RectF_Data {
 ...
 private:
  RectF_Data() : header_({sizeof(*this), 0}) {
  }
  ~RectF_Data() = delete;
};
...
class Insets_Data {
 ...
 private:
  Insets_Data() : header_({sizeof(*this), 0}) {
  }
  ~Insets_Data() = delete;
};
...
class InsetsF_Data {
 ...
 private:
  InsetsF_Data() : header_({sizeof(*this), 0}) {
  }
  ~InsetsF_Data() = delete;
};
...
class Vector2d_Data {
 ...
 private:
  Vector2d_Data() : header_({sizeof(*this), 0}) {
  }
...
class Vector2dF_Data {
 ...
 private:
  Vector2dF_Data() : header_({sizeof(*this), 0}) {
  }
