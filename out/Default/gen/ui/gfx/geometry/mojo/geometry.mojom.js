...
define("ui/gfx/geometry/mojo/geometry.mojom", [
  ...
  SizeF.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, SizeF.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  InsetsF.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, InsetsF.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Vector2d.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Vector2d.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Vector2dF.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, Vector2dF.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
