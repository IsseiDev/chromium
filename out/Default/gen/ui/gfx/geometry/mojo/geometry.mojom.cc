...
// static
bool StructTraits<::gfx::mojom::Point, ::gfx::mojom::PointPtr>::Read(
    ::gfx::mojom::PointDataView input,
...
// static
bool StructTraits<::gfx::mojom::PointF, ::gfx::mojom::PointFPtr>::Read(
    ::gfx::mojom::PointFDataView input,
...
// static
bool StructTraits<::gfx::mojom::Size, ::gfx::mojom::SizePtr>::Read(
    ::gfx::mojom::SizeDataView input,
...
// static
bool StructTraits<::gfx::mojom::SizeF, ::gfx::mojom::SizeFPtr>::Read(
    ::gfx::mojom::SizeFDataView input,
...
// static
bool StructTraits<::gfx::mojom::Rect, ::gfx::mojom::RectPtr>::Read(
    ::gfx::mojom::RectDataView input,
...
// static
bool StructTraits<::gfx::mojom::RectF, ::gfx::mojom::RectFPtr>::Read(
    ::gfx::mojom::RectFDataView input,
...
// static
bool StructTraits<::gfx::mojom::Insets, ::gfx::mojom::InsetsPtr>::Read(
    ::gfx::mojom::InsetsDataView input,
...
// static
bool StructTraits<::gfx::mojom::InsetsF, ::gfx::mojom::InsetsFPtr>::Read(
    ::gfx::mojom::InsetsFDataView input,
...
// static
bool StructTraits<::gfx::mojom::Vector2d, ::gfx::mojom::Vector2dPtr>::Read(
    ::gfx::mojom::Vector2dDataView input,
...
// static
bool StructTraits<::gfx::mojom::Vector2dF, ::gfx::mojom::Vector2dFPtr>::Read(
    ::gfx::mojom::Vector2dFDataView input,
