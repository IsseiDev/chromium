...
"Landroid/graphics/Bitmap;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(BitmapHelper_clazz(env),
...
static jint Java_BitmapHelper_getBitmapFormatForConfig(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& bitmapConfig) {
  CHECK_CLAZZ(env, BitmapHelper_clazz(env),
...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(BitmapHelper_clazz(env),
...
static jint Java_BitmapHelper_getByteCount(JNIEnv* env, const
