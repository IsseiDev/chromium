...
namespace {
const char kViewConfigurationHelperClassPath[] =
    "org/chromium/ui/gfx/ViewConfigurationHelper";
...
static void UpdateSharedViewConfiguration(JNIEnv* env, const
...
static base::subtle::AtomicWord g_ViewConfigurationHelper_getDoubleTapTimeout =
    0;
...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(ViewConfigurationHelper_clazz(env),
          method_id);
  jni_generator::CheckException(env);
  return ret;
}

static base::subtle::AtomicWord g_ViewConfigurationHelper_getLongPressTimeout =
    0;
...
static base::subtle::AtomicWord g_ViewConfigurationHelper_getScrollFriction = 0;
static jfloat Java_ViewConfigurationHelper_getScrollFriction(JNIEnv* env) {
  CHECK_CLAZZ(env, ViewConfigurationHelper_clazz(env),
      ViewConfigurationHelper_clazz(env), 0);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
")"
"F",
      &g_ViewConfigurationHelper_getScrollFriction);

  jfloat ret =
      env->CallStaticFloatMethod(ViewConfigurationHelper_clazz(env),
          method_id);
  jni_generator::CheckException(env);
  return ret;
}
...
static base::subtle::AtomicWord
    g_ViewConfigurationHelper_getMaximumFlingVelocity = 0;
...
static base::subtle::AtomicWord
    g_ViewConfigurationHelper_getMinimumFlingVelocity = 0;
...
static base::subtle::AtomicWord g_ViewConfigurationHelper_createWithListener =
    0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_ViewConfigurationHelper_createWithListener(JNIEnv* env, const
...
"Lorg/chromium/ui/gfx/ViewConfigurationHelper;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ViewConfigurationHelper_clazz(env),
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsViewConfigurationHelperSize =
      arraysize(kMethodsViewConfigurationHelper);

  if (env->RegisterNatives(ViewConfigurationHelper_clazz(env),
                           kMethodsViewConfigurationHelper,
                           kMethodsViewConfigurationHelperSize) < 0) {
