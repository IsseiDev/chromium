...
AcceleratedWidgetPtr AcceleratedWidget::New() {
  AcceleratedWidgetPtr rv;
  mojo::internal::StructHelper<AcceleratedWidget>::Initialize(&rv);
  return rv;
}
...
// static
bool StructTraits<::gfx::mojom::AcceleratedWidget, ::gfx::mojom::AcceleratedWidgetPtr>::Read(
    ::gfx::mojom::AcceleratedWidgetDataView input,
