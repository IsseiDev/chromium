...
"Lorg/chromium/ui/base/Clipboard;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(Clipboard_clazz(env),
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_Clipboard_getCoercedText(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jstring>
    Java_Clipboard_getHTMLText(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      Clipboard_clazz(env), NULL);
  jmethodID method_id =
...
static void Java_Clipboard_setText(JNIEnv* env, const
...
static void Java_Clipboard_setHTMLText(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jstring>& html,
...
static void Java_Clipboard_clear(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      Clipboard_clazz(env));
  jmethodID method_id =
