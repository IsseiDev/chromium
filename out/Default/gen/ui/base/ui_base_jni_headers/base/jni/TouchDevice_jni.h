...
static jint Java_TouchDevice_maxTouchPoints(JNIEnv* env, const
...
"I",
  ...
  jint ret =
      env->CallStaticIntMethod(TouchDevice_clazz(env),
          method_id, context.obj());
  jni_generator::CheckException(env);
  return ret;
}

static base::subtle::AtomicWord g_TouchDevice_availablePointerTypes = 0;
static jint Java_TouchDevice_availablePointerTypes(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, TouchDevice_clazz(env),
      TouchDevice_clazz(env), 0);
  jmethodID method_id =
...
")"
"I",
      &g_TouchDevice_availablePointerTypes);
...
static base::subtle::AtomicWord g_TouchDevice_availableHoverTypes = 0;
static jint Java_TouchDevice_availableHoverTypes(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, TouchDevice_clazz(env),
      TouchDevice_clazz(env), 0);
  jmethodID method_id =
...
")"
"I",
      &g_TouchDevice_availableHoverTypes);
