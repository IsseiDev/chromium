...
static jint GetFirstStrongCharacterDirection(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_LocalizationUtils_getJavaLocale(JNIEnv* env, const
...
"Ljava/util/Locale;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(LocalizationUtils_clazz(env),
...
static base::android::ScopedJavaLocalRef<jstring>
    ...
    base::android::JavaRefOrBare<jobject>& locale,
...
"Ljava/lang/String;",
  ...
  jstring ret =
static_cast<jstring>(env->CallStaticObjectMethod(LocalizationUtils_clazz(env),
...
"Z",
  ...
  jboolean ret =
      env->CallStaticBooleanMethod(LocalizationUtils_clazz(env),
          method_id);
  jni_generator::CheckException(env);
  return ret;
}
