...
namespace {
const char kDeviceFormFactorClassPath[] =
    "org/chromium/ui/base/DeviceFormFactor";
...
static jboolean Java_DeviceFormFactor_isTablet(JNIEnv* env, const
...
"Z",
  ...
  jboolean ret =
      env->CallStaticBooleanMethod(DeviceFormFactor_clazz(env),
