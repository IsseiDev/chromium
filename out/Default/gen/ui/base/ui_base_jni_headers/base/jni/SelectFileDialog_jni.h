...
void Java_org_chromium_ui_base_SelectFileDialog_nativeOnFileSelected(JNIEnv*
    env,
    jobject jcaller,
  ...
  return native->OnFileSelected(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, filePath),
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_ui_base_SelectFileDialog_nativeOnFileNotSelected(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeSelectFileDialogImpl) {
  SelectFileDialogImpl* native =
...
static void Java_SelectFileDialog_selectFile(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jobjectArray>& fileTypes,
    jboolean capture,
    jboolean multiple,
...
"Lorg/chromium/ui/base/SelectFileDialog;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(SelectFileDialog_clazz(env),
