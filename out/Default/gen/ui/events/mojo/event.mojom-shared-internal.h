...
class KeyData_Data {
 ...
 private:
  KeyData_Data() : header_({sizeof(*this), 0}) {
  }
  ~KeyData_Data() = delete;
};
...
class LocationData_Data {
 ...
 private:
  LocationData_Data() : header_({sizeof(*this), 0}) {
  }
...
class PointerData_Data {
 ...
 private:
  PointerData_Data() : header_({sizeof(*this), 0}) {
  }
  ~PointerData_Data() = delete;
};
static_assert(sizeof(PointerData_Data) == 40,
...
class WheelData_Data {
 ...
 private:
  WheelData_Data() : header_({sizeof(*this), 0}) {
  }
...
class BrushData_Data {
 ...
 private:
  BrushData_Data() : header_({sizeof(*this), 0}) {
  }
...
class Event_Data {
 ...
 private:
  Event_Data() : header_({sizeof(*this), 0}) {
  }
  ~Event_Data() = delete;
};
