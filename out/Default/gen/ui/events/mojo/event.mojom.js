...
define("ui/events/mojo/event.mojom", [
...
], function(bindings, codec, connection, core, validator, event_constants$, keyboard_codes$) {
  ...
  LocationData.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, LocationData.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PointerData.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, BrushData, true);
    if (err !== validator.validationError.NONE)
        return err;

    
    // validate PointerData.wheel_data
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, WheelData, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PointerData.encodedSize = codec.kStructHeaderSize + 32;
  ...
  WheelData.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, WheelData.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  BrushData.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, BrushData.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
