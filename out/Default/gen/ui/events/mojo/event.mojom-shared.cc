...
bool KeyData_Data::Validate(
  ...
  if (!::ui::mojom::internal::KeyboardCode_Data
        ::Validate(object->windows_key_code, validation_context))
    return false;
...
bool PointerData_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->location, "null location field in PointerData",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateStruct(object->brush_data, validation_context))
    return false;
...
bool WheelData_Data::Validate(
  ...
  if (!::ui::mojom::internal::WheelMode_Data
...
bool BrushData_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const BrushData_Data* object = static_cast<const BrushData_Data*>(data);
