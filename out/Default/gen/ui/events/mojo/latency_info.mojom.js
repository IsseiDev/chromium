...
define("ui/events/mojo/latency_info.mojom", [
...
], function(bindings, codec, connection, core, validator, common_custom_types$, geometry$) {
  ...
  LatencyComponentId.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, LatencyComponentId.encodedSize, 0);
  ...
  LatencyComponent.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, LatencyComponent.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  LatencyComponent.decode = function(decoder) {
    ...
    val.event_time = decoder.decodeStructPointer(common_custom_types$.TimeTicks);
  ...
  LatencyComponent.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(common_custom_types$.TimeTicks, val.event_time);
  ...
  LatencyComponentPair.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, LatencyComponentPair.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  LatencyInfo.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, LatencyInfo.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
