  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_visual_rects;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(34)) goto parse_loop_visual_rects;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_rounded_rects;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(24)) goto parse_antialias;
        break;
      }
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(ClipPathDisplayItem, f) \
...
void ClipPathDisplayItem::clear_clip_op() {
 ...
 ::cc::proto::SkRegion_Op ClipPathDisplayItem::clip_op() const {
  // @@protoc_insertion_point(field_get:cc.proto.ClipPathDisplayItem.clip_op)
  return static_cast< ::cc::proto::SkRegion_Op >(clip_op_);
}
 void ClipPathDisplayItem::set_clip_op(::cc::proto::SkRegion_Op value) {
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(CompositingDisplayItem, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
