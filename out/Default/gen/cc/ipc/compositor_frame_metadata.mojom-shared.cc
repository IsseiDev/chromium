...
bool CompositorFrameMetadata_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->satisfies_sequences, "null satisfies_sequences field in CompositorFrameMetadata",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams satisfies_sequences_validate_params(
      0, false, nullptr);
  if (!mojo::internal::ValidateContainer(object->satisfies_sequences, validation_context,
                                         &satisfies_sequences_validate_params)) {
    return false;
  }
