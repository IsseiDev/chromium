...
define("cc/ipc/compositor_frame_metadata.mojom", [
...
], function(bindings, codec, connection, core, validator, selection$, surface_id$, latency_info$, geometry$) {
  ...
  CompositorFrameMetadata.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, CompositorFrameMetadata.encodedSize, 0);
    ...
    // validate CompositorFrameMetadata.satisfies_sequences
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 88, 8, new codec.PointerTo(surface_id$.SurfaceId), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CompositorFrameMetadata.encodedSize = codec.kStructHeaderSize + 96;
  ...
  CompositorFrameMetadata.decode = function(decoder) {
    ...
    val.satisfies_sequences = decoder.decodeArrayPointer(codec.Uint32);
  ...
  CompositorFrameMetadata.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(codec.Uint32, val.satisfies_sequences);
