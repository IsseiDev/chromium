...
// static
bool StructTraits<::cc::mojom::SharedQuadState, ::cc::mojom::SharedQuadStatePtr>::Read(
    ::cc::mojom::SharedQuadStateDataView input,
    ::cc::mojom::SharedQuadStatePtr* output) {
  bool success = true;
  ::cc::mojom::SharedQuadStatePtr result(::cc::mojom::SharedQuadState::New());
  
      if (!input.ReadQuadToTargetTransform(&result->quad_to_target_transform))
        success = false;
      if (!input.ReadQuadLayerBounds(&result->quad_layer_bounds))
        success = false;
