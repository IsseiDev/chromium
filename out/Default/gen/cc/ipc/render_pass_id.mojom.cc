...
// static
bool StructTraits<::cc::mojom::RenderPassId, ::cc::mojom::RenderPassIdPtr>::Read(
    ::cc::mojom::RenderPassIdDataView input,
    ::cc::mojom::RenderPassIdPtr* output) {
  bool success = true;
  ::cc::mojom::RenderPassIdPtr result(::cc::mojom::RenderPassId::New());
