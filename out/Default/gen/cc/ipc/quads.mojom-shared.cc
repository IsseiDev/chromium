...
bool RenderPassQuadState_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->render_pass_id, "null render_pass_id field in RenderPassQuadState",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->filters, "null filters field in RenderPassQuadState",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->background_filters, "null background_filters field in RenderPassQuadState",
          validation_context)) {
    return false;
  }
...
bool YUVVideoQuadState_Data::Validate(
  ...
  if (!::cc::mojom::internal::YUVColorSpace_Data
