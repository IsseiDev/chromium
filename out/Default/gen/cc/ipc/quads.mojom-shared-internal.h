...
class DebugBorderQuadState_Data {
 ...
 private:
  DebugBorderQuadState_Data() : header_({sizeof(*this), 0}) {
  }
...
class RenderPassQuadState_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<::cc::mojom::internal::RenderPassId_Data> render_pass_id;
 ...
 private:
  RenderPassQuadState_Data() : header_({sizeof(*this), 0}) {
  }
  ~RenderPassQuadState_Data() = delete;
};
static_assert(sizeof(RenderPassQuadState_Data) == 64,
...
class SolidColorQuadState_Data {
 ...
 private:
  SolidColorQuadState_Data() : header_({sizeof(*this), 0}) {
  }
...
class StreamVideoQuadState_Data {
 ...
 private:
  StreamVideoQuadState_Data() : header_({sizeof(*this), 0}) {
  }
...
class SurfaceQuadState_Data {
 ...
 private:
  SurfaceQuadState_Data() : header_({sizeof(*this), 0}) {
  }
...
class TextureQuadState_Data {
 ...
 private:
  TextureQuadState_Data() : header_({sizeof(*this), 0}) {
  }
...
class TileQuadState_Data {
 ...
 private:
  TileQuadState_Data() : header_({sizeof(*this), 0}) {
  }
...
class YUVVideoQuadState_Data {
 ...
 private:
  YUVVideoQuadState_Data() : header_({sizeof(*this), 0}) {
  }
...
class DrawQuad_Data {
 ...
 private:
  DrawQuad_Data() : header_({sizeof(*this), 0}) {
  }
