...
bool FilterOperation_Data::Validate(
  ...
  if (!::cc::mojom::internal::FilterType_Data
        ::Validate(object->type, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->drop_shadow_offset, "null drop_shadow_offset field in FilterOperation",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->image_filter, "null image_filter field in FilterOperation",
          validation_context)) {
    return false;
  }
