...
// static
bool StructTraits<::cc::mojom::CompositorFrameMetadata, ::cc::mojom::CompositorFrameMetadataPtr>::Read(
    ::cc::mojom::CompositorFrameMetadataDataView input,
  ...
  ::cc::mojom::CompositorFrameMetadataPtr result(::cc::mojom::CompositorFrameMetadata::New());
      ...
      if (!input.ReadLatencyInfo(&result->latency_info))
        success = false;
      if (!input.ReadSatisfiesSequences(&result->satisfies_sequences))
        success = false;
