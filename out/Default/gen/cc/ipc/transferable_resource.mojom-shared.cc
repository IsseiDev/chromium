...
bool TransferableResource_Data::Validate(
  ...
  if (!::cc::mojom::internal::ResourceFormat_Data
        ::Validate(object->format, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->size, "null size field in TransferableResource",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->mailbox_holder, "null mailbox_holder field in TransferableResource",
          validation_context)) {
    return false;
  }
