 ...
 public:
  ...
  static mojo::WTFArray<uint8_t> Serialize(UserType* input) {
    return mojo::internal::StructSerializeImpl<
        SurfaceIdPtr, mojo::WTFArray<uint8_t>>(input);
  }
  ...
  static bool Deserialize(const mojo::WTFArray<uint8_t>& input,
    ...
    return mojo::internal::StructDeserializeImpl<
        SurfaceIdPtr, mojo::WTFArray<uint8_t>>(
            input, output);
  }
...
namespace internal {
template <>
struct DataViewTraits<::cc::mojom::blink::SurfaceIdDataView> {
  using MojomType = ::cc::mojom::blink::SurfaceIdPtr;
};
}  // namespace internal
}  // namespace mojo
...
template <>
struct  StructTraits<::cc::mojom::blink::SurfaceId, ::cc::mojom::blink::SurfaceIdPtr> {
  ...
  static decltype(::cc::mojom::blink::SurfaceId::client_id) client_id(
      const ::cc::mojom::blink::SurfaceIdPtr& input) {
    return input->client_id;
  }
  static decltype(::cc::mojom::blink::SurfaceId::local_id) local_id(
      const ::cc::mojom::blink::SurfaceIdPtr& input) {
    return input->local_id;
  }
  static decltype(::cc::mojom::blink::SurfaceId::nonce) nonce(
      const ::cc::mojom::blink::SurfaceIdPtr& input) {
    return input->nonce;
  }

  static bool Read(::cc::mojom::blink::SurfaceIdDataView input, ::cc::mojom::blink::SurfaceIdPtr* output);
};

namespace internal {

template <typename MaybeConstUserType>
struct Serializer<::cc::mojom::blink::SurfaceIdPtr, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::cc::mojom::blink::SurfaceId, UserType>;
  ...
  static bool Deserialize(::cc::mojom::internal::SurfaceId_Data* input,
    ...
    ::cc::mojom::blink::SurfaceIdDataView data_view(input, context);
