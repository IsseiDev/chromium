...
// static
bool StructTraits<::cc::mojom::DebugBorderQuadState, ::cc::mojom::DebugBorderQuadStatePtr>::Read(
    ::cc::mojom::DebugBorderQuadStateDataView input,
...
// static
bool StructTraits<::cc::mojom::RenderPassQuadState, ::cc::mojom::RenderPassQuadStatePtr>::Read(
    ::cc::mojom::RenderPassQuadStateDataView input,
    ::cc::mojom::RenderPassQuadStatePtr* output) {
  bool success = true;
  ::cc::mojom::RenderPassQuadStatePtr result(::cc::mojom::RenderPassQuadState::New());
  
      if (!input.ReadRenderPassId(&result->render_pass_id))
        success = false;
...
// static
bool StructTraits<::cc::mojom::SolidColorQuadState, ::cc::mojom::SolidColorQuadStatePtr>::Read(
    ::cc::mojom::SolidColorQuadStateDataView input,
...
// static
bool StructTraits<::cc::mojom::StreamVideoQuadState, ::cc::mojom::StreamVideoQuadStatePtr>::Read(
    ::cc::mojom::StreamVideoQuadStateDataView input,
...
// static
bool StructTraits<::cc::mojom::SurfaceQuadState, ::cc::mojom::SurfaceQuadStatePtr>::Read(
    ::cc::mojom::SurfaceQuadStateDataView input,
...
// static
bool StructTraits<::cc::mojom::TextureQuadState, ::cc::mojom::TextureQuadStatePtr>::Read(
    ::cc::mojom::TextureQuadStateDataView input,
...
// static
bool StructTraits<::cc::mojom::TileQuadState, ::cc::mojom::TileQuadStatePtr>::Read(
    ::cc::mojom::TileQuadStateDataView input,
...
// static
bool StructTraits<::cc::mojom::YUVVideoQuadState, ::cc::mojom::YUVVideoQuadStatePtr>::Read(
    ::cc::mojom::YUVVideoQuadStateDataView input,
...
// static
bool StructTraits<::cc::mojom::DrawQuad, ::cc::mojom::DrawQuadPtr>::Read(
    ::cc::mojom::DrawQuadDataView input,
...
// static
bool UnionTraits<::cc::mojom::DrawQuadState, ::cc::mojom::DrawQuadStatePtr>::Read(
    ::cc::mojom::DrawQuadStateDataView input,
