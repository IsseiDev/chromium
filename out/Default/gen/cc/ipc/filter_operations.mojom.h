...
#ifndef CC_IPC_FILTER_OPERATIONS_MOJOM_H_
#define CC_IPC_FILTER_OPERATIONS_MOJOM_H_
 ...
 public:
  ...
  static mojo::Array<uint8_t> Serialize(UserType* input) {
    return mojo::internal::StructSerializeImpl<
        FilterOperationsPtr, mojo::Array<uint8_t>>(input);
  }
  ...
  static bool Deserialize(const mojo::Array<uint8_t>& input,
    ...
    return mojo::internal::StructDeserializeImpl<
        FilterOperationsPtr, mojo::Array<uint8_t>>(
            input, output);
  }
...
class FilterOperationsDataView {
 public:
  ...
  bool ReadOperations(UserType* output) {
    ...
    return mojo::internal::Deserialize<mojo::Array<::cc::mojom::FilterOperationPtr>>(
...
namespace internal {
template <>
struct DataViewTraits<::cc::mojom::FilterOperationsDataView> {
  using MojomType = ::cc::mojom::FilterOperationsPtr;
};
}  // namespace internal
}  // namespace mojo
...
template <>
struct  StructTraits<::cc::mojom::FilterOperations, ::cc::mojom::FilterOperationsPtr> {
  static bool IsNull(const ::cc::mojom::FilterOperationsPtr& input) { return !input; }
  static void SetToNull(::cc::mojom::FilterOperationsPtr* output) { output->reset(); }
  static decltype(::cc::mojom::FilterOperations::operations)& operations(
      ::cc::mojom::FilterOperationsPtr& input) {
    return input->operations;
  }

  static bool Read(::cc::mojom::FilterOperationsDataView input, ::cc::mojom::FilterOperationsPtr* output);
};

namespace internal {

template <typename MaybeConstUserType>
struct Serializer<::cc::mojom::FilterOperationsPtr, MaybeConstUserType> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
  using Traits = StructTraits<::cc::mojom::FilterOperations, UserType>;
  ...
  static size_t PrepareToSerialize(MaybeConstUserType& input,
    ...
    size += mojo::internal::PrepareToSerialize<mojo::Array<::cc::mojom::FilterOperationPtr>>(
  ...
  static void Serialize(MaybeConstUserType& input,
    ...
    auto result =
          ::cc::mojom::internal::FilterOperations_Data::New(buffer);
      ...
      const mojo::internal::ContainerValidateParams operations_validate_params(
          0, false, nullptr);
      mojo::internal::Serialize<mojo::Array<::cc::mojom::FilterOperationPtr>>(
...
#endif  // CC_IPC_FILTER_OPERATIONS_MOJOM_H_