...
class CompositorFrameMetadata_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<uint32_t>> satisfies_sequences;
 ...
 private:
  CompositorFrameMetadata_Data() : header_({sizeof(*this), 0}) {
  }
  ~CompositorFrameMetadata_Data() = delete;
};
static_assert(sizeof(CompositorFrameMetadata_Data) == 104,
