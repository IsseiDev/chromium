...
define("cc/ipc/quads.mojom", [
...
], function(bindings, codec, connection, core, validator, filter_operations$, render_pass_id$, shared_quad_state$, surface_id$, geometry$, transform$) {
  var YUVColorSpace = {};
  ...
  RenderPassQuadState.validate = function(messageValidator, offset) {
    ...
    // validate RenderPassQuadState.filters
    ...
    // validate RenderPassQuadState.background_filters
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 48, filter_operations$.FilterOperations, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RenderPassQuadState.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.render_pass_id = decoder.decodeStructPointer(render_pass_id$.RenderPassId);
  ...
  RenderPassQuadState.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(render_pass_id$.RenderPassId, val.render_pass_id);
  ...
  DrawQuad.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, DrawQuad.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
