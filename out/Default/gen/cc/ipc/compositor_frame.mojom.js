...
define("cc/ipc/compositor_frame.mojom", [
...
], function(bindings, codec, connection, core, validator, compositor_frame_metadata$, render_pass$, transferable_resource$) {
  ...
  CompositorFrame.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, CompositorFrame.encodedSize, 0);
