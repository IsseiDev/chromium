...
// static
bool StructTraits<::cc::mojom::BeginFrameArgs, ::cc::mojom::BeginFrameArgsPtr>::Read(
    ::cc::mojom::BeginFrameArgsDataView input,
    ::cc::mojom::BeginFrameArgsPtr* output) {
  bool success = true;
  ::cc::mojom::BeginFrameArgsPtr result(::cc::mojom::BeginFrameArgs::New());
