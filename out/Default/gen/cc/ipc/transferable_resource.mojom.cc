...
// static
bool StructTraits<::cc::mojom::TransferableResource, ::cc::mojom::TransferableResourcePtr>::Read(
    ::cc::mojom::TransferableResourceDataView input,
    ::cc::mojom::TransferableResourcePtr* output) {
  bool success = true;
  ::cc::mojom::TransferableResourcePtr result(::cc::mojom::TransferableResource::New());
