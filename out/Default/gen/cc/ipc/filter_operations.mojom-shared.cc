...
// static
bool FilterOperations_Data::Validate(
    const void* data,
  ...
  const FilterOperations_Data* object = static_cast<const FilterOperations_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->operations, "null operations field in FilterOperations",
          validation_context)) {
    return false;
  }
