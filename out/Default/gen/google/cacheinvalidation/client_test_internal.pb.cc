...
const RegistrationManagerStateP& RegistrationManagerStateP::default_instance() {
  ...
  protobuf_AddDesc_client_5ftest_5finternal_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_client_5ftest_5finternal_2eproto();
#endif
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_server_summary;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_registered_objects;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(26)) goto parse_loop_registered_objects;
