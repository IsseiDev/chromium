...
"Lorg/chromium/printing/PrintingContext;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(PrintingContext_clazz(env),
...
static jint Java_PrintingContext_getDpi(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      PrintingContext_clazz(env), 0);
  jmethodID method_id =
...
static jint Java_PrintingContext_getWidth(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      PrintingContext_clazz(env), 0);
  jmethodID method_id =
...
static jint Java_PrintingContext_getHeight(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      PrintingContext_clazz(env), 0);
  jmethodID method_id =
...
static void Java_PrintingContext_showPrintDialog(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static base::android::ScopedJavaLocalRef<jintArray>
    Java_PrintingContext_getPages(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      PrintingContext_clazz(env), NULL);
  jmethodID method_id =
...
static void Java_PrintingContext_pageCountEstimationDone(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper maxPages) {
  CHECK_CLAZZ(env, obj.obj(),
      PrintingContext_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
