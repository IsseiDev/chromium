...
class StartupPerformanceTimes_Data {
 ...
 private:
  StartupPerformanceTimes_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kProvider_StartTracing_Name = 0;
class Provider_StartTracing_Params_Data {
 ...
 private:
  Provider_StartTracing_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kProvider_StopTracing_Name = 1;
class Provider_StopTracing_Params_Data {
 ...
 private:
  Provider_StopTracing_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kRecorder_Record_Name = 0;
class Recorder_Record_Params_Data {
 ...
 private:
  Recorder_Record_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kCollector_Start_Name = 0;
class Collector_Start_Params_Data {
 ...
 private:
  Collector_Start_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kCollector_StopAndFlush_Name = 1;
class Collector_StopAndFlush_Params_Data {
 ...
 private:
  Collector_StopAndFlush_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kStartupPerformanceDataCollector_SetShellProcessCreationTime_Name = 0;
class StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data {
 public:
  static StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data))) StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data();
  }
 ...
 private:
  StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data() = delete;
};
static_assert(sizeof(StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data) == 16,
              "Bad sizeof(StartupPerformanceDataCollector_SetShellProcessCreationTime_Params_Data)");
const uint32_t kStartupPerformanceDataCollector_SetShellMainEntryPointTime_Name = 1;
class StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data {
 public:
  static StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data))) StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data();
  }
 ...
 private:
  StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data() = delete;
};
static_assert(sizeof(StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data) == 16,
              "Bad sizeof(StartupPerformanceDataCollector_SetShellMainEntryPointTime_Params_Data)");
const uint32_t kStartupPerformanceDataCollector_SetBrowserMessageLoopStartTicks_Name = 2;
class StartupPerformanceDataCollector_SetBrowserMessageLoopStartTicks_Params_Data {
 ...
 private:
  StartupPerformanceDataCollector_SetBrowserMessageLoopStartTicks_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kStartupPerformanceDataCollector_SetBrowserWindowDisplayTicks_Name = 3;
class StartupPerformanceDataCollector_SetBrowserWindowDisplayTicks_Params_Data {
 ...
 private:
  StartupPerformanceDataCollector_SetBrowserWindowDisplayTicks_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kStartupPerformanceDataCollector_SetBrowserOpenTabsTimeDelta_Name = 4;
class StartupPerformanceDataCollector_SetBrowserOpenTabsTimeDelta_Params_Data {
 ...
 private:
  StartupPerformanceDataCollector_SetBrowserOpenTabsTimeDelta_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kStartupPerformanceDataCollector_SetFirstWebContentsMainFrameLoadTicks_Name = 5;
class StartupPerformanceDataCollector_SetFirstWebContentsMainFrameLoadTicks_Params_Data {
 ...
 private:
  StartupPerformanceDataCollector_SetFirstWebContentsMainFrameLoadTicks_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kStartupPerformanceDataCollector_SetFirstVisuallyNonEmptyLayoutTicks_Name = 6;
class StartupPerformanceDataCollector_SetFirstVisuallyNonEmptyLayoutTicks_Params_Data {
 ...
 private:
  StartupPerformanceDataCollector_SetFirstVisuallyNonEmptyLayoutTicks_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kStartupPerformanceDataCollector_GetStartupPerformanceTimes_Name = 7;
class StartupPerformanceDataCollector_GetStartupPerformanceTimes_Params_Data {
 ...
 private:
  StartupPerformanceDataCollector_GetStartupPerformanceTimes_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class StartupPerformanceDataCollector_GetStartupPerformanceTimes_ResponseParams_Data {
 ...
 private:
  StartupPerformanceDataCollector_GetStartupPerformanceTimes_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFactory_CreateRecorder_Name = 0;
class Factory_CreateRecorder_Params_Data {
 ...
 private:
  Factory_CreateRecorder_Params_Data() : header_({sizeof(*this), 0}) {
  }
