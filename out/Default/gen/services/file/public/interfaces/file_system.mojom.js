...
define("services/file/public/interfaces/file_system.mojom", [
  ...
  FileSystem_GetDirectory_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, FileSystem_GetDirectory_Params.encodedSize, 0);
  ...
  FileSystem_GetDirectory_Params.decode = function(decoder) {
    ...
    val.dir = decoder.decodeStruct(codec.Handle);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  FileSystem_GetDirectory_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Handle, val.dir);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  FileSystem_GetDirectory_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, FileSystem_GetDirectory_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FileSystem_GetSubDirectory_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, FileSystem_GetSubDirectory_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FileSystem_GetSubDirectory_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, FileSystem_GetSubDirectory_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FileSystemProxy.prototype.getDirectory = function(dir) {
    ...
    params.dir = core.isHandle(dir) ? dir : connection.bindProxy(dir, directory$.Directory);
  ...
  FileSystemStub.prototype.getDirectory = function(dir) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.getDirectory && bindings.StubBindings(this).delegate.getDirectory(connection.bindHandleToStub(dir, directory$.Directory));
  }
  FileSystemStub.prototype.getSubDirectory = function(dir_path, dir) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.getSubDirectory && bindings.StubBindings(this).delegate.getSubDirectory(dir_path, connection.bindHandleToStub(dir, directory$.Directory));
  }
