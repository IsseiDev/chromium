...
define("services/ui/public/interfaces/window_manager_window_tree_factory.mojom", [
...
], function(bindings, codec, connection, core, validator, window_manager_constants$, window_tree$) {
  ...
  WindowManagerWindowTreeFactory_CreateWindowTree_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, WindowManagerWindowTreeFactory_CreateWindowTree_Params.encodedSize, 0);
  ...
  WindowManagerWindowTreeFactoryProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  WindowManagerWindowTreeFactoryProxy.prototype.createWindowTree = function(tree_request, client) {
    ...
    params.tree_request = core.isHandle(tree_request) ? tree_request : connection.bindProxy(tree_request, window_tree$.WindowTree);
    params.client = core.isHandle(client) ? client : connection.bindImpl(client, window_tree$.WindowTreeClient);
  ...
  WindowManagerWindowTreeFactoryStub.prototype = Object.create(bindings.StubBase.prototype);
  WindowManagerWindowTreeFactoryStub.prototype.createWindowTree = function(tree_request, client) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.createWindowTree && bindings.StubBindings(this).delegate.createWindowTree(connection.bindHandleToStub(tree_request, window_tree$.WindowTree), connection.bindHandleToProxy(client, window_tree$.WindowTreeClient));
  }
