...
#pragma pack(push, 1)
const uint32_t kClipboard_GetSequenceNumber_Name = 0;
class Clipboard_GetSequenceNumber_Params_Data {
 ...
 private:
  Clipboard_GetSequenceNumber_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Clipboard_GetSequenceNumber_ResponseParams_Data {
 ...
 private:
  Clipboard_GetSequenceNumber_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kClipboard_GetAvailableMimeTypes_Name = 1;
class Clipboard_GetAvailableMimeTypes_Params_Data {
 ...
 private:
  Clipboard_GetAvailableMimeTypes_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Clipboard_GetAvailableMimeTypes_ResponseParams_Data {
 ...
 private:
  Clipboard_GetAvailableMimeTypes_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kClipboard_ReadClipboardData_Name = 2;
class Clipboard_ReadClipboardData_Params_Data {
 ...
 private:
  Clipboard_ReadClipboardData_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Clipboard_ReadClipboardData_ResponseParams_Data {
 ...
 private:
  Clipboard_ReadClipboardData_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kClipboard_WriteClipboardData_Name = 3;
class Clipboard_WriteClipboardData_Params_Data {
 ...
 private:
  Clipboard_WriteClipboardData_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Clipboard_WriteClipboardData_ResponseParams_Data {
 ...
 private:
  Clipboard_WriteClipboardData_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
