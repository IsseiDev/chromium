...
bool NativePixmapHandle_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->fd,
          "invalid fd field in NativePixmapHandle", validation_context)) {
    return false;
  }
...
bool GpuMemoryBufferHandle_Data::Validate(
  ...
  if (!::ui::mojom::internal::GpuMemoryBufferType_Data
        ::Validate(object->type, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->id, "null id field in GpuMemoryBufferHandle",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->buffer_handle,
          "invalid buffer_handle field in GpuMemoryBufferHandle", validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateStruct(object->native_pixmap_handle, validation_context))
    return false;
