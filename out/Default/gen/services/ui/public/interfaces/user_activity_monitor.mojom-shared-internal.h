...
#pragma pack(push, 1)
const uint32_t kUserActivityObserver_OnUserActivity_Name = 0;
class UserActivityObserver_OnUserActivity_Params_Data {
 ...
 private:
  UserActivityObserver_OnUserActivity_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kUserIdleObserver_OnUserIdleStateChanged_Name = 0;
class UserIdleObserver_OnUserIdleStateChanged_Params_Data {
 ...
 private:
  UserIdleObserver_OnUserIdleStateChanged_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kUserActivityMonitor_AddUserActivityObserver_Name = 0;
class UserActivityMonitor_AddUserActivityObserver_Params_Data {
 ...
 private:
  UserActivityMonitor_AddUserActivityObserver_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kUserActivityMonitor_AddUserIdleObserver_Name = 1;
class UserActivityMonitor_AddUserIdleObserver_Params_Data {
 ...
 private:
  UserActivityMonitor_AddUserIdleObserver_Params_Data() : header_({sizeof(*this), 0}) {
  }
