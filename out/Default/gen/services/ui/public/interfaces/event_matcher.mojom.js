...
define("services/ui/public/interfaces/event_matcher.mojom", [
...
], function(bindings, codec, connection, core, validator, event_constants$, keyboard_codes$, geometry$) {
  ...
  KeyEventMatcher.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, KeyEventMatcher.encodedSize, 0);
  ...
  PointerKindMatcher.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, PointerKindMatcher.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PointerLocationMatcher.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, PointerLocationMatcher.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  EventTypeMatcher.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, EventTypeMatcher.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  EventFlagsMatcher.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, EventFlagsMatcher.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  EventMatcher.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, EventMatcher.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
