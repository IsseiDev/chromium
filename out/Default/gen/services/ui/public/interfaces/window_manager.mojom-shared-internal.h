...
#pragma pack(push, 1)
const uint32_t kWindowManager_OnConnect_Name = 0;
...
const uint32_t kWindowManager_WmNewDisplayAdded_Name = 1;
...
const uint32_t kWindowManager_WmSetBounds_Name = 2;
...
const uint32_t kWindowManager_WmSetProperty_Name = 3;
...
const uint32_t kWindowManager_WmCreateTopLevelWindow_Name = 4;
...
const uint32_t kWindowManager_WmClientJankinessChanged_Name = 5;
...
const uint32_t kWindowManager_WmPerformMoveLoop_Name = 6;
...
const uint32_t kWindowManager_WmCancelMoveLoop_Name = 7;
...
const uint32_t kWindowManager_OnAccelerator_Name = 8;
...
const uint32_t kWindowManagerClient_AddActivationParent_Name = 0;
...
const uint32_t kWindowManagerClient_RemoveActivationParent_Name = 1;
...
const uint32_t kWindowManagerClient_ActivateNextWindow_Name = 2;
...
const uint32_t kWindowManagerClient_SetUnderlaySurfaceOffsetAndExtendedHitArea_Name = 3;
class WindowManagerClient_SetUnderlaySurfaceOffsetAndExtendedHitArea_Params_Data {
 ...
 private:
  WindowManagerClient_SetUnderlaySurfaceOffsetAndExtendedHitArea_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWindowManagerClient_AddAccelerator_Name = 4;
class WindowManagerClient_AddAccelerator_Params_Data {
 public:
  static WindowManagerClient_AddAccelerator_Params_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(WindowManagerClient_AddAccelerator_Params_Data))) WindowManagerClient_AddAccelerator_Params_Data();
  }
 ...
 private:
  WindowManagerClient_AddAccelerator_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~WindowManagerClient_AddAccelerator_Params_Data() = delete;
};
static_assert(sizeof(WindowManagerClient_AddAccelerator_Params_Data) == 24,
              "Bad sizeof(WindowManagerClient_AddAccelerator_Params_Data)");
class WindowManagerClient_AddAccelerator_ResponseParams_Data {
 public:
  static WindowManagerClient_AddAccelerator_ResponseParams_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(WindowManagerClient_AddAccelerator_ResponseParams_Data))) WindowManagerClient_AddAccelerator_ResponseParams_Data();
  }
 ...
 private:
  WindowManagerClient_AddAccelerator_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
  ~WindowManagerClient_AddAccelerator_ResponseParams_Data() = delete;
};
static_assert(sizeof(WindowManagerClient_AddAccelerator_ResponseParams_Data) == 16,
              "Bad sizeof(WindowManagerClient_AddAccelerator_ResponseParams_Data)");
const uint32_t kWindowManagerClient_RemoveAccelerator_Name = 5;
...
const uint32_t kWindowManagerClient_WmResponse_Name = 6;
...
const uint32_t kWindowManagerClient_WmRequestClose_Name = 7;
...
const uint32_t kWindowManagerClient_WmSetFrameDecorationValues_Name = 8;
...
const uint32_t kWindowManagerClient_WmSetNonClientCursor_Name = 9;
...
const uint32_t kWindowManagerClient_OnWmCreatedTopLevelWindow_Name = 10;
...
const uint32_t kWindowManagerClient_OnAcceleratorAck_Name = 11;
