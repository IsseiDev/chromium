...
WindowDataPtr WindowData::New() {
  WindowDataPtr rv;
  mojo::internal::StructHelper<WindowData>::Initialize(&rv);
  return rv;
}
...
// static
bool StructTraits<::ui::mojom::WindowData, ::ui::mojom::WindowDataPtr>::Read(
    ::ui::mojom::WindowDataDataView input,
