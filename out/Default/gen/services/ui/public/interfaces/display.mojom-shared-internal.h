...
#ifndef SERVICES_UI_PUBLIC_INTERFACES_DISPLAY_MOJOM_SHARED_INTERNAL_H_
#define SERVICES_UI_PUBLIC_INTERFACES_DISPLAY_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
const uint32_t kDisplayManagerObserver_OnDisplays_Name = 0;
class DisplayManagerObserver_OnDisplays_Params_Data {
 ...
 private:
  DisplayManagerObserver_OnDisplays_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~DisplayManagerObserver_OnDisplays_Params_Data() = delete;
};
static_assert(sizeof(DisplayManagerObserver_OnDisplays_Params_Data) == 16,
              "Bad sizeof(DisplayManagerObserver_OnDisplays_Params_Data)");
const uint32_t kDisplayManagerObserver_OnDisplaysChanged_Name = 1;
class DisplayManagerObserver_OnDisplaysChanged_Params_Data {
 ...
 private:
  DisplayManagerObserver_OnDisplaysChanged_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDisplayManagerObserver_OnDisplayRemoved_Name = 2;
class DisplayManagerObserver_OnDisplayRemoved_Params_Data {
 ...
 private:
  DisplayManagerObserver_OnDisplayRemoved_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kDisplayManager_AddObserver_Name = 0;
class DisplayManager_AddObserver_Params_Data {
 ...
 private:
  DisplayManager_AddObserver_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
#endif  // SERVICES_UI_PUBLIC_INTERFACES_DISPLAY_MOJOM_SHARED_INTERNAL_H_