...
define("services/ui/public/interfaces/user_access_manager.mojom", [
  ...
  UserAccessManager_SetActiveUser_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, UserAccessManager_SetActiveUser_Params.encodedSize, 0);
  ...
  UserAccessManagerProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  UserAccessManagerStub.prototype = Object.create(bindings.StubBase.prototype);
  UserAccessManagerStub.prototype.setActiveUser = function(user_id) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.setActiveUser && bindings.StubBindings(this).delegate.setActiveUser(user_id);
  }
