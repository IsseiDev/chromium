...
using UserAccessManagerAssociatedPtr =
    mojo::AssociatedInterfacePtr<UserAccessManager>;
using UserAccessManagerAssociatedPtrInfo =
    mojo::AssociatedInterfacePtrInfo<UserAccessManager>;
using UserAccessManagerAssociatedRequest =
    mojo::AssociatedInterfaceRequest<UserAccessManager>;
...
class  UserAccessManagerStub : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
 public:
  UserAccessManagerStub();
  ~UserAccessManagerStub() override;
  void set_sink(UserAccessManager* sink) { sink_ = sink; }
  UserAccessManager* sink() { return sink_; }
  mojo::internal::SerializationContext* serialization_context() {
    return &serialization_context_;
  }
 ...
 private:
  UserAccessManager* sink_;
  mojo::internal::SerializationContext serialization_context_;
  mojo::internal::ControlMessageHandler control_message_handler_;
};
class  UserAccessManagerRequestValidator : public NON_EXPORTED_BASE(mojo::MessageFilter) {
 public:
  explicit UserAccessManagerRequestValidator(mojo::MessageReceiver* sink = nullptr);
