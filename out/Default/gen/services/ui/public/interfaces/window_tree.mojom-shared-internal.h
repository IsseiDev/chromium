...
#include "services/ui/public/interfaces/surface.mojom-shared-internal.h"
...
#pragma pack(push, 1)
const uint32_t kWindowTree_NewWindow_Name = 0;
...
const uint32_t kWindowTree_NewTopLevelWindow_Name = 1;
...
const uint32_t kWindowTree_DeleteWindow_Name = 2;
...
const uint32_t kWindowTree_SetCapture_Name = 3;
...
const uint32_t kWindowTree_ReleaseCapture_Name = 4;
...
const uint32_t kWindowTree_StartPointerWatcher_Name = 5;
...
const uint32_t kWindowTree_StopPointerWatcher_Name = 6;
...
const uint32_t kWindowTree_SetWindowBounds_Name = 7;
...
const uint32_t kWindowTree_SetClientArea_Name = 8;
...
const uint32_t kWindowTree_SetHitTestMask_Name = 9;
...
const uint32_t kWindowTree_SetWindowVisibility_Name = 10;
...
const uint32_t kWindowTree_SetWindowProperty_Name = 11;
...
const uint32_t kWindowTree_SetWindowOpacity_Name = 12;
...
const uint32_t kWindowTree_AttachSurface_Name = 13;
class WindowTree_AttachSurface_Params_Data {
 public:
  static WindowTree_AttachSurface_Params_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(WindowTree_AttachSurface_Params_Data))) WindowTree_AttachSurface_Params_Data();
  }
  ...
  uint32_t window_id;
  int32_t type;
  mojo::internal::Handle_Data surface;
  mojo::internal::Interface_Data client;
  uint8_t padfinal_[4];

 private:
  WindowTree_AttachSurface_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~WindowTree_AttachSurface_Params_Data() = delete;
};
static_assert(sizeof(WindowTree_AttachSurface_Params_Data) == 32,
              "Bad sizeof(WindowTree_AttachSurface_Params_Data)");
const uint32_t kWindowTree_AddWindow_Name = 14;
...
const uint32_t kWindowTree_RemoveWindowFromParent_Name = 15;
...
const uint32_t kWindowTree_AddTransientWindow_Name = 16;
...
const uint32_t kWindowTree_RemoveTransientWindowFromParent_Name = 17;
...
const uint32_t kWindowTree_SetModal_Name = 18;
class WindowTree_SetModal_Params_Data {
 ...
 private:
  WindowTree_SetModal_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWindowTree_ReorderWindow_Name = 19;
...
const uint32_t kWindowTree_GetWindowTree_Name = 20;
...
const uint32_t kWindowTree_Embed_Name = 21;
...
const uint32_t kWindowTree_SetFocus_Name = 22;
...
const uint32_t kWindowTree_SetCanFocus_Name = 23;
...
const uint32_t kWindowTree_SetPredefinedCursor_Name = 24;
class WindowTree_SetPredefinedCursor_Params_Data {
 ...
 private:
  WindowTree_SetPredefinedCursor_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWindowTree_SetWindowTextInputState_Name = 25;
...
const uint32_t kWindowTree_SetImeVisibility_Name = 26;
...
const uint32_t kWindowTree_SetCanAcceptEvents_Name = 27;
class WindowTree_SetCanAcceptEvents_Params_Data {
 ...
 private:
  WindowTree_SetCanAcceptEvents_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWindowTree_OnWindowInputEventAck_Name = 28;
...
const uint32_t kWindowTree_GetWindowManagerClient_Name = 29;
...
const uint32_t kWindowTree_GetCursorLocationMemory_Name = 30;
...
const uint32_t kWindowTree_PerformWindowMove_Name = 31;
...
const uint32_t kWindowTree_CancelWindowMove_Name = 32;
...
const uint32_t kWindowTreeClient_OnEmbed_Name = 0;
...
const uint32_t kWindowTreeClient_OnEmbeddedAppDisconnected_Name = 1;
...
const uint32_t kWindowTreeClient_OnUnembed_Name = 2;
...
const uint32_t kWindowTreeClient_OnCaptureChanged_Name = 3;
...
const uint32_t kWindowTreeClient_OnTopLevelCreated_Name = 4;
...
const uint32_t kWindowTreeClient_OnWindowBoundsChanged_Name = 5;
...
const uint32_t kWindowTreeClient_OnClientAreaChanged_Name = 6;
...
const uint32_t kWindowTreeClient_OnTransientWindowAdded_Name = 7;
...
const uint32_t kWindowTreeClient_OnTransientWindowRemoved_Name = 8;
...
const uint32_t kWindowTreeClient_OnWindowHierarchyChanged_Name = 9;
...
const uint32_t kWindowTreeClient_OnWindowReordered_Name = 10;
...
const uint32_t kWindowTreeClient_OnWindowDeleted_Name = 11;
...
const uint32_t kWindowTreeClient_OnWindowVisibilityChanged_Name = 12;
...
const uint32_t kWindowTreeClient_OnWindowOpacityChanged_Name = 13;
...
const uint32_t kWindowTreeClient_OnWindowParentDrawnStateChanged_Name = 14;
...
const uint32_t kWindowTreeClient_OnWindowSharedPropertyChanged_Name = 15;
...
const uint32_t kWindowTreeClient_OnWindowInputEvent_Name = 16;
...
const uint32_t kWindowTreeClient_OnPointerEventObserved_Name = 17;
...
const uint32_t kWindowTreeClient_OnWindowFocused_Name = 18;
...
const uint32_t kWindowTreeClient_OnWindowPredefinedCursorChanged_Name = 19;
class WindowTreeClient_OnWindowPredefinedCursorChanged_Params_Data {
 ...
 private:
  WindowTreeClient_OnWindowPredefinedCursorChanged_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWindowTreeClient_OnChangeCompleted_Name = 20;
...
const uint32_t kWindowTreeClient_RequestClose_Name = 21;
...
const uint32_t kWindowTreeClient_GetWindowManager_Name = 22;
...
const uint32_t kWindowTreeFactory_CreateWindowTree_Name = 0;
