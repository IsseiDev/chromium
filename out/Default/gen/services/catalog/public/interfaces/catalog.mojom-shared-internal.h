...
class Entry_Data {
 ...
 private:
  Entry_Data() : header_({sizeof(*this), 0}) {
  }
  ~Entry_Data() = delete;
};
static_assert(sizeof(Entry_Data) == 24,
              "Bad sizeof(Entry_Data)");
const uint32_t kCatalog_GetEntries_Name = 0;
class Catalog_GetEntries_Params_Data {
 ...
 private:
  Catalog_GetEntries_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Catalog_GetEntries_ResponseParams_Data {
 ...
 private:
  Catalog_GetEntries_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kCatalog_GetEntriesProvidingClass_Name = 1;
class Catalog_GetEntriesProvidingClass_Params_Data {
 public:
  static Catalog_GetEntriesProvidingClass_Params_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(Catalog_GetEntriesProvidingClass_Params_Data))) Catalog_GetEntriesProvidingClass_Params_Data();
  }
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<mojo::internal::String_Data> clazz;

 private:
  Catalog_GetEntriesProvidingClass_Params_Data() : header_({sizeof(*this), 0}) {
  }
  ~Catalog_GetEntriesProvidingClass_Params_Data() = delete;
};
static_assert(sizeof(Catalog_GetEntriesProvidingClass_Params_Data) == 16,
              "Bad sizeof(Catalog_GetEntriesProvidingClass_Params_Data)");
class Catalog_GetEntriesProvidingClass_ResponseParams_Data {
 public:
  static Catalog_GetEntriesProvidingClass_ResponseParams_Data* New(mojo::internal::Buffer* buf) {
    return new (buf->Allocate(sizeof(Catalog_GetEntriesProvidingClass_ResponseParams_Data))) Catalog_GetEntriesProvidingClass_ResponseParams_Data();
  }
 ...
 private:
  Catalog_GetEntriesProvidingClass_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
  ~Catalog_GetEntriesProvidingClass_ResponseParams_Data() = delete;
};
static_assert(sizeof(Catalog_GetEntriesProvidingClass_ResponseParams_Data) == 16,
              "Bad sizeof(Catalog_GetEntriesProvidingClass_ResponseParams_Data)");
const uint32_t kCatalog_GetEntriesConsumingMIMEType_Name = 2;
class Catalog_GetEntriesConsumingMIMEType_Params_Data {
 ...
 private:
  Catalog_GetEntriesConsumingMIMEType_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Catalog_GetEntriesConsumingMIMEType_ResponseParams_Data {
 ...
 private:
  Catalog_GetEntriesConsumingMIMEType_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kCatalog_GetEntriesSupportingScheme_Name = 3;
class Catalog_GetEntriesSupportingScheme_Params_Data {
 ...
 private:
  Catalog_GetEntriesSupportingScheme_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class Catalog_GetEntriesSupportingScheme_ResponseParams_Data {
 ...
 private:
  Catalog_GetEntriesSupportingScheme_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
