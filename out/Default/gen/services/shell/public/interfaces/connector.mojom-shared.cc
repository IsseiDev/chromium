...
// static
bool ClientProcessConnection_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const ClientProcessConnection_Data* object = static_cast<const ClientProcessConnection_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->service,
          "invalid service field in ClientProcessConnection", validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          ...
          "invalid pid_receiver_request field in ClientProcessConnection", validation_context)) {
    return false;
  }
...
bool Connector_Connect_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateStruct(object->client_process_connection, validation_context))
    return false;
...
bool Connector_Connect_ResponseParams_Data::Validate(
  ...
  if (!::shell::mojom::internal::ConnectResult_Data
