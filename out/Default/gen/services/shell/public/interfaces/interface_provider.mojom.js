...
define("services/shell/public/interfaces/interface_provider.mojom", [
  ...
  InterfaceProvider_GetInterface_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, InterfaceProvider_GetInterface_Params.encodedSize, 0);
  ...
  InterfaceProviderProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  InterfaceProviderStub.prototype = Object.create(bindings.StubBase.prototype);
  InterfaceProviderStub.prototype.getInterface = function(interface_name, pipe) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.getInterface && bindings.StubBindings(this).delegate.getInterface(interface_name, pipe);
  }
  ...
  var InterfaceProvider = {
    name: 'shell::mojom::InterfaceProvider',
