...
#ifndef SERVICES_SHELL_PUBLIC_INTERFACES_SERVICE_FACTORY_MOJOM_H_
#define SERVICES_SHELL_PUBLIC_INTERFACES_SERVICE_FACTORY_MOJOM_H_
...
#include "services/shell/public/interfaces/service_factory.mojom-shared.h"
...
class  ServiceFactory {
 public:
  ...
  virtual void CreateService(::shell::mojom::ServiceRequest service, const std::string& name) = 0;
};
...
class  ServiceFactoryProxy
 ...
 public:
  ...
  void CreateService(::shell::mojom::ServiceRequest service, const std::string& name) override;
...
#endif  // SERVICES_SHELL_PUBLIC_INTERFACES_SERVICE_FACTORY_MOJOM_H_