...
bool Service_OnStart_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->identity, "null identity field in Service_OnStart_Params",
          validation_context)) {
    return false;
  }
...
// static
bool Service_OnConnect_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const Service_OnConnect_Params_Data* object = static_cast<const Service_OnConnect_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->source, "null source field in Service_OnConnect_Params",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->allowed_capabilities, "null allowed_capabilities field in Service_OnConnect_Params",
          validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->allowed_capabilities, validation_context))
    return false;
