...
#ifndef SERVICES_SHELL_PUBLIC_INTERFACES_INTERFACE_PROVIDER_MOJOM_SHARED_INTERNAL_H_
#define SERVICES_SHELL_PUBLIC_INTERFACES_INTERFACE_PROVIDER_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
const uint32_t kInterfaceProvider_GetInterface_Name = 0;
class InterfaceProvider_GetInterface_Params_Data {
 ...
 private:
  InterfaceProvider_GetInterface_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
#endif  // SERVICES_SHELL_PUBLIC_INTERFACES_INTERFACE_PROVIDER_MOJOM_SHARED_INTERNAL_H_