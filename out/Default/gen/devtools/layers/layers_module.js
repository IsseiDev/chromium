...
return Promise.reject(new Error("Internal error: not a WebInspector.DeferredLayerTree"));var panel=(self.runtime.sharedInstance(WebInspector.LayersPanel));WebInspector.inspectorView.setCurrentPanel(panel);panel._showLayerTree((snapshotData));return Promise.resolve();}};