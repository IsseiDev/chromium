...
const ChromeUserMetricsExtension& ChromeUserMetricsExtension::default_instance() {
  ...
  protobuf_AddDesc_chrome_5fuser_5fmetrics_5fextension_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_chrome_5fuser_5fmetrics_5fextension_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(ChromeUserMetricsExtension, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_system_profile;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_user_action_event;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(34)) goto parse_loop_user_action_event;
        if (input->ExpectTag(42)) goto parse_loop_omnibox_event;
      ...
      case 5: {
        ...
        if (input->ExpectTag(42)) goto parse_loop_omnibox_event;
        if (input->ExpectTag(50)) goto parse_loop_histogram_event;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(50)) goto parse_loop_histogram_event;
        if (input->ExpectTag(58)) goto parse_loop_profiler_event;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(58)) goto parse_loop_profiler_event;
        if (input->ExpectTag(66)) goto parse_loop_perf_data;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(66)) goto parse_loop_perf_data;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(80)) goto parse_product;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(90)) goto parse_sampled_profile;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(90)) goto parse_loop_sampled_profile;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(98)) goto parse_cast_logs;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(106)) goto parse_memory_leak_report;
        break;
      }
      ...
      case 13: {
        ...
        if (input->ExpectTag(106)) goto parse_loop_memory_leak_report;
        input->UnsafeDecrementRecursionDepth();
