...
const ProfilerEventProto_TrackedObject& ProfilerEventProto_TrackedObject::default_instance() {
  ...
  protobuf_AddDesc_profiler_5fevent_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_profiler_5fevent_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(ProfilerEventProto_TrackedObject, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(17)) goto parse_exec_thread_name_hash;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(25)) goto parse_source_file_name_hash;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(33)) goto parse_source_function_name_hash;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_source_line_number;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_exec_count;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_exec_time_total;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_exec_time_sampled;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_queue_time_total;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(80)) goto parse_queue_time_sampled;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_process_type;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(96)) goto parse_process_id;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(ProfilerEventProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_tracked_object;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(26)) goto parse_loop_tracked_object;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(32)) goto parse_past_session_event;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(32)) goto parse_past_session_event;
        if (input->ExpectTag(40)) goto parse_profiling_start_ms;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_profiling_finish_ms;
        break;
      }
