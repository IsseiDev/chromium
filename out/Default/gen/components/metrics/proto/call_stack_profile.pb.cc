...
const CallStackProfile_Entry& CallStackProfile_Entry::default_instance() {
  ...
  protobuf_AddDesc_call_5fstack_5fprofile_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_call_5fstack_5fprofile_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(CallStackProfile_Entry, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_module_id_index;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(17)) goto parse_name_md5_prefix;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(CallStackProfile, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(10)) goto parse_loop_sample;
        if (input->ExpectTag(18)) goto parse_loop_module_id;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_module_id;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(24)) goto parse_profile_duration_ms;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_sampling_period_ms;
        break;
      }
