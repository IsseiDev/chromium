...
const SampledProfile& SampledProfile::default_instance() {
  ...
  protobuf_AddDesc_sampled_5fprofile_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_sampled_5fprofile_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(SampledProfile, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_ms_after_boot;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_ms_after_login;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_perf_data;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_suspend_duration_ms;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_ms_after_resume;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_num_tabs_restored;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_ms_after_restore;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_call_stack_profile;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(82)) goto parse_perf_stat;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_process;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(96)) goto parse_thread;
        break;
      }
