...
const CastLogsProto_CastDeviceInfo& CastLogsProto_CastDeviceInfo::default_instance() {
  ...
  protobuf_AddDesc_cast_5flogs_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_cast_5flogs_2eproto();
#endif
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_hardware_revision;
        break;
      }
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(CastLogsProto_CastConnectionInfo_SenderInfo, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_sdk_type;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_chrome_browser_version;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(50)) goto parse_system_version;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_transport_connection_type;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_sender_local_ip_fragment;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(CastLogsProto_CastConnectionInfo, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(21)) goto parse_virtual_connection_id;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_sender_info;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(CastLogsProto_CastEventProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_time_msec;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(29)) goto parse_app_id;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(33)) goto parse_application_session_id;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(41)) goto parse_cast_receiver_version;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(53)) goto parse_transport_connection_id;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(61)) goto parse_virtual_connection_id;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(73)) goto parse_cast_mpl_version;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(81)) goto parse_group_uuid;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(CastLogsProto_CastDeviceMutableInfo, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  &reinterpret_cast<CastLogsProto_CastDeviceMutableInfo*>(16)->f)
#endif
...
#define ZR_(first, last) do {\
  ...
  ZR_(system_build_number_, last_reboot_type_);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(17)) goto parse_system_build_number;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(CastLogsProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_cast_connection_info;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_cast_connection_info;
        if (input->ExpectTag(26)) goto parse_loop_cast_event;
      ...
      case 3: {
        ...
        if (input->ExpectTag(26)) goto parse_loop_cast_event;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(37)) goto parse_virtual_release_track;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_cast_device_mutable_info;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(49)) goto parse_receiver_metrics_id;
        break;
      }
