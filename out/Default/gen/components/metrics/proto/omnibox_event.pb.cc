...
const OmniboxEventProto_Suggestion& OmniboxEventProto_Suggestion::default_instance() {
  ...
  protobuf_AddDesc_omnibox_5fevent_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_omnibox_5fevent_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(OmniboxEventProto_Suggestion, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_relevance;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_is_starred;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_typed_count;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_is_disabled;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(OmniboxEventProto_ProviderInfo, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_provider_done;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(29)) goto parse_field_trial_triggered;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(29)) goto parse_field_trial_triggered;
        if (input->ExpectTag(37)) goto parse_field_trial_triggered_in_session;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(37)) goto parse_field_trial_triggered_in_session;
        if (input->ExpectTag(40)) goto parse_times_returned_results_in_session;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(OmniboxEventProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_tab_id;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_typed_length;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_num_typed_terms;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_selected_index;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(48)) goto parse_completed_length;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_typing_duration_ms;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_input_type;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_suggestion;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(74)) goto parse_loop_suggestion;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(80)) goto parse_current_page_classification;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(88)) goto parse_just_deleted_text;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(98)) goto parse_provider_info;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(98)) goto parse_loop_provider_info;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(104)) goto parse_duration_since_last_default_match_update_ms;
        break;
      }
      ...
      case 13: {
        ...
        if (input->ExpectTag(112)) goto parse_DEPRECATED_is_top_result_hidden_in_dropdown;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(120)) goto parse_is_popup_open;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(128)) goto parse_is_paste_and_go;
        break;
      }
