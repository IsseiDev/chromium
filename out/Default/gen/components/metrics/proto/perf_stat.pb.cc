...
const PerfStatProto_PerfStatLine& PerfStatProto_PerfStatLine::default_instance() {
  ...
  protobuf_AddDesc_perf_5fstat_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_perf_5fstat_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(PerfStatProto_PerfStatLine, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(10)) goto parse_loop_line;
