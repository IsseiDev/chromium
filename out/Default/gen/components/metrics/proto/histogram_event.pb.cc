...
const HistogramEventProto_Bucket& HistogramEventProto_Bucket::default_instance() {
  ...
  protobuf_AddDesc_histogram_5fevent_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_histogram_5fevent_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(HistogramEventProto_Bucket, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_bucket_index;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(HistogramEventProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
