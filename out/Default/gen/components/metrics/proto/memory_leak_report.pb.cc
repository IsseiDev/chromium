...
const MemoryLeakReportProto_Params& MemoryLeakReportProto_Params::default_instance() {
  ...
  protobuf_AddDesc_memory_5fleak_5freport_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_memory_5fleak_5freport_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(MemoryLeakReportProto_Params, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_max_stack_depth;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_analysis_interval_bytes;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_size_suspicion_threshold;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_call_stack_suspicion_threshold;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(8)) goto parse_counts_by_size;
        if (input->ExpectTag(16)) goto parse_count_for_call_stack;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(MemoryLeakReportProto, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(8)) goto parse_call_stack;
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_alloc_breakdown_history;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(34)) goto parse_loop_alloc_breakdown_history;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(40)) goto parse_source_process;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(50)) goto parse_build_id;
        break;
      }
