...
const Fingerprint_Dimension& Fingerprint_Dimension::default_instance() {
  ...
  protobuf_AddDesc_fingerprint_2eproto();
#else
  if (default_instance_ == NULL) protobuf_AddDesc_fingerprint_2eproto();
#endif
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(Fingerprint_Dimension, f) \
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Fingerprint_MachineCharacteristics_Graphics, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Fingerprint_MachineCharacteristics, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_operating_system_build;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_browser_install_time_hours;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_font;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(34)) goto parse_font;
        if (input->ExpectTag(42)) goto parse_plugin;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(42)) goto parse_loop_plugin;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(48)) goto parse_utc_offset_ms;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(58)) goto parse_browser_language;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(66)) goto parse_requested_language;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(80)) goto parse_screen_count;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(90)) goto parse_screen_size;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(96)) goto parse_screen_color_depth;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(106)) goto parse_unavailable_screen_size;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(120)) goto parse_partition_size;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(120)) goto parse_partition_size;
        if (input->ExpectTag(130)) goto parse_cpu;
        break;
      }
      ...
      case 16: {
        ...
        if (input->ExpectTag(136)) goto parse_ram;
        break;
      }
      ...
      case 17: {
        ...
        if (input->ExpectTag(146)) goto parse_graphics_card;
        break;
      }
      ...
      case 18: {
        ...
        if (input->ExpectTag(154)) goto parse_browser_build;
        break;
      }
      ...
      case 19: {
        ...
        if (input->ExpectTag(160)) goto parse_browser_feature;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_outer_window_size;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Fingerprint_Performance, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_metered;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_network_type;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Fingerprint_UserCharacteristics_Vector, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Fingerprint_UserCharacteristics_Location, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_time_in_ms;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Fingerprint_UserCharacteristics, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(21)) goto parse_touch_width;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(29)) goto parse_touch_height;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_touch_rotation;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_device_orientation;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(50)) goto parse_device_acceleration;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(Fingerprint_Metadata, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_obfuscated_gaia_id;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_fingerprinter_version;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_user_characteristics;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_transient_state;
        break;
      }
