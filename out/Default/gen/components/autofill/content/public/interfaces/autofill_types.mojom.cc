...
// static
bool StructTraits<::autofill::mojom::FormFieldData, ::autofill::mojom::FormFieldDataPtr>::Read(
    ::autofill::mojom::FormFieldDataDataView input,
...
// static
bool StructTraits<::autofill::mojom::FormData, ::autofill::mojom::FormDataPtr>::Read(
    ::autofill::mojom::FormDataDataView input,
...
// static
bool StructTraits<::autofill::mojom::FormFieldDataPredictions, ::autofill::mojom::FormFieldDataPredictionsPtr>::Read(
    ::autofill::mojom::FormFieldDataPredictionsDataView input,
...
// static
bool StructTraits<::autofill::mojom::FormDataPredictions, ::autofill::mojom::FormDataPredictionsPtr>::Read(
    ::autofill::mojom::FormDataPredictionsDataView input,
...
// static
bool StructTraits<::autofill::mojom::PasswordAndRealm, ::autofill::mojom::PasswordAndRealmPtr>::Read(
    ::autofill::mojom::PasswordAndRealmDataView input,
...
// static
bool StructTraits<::autofill::mojom::UsernamesCollectionKey, ::autofill::mojom::UsernamesCollectionKeyPtr>::Read(
    ::autofill::mojom::UsernamesCollectionKeyDataView input,
...
// static
bool StructTraits<::autofill::mojom::PasswordFormFillData, ::autofill::mojom::PasswordFormFillDataPtr>::Read(
    ::autofill::mojom::PasswordFormFillDataDataView input,
...
// static
bool StructTraits<::autofill::mojom::PasswordFormGenerationData, ::autofill::mojom::PasswordFormGenerationDataPtr>::Read(
    ::autofill::mojom::PasswordFormGenerationDataDataView input,
  ...
  ::autofill::mojom::PasswordFormGenerationDataPtr result(::autofill::mojom::PasswordFormGenerationData::New());
      ...
      if (!input.ReadAction(&result->action))
        success = false;
      if (!input.ReadGenerationField(&result->generation_field))
        success = false;
  *output = std::move(result);
  return success;
}
...
// static
bool StructTraits<::autofill::mojom::PasswordForm, ::autofill::mojom::PasswordFormPtr>::Read(
    ::autofill::mojom::PasswordFormDataView input,
...
// static
bool StructTraits<::autofill::mojom::PasswordFormFieldPredictionMap, ::autofill::mojom::PasswordFormFieldPredictionMapPtr>::Read(
    ::autofill::mojom::PasswordFormFieldPredictionMapDataView input,
...
// static
bool StructTraits<::autofill::mojom::FormsPredictionsMap, ::autofill::mojom::FormsPredictionsMapPtr>::Read(
    ::autofill::mojom::FormsPredictionsMapDataView input,
