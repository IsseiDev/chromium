...
#ifndef COMPONENTS_AUTOFILL_CONTENT_PUBLIC_INTERFACES_AUTOFILL_TYPES_MOJOM_SHARED_INTERNAL_H_
#define COMPONENTS_AUTOFILL_CONTENT_PUBLIC_INTERFACES_AUTOFILL_TYPES_MOJOM_SHARED_INTERNAL_H_
...
class FormFieldData_Data {
 ...
 private:
  FormFieldData_Data() : header_({sizeof(*this), 0}) {
  }
...
class FormData_Data {
 ...
 private:
  FormData_Data() : header_({sizeof(*this), 0}) {
  }
...
class FormFieldDataPredictions_Data {
 ...
 private:
  FormFieldDataPredictions_Data() : header_({sizeof(*this), 0}) {
  }
...
class FormDataPredictions_Data {
 ...
 private:
  FormDataPredictions_Data() : header_({sizeof(*this), 0}) {
  }
...
class PasswordAndRealm_Data {
 ...
 private:
  PasswordAndRealm_Data() : header_({sizeof(*this), 0}) {
  }
...
class UsernamesCollectionKey_Data {
 ...
 private:
  UsernamesCollectionKey_Data() : header_({sizeof(*this), 0}) {
  }
...
class PasswordFormFillData_Data {
 ...
 private:
  PasswordFormFillData_Data() : header_({sizeof(*this), 0}) {
  }
...
class PasswordFormGenerationData_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::String_Data> name;
  mojo::internal::Pointer<::url::mojom::internal::Url_Data> action;
  mojo::internal::Pointer<internal::FormFieldData_Data> generation_field;

 private:
  PasswordFormGenerationData_Data() : header_({sizeof(*this), 0}) {
  }
...
class PasswordForm_Data {
 ...
 private:
  PasswordForm_Data() : header_({sizeof(*this), 0}) {
  }
...
class PasswordFormFieldPredictionMap_Data {
 ...
 private:
  PasswordFormFieldPredictionMap_Data() : header_({sizeof(*this), 0}) {
  }
...
class FormsPredictionsMap_Data {
 ...
 private:
  FormsPredictionsMap_Data() : header_({sizeof(*this), 0}) {
  }
...
#endif  // COMPONENTS_AUTOFILL_CONTENT_PUBLIC_INTERFACES_AUTOFILL_TYPES_MOJOM_SHARED_INTERNAL_H_