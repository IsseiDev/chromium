...
bool PasswordFormGenerationData_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->name, "null name field in PasswordFormGenerationData",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams name_validate_params(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->action, "null action field in PasswordFormGenerationData",
          validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->action, validation_context))
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->generation_field, "null generation_field field in PasswordFormGenerationData",
          validation_context)) {
    return false;
  }
