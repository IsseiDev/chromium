...
#ifndef COMPONENTS_AUTOFILL_CONTENT_PUBLIC_INTERFACES_AUTOFILL_AGENT_MOJOM_SHARED_INTERNAL_H_
#define COMPONENTS_AUTOFILL_CONTENT_PUBLIC_INTERFACES_AUTOFILL_AGENT_MOJOM_SHARED_INTERNAL_H_
...
#pragma pack(push, 1)
const uint32_t kAutofillAgent_FirstUserGestureObservedInTab_Name = 0;
class AutofillAgent_FirstUserGestureObservedInTab_Params_Data {
 ...
 private:
  AutofillAgent_FirstUserGestureObservedInTab_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_FillForm_Name = 1;
class AutofillAgent_FillForm_Params_Data {
 ...
 private:
  AutofillAgent_FillForm_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_PreviewForm_Name = 2;
class AutofillAgent_PreviewForm_Params_Data {
 ...
 private:
  AutofillAgent_PreviewForm_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_FieldTypePredictionsAvailable_Name = 3;
class AutofillAgent_FieldTypePredictionsAvailable_Params_Data {
 ...
 private:
  AutofillAgent_FieldTypePredictionsAvailable_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_ClearForm_Name = 4;
class AutofillAgent_ClearForm_Params_Data {
 ...
 private:
  AutofillAgent_ClearForm_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_ClearPreviewedForm_Name = 5;
class AutofillAgent_ClearPreviewedForm_Params_Data {
 ...
 private:
  AutofillAgent_ClearPreviewedForm_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_FillFieldWithValue_Name = 6;
class AutofillAgent_FillFieldWithValue_Params_Data {
 ...
 private:
  AutofillAgent_FillFieldWithValue_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_PreviewFieldWithValue_Name = 7;
class AutofillAgent_PreviewFieldWithValue_Params_Data {
 ...
 private:
  AutofillAgent_PreviewFieldWithValue_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_AcceptDataListSuggestion_Name = 8;
class AutofillAgent_AcceptDataListSuggestion_Params_Data {
 ...
 private:
  AutofillAgent_AcceptDataListSuggestion_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_FillPasswordSuggestion_Name = 9;
class AutofillAgent_FillPasswordSuggestion_Params_Data {
 ...
 private:
  AutofillAgent_FillPasswordSuggestion_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_PreviewPasswordSuggestion_Name = 10;
class AutofillAgent_PreviewPasswordSuggestion_Params_Data {
 ...
 private:
  AutofillAgent_PreviewPasswordSuggestion_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kAutofillAgent_ShowInitialPasswordAccountSuggestions_Name = 11;
class AutofillAgent_ShowInitialPasswordAccountSuggestions_Params_Data {
 ...
 private:
  AutofillAgent_ShowInitialPasswordAccountSuggestions_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordAutofillAgent_FillPasswordForm_Name = 0;
class PasswordAutofillAgent_FillPasswordForm_Params_Data {
 ...
 private:
  PasswordAutofillAgent_FillPasswordForm_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordAutofillAgent_SetLoggingState_Name = 1;
class PasswordAutofillAgent_SetLoggingState_Params_Data {
 ...
 private:
  PasswordAutofillAgent_SetLoggingState_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordAutofillAgent_AutofillUsernameAndPasswordDataReceived_Name = 2;
class PasswordAutofillAgent_AutofillUsernameAndPasswordDataReceived_Params_Data {
 ...
 private:
  PasswordAutofillAgent_AutofillUsernameAndPasswordDataReceived_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordAutofillAgent_FindFocusedPasswordForm_Name = 3;
class PasswordAutofillAgent_FindFocusedPasswordForm_Params_Data {
 ...
 private:
  PasswordAutofillAgent_FindFocusedPasswordForm_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class PasswordAutofillAgent_FindFocusedPasswordForm_ResponseParams_Data {
 ...
 private:
  PasswordAutofillAgent_FindFocusedPasswordForm_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordGenerationAgent_GeneratedPasswordAccepted_Name = 0;
class PasswordGenerationAgent_GeneratedPasswordAccepted_Params_Data {
 ...
 private:
  PasswordGenerationAgent_GeneratedPasswordAccepted_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordGenerationAgent_UserTriggeredGeneratePassword_Name = 1;
class PasswordGenerationAgent_UserTriggeredGeneratePassword_Params_Data {
 ...
 private:
  PasswordGenerationAgent_UserTriggeredGeneratePassword_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordGenerationAgent_FormNotBlacklisted_Name = 2;
class PasswordGenerationAgent_FormNotBlacklisted_Params_Data {
 ...
 private:
  PasswordGenerationAgent_FormNotBlacklisted_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordGenerationAgent_FoundFormsEligibleForGeneration_Name = 3;
class PasswordGenerationAgent_FoundFormsEligibleForGeneration_Params_Data {
 ...
 private:
  PasswordGenerationAgent_FoundFormsEligibleForGeneration_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kPasswordGenerationAgent_AllowToRunFormClassifier_Name = 4;
class PasswordGenerationAgent_AllowToRunFormClassifier_Params_Data {
 ...
 private:
  PasswordGenerationAgent_AllowToRunFormClassifier_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
#endif  // COMPONENTS_AUTOFILL_CONTENT_PUBLIC_INTERFACES_AUTOFILL_AGENT_MOJOM_SHARED_INTERNAL_H_