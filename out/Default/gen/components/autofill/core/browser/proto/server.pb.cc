  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(35)) goto parse_field;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(35)) goto parse_loop_field;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(19)) goto parse_form;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(19)) goto parse_loop_form;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(19)) goto parse_field;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(19)) goto parse_loop_field;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(AutofillUploadContents_Field, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 6: {
        ...
        if (input->ExpectTag(61)) goto parse_autofill_type;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(74)) goto parse_autocomplete;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(136)) goto parse_generation_type;
        break;
      }
      ...
      case 17: {
        ...
        if (input->ExpectTag(144)) goto parse_form_classifier_outcome;
        break;
      }
      ...
      case 18: {
        ...
        if (input->ExpectTag(154)) goto parse_css_classes;
        break;
      }
      ...
      case 19: {
        ...
        if (input->ExpectTag(160)) goto parse_properties_mask;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(AutofillUploadContents, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(17)) goto parse_form_signature;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_autofill_used;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_data_present;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(43)) goto parse_field;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(43)) goto parse_loop_field;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(105)) goto parse_action_signature;
        break;
      }
      ...
      case 13: {
        ...
        if (input->ExpectTag(113)) goto parse_login_form_signature;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(120)) goto parse_submission;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(130)) goto parse_form_name;
        break;
      }
