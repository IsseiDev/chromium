...
namespace {
const char kVariationsSeedBridgeClassPath[] =
    "org/chromium/components/variations/firstrun/VariationsSeedBridge";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_VariationsSeedBridge_clazz __attribute__((unused)) =
    0;
...
static void Java_VariationsSeedBridge_clearFirstRunPrefs(JNIEnv* env, const
...
static base::subtle::AtomicWord
    g_VariationsSeedBridge_markVariationsSeedAsStored = 0;
...
static base::subtle::AtomicWord
    g_VariationsSeedBridge_getVariationsFirstRunSeedData = 0;
static base::android::ScopedJavaLocalRef<jbyteArray>
    Java_VariationsSeedBridge_getVariationsFirstRunSeedData(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, VariationsSeedBridge_clazz(env),
...
"[B",
  ...
  jbyteArray ret =
static_cast<jbyteArray>(env->CallStaticObjectMethod(VariationsSeedBridge_clazz(env),
          method_id, context.obj()));
  jni_generator::CheckException(env);
...
static base::subtle::AtomicWord
    g_VariationsSeedBridge_getVariationsFirstRunSeedSignature = 0;
...
"Ljava/lang/String;",
  ...
  jstring ret =
static_cast<jstring>(env->CallStaticObjectMethod(VariationsSeedBridge_clazz(env),
          method_id, context.obj()));
  jni_generator::CheckException(env);
...
static base::subtle::AtomicWord
    g_VariationsSeedBridge_getVariationsFirstRunSeedCountry = 0;
static base::android::ScopedJavaLocalRef<jstring>
...
static base::subtle::AtomicWord
    g_VariationsSeedBridge_getVariationsFirstRunSeedDate = 0;
static base::android::ScopedJavaLocalRef<jstring>
    Java_VariationsSeedBridge_getVariationsFirstRunSeedDate(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& context) {
  CHECK_CLAZZ(env, VariationsSeedBridge_clazz(env),
      VariationsSeedBridge_clazz(env), NULL);
  jmethodID method_id =
...
static base::subtle::AtomicWord
    g_VariationsSeedBridge_getVariationsFirstRunSeedIsGzipCompressed = 0;
static jboolean
...
"Z",
  ...
  jboolean ret =
      env->CallStaticBooleanMethod(VariationsSeedBridge_clazz(env),
          method_id, context.obj());
  jni_generator::CheckException(env);
  return ret;
}
