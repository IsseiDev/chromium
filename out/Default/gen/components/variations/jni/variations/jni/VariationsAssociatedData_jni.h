...
namespace {
const char kVariationsAssociatedDataClassPath[] =
    "org/chromium/components/variations/VariationsAssociatedData";
...
jstring
    ...
    jstring trialName,
    jstring paramName) {
  return GetVariationParamValue(env, base::android::JavaParamRef<jclass>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, trialName),
...
jstring
    ...
    env, jclass jcaller) {
  return GetFeedbackVariations(env, base::android::JavaParamRef<jclass>(env,
      jcaller)).Release();
}
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsVariationsAssociatedDataSize =
      arraysize(kMethodsVariationsAssociatedData);

  if (env->RegisterNatives(VariationsAssociatedData_clazz(env),
                           kMethodsVariationsAssociatedData,
                           kMethodsVariationsAssociatedDataSize) < 0) {
