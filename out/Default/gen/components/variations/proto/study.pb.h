...
class Study_Experiment : public ::google::protobuf::MessageLite {
 public:
  ...
  bool has_google_update_experiment_id() const;
  void clear_google_update_experiment_id();
  static const int kGoogleUpdateExperimentIdFieldNumber = 4;
  ::google::protobuf::uint64 google_update_experiment_id() const;
  void set_google_update_experiment_id(::google::protobuf::uint64 value);
