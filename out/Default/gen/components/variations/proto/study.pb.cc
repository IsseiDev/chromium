...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(Study_Experiment, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 9: {
        ...
        if (input->ExpectTag(74)) goto parse_loop_override_ui_string;
        input->UnsafeDecrementRecursionDepth();
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 9: {
        ...
        if (input->ExpectTag(74)) goto parse_loop_experiment;
        input->UnsafeDecrementRecursionDepth();
...
// optional uint64 google_update_experiment_id = 4;
bool Study_Experiment::has_google_update_experiment_id() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
void Study_Experiment::set_has_google_update_experiment_id() {
  _has_bits_[0] |= 0x00000010u;
}
void Study_Experiment::clear_has_google_update_experiment_id() {
  _has_bits_[0] &= ~0x00000010u;
}
void Study_Experiment::clear_google_update_experiment_id() {
  google_update_experiment_id_ = GOOGLE_ULONGLONG(0);
  clear_has_google_update_experiment_id();
}
 ::google::protobuf::uint64 Study_Experiment::google_update_experiment_id() const {
  // @@protoc_insertion_point(field_get:variations.Study.Experiment.google_update_experiment_id)
  return google_update_experiment_id_;
}
 void Study_Experiment::set_google_update_experiment_id(::google::protobuf::uint64 value) {
  set_has_google_update_experiment_id();
  google_update_experiment_id_ = value;
  // @@protoc_insertion_point(field_set:variations.Study.Experiment.google_update_experiment_id)
}
