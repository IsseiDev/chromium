...
static ::std::string* MutableUnknownFieldsForVariationsSeed(
    VariationsSeed* ptr) {
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  ::google::protobuf::io::LazyStringOutputStream unknown_fields_string(
      ::google::protobuf::internal::NewPermanentCallback(
          &MutableUnknownFieldsForVariationsSeed, this));
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_study;
...
void VariationsSeed::SerializeWithCachedSizes(
  ...
  // repeated .variations.Study study = 2;
  for (unsigned int i = 0, n = this->study_size(); i < n; i++) {
...
void VariationsSeed::InternalSwap(VariationsSeed* other) {
  ...
  study_.UnsafeArenaSwap(&other->study_);
