...
namespace {
const char kChildAccountInfoFetcherClassPath[] =
    "org/chromium/components/signin/ChildAccountInfoFetcher";
...
static void SetIsChildAccount(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong ptrAccountFetcherService,
...
void
    ...
    jstring accountId,
    jboolean isChildAccount) {
  return SetIsChildAccount(env, base::android::JavaParamRef<jclass>(env,
      jcaller), ptrAccountFetcherService,
      base::android::JavaParamRef<jstring>(env, accountId), isChildAccount);
}

static base::subtle::AtomicWord g_ChildAccountInfoFetcher_fetch = 0;
static void Java_ChildAccountInfoFetcher_fetch(JNIEnv* env, jlong
    nativeAccountFetcherService,
...
")"
"V",
      &g_ChildAccountInfoFetcher_fetch);

     env->CallStaticVoidMethod(ChildAccountInfoFetcher_clazz(env),
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsChildAccountInfoFetcherSize =
      arraysize(kMethodsChildAccountInfoFetcher);

  if (env->RegisterNatives(ChildAccountInfoFetcher_clazz(env),
                           kMethodsChildAccountInfoFetcher,
                           kMethodsChildAccountInfoFetcherSize) < 0) {
