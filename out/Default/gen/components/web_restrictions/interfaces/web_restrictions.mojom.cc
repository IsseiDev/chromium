...
class WebRestrictions_GetResult_ResponseParamsDataView {
 public:
  ...
  template <typename UserType>
  bool ReadReply(UserType* output) {
    auto pointer = data_->reply.Get();
    return mojo::internal::Deserialize<::web_restrictions::mojom::ClientResultPtr>(
        pointer, output, context_);
  }
 private:
...
const uint32_t WebRestrictions::Version_;
...
class WebRestrictions_GetResult_HandleSyncResponse
 ...
 public:
  WebRestrictions_GetResult_HandleSyncResponse(
      ...
      : serialization_context_(std::move(group_controller)), result_(result), out_reply_(out_reply) {
    DCHECK(!*result_);
  }
 ...
 private:
  ...
  bool* result_;
  ClientResultPtr* out_reply_;DISALLOW_COPY_AND_ASSIGN(WebRestrictions_GetResult_HandleSyncResponse);
};
bool WebRestrictions_GetResult_HandleSyncResponse::Accept(
    mojo::Message* message) {
  internal::WebRestrictions_GetResult_ResponseParams_Data* params =
      reinterpret_cast<internal::WebRestrictions_GetResult_ResponseParams_Data*>(
...
bool WebRestrictions_RequestPermission_ForwardToCallback::Accept(
    mojo::Message* message) {
  internal::WebRestrictions_RequestPermission_ResponseParams_Data* params =
      reinterpret_cast<internal::WebRestrictions_RequestPermission_ResponseParams_Data*>(
          message->mutable_payload());
...
bool WebRestrictionsProxy::GetResult(
  ...
  auto params =
      ::web_restrictions::mojom::internal::WebRestrictions_GetResult_Params_Data::New(builder.buffer());
  ...
  mojo::MessageReceiver* responder =
      new WebRestrictions_GetResult_HandleSyncResponse(
          serialization_context_.group_controller, &result, param_reply);
...
void WebRestrictionsProxy::GetResult(
  ...
  (&serialization_context_)->handles.Swap(
      builder.message()->mutable_handles());
  mojo::MessageReceiver* responder =
      new WebRestrictions_GetResult_ForwardToCallback(
...
void WebRestrictionsProxy::RequestPermission(
  ...
  auto params =
      ::web_restrictions::mojom::internal::WebRestrictions_RequestPermission_Params_Data::New(builder.buffer());
  ALLOW_UNUSED_LOCAL(params);
  typename decltype(params->url)::BaseType* url_ptr;
  mojo::internal::Serialize<mojo::String>(
      in_url, builder.buffer(), &url_ptr, &serialization_context_);
  ...
  (&serialization_context_)->handles.Swap(
      builder.message()->mutable_handles());
  mojo::MessageReceiver* responder =
      new WebRestrictions_RequestPermission_ForwardToCallback(
          callback, serialization_context_.group_controller);
  if (!receiver_->AcceptWithResponder(builder.message(), responder))
    delete responder;
}
...
void WebRestrictions_GetResult_ProxyToResponder::Run(
  ...
  size += mojo::internal::PrepareToSerialize<::web_restrictions::mojom::ClientResultPtr>(
      in_reply, &serialization_context_);
  mojo::internal::ResponseMessageBuilder builder(
      internal::kWebRestrictions_GetResult_Name, size, request_id_,
      is_sync_ ? mojo::Message::kFlagIsSync : 0);
  auto params =
      ::web_restrictions::mojom::internal::WebRestrictions_GetResult_ResponseParams_Data::New(builder.buffer());
  ALLOW_UNUSED_LOCAL(params);
  typename decltype(params->reply)::BaseType* reply_ptr;
  mojo::internal::Serialize<::web_restrictions::mojom::ClientResultPtr>(
...
void WebRestrictions_RequestPermission_ProxyToResponder::Run(
  ...
  mojo::internal::ResponseMessageBuilder builder(
      ...
      is_sync_ ? mojo::Message::kFlagIsSync : 0);
  auto params =
      ::web_restrictions::mojom::internal::WebRestrictions_RequestPermission_ResponseParams_Data::New(builder.buffer());
  ALLOW_UNUSED_LOCAL(params);
...
WebRestrictionsStub::WebRestrictionsStub()
    : sink_(nullptr),
      control_message_handler_(WebRestrictions::Version_) {
}

WebRestrictionsStub::~WebRestrictionsStub() {}

bool WebRestrictionsStub::Accept(mojo::Message* message) {
...
bool WebRestrictionsStub::AcceptWithResponder(
    mojo::Message* message, mojo::MessageReceiverWithStatus* responder) {
  if (mojo::internal::ControlMessageHandler::IsControlMessage(message))
    return control_message_handler_.AcceptWithResponder(message, responder);
  switch (message->header()->name) {
    case internal::kWebRestrictions_GetResult_Name: {
      internal::WebRestrictions_GetResult_Params_Data* params =
          reinterpret_cast<internal::WebRestrictions_GetResult_Params_Data*>(
              message->mutable_payload());
      ...
      WebRestrictions::GetResultCallback callback =
          WebRestrictions_GetResult_ProxyToResponder::CreateCallback(
              message->request_id(),
...
std::move(p_url), callback);
    ...
    case internal::kWebRestrictions_RequestPermission_Name: {
      internal::WebRestrictions_RequestPermission_Params_Data* params =
          reinterpret_cast<internal::WebRestrictions_RequestPermission_Params_Data*>(
              message->mutable_payload());
      ...
      WebRestrictions::RequestPermissionCallback callback =
          WebRestrictions_RequestPermission_ProxyToResponder::CreateCallback(
              message->request_id(),
              message->has_flag(mojo::Message::kFlagIsSync),
              responder,
              serialization_context_.group_controller);
...
WebRestrictionsRequestValidator::WebRestrictionsRequestValidator(
...
WebRestrictionsResponseValidator::WebRestrictionsResponseValidator(
    mojo::MessageReceiver* sink) : MessageFilter(sink) {
}
...
// static
bool StructTraits<::web_restrictions::mojom::ClientResult, ::web_restrictions::mojom::ClientResultPtr>::Read(
    ::web_restrictions::mojom::ClientResultDataView input,
