...
class WebRestrictions_GetResult_Params_Data {
 ...
 private:
  WebRestrictions_GetResult_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebRestrictions_GetResult_ResponseParams_Data {
 ...
 private:
  WebRestrictions_GetResult_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebRestrictions_RequestPermission_Name = 1;
class WebRestrictions_RequestPermission_Params_Data {
 ...
 private:
  WebRestrictions_RequestPermission_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebRestrictions_RequestPermission_ResponseParams_Data {
 ...
 private:
  WebRestrictions_RequestPermission_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
