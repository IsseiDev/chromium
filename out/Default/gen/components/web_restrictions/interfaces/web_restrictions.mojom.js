...
define("components/web_restrictions/interfaces/web_restrictions.mojom", [
  ...
  ClientResult.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, ClientResult.encodedSize, 0);
  ...
  WebRestrictions_GetResult_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, WebRestrictions_GetResult_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebRestrictions_GetResult_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, WebRestrictions_GetResult_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebRestrictions_RequestPermission_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, WebRestrictions_RequestPermission_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebRestrictions_RequestPermission_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, WebRestrictions_RequestPermission_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebRestrictions_RequestPermission_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.result = decoder.decodeStruct(codec.Uint8);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  WebRestrictions_RequestPermission_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Uint8, val.result);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  WebRestrictionsProxy.prototype = Object.create(bindings.ProxyBase.prototype);
  ...
  WebRestrictionsStub.prototype = Object.create(bindings.StubBase.prototype);
  WebRestrictionsStub.prototype.getResult = function(url) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.getResult && bindings.StubBindings(this).delegate.getResult(url);
  }
  WebRestrictionsStub.prototype.requestPermission = function(url) {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.requestPermission && bindings.StubBindings(this).delegate.requestPermission(url);
  }
