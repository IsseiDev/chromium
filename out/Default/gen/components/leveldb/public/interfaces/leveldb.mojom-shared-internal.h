...
class BatchedOperation_Data {
 ...
 private:
  BatchedOperation_Data() : header_({sizeof(*this), 0}) {
  }
...
class KeyValue_Data {
 ...
 private:
  KeyValue_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBService_Open_Params_Data {
 ...
 private:
  LevelDBService_Open_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBService_Open_ResponseParams_Data {
 ...
 private:
  LevelDBService_Open_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBService_OpenWithOptions_Name = 1;
class LevelDBService_OpenWithOptions_Params_Data {
 ...
 private:
  LevelDBService_OpenWithOptions_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBService_OpenWithOptions_ResponseParams_Data {
 ...
 private:
  LevelDBService_OpenWithOptions_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBService_OpenInMemory_Name = 2;
class LevelDBService_OpenInMemory_Params_Data {
 ...
 private:
  LevelDBService_OpenInMemory_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBService_OpenInMemory_ResponseParams_Data {
 ...
 private:
  LevelDBService_OpenInMemory_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_Put_Name = 0;
class LevelDBDatabase_Put_Params_Data {
 ...
 private:
  LevelDBDatabase_Put_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_Put_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_Put_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_Delete_Name = 1;
class LevelDBDatabase_Delete_Params_Data {
 ...
 private:
  LevelDBDatabase_Delete_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_Delete_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_Delete_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_DeletePrefixed_Name = 2;
class LevelDBDatabase_DeletePrefixed_Params_Data {
 ...
 private:
  LevelDBDatabase_DeletePrefixed_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_DeletePrefixed_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_DeletePrefixed_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_Write_Name = 3;
class LevelDBDatabase_Write_Params_Data {
 ...
 private:
  LevelDBDatabase_Write_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_Write_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_Write_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_Get_Name = 4;
class LevelDBDatabase_Get_Params_Data {
 ...
 private:
  LevelDBDatabase_Get_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_Get_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_Get_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_GetPrefixed_Name = 5;
class LevelDBDatabase_GetPrefixed_Params_Data {
 ...
 private:
  LevelDBDatabase_GetPrefixed_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_GetPrefixed_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_GetPrefixed_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_GetSnapshot_Name = 6;
class LevelDBDatabase_GetSnapshot_Params_Data {
 ...
 private:
  LevelDBDatabase_GetSnapshot_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_GetSnapshot_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_GetSnapshot_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_ReleaseSnapshot_Name = 7;
class LevelDBDatabase_ReleaseSnapshot_Params_Data {
 ...
 private:
  LevelDBDatabase_ReleaseSnapshot_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_GetFromSnapshot_Name = 8;
class LevelDBDatabase_GetFromSnapshot_Params_Data {
 ...
 private:
  LevelDBDatabase_GetFromSnapshot_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_GetFromSnapshot_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_GetFromSnapshot_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_NewIterator_Name = 9;
class LevelDBDatabase_NewIterator_Params_Data {
 ...
 private:
  LevelDBDatabase_NewIterator_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_NewIterator_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_NewIterator_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_NewIteratorFromSnapshot_Name = 10;
class LevelDBDatabase_NewIteratorFromSnapshot_Params_Data {
 ...
 private:
  LevelDBDatabase_NewIteratorFromSnapshot_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_NewIteratorFromSnapshot_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_NewIteratorFromSnapshot_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_ReleaseIterator_Name = 11;
class LevelDBDatabase_ReleaseIterator_Params_Data {
 ...
 private:
  LevelDBDatabase_ReleaseIterator_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_IteratorSeekToFirst_Name = 12;
class LevelDBDatabase_IteratorSeekToFirst_Params_Data {
 ...
 private:
  LevelDBDatabase_IteratorSeekToFirst_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_IteratorSeekToFirst_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_IteratorSeekToFirst_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_IteratorSeekToLast_Name = 13;
class LevelDBDatabase_IteratorSeekToLast_Params_Data {
 ...
 private:
  LevelDBDatabase_IteratorSeekToLast_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_IteratorSeekToLast_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_IteratorSeekToLast_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_IteratorSeek_Name = 14;
class LevelDBDatabase_IteratorSeek_Params_Data {
 ...
 private:
  LevelDBDatabase_IteratorSeek_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_IteratorSeek_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_IteratorSeek_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_IteratorNext_Name = 15;
class LevelDBDatabase_IteratorNext_Params_Data {
 ...
 private:
  LevelDBDatabase_IteratorNext_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_IteratorNext_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_IteratorNext_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kLevelDBDatabase_IteratorPrev_Name = 16;
class LevelDBDatabase_IteratorPrev_Params_Data {
 ...
 private:
  LevelDBDatabase_IteratorPrev_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class LevelDBDatabase_IteratorPrev_ResponseParams_Data {
 ...
 private:
  LevelDBDatabase_IteratorPrev_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
