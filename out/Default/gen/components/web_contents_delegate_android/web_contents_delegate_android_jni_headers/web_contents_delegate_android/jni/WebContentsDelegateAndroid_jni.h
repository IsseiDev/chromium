...
static void Java_WebContentsDelegateAndroid_loadingStateChanged(JNIEnv* env,
    const base::android::JavaRefOrBare<jobject>& obj, jboolean
    toDifferentDocument) {
  CHECK_CLAZZ(env, obj.obj(),
      WebContentsDelegateAndroid_clazz(env));
  jmethodID method_id =
...
static base::subtle::AtomicWord
    g_WebContentsDelegateAndroid_visibleSSLStateChanged = 0;
...
static void Java_WebContentsDelegateAndroid_notifyLoadProgressChanged(JNIEnv*
    env, const base::android::JavaRefOrBare<jobject>& obj, jdouble progress) {
  CHECK_CLAZZ(env, obj.obj(),
      WebContentsDelegateAndroid_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
"V",
     ...
     env->CallVoidMethod(obj.obj(),
          method_id, sourceWebContents.obj(), openerRenderFrameId,
              frameName.obj(), targetUrl.obj(), newWebContents.obj());
  jni_generator::CheckException(env);

}

static base::subtle::AtomicWord
    g_WebContentsDelegateAndroid_shouldCreateWebContents = 0;
static jboolean Java_WebContentsDelegateAndroid_shouldCreateWebContents(JNIEnv*
    ...
    base::android::JavaRefOrBare<jstring>& targetUrl) {
  CHECK_CLAZZ(env, obj.obj(),
...
static base::subtle::AtomicWord g_WebContentsDelegateAndroid_onGoToEntryOffset =
    0;
...
static jboolean Java_WebContentsDelegateAndroid_takeFocus(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jboolean reverse) {
  CHECK_CLAZZ(env, obj.obj(),
      WebContentsDelegateAndroid_clazz(env), false);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
