...
base::subtle::AtomicWord g_ColorChooserAndroid_clazz __attribute__((unused)) =
    0;
...
void
  ...
  return native->OnColorChosen(env, base::android::JavaParamRef<jobject>(env,
      jcaller), color);
}
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ColorChooserAndroid_createColorChooserAndroid(JNIEnv* env, jlong
...
"Lorg/chromium/components/web_contents_delegate_android/ColorChooserAndroid;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ColorChooserAndroid_clazz(env),
...
"[Lorg/chromium/ui/ColorSuggestion;",
  ...
  jobjectArray ret =
static_cast<jobjectArray>(env->CallStaticObjectMethod(ColorChooserAndroid_clazz(env),
