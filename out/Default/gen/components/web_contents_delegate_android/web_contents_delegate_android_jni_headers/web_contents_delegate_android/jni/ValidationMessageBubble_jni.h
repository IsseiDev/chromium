...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ValidationMessageBubble_createAndShow(JNIEnv* env, const
...
"Lorg/chromium/components/web_contents_delegate_android/ValidationMessageBubble;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ValidationMessageBubble_clazz(env),
...
static void Java_ValidationMessageBubble_close(JNIEnv* env, const
