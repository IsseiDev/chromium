  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_element_types;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_activation_types;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_domains;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(42)) goto parse_loop_domains;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(48)) goto parse_url_pattern_type;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_anchor_left;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_anchor_right;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_match_case;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(82)) goto parse_url_pattern;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_domains;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_domains;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(26)) goto parse_css_selector;
        break;
      }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(10)) goto parse_loop_url_rules;
        if (input->ExpectTag(18)) goto parse_loop_css_rules;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
