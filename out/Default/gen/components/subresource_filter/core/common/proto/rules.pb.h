...
template <> struct is_proto_enum< ::subresource_filter::proto::RuleType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::subresource_filter::proto::UrlPatternType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::subresource_filter::proto::AnchorType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::subresource_filter::proto::ElementType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::subresource_filter::proto::ActivationType> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::subresource_filter::proto::RuleSemantics> : ::google::protobuf::internal::true_type {};
template <> struct is_proto_enum< ::subresource_filter::proto::SourceType> : ::google::protobuf::internal::true_type {};
