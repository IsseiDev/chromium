...
struct UrlRule FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(domains()) &&
           verifier.VerifyVectorOfStrings(domains()) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_URL_PATTERN) &&
           verifier.Verify(url_pattern()) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_FAILURE_FUNCTION) &&
           verifier.Verify(failure_function()) &&
           verifier.EndTable();
  }
};
...
struct UrlRuleBuilder {
  ...
  UrlRuleBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct NGramToRules FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_RULE_LIST) &&
...
struct NGramToRulesBuilder {
  ...
  NGramToRulesBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct UrlPatternIndex FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_NGRAM_INDEX) &&
           verifier.Verify(ngram_index()) &&
           verifier.VerifyVectorOfTables(ngram_index()) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_NGRAM_INDEX_EMPTY_SLOT) &&
           verifier.VerifyTable(ngram_index_empty_slot()) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_FALLBACK_RULES) &&
...
struct UrlPatternIndexBuilder {
  ...
  UrlPatternIndexBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
...
struct IndexedRuleset FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_BLACKLIST_INDEX) &&
           verifier.VerifyTable(blacklist_index()) &&
           VerifyField<flatbuffers::uoffset_t>(verifier, VT_WHITELIST_INDEX) &&
...
struct IndexedRulesetBuilder {
  ...
  IndexedRulesetBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) { start_ = fbb_.StartTable(); }
