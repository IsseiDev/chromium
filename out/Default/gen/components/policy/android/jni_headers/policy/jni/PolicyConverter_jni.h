...
void Java_org_chromium_policy_PolicyConverter_nativeSetPolicyBoolean(JNIEnv*
    env,
    jobject jcaller,
    jlong nativePolicyConverter,
    jstring policyKey,
    jboolean value) {
  PolicyConverter* native =
      reinterpret_cast<PolicyConverter*>(nativePolicyConverter);
  CHECK_NATIVE_PTR(env, jcaller, native, "SetPolicyBoolean");
  return native->SetPolicyBoolean(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, policyKey), value);
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_policy_PolicyConverter_nativeSetPolicyInteger(JNIEnv*
    env,
    jobject jcaller,
    jlong nativePolicyConverter,
    jstring policyKey,
  ...
  return native->SetPolicyInteger(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, policyKey), value);
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_policy_PolicyConverter_nativeSetPolicyString(JNIEnv* env,
    jobject jcaller,
    jlong nativePolicyConverter,
    jstring policyKey,
    jstring value) {
  ...
  return native->SetPolicyString(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, policyKey),
      base::android::JavaParamRef<jstring>(env, value));
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_policy_PolicyConverter_nativeSetPolicyStringArray(JNIEnv*
    env,
    jobject jcaller,
    jlong nativePolicyConverter,
    jstring policyKey,
...
"Lorg/chromium/policy/PolicyConverter;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(PolicyConverter_clazz(env),
