...
namespace {
const char kCombinedPolicyProviderClassPath[] =
    "org/chromium/policy/CombinedPolicyProvider";
...
void Java_org_chromium_policy_CombinedPolicyProvider_nativeFlushPolicies(JNIEnv*
    env,
    jobject jcaller,
  ...
  return native->FlushPolicies(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}

static base::subtle::AtomicWord g_CombinedPolicyProvider_linkNative = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_CombinedPolicyProvider_linkNative(JNIEnv* env, jlong
    nativeCombinedPolicyProvider,
...
"Lorg/chromium/policy/CombinedPolicyProvider;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(CombinedPolicyProvider_clazz(env),
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsCombinedPolicyProviderSize =
      arraysize(kMethodsCombinedPolicyProvider);

  if (env->RegisterNatives(CombinedPolicyProvider_clazz(env),
                           kMethodsCombinedPolicyProvider,
                           kMethodsCombinedPolicyProviderSize) < 0) {
