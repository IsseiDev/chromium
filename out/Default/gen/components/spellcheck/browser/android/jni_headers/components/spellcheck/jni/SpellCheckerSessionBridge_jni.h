...
namespace {
const char kSpellCheckerSessionBridgeClassPath[] =
    "org/chromium/components/spellcheck/SpellCheckerSessionBridge";
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_SpellCheckerSessionBridge_create(JNIEnv* env, jlong
...
"Lorg/chromium/components/spellcheck/SpellCheckerSessionBridge;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(SpellCheckerSessionBridge_clazz(env),
          method_id, nativeSpellCheckerSessionBridge);
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_SpellCheckerSessionBridge_requestTextCheck =
    0;
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsSpellCheckerSessionBridgeSize =
      arraysize(kMethodsSpellCheckerSessionBridge);

  if (env->RegisterNatives(SpellCheckerSessionBridge_clazz(env),
                           kMethodsSpellCheckerSessionBridge,
                           kMethodsSpellCheckerSessionBridgeSize) < 0) {
