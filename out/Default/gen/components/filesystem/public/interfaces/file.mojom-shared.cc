...
bool File_Write_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->bytes_to_write, "null bytes_to_write field in File_Write_Params",
          validation_context)) {
    return false;
  }
...
bool File_Dup_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->file,
          "invalid file field in File_Dup_Params", validation_context)) {
    return false;
  }
...
bool File_AsHandle_ResponseParams_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->file_handle,
          "invalid file_handle field in File_AsHandle_ResponseParams", validation_context)) {
    return false;
  }
