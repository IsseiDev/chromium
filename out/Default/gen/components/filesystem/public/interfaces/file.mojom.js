...
define("components/filesystem/public/interfaces/file.mojom", [
  ...
  File_Flush_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_Flush_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_Flush_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_Flush_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_Lock_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_Lock_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_Lock_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_Lock_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_Unlock_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_Unlock_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_Unlock_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_Unlock_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_AsHandle_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_AsHandle_Params.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_AsHandle_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, File_AsHandle_ResponseParams.encodedSize, 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  File_AsHandle_ResponseParams.encodedSize = codec.kStructHeaderSize + 8;
  ...
  FileStub.prototype.lock = function() {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.lock && bindings.StubBindings(this).delegate.lock();
  }
  FileStub.prototype.unlock = function() {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.unlock && bindings.StubBindings(this).delegate.unlock();
  }
  FileStub.prototype.asHandle = function() {
    return bindings.StubBindings(this).delegate && bindings.StubBindings(this).delegate.asHandle && bindings.StubBindings(this).delegate.asHandle();
  }
