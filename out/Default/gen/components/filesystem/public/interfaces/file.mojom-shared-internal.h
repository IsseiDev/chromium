...
#pragma pack(push, 1)
const uint32_t kFile_Close_Name = 0;
class File_Close_Params_Data {
 ...
 private:
  File_Close_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Close_ResponseParams_Data {
 ...
 private:
  File_Close_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Read_Name = 1;
class File_Read_Params_Data {
 ...
 private:
  File_Read_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Read_ResponseParams_Data {
 ...
 private:
  File_Read_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Write_Name = 2;
class File_Write_Params_Data {
 ...
 private:
  File_Write_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Write_ResponseParams_Data {
 ...
 private:
  File_Write_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Tell_Name = 3;
class File_Tell_Params_Data {
 ...
 private:
  File_Tell_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Tell_ResponseParams_Data {
 ...
 private:
  File_Tell_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Seek_Name = 4;
class File_Seek_Params_Data {
 ...
 private:
  File_Seek_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Seek_ResponseParams_Data {
 ...
 private:
  File_Seek_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Stat_Name = 5;
class File_Stat_Params_Data {
 ...
 private:
  File_Stat_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Stat_ResponseParams_Data {
 ...
 private:
  File_Stat_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Truncate_Name = 6;
class File_Truncate_Params_Data {
 ...
 private:
  File_Truncate_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Truncate_ResponseParams_Data {
 ...
 private:
  File_Truncate_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Touch_Name = 7;
class File_Touch_Params_Data {
 ...
 private:
  File_Touch_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Touch_ResponseParams_Data {
 ...
 private:
  File_Touch_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Dup_Name = 8;
class File_Dup_Params_Data {
 ...
 private:
  File_Dup_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Dup_ResponseParams_Data {
 ...
 private:
  File_Dup_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Flush_Name = 9;
class File_Flush_Params_Data {
 ...
 private:
  File_Flush_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Flush_ResponseParams_Data {
 ...
 private:
  File_Flush_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Lock_Name = 10;
class File_Lock_Params_Data {
 ...
 private:
  File_Lock_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Lock_ResponseParams_Data {
 ...
 private:
  File_Lock_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_Unlock_Name = 11;
class File_Unlock_Params_Data {
 ...
 private:
  File_Unlock_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_Unlock_ResponseParams_Data {
 ...
 private:
  File_Unlock_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFile_AsHandle_Name = 12;
class File_AsHandle_Params_Data {
 ...
 private:
  File_AsHandle_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
class File_AsHandle_ResponseParams_Data {
 ...
 private:
  File_AsHandle_ResponseParams_Data() : header_({sizeof(*this), 0}) {
  }
  ~File_AsHandle_ResponseParams_Data() = delete;
};
static_assert(sizeof(File_AsHandle_ResponseParams_Data) == 16,
