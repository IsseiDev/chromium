...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(SearchEngineSpecifics, f) \
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[8 / 32] & 32512u) {
    ZR_(show_in_default_list_, prepopulate_id_);
...
// optional bool show_in_default_list = 9;
bool SearchEngineSpecifics::has_show_in_default_list() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
void SearchEngineSpecifics::set_has_show_in_default_list() {
  _has_bits_[0] |= 0x00000100u;
}
void SearchEngineSpecifics::clear_has_show_in_default_list() {
  _has_bits_[0] &= ~0x00000100u;
}
void SearchEngineSpecifics::clear_show_in_default_list() {
  show_in_default_list_ = false;
  clear_has_show_in_default_list();
}
 bool SearchEngineSpecifics::show_in_default_list() const {
  // @@protoc_insertion_point(field_get:sync_pb.SearchEngineSpecifics.show_in_default_list)
  return show_in_default_list_;
}
 void SearchEngineSpecifics::set_show_in_default_list(bool value) {
  set_has_show_in_default_list();
  show_in_default_list_ = value;
  // @@protoc_insertion_point(field_set:sync_pb.SearchEngineSpecifics.show_in_default_list)
}
