  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_window;
...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(SessionTab, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        ...
        if (input->ExpectTag(58)) goto parse_loop_navigation;
        input->UnsafeDecrementRecursionDepth();
      ...
      case 11: {
        ...
        if (input->ExpectTag(96)) goto parse_variation_id;
        break;
      }
...
#define ZR_HELPER_(f) \
  _Pragma("clang diagnostic push") \
  _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") \
  __builtin_offsetof(TabNavigation, f) \
  _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>(\
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 20: {
        ...
        if (input->ExpectTag(168)) goto parse_obsolete_referrer_policy;
        break;
      }
      ...
      case 22: {
        ...
        if (input->ExpectTag(186)) goto parse_navigation_redirect;
        break;
      }
      ...
      case 23: {
        ...
        if (input->ExpectTag(186)) goto parse_loop_navigation_redirect;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectTag(194)) goto parse_last_navigation_redirect_url;
        break;
      }
      ...
      case 24: {
        ...
        if (input->ExpectTag(200)) goto parse_correct_referrer_policy;
        break;
      }
