...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(PasswordSpecificsData, f) \
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 13: {
        ...
        if (input->ExpectTag(112)) goto parse_times_used;
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(122)) goto parse_display_name;
        break;
      }
      ...
      case 15: {
        ...
        if (input->ExpectTag(130)) goto parse_avatar_url;
        break;
      }
      ...
      case 16: {
        ...
        if (input->ExpectTag(138)) goto parse_federation_url;
        break;
      }
