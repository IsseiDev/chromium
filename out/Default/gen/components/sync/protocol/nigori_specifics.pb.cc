...
#define ZR_HELPER_(f) \
  ...
  __builtin_offsetof(NigoriSpecifics, f) \
...
#define ZR_(first, last) do {\
  ...
  if (_has_bits_[24 / 32] & 520093696u) {
    ZR_(encrypt_articles_, encrypt_arc_package_);
  }
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 38: {
        ...
        if (input->ExpectTag(312)) goto parse_encrypt_autofill_wallet_metadata;
        break;
      }
      ...
      case 39: {
        ...
        if (input->ExpectTag(320)) goto parse_server_only_was_missing_keystore_migration_time;
        break;
      }
      ...
      case 40: {
        ...
        if (input->ExpectTag(328)) goto parse_encrypt_arc_package;
        break;
      }
