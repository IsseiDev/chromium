...
class NigoriSpecifics : public ::google::protobuf::MessageLite {
 public:
  ...
  static const PassphraseType IMPLICIT_PASSPHRASE =
    NigoriSpecifics_PassphraseType_IMPLICIT_PASSPHRASE;
  static const PassphraseType KEYSTORE_PASSPHRASE =
    NigoriSpecifics_PassphraseType_KEYSTORE_PASSPHRASE;
  static const PassphraseType FROZEN_IMPLICIT_PASSPHRASE =
    NigoriSpecifics_PassphraseType_FROZEN_IMPLICIT_PASSPHRASE;
  static const PassphraseType CUSTOM_PASSPHRASE =
...
template <> struct is_proto_enum< ::sync_pb::NigoriSpecifics_PassphraseType> : ::google::protobuf::internal::true_type {};
