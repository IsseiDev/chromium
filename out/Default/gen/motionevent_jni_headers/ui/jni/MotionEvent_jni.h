...
static base::subtle::AtomicWord g_MotionEvent_getActionButton = 0;
static jint Java_MotionEvent_getActionButton(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) __attribute__ ((unused));
static jint Java_MotionEvent_getActionButton(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static base::subtle::AtomicWord g_MotionEvent_isButtonPressed = 0;
static jboolean Java_MotionEvent_isButtonPressed(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper p0) __attribute__
    ((unused));
static jboolean Java_MotionEvent_isButtonPressed(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper p0) {
  CHECK_CLAZZ(env, obj.obj(),
      MotionEvent_clazz(env), false);
  jmethodID method_id =
      base::android::MethodID::LazyGet<
      base::android::MethodID::TYPE_INSTANCE>(
      env, MotionEvent_clazz(env),
