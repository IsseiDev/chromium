...
jboolean
  ...
  return native->StartTracing(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, categories),
...
void
  ...
  return native->StopTracing(env, base::android::JavaParamRef<jobject>(env,
...
jstring
    ...
    env, jobject jcaller) {
  return GetDefaultCategories(env, base::android::JavaParamRef<jobject>(env,
      jcaller)).Release();
}

static base::subtle::AtomicWord
    g_TracingControllerAndroid_generateTracingFilePath = 0;
...
"Ljava/lang/String;",
  ...
  jstring ret =
static_cast<jstring>(env->CallStaticObjectMethod(TracingControllerAndroid_clazz(env),
          method_id));
...
static void Java_TracingControllerAndroid_onTracingStopped(JNIEnv* env, const
