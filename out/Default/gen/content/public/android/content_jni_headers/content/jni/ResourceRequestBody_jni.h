...
namespace {
const char kResourceRequestBodyClassPath[] =
    "org/chromium/content_public/common/ResourceRequestBody";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_ResourceRequestBody_clazz __attribute__((unused)) =
    0;
...
static base::android::ScopedJavaLocalRef<jbyteArray>
    CreateResourceRequestBodyFromBytes(JNIEnv* env, const
...
static base::subtle::AtomicWord
    g_ResourceRequestBody_createFromEncodedNativeForm = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_ResourceRequestBody_createFromEncodedNativeForm(JNIEnv* env, const
    base::android::JavaRefOrBare<jbyteArray>& encodedNativeForm) {
...
"Lorg/chromium/content_public/common/ResourceRequestBody;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ResourceRequestBody_clazz(env),
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsResourceRequestBodySize =
      arraysize(kMethodsResourceRequestBody);

  if (env->RegisterNatives(ResourceRequestBody_clazz(env),
                           kMethodsResourceRequestBody,
                           kMethodsResourceRequestBodySize) < 0) {
