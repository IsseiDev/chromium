...
void
  ...
  return native->Proceed(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
void
  ...
  return native->DontProceed(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
static void Java_InterstitialPageDelegateAndroid_commandReceived(JNIEnv* env,
    ...
    base::android::JavaRefOrBare<jstring>& command) {
  CHECK_CLAZZ(env, obj.obj(),
      InterstitialPageDelegateAndroid_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
