...
namespace {
const char kMediaThrottlerClassPath[] =
    "org/chromium/content/browser/MediaThrottler";
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_MediaThrottler_create(JNIEnv* env, const
...
"Lorg/chromium/content/browser/MediaThrottler;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(MediaThrottler_clazz(env),
...
static jboolean Java_MediaThrottler_requestDecoderResources(JNIEnv* env, const
...
static void Java_MediaThrottler_onDecodeRequestFinished(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static void Java_MediaThrottler_reset(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      MediaThrottler_clazz(env));
  jmethodID method_id =
