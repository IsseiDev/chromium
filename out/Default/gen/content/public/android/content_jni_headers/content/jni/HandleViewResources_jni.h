...
namespace {
const char kHandleViewResourcesClassPath[] =
    "org/chromium/content/browser/input/HandleViewResources";
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_HandleViewResources_clazz __attribute__((unused)) =
    0;
...
static base::subtle::AtomicWord
    g_HandleViewResources_getHandleHorizontalPaddingRatio = 0;
...
"F",
  ...
  jfloat ret =
      env->CallStaticFloatMethod(HandleViewResources_clazz(env),
          method_id);
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_HandleViewResources_getLeftHandleBitmap(JNIEnv* env, const
...
"Landroid/graphics/Bitmap;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(HandleViewResources_clazz(env),
