...
namespace {
const char kDeviceSensorsClassPath[] =
    "org/chromium/content/browser/DeviceSensors";
...
void
    ...
    jdouble beta,
    jdouble gamma) {
  SensorManagerAndroid* native =
      reinterpret_cast<SensorManagerAndroid*>(nativeSensorManagerAndroid);
...
void
  ...
  return native->GotAcceleration(env, base::android::JavaParamRef<jobject>(env,
      jcaller), x, y, z);
}
...
void
  ...
  return native->GotRotationRate(env, base::android::JavaParamRef<jobject>(env,
      jcaller), alpha, beta, gamma);
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_content_browser_DeviceSensors_nativeGotLight(JNIEnv* env,
    jobject jcaller,
    jlong nativeSensorManagerAndroid,
    jdouble value) {
  SensorManagerAndroid* native =
  ...
  return native->GotLight(env, base::android::JavaParamRef<jobject>(env,
      jcaller), value);
}

static base::subtle::AtomicWord g_DeviceSensors_start = 0;
static jboolean Java_DeviceSensors_start(JNIEnv* env, const
...
static base::subtle::AtomicWord
    g_DeviceSensors_getNumberActiveDeviceMotionSensors = 0;
...
static base::subtle::AtomicWord g_DeviceSensors_getOrientationSensorTypeUsed =
    0;
static jint Java_DeviceSensors_getOrientationSensorTypeUsed(JNIEnv* env, const
...
static void Java_DeviceSensors_stop(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_DeviceSensors_getInstance(JNIEnv* env, const
...
"Lorg/chromium/content/browser/DeviceSensors;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(DeviceSensors_clazz(env),
