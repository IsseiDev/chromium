...
namespace {
const char kBackgroundSyncNetworkObserverClassPath[] =
    "org/chromium/content/browser/BackgroundSyncNetworkObserver";
...
static base::subtle::AtomicWord g_BackgroundSyncNetworkObserver_createObserver =
    0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_BackgroundSyncNetworkObserver_createObserver(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& ctx,
    jlong nativePtr) {
...
"Lorg/chromium/content/browser/BackgroundSyncNetworkObserver;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(BackgroundSyncNetworkObserver_clazz(env),
          method_id, ctx.obj(), nativePtr);
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_BackgroundSyncNetworkObserver_removeObserver =
    0;
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsBackgroundSyncNetworkObserverSize =
      arraysize(kMethodsBackgroundSyncNetworkObserver);

  if (env->RegisterNatives(BackgroundSyncNetworkObserver_clazz(env),
                           kMethodsBackgroundSyncNetworkObserver,
                           kMethodsBackgroundSyncNetworkObserverSize) < 0) {
