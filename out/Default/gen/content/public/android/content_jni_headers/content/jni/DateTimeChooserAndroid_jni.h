...
void
  ...
  return native->ReplaceDateTime(env, base::android::JavaParamRef<jobject>(env,
      jcaller), dialogValue);
}
...
"Lorg/chromium/content/browser/input/DateTimeChooserAndroid;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(DateTimeChooserAndroid_clazz(env),
...
"[Lorg/chromium/ui/picker/DateTimeSuggestion;",
  ...
  jobjectArray ret =
static_cast<jobjectArray>(env->CallStaticObjectMethod(DateTimeChooserAndroid_clazz(env),
