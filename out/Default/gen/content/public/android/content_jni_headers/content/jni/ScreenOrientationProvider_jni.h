...
namespace {
const char kScreenOrientationProviderClassPath[] =
    "org/chromium/content/browser/ScreenOrientationProvider";
...
static void Java_ScreenOrientationProvider_lockOrientation(JNIEnv* env, jbyte
    orientation) {
...
"V",
     ...
     env->CallStaticVoidMethod(ScreenOrientationProvider_clazz(env),
          method_id, orientation);
  jni_generator::CheckException(env);

}

static base::subtle::AtomicWord g_ScreenOrientationProvider_unlockOrientation =
    0;
static void Java_ScreenOrientationProvider_unlockOrientation(JNIEnv* env) {
  CHECK_CLAZZ(env, ScreenOrientationProvider_clazz(env),
      ScreenOrientationProvider_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static base::subtle::AtomicWord
    g_ScreenOrientationProvider_startAccurateListening = 0;
...
static base::subtle::AtomicWord
    g_ScreenOrientationProvider_stopAccurateListening = 0;
