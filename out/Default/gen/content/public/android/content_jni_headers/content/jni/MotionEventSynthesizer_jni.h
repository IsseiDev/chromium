...
namespace {
const char kMotionEventSynthesizerClassPath[] =
    "org/chromium/content/browser/MotionEventSynthesizer";
...
static void Java_MotionEventSynthesizer_setPointer(JNIEnv* env, const
...
static void Java_MotionEventSynthesizer_setScrollDeltas(JNIEnv* env, const
...
static void Java_MotionEventSynthesizer_inject(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper action,
