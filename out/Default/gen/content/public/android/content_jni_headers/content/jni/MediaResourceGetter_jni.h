...
// Leaking this jclass as we cannot use LazyInstance from some threads.
base::subtle::AtomicWord g_MediaResourceGetter_clazz __attribute__((unused)) =
    0;
...
static jint Java_MediaMetadata_getDurationInMilliseconds(JNIEnv* env, const
...
static jint Java_MediaMetadata_getWidth(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      MediaMetadata_clazz(env), 0);
  jmethodID method_id =
...
static jint Java_MediaMetadata_getHeight(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      MediaMetadata_clazz(env), 0);
  jmethodID method_id =
...
static jboolean Java_MediaMetadata_isSuccess(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_MediaResourceGetter_extractMediaMetadata(JNIEnv* env, const
...
"Lorg/chromium/content/browser/MediaResourceGetter$MediaMetadata;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(MediaResourceGetter_clazz(env),
