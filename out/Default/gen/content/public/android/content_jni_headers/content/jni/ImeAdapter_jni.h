...
jboolean
  ...
  return native->SendKeyEvent(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jobject>(env, event), type,
      modifiers, timestampMs, keyCode, scanCode, isSystemKey, unicodeChar);
}

static void AppendUnderlineSpan(JNIEnv* env, const
...
void
    ...
    jint start,
    jint end) {
  return AppendUnderlineSpan(env, base::android::JavaParamRef<jclass>(env,
      jcaller), underlinePtr, start, end);
}

static void AppendBackgroundColorSpan(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jlong underlinePtr,
    jint start,
    jint end,
...
void
    ...
    jint end,
    jint backgroundColor) {
  return AppendBackgroundColorSpan(env, base::android::JavaParamRef<jclass>(env,
      jcaller), underlinePtr, start, end, backgroundColor);
}
...
void
  ...
  return native->SetComposingText(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jobject>(env, text),
      base::android::JavaParamRef<jstring>(env, textStr), newCursorPosition);
}

extern "C" __attribute__((visibility("default")))
void Java_org_chromium_content_browser_input_ImeAdapter_nativeCommitText(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeImeAdapterAndroid,
    jstring textStr) {
  ...
  return native->CommitText(env, base::android::JavaParamRef<jobject>(env,
      jcaller), base::android::JavaParamRef<jstring>(env, textStr));
}
...
void
  ...
  return native->AttachImeAdapter(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
void
  ...
  return native->ResetImeAdapter(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
extern "C" __attribute__((visibility("default")))
jboolean
    Java_org_chromium_content_browser_input_ImeAdapter_nativeIsImeThreadEnabled(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeImeAdapterAndroid) {
  ImeAdapterAndroid* native =
      reinterpret_cast<ImeAdapterAndroid*>(nativeImeAdapterAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "IsImeThreadEnabled", false);
  return native->IsImeThreadEnabled(env,
      base::android::JavaParamRef<jobject>(env, jcaller));
}

static base::subtle::AtomicWord g_ImeAdapter_focusedNodeChanged = 0;
static void Java_ImeAdapter_focusedNodeChanged(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jboolean isEditable) {
...
static void Java_ImeAdapter_populateUnderlinesFromSpans(JNIEnv* env, const
...
static void Java_ImeAdapter_cancelComposition(JNIEnv* env, const
...
static void Java_ImeAdapter_setCharacterBounds(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jfloatArray>& characterBounds) {
  CHECK_CLAZZ(env, obj.obj(),
      ImeAdapter_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static void Java_ImeAdapter_detach(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      ImeAdapter_clazz(env));
  jmethodID method_id =
...
"V",
    ...
    { "nativeIsImeThreadEnabled",
"("
"J"
")"
"Z",
    reinterpret_cast<void*>(Java_org_chromium_content_browser_input_ImeAdapter_nativeIsImeThreadEnabled)
    },
};
