...
static base::android::ScopedJavaLocalRef<jstring> FindAddress(JNIEnv* env, const
...
jstring
  ...
  return FindAddress(env, base::android::JavaParamRef<jclass>(env, jcaller),
      base::android::JavaParamRef<jstring>(env, addr)).Release();
}

static void SetWebKitSharedTimersSuspended(JNIEnv* env, const
    base::android::JavaParamRef<jclass>& jcaller,
    jboolean suspend);
