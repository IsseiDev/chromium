...
static base::subtle::AtomicWord g_MediaMetadata_createAndAddArtwork = 0;
static void Java_MediaMetadata_createAndAddArtwork(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jstring>& src,
...
")"
"V",
      &g_MediaMetadata_createAndAddArtwork);
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_MediaMetadata_create(JNIEnv* env, const
...
"Lorg/chromium/content_public/common/MediaMetadata;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(MediaMetadata_clazz(env),
