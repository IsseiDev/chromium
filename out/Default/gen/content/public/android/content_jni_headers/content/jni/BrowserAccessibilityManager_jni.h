...
jint
  ...
  return native->GetRootId(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
jboolean
  ...
  return native->IsNodeValid(env, base::android::JavaParamRef<jobject>(env,
      jcaller), id);
}
...
jboolean
  ...
  return native->IsEditableText(env, base::android::JavaParamRef<jobject>(env,
      jcaller), id);
}
...
void
  ...
  return native->HitTest(env, base::android::JavaParamRef<jobject>(env,
      jcaller), x, y);
}
...
jint
  ...
  return native->FindElementType(env, base::android::JavaParamRef<jobject>(env,
      jcaller), startId, base::android::JavaParamRef<jstring>(env, elementType),
      forwards);
}
...
void
  ...
  return native->SetSelection(env, base::android::JavaParamRef<jobject>(env,
      jcaller), id, start, end);
}
...
jboolean
  ...
  return native->AdjustSlider(env, base::android::JavaParamRef<jobject>(env,
      jcaller), id, increment);
}
...
jboolean
  ...
  return native->IsSlider(env, base::android::JavaParamRef<jobject>(env,
      jcaller), id);
}
...
"Lorg/chromium/content/browser/accessibility/BrowserAccessibilityManager;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(BrowserAccessibilityManager_clazz(env),
...
static void Java_BrowserAccessibilityManager_onNativeObjectDestroyed(JNIEnv*
    env, const base::android::JavaRefOrBare<jobject>& obj, jlong
    nativeBrowserAccessibilityManagerAndroid) {
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_finishGranularityMove = 0;
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_sendDelayedWindowContentChangedEvent = 0;
static void
...
static base::subtle::AtomicWord g_BrowserAccessibilityManager_handlePageLoaded =
    0;
static void Java_BrowserAccessibilityManager_handlePageLoaded(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper id) {
  CHECK_CLAZZ(env, obj.obj(),
      BrowserAccessibilityManager_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static void Java_BrowserAccessibilityManager_handleCheckStateChanged(JNIEnv*
    env, const base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper id) {
  CHECK_CLAZZ(env, obj.obj(),
      BrowserAccessibilityManager_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static void Java_BrowserAccessibilityManager_handleClicked(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper id) {
  CHECK_CLAZZ(env, obj.obj(),
      BrowserAccessibilityManager_clazz(env));
  jmethodID method_id =
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_handleSliderChanged = 0;
...
static base::subtle::AtomicWord g_BrowserAccessibilityManager_handleNavigate =
    0;
static void Java_BrowserAccessibilityManager_handleNavigate(JNIEnv* env, const
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_handleScrollPositionChanged = 0;
...
static void Java_BrowserAccessibilityManager_handleHover(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper id) {
  CHECK_CLAZZ(env, obj.obj(),
      BrowserAccessibilityManager_clazz(env));
  jmethodID method_id =
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_addAccessibilityNodeInfoActions = 0;
static void
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_setAccessibilityNodeInfoClassName = 0;
static void
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_setAccessibilityNodeInfoText = 0;
static void
...
static void
    ...
    env, const base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jobject>& event,
    jboolean checked,
    jboolean enabled,
    jboolean password,
    jboolean scrollable) {
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_setAccessibilityEventLollipopAttributes = 0;
static void
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_setAccessibilityEventHeadingFlag = 0;
static void
...
static base::subtle::AtomicWord
    g_BrowserAccessibilityManager_shouldExposePasswordText = 0;
static jboolean
    Java_BrowserAccessibilityManager_shouldExposePasswordText(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
