...
void
  ...
  return native->OnAudioStart(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
void
  ...
  return native->OnSoundStart(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
void
  ...
  return native->OnSoundEnd(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
void
  ...
  return native->OnAudioEnd(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}
...
void
  ...
  return native->OnRecognitionEnd(env, base::android::JavaParamRef<jobject>(env,
      jcaller));
}

static base::subtle::AtomicWord g_SpeechRecognition_createSpeechRecognition = 0;
static base::android::ScopedJavaLocalRef<jobject>
    Java_SpeechRecognition_createSpeechRecognition(JNIEnv* env, const
...
"Lorg/chromium/content/browser/SpeechRecognition;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(SpeechRecognition_clazz(env),
...
static void Java_SpeechRecognition_startRecognition(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, const
    base::android::JavaRefOrBare<jstring>& language,
    jboolean continuous,
...
static void Java_SpeechRecognition_abortRecognition(JNIEnv* env, const
...
static void Java_SpeechRecognition_stopRecognition(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj) {
  CHECK_CLAZZ(env, obj.obj(),
      SpeechRecognition_clazz(env));
  jmethodID method_id =
