...
static base::android::ScopedJavaLocalRef<jobject>
    GetSingletonJavaContentVideoView(JNIEnv* env, const
...
extern "C" __attribute__((visibility("default")))
void Java_org_chromium_content_browser_ContentVideoView_nativeSetSurface(JNIEnv*
    env,
    jobject jcaller,
    jlong nativeContentVideoView,
    jobject surface) {
  ...
  return native->SetSurface(env, base::android::JavaParamRef<jobject>(env,
...
static void Java_ContentVideoView_onMediaPlayerError(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, JniIntWrapper errorType) {
...
static void Java_ContentVideoView_onVideoSizeChanged(JNIEnv* env, const
...
static void Java_ContentVideoView_openVideo(JNIEnv* env, const
...
static base::android::ScopedJavaLocalRef<jobject>
    Java_ContentVideoView_createContentVideoView(JNIEnv* env, const
...
"Lorg/chromium/content/browser/ContentVideoView;",
  ...
  jobject ret =
      env->CallStaticObjectMethod(ContentVideoView_clazz(env),
          method_id, contentViewCore.obj(), nativeContentVideoView,
              as_jint(videoWidth), as_jint(videoHeight));
  jni_generator::CheckException(env);
  return base::android::ScopedJavaLocalRef<jobject>(env, ret);
}

static base::subtle::AtomicWord g_ContentVideoView_exitFullscreen = 0;
static void Java_ContentVideoView_exitFullscreen(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jboolean releaseMediaPlayer) {
  CHECK_CLAZZ(env, obj.obj(),
      ContentVideoView_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
...
static void Java_ContentVideoView_destroyContentVideoView(JNIEnv* env, const
    base::android::JavaRefOrBare<jobject>& obj, jboolean nativeViewDestroyed) {
  CHECK_CLAZZ(env, obj.obj(),
      ContentVideoView_clazz(env));
  jmethodID method_id =
      base::android::MethodID::LazyGet<
