...
// static
bool LevelDBObserver_GetAllComplete_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  const LevelDBObserver_GetAllComplete_Params_Data* object = static_cast<const LevelDBObserver_GetAllComplete_Params_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->source, "null source field in LevelDBObserver_GetAllComplete_Params",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams source_validate_params(
...
bool LevelDBWrapper_GetAll_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->source, "null source field in LevelDBWrapper_GetAll_Params",
          validation_context)) {
    return false;
  }
  const mojo::internal::ContainerValidateParams source_validate_params(
