...
#ifndef CONTENT_COMMON_WEBSOCKET_MOJOM_SHARED_INTERNAL_H_
#define CONTENT_COMMON_WEBSOCKET_MOJOM_SHARED_INTERNAL_H_
...
class HttpHeader_Data {
 ...
 private:
  HttpHeader_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebSocketHandshakeRequest_Data {
 ...
 private:
  WebSocketHandshakeRequest_Data() : header_({sizeof(*this), 0}) {
  }
...
class WebSocketHandshakeResponse_Data {
 ...
 private:
  WebSocketHandshakeResponse_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnFailChannel_Name = 0;
class WebSocketClient_OnFailChannel_Params_Data {
 ...
 private:
  WebSocketClient_OnFailChannel_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnStartOpeningHandshake_Name = 1;
class WebSocketClient_OnStartOpeningHandshake_Params_Data {
 ...
 private:
  WebSocketClient_OnStartOpeningHandshake_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnFinishOpeningHandshake_Name = 2;
class WebSocketClient_OnFinishOpeningHandshake_Params_Data {
 ...
 private:
  WebSocketClient_OnFinishOpeningHandshake_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnAddChannelResponse_Name = 3;
class WebSocketClient_OnAddChannelResponse_Params_Data {
 ...
 private:
  WebSocketClient_OnAddChannelResponse_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnDataFrame_Name = 4;
class WebSocketClient_OnDataFrame_Params_Data {
 ...
 private:
  WebSocketClient_OnDataFrame_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnFlowControl_Name = 5;
class WebSocketClient_OnFlowControl_Params_Data {
 ...
 private:
  WebSocketClient_OnFlowControl_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnDropChannel_Name = 6;
class WebSocketClient_OnDropChannel_Params_Data {
 ...
 private:
  WebSocketClient_OnDropChannel_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocketClient_OnClosingHandshake_Name = 7;
class WebSocketClient_OnClosingHandshake_Params_Data {
 ...
 private:
  WebSocketClient_OnClosingHandshake_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocket_AddChannelRequest_Name = 0;
class WebSocket_AddChannelRequest_Params_Data {
 ...
 private:
  WebSocket_AddChannelRequest_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocket_SendFrame_Name = 1;
class WebSocket_SendFrame_Params_Data {
 ...
 private:
  WebSocket_SendFrame_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocket_SendFlowControl_Name = 2;
class WebSocket_SendFlowControl_Params_Data {
 ...
 private:
  WebSocket_SendFlowControl_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kWebSocket_StartClosingHandshake_Name = 3;
class WebSocket_StartClosingHandshake_Params_Data {
 ...
 private:
  WebSocket_StartClosingHandshake_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
#endif  // CONTENT_COMMON_WEBSOCKET_MOJOM_SHARED_INTERNAL_H_