...
#pragma pack(push, 1)
const uint32_t kFrame_GetInterfaceProvider_Name = 0;
class Frame_GetInterfaceProvider_Params_Data {
 ...
 private:
  Frame_GetInterfaceProvider_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFrameHost_GetInterfaceProvider_Name = 0;
class FrameHost_GetInterfaceProvider_Params_Data {
 ...
 private:
  FrameHost_GetInterfaceProvider_Params_Data() : header_({sizeof(*this), 0}) {
  }
...
const uint32_t kFrameFactory_CreateFrame_Name = 0;
class FrameFactory_CreateFrame_Params_Data {
 ...
 private:
  FrameFactory_CreateFrame_Params_Data() : header_({sizeof(*this), 0}) {
  }
