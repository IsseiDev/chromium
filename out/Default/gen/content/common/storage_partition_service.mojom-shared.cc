...
bool StoragePartitionService_OpenLocalStorage_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->origin, "null origin field in StoragePartitionService_OpenLocalStorage_Params",
          validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->observer,
          "invalid observer field in StoragePartitionService_OpenLocalStorage_Params", validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->database,
          "invalid database field in StoragePartitionService_OpenLocalStorage_Params", validation_context)) {
    return false;
  }
